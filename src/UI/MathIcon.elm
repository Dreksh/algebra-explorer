...
charStrokes_ c = case c of
    ...
    '4' -> ([Move (0.6,-0.9), Curve (-0.1,0.2) (-0.1,0) (0.9,-0.2), Move (0.7,-0.7), Curve (0.75,-0.2) (0.7,-0.2) (0.7,0.4)], (0, -1), (1, 0.5))
    '5' -> ([Move (0.1,-0.8), Curve (0.6,-0.8) (0.5,-0.8) (0.8,-0.9), Move (0.15,-0.8), Line (0.1,-0.4), Curve (1.1,-0.1) (1.1,0.4) (0.2,0.4)], (0, -1), (1, 0.5))
