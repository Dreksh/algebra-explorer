...
{
	if (region.ap.T === region.aA.T)
	{
		return 'on line ' + region.ap.T;
	}
	return 'on lines ' + region.ap.T + ' through ' + region.aA.T;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aE: fragment, aI: host, aO: path, aQ: port_, aT: protocol, ad: query};
	});
...
var $author$project$Display$init = A2(
	...
	{ax: $elm$core$Maybe$Nothing, F: $elm$core$Dict$empty, V: 0, w: $elm$core$Maybe$Nothing});
var $author$project$Menu$init = function (shown) {
	return {B: shown};
};
var $author$project$Notification$init = {M: 0, v: $elm$core$Dict$empty};
var $author$project$Rules$init = {n: $elm$core$Dict$empty, o: false, p: $elm$core$Dict$empty, C: $elm$core$Dict$empty};
var $author$project$Tutorial$init = {aM: 0, a$: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bh: col, c: s0.c, d: s0.d, b: offset, aZ: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aZ, s.bh, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bh: col, bi: contextStack, bw: problem, aZ: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aZ, s.bh, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aZ, s.bh, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bh: newCol, c: s.c, d: s.d, b: newOffset, aZ: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {bh: col, c: context, d: indent, b: offset, aZ: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.af, s.b + 1, s.aZ + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.af, firstOffset, s.aZ, s.bh + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aC: $elm$parser$Parser$ExpectingVariable, af: i.af, al: i.al, ap: i.ap});
};
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Math$BinaryNode(
					{as: true, S: children, aw: true, y: '+', J: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bh: col, bw: problem, aZ: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aZ, p.bh, p.bw);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bh: 1, c: _List_Nil, d: 1, b: 0, aZ: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				o: newScreen ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
				E: $elm$core$Maybe$Nothing,
				t: $author$project$Display$init(eqs),
...
var $author$project$Rules$addTopic = F2(
	function (topic, m) {
		var id = $elm$core$String$toLower(topic.y);
					...
					function (name, props, result) {
						if (result.$ === 1) {
							...
							if (_v1.$ === 1) {
								...
								var p = _v2.a;
								var count = _v2.b;
								return (_Utils_eq(p.ab, props.ab) && (_Utils_eq(p.ac, props.ac) && (_Utils_eq(p.as, props.as) && _Utils_eq(p.aw, props.aw)))) ? $elm$core$Result$Ok(
									A3(
										$elm$core$Dict$insert,
										name,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bd: false, bf: r.bf, bl: r.bl, aF: r.aF, br: r.br, bD: r.bD, a5: r.a5, bG: r.bG}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bf: $elm$http$Http$emptyBody, bl: r.bl, aF: _List_Nil, br: 'GET', bD: $elm$core$Maybe$Nothing, a5: $elm$core$Maybe$Nothing, bG: r.bG});
};
				...
				switch (root.$) {
					case 0:
						...
						return _List_fromArray(
							[
								$author$project$Math$Text(
								$elm$core$String$fromFloat(s.a7))
							]);
					case 1:
						var s = root.a;
						return ($elm$core$String$length(s.y) === 1) ? _List_fromArray(
							[
								$author$project$Math$Text(s.y)
							]) : _List_fromArray(
							[
								$author$project$Math$Text('\\' + s.y)
							]);
					case 2:
						var s = root.a;
						return (s.y === '/') ? (multiplicativeFirst ? _List_fromArray(
							[
...
var $author$project$Rules$Rule_ = F6(
	function (title, description, reversible, lhs, rhs, parameters) {
		return {az: description, ah: lhs, bv: parameters, am: reversible, an: rhs, bE: title};
	});
...
var $author$project$Rules$parseExpression_ = F2(
	function (functions, str) {
		...
		if (_v0.$ === 1) {
			...
			var root = _v0.a;
			return $elm$core$Result$Ok(
				{y: str, aY: root, Z: $elm$core$Dict$empty});
		}
	});
		...
		if (!e.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						v: A2($elm$core$Dict$remove, id, model.v)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Display$update, e, model.t);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				var query = A2(
			...
			case 8:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{o: $elm$core$Maybe$Nothing, A: false}),
			...
			case 9:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: $elm$core$Maybe$Just($elm$core$Maybe$Nothing)
						}),
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{o: $elm$core$Maybe$Nothing, t: dModel, A: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
						...
						function () {
							if (id.$ === 1) {
								return A2($author$project$Display$addEquation, root, model.t);
							} else {
								var i = id.a;
								return A3($author$project$Display$updateEquation, i, root, model.t);
							}
						}());
				} else {
					var err = _v5.a;
																						...
																						[
																							...
																							_List_fromArray(
																								[
																									$author$project$HtmlEvent$onClick(
																									converter(
																										A2($author$project$Rules$ClickRule, topic.y, index)))
																								]),
																							_List_fromArray(
																								[
		...
		while (true) {
			if (!children.b) {
				...
				if (!path.b) {
					...
					if (!path.b.b) {
						var x = path.a;
						return (!_Utils_eq(x, s.q)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(root);
					} else {
						var x = path.a;
						var next = path.b;
						if (!_Utils_eq(x, s.q)) {
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$author$project$HtmlEvent$onClick(
							A2($author$project$Display$Select, eq, s.J.q))
						]),
					_Utils_eq(
						s.J.q,
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Main$RulesEvent,
											model.j,
											$author$project$Display$selectedNode(model.t))
										]))
								]))
						])),
