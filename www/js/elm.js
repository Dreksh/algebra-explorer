...
{
	if (region.aB.D === region.V.D)
	{
		return 'on line ' + region.aB.D;
	}
	return 'on lines ' + region.aB.D + ' through ' + region.V.D;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {Z: fragment, aa: host, aj: path, al: port_, ap: protocol, aq: query};
	});
...
var $author$project$Display$init = function (trees) {
	return {W: _List_Nil, ag: 0, ay: _List_Nil};
};
var $author$project$Notification$init = {af: 0, ah: _List_Nil};
var $author$project$Rules$init = {av: _List_Nil};
var $author$project$Tutorial$init = {ai: 0, ax: 0};
...
var $author$project$Main$init = F3(
	function (_v0, _v1, _v2) {
		return _Utils_Tuple2(
			{
				I: $author$project$Display$init(_List_Nil),
				K: $author$project$Notification$init,
				N: $author$project$Rules$init,
				Q: $author$project$Tutorial$init
			},
...
var $author$project$Main$append = F2(
	function (child, current) {
		return _Utils_ap(
			current,
			_List_fromArray(
				[child]));
...
var $author$project$Main$wrap = F3(
	function (tag, attrs, childrenGenerator) {
		return A2(
			tag,
			attrs,
			childrenGenerator(_List_Nil));
	});
var $author$project$Main$view = function (model) {
	return {
		aM: A2(
			$author$project$Main$append,
			A3($author$project$Notification$view, $author$project$Main$NotificationEvent, _List_Nil, model.K),
			A2(
				$author$project$Main$append,
				A3($author$project$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.Q),
				A2(
					$author$project$Main$append,
					A3(
							...
							$author$project$Main$append(
								A3(
									...
									A2(
										...
										$author$project$Main$append(
											A3($author$project$Display$view, $author$project$Main$DisplayEvent, _List_Nil, model.I))))),
							$author$project$Main$append(
								A3($author$project$Rules$view, $author$project$Main$RulesEvent, _List_Nil, model.N)))),
					_List_Nil))),
		a8: 'Maths'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{aY: $author$project$Main$init, a1: $author$project$Main$EventUrlChange, a2: $author$project$Main$EventUrlRequest, a7: $author$project$Main$subscriptions, a9: $author$project$Main$update, bb: $author$project$Main$view});
