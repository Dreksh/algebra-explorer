...
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			n: {A: top + height, u: left, y: left + width, D: top},
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{z: true, ak: children, t: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{z: s.z, ak: newChildren, t: s.t, a: s.a, b: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.e, props.e) && (_Utils_eq(p.z, props.z) && _Utils_eq(p.t, props.t))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
	...
	function (parent, result, args, existing, tracker) {
		...
		switch (existing.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{z: s.z, ak: newChildren, t: s.t, a: s.a, b: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
					...
					function (children) {
						...
						if (_v1.$ === 1) {
							...
							if ((f.e === 2) && (f.z || f.t)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{z: f.z, ak: children, t: f.t, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
			...
			return A2(
				...
				A3(
					...
					function (subEq) {
						...
						if (!_v2.$) {
							var n = _v2.a;
							return (!_Utils_eq(target, n.w)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.n.u)),
				_Utils_Tuple2(
				'right',
				$elm$json$Json$Encode$float(model.n.y)),
				_Utils_Tuple2(
				'top',
				$elm$json$Json$Encode$float(model.n.D)),
				_Utils_Tuple2(
				'bottom',
				$elm$json$Json$Encode$float(model.n.A)),
				_Utils_Tuple2(
				'id',
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {B: createMode, i: display, R: evaluator, aF: historyBox, aG: menu, aq: nextCreateInt, ae: notification, bn: rules, Y: showHelp, aI: showHistory, ab: showMenu, aK: tutorial};
											};
										};
									};
								};
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, z: associative, t: commutative, an: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.z || f.t) && (f.e !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.z && (!f.t)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {F: constants, C: functions, a: name, bn: rules};
	});
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {A: bottom, u: left, y: right, D: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {n: coordinates, al: drags, ck: id};
	});
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										n: {A: orig.A + dy, u: orig.u + dx, y: orig.y + dx, D: orig.D + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										n: _Utils_update(
											orig,
											{
												u: A2($elm$core$Basics$min, orig.y - 2, orig.u + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 1:
								...
								_Utils_update(
									model,
									{
										n: _Utils_update(
											orig,
											{
												y: A2($elm$core$Basics$max, orig.u + 2, orig.y + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 3:
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{B: $elm$core$Maybe$Nothing, i: dModel, Y: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bn: A2($author$project$Components$Rules$addSources, source.v, model.bn)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
			...
			default:
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var eqNum = _v40.a;
						var id = _v40.b;
						var _v41 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.w, model.i);
						if (_v41.$ === 1) {
							var errStr = _v41.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
						...
						return _Utils_update(
							applies,
							{
								a5: $elm$core$Maybe$Just(
									$author$project$Components$Rules$NumericalSubstitution(n.w))
							});
					case 5:
						return _Utils_update(
							applies,
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{a2: res, m: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				...
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.z, r.z) && (_Utils_eq(l.t, r.t) && (_Utils_eq(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					'left',
					$elm$core$String$fromFloat(model.n.u) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(model.n.D) + 'dvh'),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.n.y - model.n.u) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.n.A - model.n.D) + 'dvh'),
