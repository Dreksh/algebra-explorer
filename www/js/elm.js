...
{
	if (region.aK.I === region.af.I)
	{
		return 'on line ' + region.aK.I;
	}
	return 'on lines ' + region.aK.I + ' through ' + region.af.I;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ai: fragment, ak: host, at: path, av: port_, aA: protocol, V: query};
	});
...
var $author$project$Notification$ClearEvent = $elm$core$Basics$identity;
...
var $author$project$Notification$parsingErrorMessage_ = F2(
	function (str, err) {
		return 'Error parsing \"' + (str + ('\": ' + $elm$parser$Parser$deadEndsToString(err)));
	});
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$Notification$delayedClear_(model.E)
					])));
	});
...
var $author$project$Math$Add = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Math$Collapsed = F2(
	function (a, b) {
		return {$: 8, a: a, b: b};
	});
...
var $author$project$Math$Multiply = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Math$Negative = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
...
var $author$project$Math$Reciprocal = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
...
var $author$project$Display$finalizeNode_ = F4(
	function (nodeGen, parentId, id, _v0) {
		var c = _v0.a;
		var _v1 = _v0.b;
		var nextId = _v1.a;
		var map = _v1.b;
		return _Utils_Tuple2(
			...
			_Utils_Tuple2(
				nextId,
				A3($elm$core$Dict$insert, id, parentId, map)));
	});
var $author$project$Display$processChildren_ = F3(
	function (id, map, children) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (input, _v4) {
					var list = _v4.a;
					var newMap = _v4.b;
					var _v5 = A3($author$project$Display$processNode_, id, newMap, input);
					var node = _v5.a;
					var finalMap = _v5.b;
					return _Utils_Tuple2(
						_Utils_ap(
			...
			_Utils_Tuple2(_List_Nil, map),
			children);
	});
var $author$project$Display$processFunctionProperties_ = F3(
	function (id, map, properties) {
		var _v2 = A3($author$project$Display$processChildren_, id, map, properties.Z);
		var newArgs = _v2.a;
		var newMap = _v2.b;
		var _v3 = A3($author$project$Display$processChildren_, id, newMap, properties.as);
		var newParams = _v3.a;
		var finalMap = _v3.b;
		return _Utils_Tuple2(
			{Z: newArgs, _: properties._, ac: properties.ac, ao: properties.ao, aq: properties.aq, as: newParams, aO: properties.aO},
			finalMap);
	});
var $author$project$Display$processNode_ = F3(
	function (parentId, _v0, root) {
		var id = _v0.a;
		var map = _v0.b;
		switch (root.$) {
			case 0:
				var children = root.b;
				return A4(
					$author$project$Display$finalizeNode_,
					$author$project$Math$Add,
					parentId,
					id,
					A3(
						$author$project$Display$processChildren_,
						id,
						_Utils_Tuple2(id + 1, map),
						children));
			case 1:
				var children = root.b;
				return A4(
					$author$project$Display$finalizeNode_,
					$author$project$Math$Multiply,
					parentId,
					id,
					A3(
						$author$project$Display$processChildren_,
			...
			case 5:
				...
				return A4(
					...
					id,
					A3(
						$author$project$Display$processFunctionProperties_,
						id,
						_Utils_Tuple2(id + 1, map),
						properties));
			case 3:
				...
				return A4(
					$author$project$Display$finalizeNode_,
					$author$project$Math$Negative,
					parentId,
					id,
					A3(
						$author$project$Display$processNode_,
						id,
						_Utils_Tuple2(id + 1, map),
						child));
			case 4:
				...
				return A4(
					$author$project$Display$finalizeNode_,
					$author$project$Math$Reciprocal,
					parentId,
					id,
					A3(
						$author$project$Display$processNode_,
...
var $author$project$Display$addEquation = F2(
	function (tree, model) {
		var equation = A3(
			$author$project$Display$processNode_,
			0,
			_Utils_Tuple2(1, $elm$core$Dict$empty),
			tree);
		return _Utils_update(
			model,
			{
				D: A3($elm$core$Dict$insert, model.J, equation, model.D),
				J: model.J + 1
			});
	});
var $author$project$Display$init = A2(
	...
	{ad: $elm$core$Maybe$Nothing, D: $elm$core$Dict$empty, J: 0, aH: $elm$core$Maybe$Nothing});
var $author$project$Notification$init = {E: 0, y: _List_Nil};
var $author$project$Rules$init = {K: _List_Nil};
var $author$project$Tutorial$init = {ar: 0, aG: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ab: col, c: s0.c, d: s0.d, b: offset, aE: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aE, s.ab, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ab: col, aY: contextStack, ax: problem, aE: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aE, s.ab, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aE, s.ab, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ab: newCol, c: s.c, d: s.d, b: newOffset, aE: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ab: col, c: context, d: indent, b: offset, aE: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.am, s.b + 1, s.aE + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.am, firstOffset, s.aE, s.ab + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{ah: $elm$parser$Parser$ExpectingVariable, am: i.am, aD: i.aD, aK: i.aK});
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {ab: s.ab + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, aE: s.aE, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aE, s.ab - (floatOffset + s.b), invalid, s.c));
		} else {
	...
	return $elm$parser$Parser$Advanced$number(
		{
			...
			ah: $elm$parser$Parser$ExpectingNumber,
			a1: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.a1),
			a2: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.a2),
			a6: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.a6),
			a7: $elm$parser$Parser$ExpectingNumber,
			a8: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.a8)
		});
};
var $author$project$Math$tokenNumber_ = $elm$parser$Parser$number(
	{
		aV: $elm$core$Maybe$Nothing,
		a1: $elm$core$Maybe$Just(
			$author$project$Math$Real(0)),
				...
				A2(
					...
					A2(
						...
						$elm$parser$Parser$succeed(
							$author$project$Math$Negative(0)),
...
function $author$project$Math$cyclic$args_() {
	return A2(
		...
		function (_v5) {
			...
			return {Z: args, _: false, ac: false, ao: false, aq: '', as: parameters, aO: false};
		},
		A2(
			$elm$parser$Parser$keeper,
			A2(
	...
	return A2(
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return A2($author$project$Math$Add, 0, children);
			}
		},
		A2(
			$elm$parser$Parser$loop,
								...
								$elm$parser$Parser$succeed(
									function (elem) {
										return $elm$parser$Parser$Loop(
											A2(
												$elm$core$List$cons,
												A2($author$project$Math$Negative, 0, elem),
												list));
									}),
								$elm$parser$Parser$symbol('-')),
							A2(
	...
	return A2(
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return A2($author$project$Math$Multiply, 0, children);
			}
		},
		A2(
			$elm$parser$Parser$loop,
								...
								$elm$parser$Parser$succeed(
									function (elem) {
										return $elm$parser$Parser$Loop(
											A2(
												$elm$core$List$cons,
												A2($author$project$Math$Reciprocal, 0, elem),
												list));
									}),
								$elm$parser$Parser$symbol('/')),
							A2(
...
var $author$project$Math$equation_ = A2(
	...
	function (children) {
		if (children.b && (!children.b.b)) {
			...
			return A2($author$project$Math$Equal, 0, children);
		}
	},
	A2(
		$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ab: col, ax: problem, aE: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aE, p.ab, p.ax);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ab: 1, c: _List_Nil, d: 1, b: 0, aE: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{Q: url, D: _List_Nil, R: key},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.V)));
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				r: $elm$core$List$isEmpty(eqs) ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
				s: $author$project$Display$init(eqs),
				x: nModel,
				V: query,
...
var $author$project$Query$pushUrl = function (model) {
	var eqs = $author$project$Query$marshalEquations_(model.D);
	return A2(
...
var $author$project$Math$toString = function (root) {
	...
	while (true) {
		switch (root.$) {
			case 4:
				return '1' + $author$project$Math$toStringRecursive(root);
			case 8:
				var child = root.b;
				var $temp$root = child;
				root = $temp$root;
				continue toString;
			default:
				return $author$project$Math$toStringRecursive(root);
		}
	}
};
var $author$project$Math$toStringRecursive = function (root) {
	switch (root.$) {
		case 0:
			var list = root.b;
			return A3(
				...
				F2(
					function (elem, result) {
						if (result === '') {
							return $author$project$Math$toStringRecursive(elem);
						} else {
							switch (elem.$) {
								case 1:
									return result + ('+' + $author$project$Math$toStringRecursive(elem));
								case 3:
									return _Utils_ap(
										result,
										$author$project$Math$toStringRecursive(elem));
								case 4:
									return result + ('+1' + $author$project$Math$toStringRecursive(elem));
								case 5:
									return result + ('+' + $author$project$Math$toStringRecursive(elem));
								case 6:
									return result + ('+' + $author$project$Math$toStringRecursive(elem));
						...
						if (prev.$ === 1) {
							switch (elem.$) {
								...
								case 4:
									return _Utils_Tuple2(
										$elm$core$Maybe$Just(elem),
										'1' + $author$project$Math$toStringRecursive(elem));
								default:
									return _Utils_Tuple2(
										$elm$core$Maybe$Just(elem),
										$author$project$Math$toStringRecursive(elem));
							...
							if (prev.a.$ === 6) {
								var _v5 = prev.a;
								var name = _v5.b;
								if ($elm$core$String$length(name) === 1) {
									switch (elem.$) {
										case 5:
											return _Utils_Tuple2(
												$elm$core$Maybe$Just(elem),
										...
										case 7:
											return _Utils_Tuple2(
												$elm$core$Maybe$Just(elem),
												result + ('*' + $author$project$Math$toStringRecursive(elem)));
										default:
											return _Utils_Tuple2(
												$elm$core$Maybe$Just(elem),
												result + ('(' + ($author$project$Math$toStringRecursive(elem) + ')')));
									...
									switch (elem.$) {
										...
										case 6:
											var nextName = elem.b;
											return ($elm$core$String$length(nextName) === 1) ? _Utils_Tuple2(
												$elm$core$Maybe$Just(elem),
												result + ('*' + $author$project$Math$toStringRecursive(elem))) : _Utils_Tuple2(
												$elm$core$Maybe$Just(elem),
												_Utils_ap(
													result,
													$author$project$Math$toStringRecursive(elem)));
		...
		case 2:
			...
			return A3(
				...
				F2(
					function (elem, result) {
						return (result === '') ? $author$project$Math$toString(elem) : (result + ('=' + $author$project$Math$toString(elem)));
					}),
				'',
				list);
		case 3:
			...
			switch (child.$) {
				case 4:
					return '-1' + $author$project$Math$toStringRecursive(child);
				case 1:
					return '-' + $author$project$Math$toStringRecursive(child);
				case 5:
					return '-' + $author$project$Math$toStringRecursive(child);
				case 6:
					return '-' + $author$project$Math$toStringRecursive(child);
		...
		case 5:
			...
			var params = A3(
				...
				F2(
					function (elem, result) {
						return (result === '') ? $author$project$Math$toStringRecursive(elem) : (result + (',' + $author$project$Math$toStringRecursive(elem)));
					}),
				'',
				properties.as);
			var input = A3(
				...
				'',
				properties.Z);
			var args = $elm$core$String$isEmpty(params) ? input : (input + (';' + params));
			return '\\' + (properties.aq + ('(' + (args + ')')));
		case 6:
			var name = root.b;
			return ($elm$core$String$length(name) === 1) ? name : ('\\' + name);
		case 7:
			var val = root.b;
			...
			A3(
				...
				F3(
					function (_v0, elem, result) {
						return A2(
							$elm$core$List$cons,
							$author$project$Math$toString(elem),
							result);
					}),
				_List_Nil,
				dict));
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Display$update, e, model.s);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.x);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var id = event.a;
				var str = event.b;
				var _v6 = $author$project$Math$parse(str);
				if (!_v6.$) {
					var root = _v6.a;
					return function (nModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{r: $elm$core$Maybe$Nothing, s: nModel}),
								$author$project$Query$pushUrl(query));
						}(
							function (list) {
								return A2($author$project$Query$setEquations, list, model.V);
							}(
								$author$project$Display$listEquations(nModel)));
					}(
						function () {
							if (id.$ === 1) {
								return A2($author$project$Display$addEquation, root, model.s);
							} else {
								var i = id.a;
								return A3($author$project$Display$updateEquation, i, root, model.s);
							}
						}());
				} else {
					var err = _v6.a;
					var _v8 = A3(
						...
						str,
						err,
						_Utils_Tuple2(model.x, $elm$core$Platform$Cmd$none));
					var nModel = _v8.a;
					var nCmd = _v8.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$stroke('1')
					]),
				_List_fromArray(
					[
						$elm$svg$Svg$text('?')
...
var $author$project$HtmlEvent$onBlur = $elm$html$Html$Events$onBlur;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Icon$add(_List_Nil)
						]))
				]));
	} else {
		var eq = _v0.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$HtmlEvent$onBlur($author$project$Main$CancelCreateMode)
						]),
					_List_Nil),
					A2(
					$elm$html$Html$button,
					...
					_List_fromArray(
						[
							$author$project$Icon$tick(_List_Nil)
						]))
				]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M5 0H145A5 5 0 0 1 145 10H5A5 5 0 0 1 5 0Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M5 20H145A5 5 0 0 1 145 30H5A5 5 0 0 1 5 20Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M5 40H145A5 5 0 0 1 145 50H5A5 5 0 0 1 5 40Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil)
...
var $author$project$Main$view = function (model) {
	return {
		aW: _List_fromArray(
			[
				A3($author$project$Display$view, $author$project$Main$DisplayEvent, _List_Nil, model.s),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Icon$menu(_List_Nil)
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										A3($author$project$Rules$view, $author$project$Main$RulesEvent, _List_Nil, model.K)
									]))
							]))
					])),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{a5: $author$project$Main$init, a9: $author$project$Main$EventUrlChange, ba: $author$project$Main$EventUrlRequest, be: $author$project$Main$subscriptions, bg: $author$project$Main$update, bi: $author$project$Main$view});
