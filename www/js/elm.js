		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{x: true, af: children, s: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{x: s.x, af: newChildren, s: s.s, a: s.a, b: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
		...
		return _Utils_Tuple2(
			{
				...
				bH: query,
				z: {
					v: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.z.v, model.o);
				if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.e, props.e) && (_Utils_eq(p.x, props.x) && _Utils_eq(p.s, props.s))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
	...
	function (parent, result, args, existing, tracker) {
		...
		switch (existing.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{x: s.x, af: newChildren, s: s.s, a: s.a, b: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
					...
					function (children) {
						...
						if (_v1.$ === 1) {
							...
							if ((f.e === 2) && (f.x || f.s)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{x: f.x, af: children, s: f.s, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'associative',
				$elm$json$Json$Encode$bool(prop.x)),
				_Utils_Tuple2(
				'commutative',
								...
								return function (showHelp) {
									return function (showMenu) {
										return function (showHistory) {
											return {v: createMode, l: display, M: evaluator, aC: menu, al: nextCreateInt, _: notification, bd: rules, T: showHelp, aE: showHistory, au: showMenu, ax: tutorial};
										};
									};
								};
							};
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, x: associative, s: commutative, ai: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.x || f.s) && (f.e !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.x && (!f.s)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
		...
		switch (event.$) {
			...
			case 8:
				...
				if (str !== 'Escape') {
					...
					var _v4 = _Utils_Tuple2(core.o, model.v);
					if (!_v4.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{v: $elm$core$Maybe$Nothing, T: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v10 = A3($author$project$Algo$Matcher$parseEquation, $author$project$Components$Display$createState, $author$project$Components$Display$updateState, str);
					if (!_v10.$) {
						var root = _v10.a;
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{v: $elm$core$Maybe$Nothing, l: dModel, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
			...
			case 19:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v13 = A2($author$project$Components$Rules$addTopic, topic, model.bd);
					if (_v13.$ === 1) {
						var errStr = _v13.a;
				...
				switch (e.$) {
					case 0:
						...
						if (($elm$core$List$length(p.j) === 1) && $elm$core$List$isEmpty(p.an)) {
							var _v19 = A2($author$project$Helper$listIndex, 0, p.j);
							if (_v19.$ === 1) {
					...
					case 1:
						var _v20 = $author$project$Components$Display$groupChildren(model.l);
						if (_v20.$ === 1) {
							var errStr = _v20.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v21 = $author$project$Components$Display$ungroupChildren(model.l);
						if (_v21.$ === 1) {
							var errStr = _v21.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v22 = $author$project$Components$Display$selectedNode(model.l);
						if (_v22.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v22.a;
							...
							var _v23 = A2($author$project$Components$Rules$evaluateStr, model.bd, n.at);
							if (_v23.$ === 1) {
								var errStr = _v23.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
			...
			case 27:
				...
				if (_v31.$ === 1) {
					...
					var newTree = _v31.a;
					var _v32 = A2($author$project$Components$Rules$evaluateStr, model.bd, newTree);
					if (_v32.$ === 1) {
						var errStr = _v32.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v34 = A2($author$project$Components$Evaluate$finish, reply.b9, model.M);
				var eModel = _v34.a;
				var c = _v34.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.u)) {
							...
							var _v37 = A3($author$project$Components$Display$replaceNumber, target, tree, model.l);
							if (_v37.$ === 1) {
								var errStr = _v37.a;
						...
						var eqNum = _v38.a;
						var id = _v38.b;
						var _v39 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.u, model.l);
						if (_v39.$ === 1) {
							var errStr = _v39.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
			...
			switch (_v0.a.$) {
				...
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.x, r.x) && (_Utils_eq(l.s, r.s) && (_Utils_eq(
									...
									_List_fromArray(
										[
											...
											_Utils_Tuple2(
												'history',
												A3(
													$author$project$Components$Display$historyView,
													$author$project$Main$DisplayEvent,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$id('history')
													...
													model.l))),
											A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.v)
										])))
							]))),
					$elm$core$Maybe$Just(
