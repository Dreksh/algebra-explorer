...
{
	if (region.bm.aJ === region.bx.aJ)
	{
		return 'on line ' + region.bm.aJ;
	}
	return 'on lines ' + region.bm.aJ + ' through ' + region.bx.aJ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { S: 'hidden', ch: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { S: 'mozHidden', ch: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { S: 'msHidden', ch: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { S: 'webkitHidden', ch: 'webkitvisibilitychange' }
		: { S: 'hidden', ch: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cs, request.b8, true);
		} catch (e) {
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{w: nodeList, r: (len / $elm$core$Array$branchFactor) | 0, u: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bA: fragment, bE: host, bN: path, bP: port_, bU: protocol, bV: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ck: false, bw: element, a4: trigger};
	});
				...
				model,
				{
					...
					O: A3(
						...
						A2(
							...
							$author$project$UI$Notification$delayedDelete_(model.n),
							str),
						model.O)
				}),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$UI$Animation$delayEvent,
						15000,
						$author$project$UI$Notification$ClearEvent(model.n))
					])));
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {ao: nextCallID, ag: ongoing, bj: sender};
	});
	...
	H: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					{
						ab: $author$project$Components$Rules$InfixOp('+'),
						X: $author$project$Algo$Math$BinaryNode(
							{l: true, E: _List_Nil, h: true, m: 0, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'*',
				_Utils_Tuple2(
					{
						ab: $author$project$Components$Rules$InfixOp('*'),
						X: $author$project$Algo$Math$BinaryNode(
							{l: true, E: _List_Nil, h: true, m: 1, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'-',
				_Utils_Tuple2(
					{
						ab: $author$project$Components$Rules$PrefixOp('-'),
						X: $author$project$Algo$Math$UnaryNode(
							{
								Q: $author$project$Algo$Math$RealNode(
									{c: 0, s: 0}),
								a: '',
								c: 0
							})
				...
				_Utils_Tuple2(
					{
						ab: $author$project$Components$Rules$PrefixOp('1/'),
						X: $author$project$Algo$Math$UnaryNode(
							{
								Q: $author$project$Algo$Math$RealNode(
									{c: 0, s: 0}),
...
var $author$project$Components$Tutorial$init = {bI: 0, b1: 0};
var $author$project$UI$ActionView$Current = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$UI$ActionView$init = A2($author$project$UI$ActionView$Current, 0, false);
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			p: {D: top + height, y: left, B: left + width, J: top},
...
var $author$project$UI$Notification$init = {n: 0, O: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ce: false, cg: r.cg, aV: r.aV, bB: r.bB, cs: r.cs, cE: r.cE, j: r.j, b8: r.b8}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cg: $elm$http$Http$emptyBody, aV: r.aV, bB: _List_Nil, cs: 'GET', cE: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, b8: r.b8});
};
...
var $author$project$Algo$Math$addConstant = function (key) {
	return A2(
		$elm$core$Dict$insert,
		key,
...
var $author$project$Components$Rules$functionProperties = function (model) {
	return function (dict) {
		return A3(
			...
			F2(
				function (k, _v2) {
					return $author$project$Algo$Math$addConstant(k);
				}),
			dict,
			model.F);
	}(
...
var $author$project$Algo$Math$EOF_ = {$: 0};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ae: col, cj: contextStack, cw: problem, b$: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.b$, s.ae, x, s.ci));
	});
...
var $author$project$Algo$Math$PrevStr_ = $elm$core$Basics$identity;
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.b$, s.ae, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ae: newCol, ci: s.ci, i: s.i, f: newOffset, b$: newRow, d: s.d});
	};
};
var $elm$parser$Parser$Advanced$symbol = $elm$parser$Parser$Advanced$token;
var $author$project$Algo$Math$expectSymbol_ = function (name) {
	return $elm$parser$Parser$Advanced$symbol(
		A2($elm$parser$Parser$Advanced$Token, name, $author$project$Algo$Math$EOF_));
};
var $author$project$Algo$Math$ArgMismatch_ = function (a) {
	return {$: 1, a: a};
};
var $author$project$Algo$Math$ExpectingConstant_ = function (a) {
	return {$: 5, a: a};
};
var $author$project$Algo$Math$ExpectingFunction_ = function (a) {
	return {$: 4, a: a};
};
var $author$project$Algo$Math$GenericNode = function (a) {
	return {$: 4, a: a};
};
var $author$project$Algo$Math$UnknownArguments_ = function (a) {
	return {$: 2, a: a};
};
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {ae: col, ci: context, b$: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {ae: s.ae, ci: newContext, i: s.i, f: s.f, b$: s.b$, d: s.d};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.b$, s0.ae, context),
						s0.ci),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
				...
				return A3(
					...
					p,
					a,
					A2($elm$parser$Parser$Advanced$changeContext, s0.ci, s1));
			} else {
				var step = _v1;
				return step;
			}
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ae: col, ci: s0.ci, i: s0.i, f: offset, b$: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.b$, s.ae, s);
	};
};
...
var $author$project$Algo$Math$ExpectingVariableName_ = {$: 3};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ae: col, ci: context, i: indent, f: offset, b$: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bm, s.f, s.d);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.ba, s.f + 1, s.b$ + 1, 1, s.d, s.i, s.ci) : A7($elm$parser$Parser$Advanced$varHelp, i.ba, firstOffset, s.b$, s.ae + 1, s.d, s.i, s.ci);
			var name = A3($elm$core$String$slice, s.f, s1.f, s.d);
...
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$Advanced$variable(
	{
		a7: $author$project$Algo$Math$ExpectingVariableName_,
		ba: function (c) {
...
var $author$project$Algo$Math$ExpectingDigits_ = {$: 6};
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$Advanced$variable(
	{a7: $author$project$Algo$Math$ExpectingDigits_, ba: $elm$core$Char$isDigit, bh: $elm$core$Set$empty, bm: $elm$core$Char$isDigit});
var $author$project$Algo$Math$tokenNumber_ = A2(
	$elm$parser$Parser$Advanced$andThen,
	function (str) {
		var _v0 = $elm$core$String$toFloat(str);
		if (_v0.$ === 1) {
			return $elm$parser$Parser$Advanced$problem($author$project$Algo$Math$ExpectingDigits_);
		} else {
			var f = _v0.a;
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$author$project$Algo$Math$expectSymbol_('.')),
					$author$project$Algo$Math$tokenDigit_),
					$elm$parser$Parser$Advanced$succeed('')
				]))));
var $author$project$Algo$Math$tokenShortName_ = $elm$parser$Parser$Advanced$variable(
	{
		a7: $author$project$Algo$Math$ExpectingVariableName_,
		ba: function (_v0) {
			return false;
...
var $author$project$Algo$Math$argsList_ = function (funcProps) {
	return A2(
		...
		function (list) {
			return $elm$core$List$isEmpty(list) ? A2(
				$elm$parser$Parser$Advanced$keeper,
				$elm$parser$Parser$Advanced$succeed(
					A2($elm$core$Basics$composeR, $elm$core$List$singleton, $elm$parser$Parser$Advanced$Loop)),
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					A2(
						$elm$parser$Parser$Advanced$inContext,
						'(',
						$author$project$Algo$Math$expression_(funcProps)),
					$elm$parser$Parser$Advanced$spaces)) : $elm$parser$Parser$Advanced$oneOf(
				_List_fromArray(
					[
						A2(
						$elm$parser$Parser$Advanced$keeper,
...
var $author$project$Algo$Math$expression_ = function (funcProps) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{l: true, E: children, h: true, m: 0, a: '+', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$Advanced$loop,
			...
			function (list) {
				return $elm$core$List$isEmpty(list) ? A2(
					...
					A2(
						$elm$parser$Parser$Advanced$ignorer,
						$author$project$Algo$Math$multiple_(funcProps),
						$elm$parser$Parser$Advanced$spaces)) : $elm$parser$Parser$Advanced$oneOf(
					_List_fromArray(
						[
							A2(
...
var $author$project$Algo$Math$multiple_ = function (funcProps) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{l: true, E: children, h: true, m: 1, a: '*', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$Advanced$loop,
			...
			function (list) {
				return $elm$core$List$isEmpty(list) ? A2(
					...
					A2(
						$elm$parser$Parser$Advanced$ignorer,
						$author$project$Algo$Math$negatable_(funcProps),
						$elm$parser$Parser$Advanced$spaces)) : $elm$parser$Parser$Advanced$oneOf(
					_List_fromArray(
						[
							A2(
							...
							A2(
								$elm$parser$Parser$Advanced$ignorer,
								$author$project$Algo$Math$term_(funcProps),
								$elm$parser$Parser$Advanced$spaces)),
							A2(
							$elm$parser$Parser$Advanced$map,
							function (_v12) {
...
var $author$project$Algo$Math$negatable_ = function (funcProps) {
...
var $author$project$Algo$Math$term_ = function (funcProps) {
	return $elm$parser$Parser$Advanced$oneOf(
		_List_fromArray(
			[
				A2(
				...
				function (_v0) {
					...
					var _v1 = _Utils_Tuple2(
						A2($elm$core$Dict$get, name, funcProps),
						props);
					if (_v1.a.$ === 1) {
						if (_v1.b.$ === 1) {
							var _v2 = _v1.a;
							...
							var _v4 = _v1.a;
							var children = _v1.b.a;
							return $elm$parser$Parser$Advanced$succeed(
								$author$project$Algo$Math$GenericNode(
									{b: $elm$core$Maybe$Nothing, E: children, a: name, c: 0}));
						}
					} else {
						if (_v1.b.$ === 1) {
							var p = _v1.a.a;
							...
							if (p.$ === 1) {
								...
								return $elm$parser$Parser$Advanced$problem(
									$author$project$Algo$Math$ExpectingFunction_(name));
							}
						} else {
							var p = _v1.a.a;
							var children = _v1.b.a;
							switch (p.$) {
								case 2:
									if (children.b && (!children.b.b)) {
										...
										return $elm$parser$Parser$Advanced$problem(
											$author$project$Algo$Math$ArgMismatch_(
												{
													aV: 1,
													aW: $elm$core$List$length(children),
													a: name
												}));
									}
								case 4:
									...
									if (_v9.$ === 1) {
										return $elm$parser$Parser$Advanced$problem(
											$author$project$Algo$Math$UnknownArguments_(name));
									} else {
										var args = _v9.a;
										return (!_Utils_eq(
											args,
											$elm$core$List$length(children))) ? $elm$parser$Parser$Advanced$problem(
											$author$project$Algo$Math$ArgMismatch_(
												{
													aV: args,
													aW: $elm$core$List$length(children),
								...
								case 3:
									var n = p.a;
									return ($elm$core$List$length(children) < 2) ? $elm$parser$Parser$Advanced$problem(
										$author$project$Algo$Math$ArgMismatch_(
											{
												aV: 2,
												aW: $elm$core$List$length(children),
										...
										$author$project$Algo$Math$BinaryNode(
											{l: n.l, E: children, h: n.h, m: n.m, a: name, c: 0}));
								default:
									return $elm$parser$Parser$Advanced$problem(
										$author$project$Algo$Math$ExpectingConstant_(name));
							}
						}
					}
				},
				A2(
					...
					$author$project$Algo$Math$varOrFunc_(funcProps))),
				A2(
				$elm$parser$Parser$Advanced$andThen,
				function (name) {
					var _v10 = A2($elm$core$Dict$get, name, funcProps);
					if (_v10.$ === 1) {
						return $elm$parser$Parser$Advanced$succeed(
							$author$project$Algo$Math$VariableNode(
								{U: false, a: name, c: 0}));
...
var $author$project$Algo$Math$varOrFunc_ = function (funcProps) {
	return $elm$parser$Parser$Advanced$oneOf(
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$author$project$Algo$Math$argsList_(funcProps),
					$author$project$Algo$Math$expectSymbol_(')'))),
				$elm$parser$Parser$Advanced$succeed($elm$core$Maybe$Nothing)
			]));
};
var $author$project$Algo$Math$equation_ = function (funcProps) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (children) {
			if (children.b && (!children.b.b)) {
...
var $author$project$Algo$Math$inputExtract_ = F2(
	function (col, input) {
		var right = A2(
			...
			(_Utils_cmp(
				...
				col + 2) < 1) ? input : (A2($elm$core$String$left, col + 1, input) + '…'));
		return function (_final) {
			return _final + ('▒' + right);
		}(
			function (str) {
				return (col > 7) ? ('…' + A2($elm$core$String$dropLeft, col - 6, str)) : str;
			}(
				A2($elm$core$String$left, col - 1, input)));
	});
var $author$project$Algo$Math$parserErrorToText = F2(
	function (input, stack) {
		var _v0 = $elm$core$List$head(stack);
		if (_v0.$ === 1) {
			return 'No error found, unable to determine the cause';
		} else {
			var end = _v0.a;
			var _v1 = end.cw;
			switch (_v1.$) {
				case 0:
					var _v2 = $elm$core$List$head(end.cj);
					if (_v2.$ === 1) {
						var _v3 = A2(
							$elm$core$String$left,
							1,
							A2($elm$core$String$dropLeft, end.ae - 1, input));
						switch (_v3) {
							case '+':
								return 'Cannot use \'+\' without having an expression to the left';
							case '/':
								return 'Cannot use \'/\' without having an expression to the left';
							case '*':
								return 'Cannot use \'*\' without having an expression to the left';
							...
							default:
								var n = _v3;
								return 'Symbol is not allowed: \'' + (n + '\'');
						}
					} else {
						var ctx = _v2.a;
						var _v4 = ctx.ci;
						switch (_v4) {
							case '+':
								return 'Got a dangling \'+\', remove it or fill in the ▒ in: ' + A2($author$project$Algo$Math$inputExtract_, end.ae, input);
							case '-':
								return 'Got a dangling \'-\', remove it or fill in the ▒ in: ' + A2($author$project$Algo$Math$inputExtract_, end.ae, input);
							case '*':
								return 'Got a dangling \'*\', remove it or fill in the ▒ in: ' + A2($author$project$Algo$Math$inputExtract_, end.ae, input);
				...
				case 1:
					var a = _v1.a;
					return 'Function \'\\' + (a.a + ('\' is defined with ' + ($elm$core$String$fromInt(a.aV) + (' arguments, got ' + $elm$core$String$fromInt(a.aW)))));
				case 2:
					var name = _v1.a;
					return 'Function \'\\' + (name + '\' did not specify the number of arguments');
				case 3:
					return 'Expecting a valid variable name at: ' + A2($author$project$Algo$Math$inputExtract_, end.ae, input);
				case 4:
					var name = _v1.a;
					return name + ' is a function. Cannot be used as a constant';
				case 5:
					var name = _v1.a;
					return name + ' is a constant. Cannot be used as a function';
				default:
					return 'Expecting digits at: ' + A2($author$project$Algo$Math$inputExtract_, end.ae, input);
			}
		}
	});
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ae: 1, ci: _List_Nil, i: 1, f: 0, b$: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Algo$Math$parse = F2(
	function (funcProps, input) {
		return A2(
			$elm$core$Result$mapError,
			$author$project$Algo$Math$parserErrorToText(input),
			A2(
				$elm$parser$Parser$Advanced$run,
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$author$project$Algo$Math$equation_(funcProps),
					$elm$parser$Parser$Advanced$end($author$project$Algo$Math$EOF_)),
				input));
	});
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aK(tracker.n);
					} else {
						var prev = previous.a;
						return A2(tracker.aH, prev, tracker.n);
					}
				}()),
			_Utils_update(
				tracker,
				{
					n: tracker.n + 1,
					aM: A3($elm$core$Dict$insert, tracker.n, parent, tracker.aM)
				}));
	});
				...
				return function (_v3) {
					...
					return _Utils_Tuple2(
						$author$project$Algo$Math$BinaryNode(
							{
								l: n.l,
								E: $elm$core$List$reverse(finChildren),
								h: n.h,
								m: n.m,
								a: n.a,
								c: finS
...
var $author$project$Algo$Matcher$parseEquation = F3(
	function (fp, newState, copyState) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Algo$Math$parse(fp),
			$elm$core$Result$map(
				A2(
					$elm$core$Basics$composeR,
					$author$project$Algo$Matcher$processID_(
						{aH: copyState, aK: newState, n: 0, aM: $elm$core$Dict$empty}),
					function (_v0) {
						var newRoot = _v0.a;
						var tracker = _v0.b;
						return {
							...
							j: _Utils_update(
								tracker,
								{
									aM: A2($elm$core$Dict$remove, 0, tracker.aM)
								})
						};
					})));
	});
var $author$project$Components$Display$updateState = F2(
	function (s, _v0) {
		return {
			as: $author$project$Algo$Matcher$getID(s)
		};
	});
var $author$project$Main$parseEquations_ = F3(
	function (model, elem, _v0) {
		...
		var errs = _v0.b;
		var _v1 = A4(
			$author$project$Algo$Matcher$parseEquation,
			$author$project$Components$Rules$functionProperties(model),
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a5: url, e: _List_Nil, bb: key, a0: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.bV)));
	});
				...
				a$: A2(
					...
					$elm$core$Result$toMaybe(
						A2(
							...
							flags))),
				I: {
					av: $author$project$UI$ActionView$init,
					G: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
							$author$project$Main$uiCancelCmd_(0),
							0)) : $elm$core$Maybe$Nothing,
					g: $author$project$Components$Display$init(eqs),
					...
					ax: A3(
						...
						_Utils_Tuple2(60, 10),
						_Utils_Tuple2(30, 80)),
					aA: $author$project$UI$Menu$init(
					...
					aB: false,
					P: false,
					aE: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.a0)
					])));
	});
	...
	if (action.$ === 1) {
		...
		if (!action.a.$) {
			...
			return $author$project$Main$capture(
				{a6: eId, bf: pId, bk: true});
		} else {
			var _v2 = action.a;
			var eId = _v2.a;
			var pId = _v2.b;
			return $author$project$Main$capture(
				{a6: eId, bf: pId, bk: false});
		}
	}
};
...
var $author$project$Algo$Matcher$addMatch = F3(
	function (key, replacement, result) {
		return _Utils_update(
			result,
			{
				L: A3(
...
var $author$project$Components$Rules$deleteTopic = F2(
	function (name, model) {
		var _v0 = A2($elm$core$Dict$get, name, model.x);
		if ((!_v0.$) && (_v0.a.$ === 1)) {
			var _v1 = _v0.a;
			var url = _v1.a;
			var topic = _v1.b;
			...
			return _Utils_update(
				model,
				{
					...
					x: function () {
						if (url.$ === 1) {
							return A2($elm$core$Dict$remove, name, model.x);
						} else {
							var existing = url.a;
							return A3(
								$elm$core$Dict$insert,
...
var $author$project$Algo$Backtrack$getState = function (c) {
	return A2($elm$core$Maybe$map, $elm$core$Tuple$first, c.o);
};
var $author$project$Algo$Backtrack$Continuation = F2(
	function (initial, progress) {
		return {ay: initial, o: progress};
	});
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{ay: res, o: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && _Utils_eq(l.s, r.s);
					} else {
						break _v0$6;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && _Utils_eq(l.a, r.a);
					} else {
						break _v0$6;
					}
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.Q, r.Q));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.l, r.l) && (_Utils_eq(l.h, r.h) && (_Utils_eq(
							$elm$core$List$length(l.E),
							$elm$core$List$length(r.E)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
				...
				case 4:
					if (_v0.b.$ === 4) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && (_Utils_eq(
							$elm$core$List$length(l.E),
							$elm$core$List$length(r.E)) && A3(
							$elm$core$List$foldl,
							$elm$core$Basics$and,
							true,
							A3(
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								...
								H: functions,
								x: function () {
									var _v7 = A2($elm$core$Dict$get, topic.a, model.x);
									if (_v7.$ === 1) {
										return A3(
											$elm$core$Dict$insert,
											topic.a,
					...
					A3(
						...
						F3(
							function (name, js, dict) {
								var _v5 = A2($elm$core$Dict$get, name, dict);
								if (_v5.$ === 1) {
									return $elm$core$Result$Ok(
										A3(
											$elm$core$Dict$insert,
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var count = _v1.b;
							return (A3(
								$author$project$Algo$Math$equal,
								F2(
									function (_v2, _v3) {
										return true;
									}),
								p.X,
								props.X) && _Utils_eq(p.ab, props.ab)) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		var swappable = model.I;
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable.af, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Algo$History$addAll = F2(
	function (list, model) {
		var id = $author$project$Algo$History$currentNode_(model);
		var start = $elm$core$Dict$size(model.q) + 1;
		return function (newModel) {
			var m = _Utils_update(
				newModel,
				{
					...
					C: A2(
						$elm$core$List$cons,
						$elm$core$Dict$size(newModel.q),
						model.C)
				});
			var end = $elm$core$Dict$size(m.q);
			if (!id) {
				var p = model.ad;
				return _Utils_update(
					m,
					...
					function (c, m) {
						return _Utils_update(
							m,
							{
								q: A3(
									$elm$core$Dict$insert,
									$elm$core$Dict$size(m.q) + 1,
									{E: _List_Nil, aj: c, aM: id},
									m.q)
							});
					}),
				model,
...
var $author$project$Algo$History$current = function (model) {
	return A2(
		...
		A2(
			$elm$core$Maybe$andThen,
			function (n) {
				return A2($elm$core$Dict$get, n, model.q);
			},
			$elm$core$List$head(model.C))).aj;
};
				...
				if (!children.b) {
					...
					if (_v1.$ === 1) {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								a,
								A2($elm$core$List$cons, newEq.ad, others),
								newEq.j));
					}
				}
			});
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.ad));
		if (!path.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												ad: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{Q: newEq.ad}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											ad: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{E: children})),
											j: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											ad: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{E: children})),
											j: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											ad: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{E: children})),
											j: t
		...
		switch (replaceNode.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromInternalReplacement_, id, t, _arguments, n.Q));
			case 3:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
							...
							function () {
								if (!res.$) {
									...
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
										$author$project$Algo$Math$BinaryNode(
											{l: n.l, E: children, h: n.h, m: n.m, a: n.a, c: s}));
								} else {
									var pre = res.b;
									var post = res.c;
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
					...
					A3(constructChildren, n.a, t, n.E));
			case 5:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
			...
			case 1:
				...
				if (_v51.b.$ === 1) {
					var oldS = _v51.a;
					var _v52 = _v51.b;
					var newState = A2(tracker.aH, oldS, tracker.n);
					return $elm$core$Result$Ok(
						_Utils_Tuple3(
							$author$project$Algo$Matcher$SingleNodeReplaced_(
								$author$project$Algo$Math$VariableNode(
									{
										U: n.U,
										a: n.a,
										c: A2($author$project$Algo$Matcher$State_, tracker.n, newState)
									})),
							_Utils_update(
								tracker,
								{
					...
					var argNum = _v51.b.a;
					var _v53 = A2($elm$core$Dict$get, argNum, _arguments.t);
					if (_v53.$ === 1) {
						...
						return A2(
								...
								return function (_v55) {
									...
									return _Utils_Tuple3(
										...
										_Utils_update(
											_arguments,
											{
												t: A3($elm$core$Dict$insert, argNum, newVal, _arguments.t)
											}));
								}(
							...
							A4(
								...
								parent,
								tracker,
								{t: $elm$core$Dict$empty, z: $elm$core$Dict$empty},
								value));
					}
				}
			default:
				...
				if (_v56.b.$ === 1) {
					...
					return A2(
						...
						A3(constructChildren, '', t, n.E));
				} else {
					var argNum = _v56.b.a;
					var _v60 = A2($elm$core$Dict$get, argNum, _arguments.t);
					if (_v60.$ === 1) {
						...
						return A2(
											...
											function (_v63) {
												...
												return _Utils_Tuple3(
													...
													_Utils_update(
														newArg,
														{
															t: A3($elm$core$Dict$insert, argNum, newVal, newArg.t)
														}));
											},
											A4(
												$author$project$Algo$Matcher$constructFromValue_,
												...
												newT,
												{
													t: $elm$core$Dict$fromList(childArgs),
							...
							A3(constructChildren, '', tracker, n.E));
					}
				}
		}
	});
var $author$project$Algo$Matcher$constructFromReplacement_ = F4(
	function (parent, tracker, _arguments, replaceNode) {
		...
		var createState = function (name) {
			var _v37 = A2($elm$core$Dict$get, name, _arguments.z);
			if ((!_v37.$) && _v37.a.b) {
				if (!_v37.a.b.b) {
					var _v38 = _v37.a;
					var x = _v38.a;
					return function (_v39) {
						var a = _v39.a;
						var b = _v39.b;
						return _Utils_Tuple3(a, b, _arguments);
					}(
						A3(
							$author$project$Algo$Matcher$addNode_,
					...
					return function (_v41) {
						...
						return _Utils_Tuple3(
							...
							_Utils_update(
								_arguments,
								{
									z: A3($elm$core$Dict$insert, name, others, _arguments.z)
								}));
					}(
						A3(
							$author$project$Algo$Matcher$addNode_,
				...
				return function (_v42) {
					...
					A3($author$project$Algo$Matcher$addNode_, $elm$core$Maybe$Nothing, parent, tracker));
			}
		};
		var constructChildren = F3(
			function (name, firstT, firstArgs) {
				return A2(
					$elm$core$Basics$composeR,
					A2(
						$author$project$Helper$resultList,
						...
						_Utils_Tuple3(_List_Nil, firstT, firstArgs)),
					$elm$core$Result$andThen(
						function (_v35) {
							var children = _v35.a;
							var newT = _v35.b;
		...
		switch (replaceNode.$) {
			case 0:
				var n = replaceNode.a;
				var _v10 = createState(
					$elm$core$String$fromFloat(n.s));
				var s = _v10.a;
				var t = _v10.b;
				var a = _v10.c;
				return $elm$core$Result$Ok(
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromReplacement_, id, t, a, n.Q));
			case 3:
				var n = replaceNode.a;
				var _v14 = createState(n.a);
				var s = _v14.a;
				var t = _v14.b;
				var a = _v14.c;
				return A2(
					...
					A4(constructChildren, n.a, t, a, n.E));
			case 5:
				var n = replaceNode.a;
				var _v17 = createState(n.a);
				var s = _v17.a;
				var t = _v17.b;
				var a = _v17.c;
				return A2(
			...
			case 1:
				...
				if (_v20.$ === 1) {
					...
					var argNum = _v20.a;
					var _v22 = A2($elm$core$Dict$get, argNum, _arguments.t);
					if (_v22.$ === 1) {
						return $elm$core$Result$Err('Couldn\'t find value to replace');
					} else {
						var value = _v22.a;
								...
								return function (_v24) {
									...
									return _Utils_Tuple3(
										...
										_Utils_update(
											_arguments,
											{
												t: A3($elm$core$Dict$insert, argNum, val, _arguments.t)
											}));
								}(
									A3($author$project$Algo$Matcher$replacedToTree_, parent, newT, replaced));
							},
			...
			default:
				...
				if (_v25.$ === 1) {
					...
					return A2(
						...
						A4(constructChildren, '', t, a, n.E));
				} else {
					var argNum = _v25.a;
					var _v29 = A2($elm$core$Dict$get, argNum, _arguments.t);
					if (_v29.$ === 1) {
						return $elm$core$Result$Err('Couldn\'t find the function to replace');
					} else {
						var value = _v29.a;
						return A2(
							...
							A4(constructChildren, '', tracker, _arguments, n.E));
					}
				}
		}
	});
	...
	switch (root.$) {
		case 0:
			...
			return $elm$core$Set$singleton(
				$author$project$Algo$Matcher$getID(s.c));
		case 1:
			var s = root.a;
			return $elm$core$Set$singleton(
				$author$project$Algo$Matcher$getID(s.c));
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aM: A2($elm$core$Dict$remove, id, tracker.aM)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aM: A3($elm$core$Dict$insert, id, p, tracker.aM)
				});
		}
	});
var $author$project$Algo$Matcher$replaceSubtree_ = F3(
	function (replacement, result, eq) {
			...
			function (_v0) {
				...
				var pID = A2(
					...
					$author$project$Algo$Matcher$getID(
						$author$project$Algo$Math$getState(eq.ad)),
					eq.j.aM);
				var _v1 = A3($author$project$Algo$Matcher$replacedToTree_, 0, t, r);
				var newRoot = _v1.a;
				var newTracker = _v1.b;
				var finalTracker = A3(
					$elm$core$Set$foldl,
					F2(
						function (elem, childT) {
							return _Utils_update(
								childT,
								{
									aM: A2($elm$core$Dict$remove, elem, childT.aM)
								});
						}),
					A3($author$project$Algo$Matcher$setParent_, newRoot, pID, newTracker),
					A2(
						$elm$core$Set$diff,
						$author$project$Algo$Matcher$getSubtreeIDs_(eq.ad),
						$author$project$Algo$Matcher$getSubtreeIDs_(newRoot)));
				return _Utils_Tuple2(
					$author$project$Algo$Matcher$getID(
						$author$project$Algo$Math$getState(newRoot)),
					{ad: newRoot, j: finalTracker});
			},
			A4(
				$author$project$Algo$Matcher$constructFromReplacement_,
				-1,
				eq.j,
				{t: args, z: result.z},
				replacement));
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, replacement, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.j.aM);
		if (_v0.$ === 1) {
			...
			return A3(
				$author$project$Algo$Matcher$processSubtree_,
				A2($author$project$Algo$Matcher$searchPath_, eq.j.aM, id),
				A2(
					$author$project$Algo$Matcher$replaceSubtree_,
					replacement,
					_Utils_update(
						_with,
						{
							...
							return _Utils_update(
								model,
								{
									e: A3(
										...
										eqNum,
										A2(
											$author$project$Algo$History$addAll,
											$elm$core$List$reverse(newEq),
											eq),
										model.e),
								...
								function (r, _v3) {
									...
									return A2(
										...
										function (_v4) {
											...
											return _Utils_Tuple2(
												num,
												A2($elm$core$List$cons, newEq, list));
										},
										A4($author$project$Algo$Matcher$replaceSubtree, ids, r.ad, result, current));
								}),
...
var $author$project$Components$Query$pushUrl = function (model) {
	var eqs = $author$project$Components$Query$marshalEquations_(model.e);
	return A2(
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.E));
	}
};
...
var $author$project$Algo$Math$getName = function (root) {
	switch (root.$) {
		case 0:
			var n = root.a;
			return $elm$core$String$fromFloat(n.s);
		case 1:
			var n = root.a;
			return n.a;
		case 2:
						...
						if (_v3.a.$ === 1) {
							...
							return (_Utils_cmp(
								...
								$author$project$Algo$Math$functionPrecedence_(root)) > -1) ? $author$project$Algo$Math$Node(
								{
									...
									c: $author$project$Algo$Math$getState(root)
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.ad);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.I;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bX, params.a8, swappable.g);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.ck ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{ck: true}),
		element.a4(0));
...
var $author$project$Components$Evaluate$finish = F2(
	function (id, model) {
		var _v0 = A2($elm$core$Dict$get, id, model.ag);
		if (_v0.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ag: A2($elm$core$Dict$remove, id, model.ag)
					}),
...
var $author$project$Algo$History$add = F2(
	function (c, model) {
		var id = $author$project$Algo$History$currentNode_(model);
		var nextID = $elm$core$Dict$size(model.q) + 1;
		return function (newModel) {
			var m = _Utils_update(
				newModel,
				{
					_: _List_Nil,
					C: A2($elm$core$List$cons, nextID, model.C)
				});
			if (!id) {
				var p = model.ad;
				return _Utils_update(
						...
						if (!n.h) {
							...
							if ((!($elm$core$List$length(pre) + $elm$core$List$length(post))) || $elm$core$List$isEmpty(group)) {
								...
								var _v2 = A3(
									$author$project$Algo$Matcher$addNode_,
									$elm$core$Maybe$Nothing,
									$author$project$Algo$Matcher$getID(n.c),
									subEq.j);
								var newS = _v2.a;
								var newT = _v2.b;
								var newP = A3(
...
var $author$project$Main$CloseDialog = {$: 19};
...
var $author$project$Main$numSubDialog_ = F3(
	function (eqNum, root, target) {
		return {
			aT: $author$project$Main$CloseDialog,
			...
			a3: 'Substitute a number for an expression'
		};
	});
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
		...
		a_: function (sections) {
			return ($elm$core$List$length(params.aX) <= 1) ? sections : A2(
				$elm$core$List$cons,
				{
					az: _List_fromArray(
						[
				...
				[
					...
					az: A2(
						...
						function (_v0) {
							var key = _v0.a;
							var param = _v0.b;
							return (!param.b) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aO: param.a + '= '}),
									$author$project$UI$Dialog$Text(
						...
						$elm$core$Dict$toList(params.bg)),
					aD: 'Fill in the parameters'
				}
				])),
		a2: $author$project$Main$ApplyParameters,
		a3: 'Set parameters for ' + params.a3
	};
};
...
var $author$project$Components$Display$newSelectedNodes_ = F2(
	function (selected, eq) {
		var intersection = A2(
			$elm$core$Set$filter,
			function (n) {
				return A2($elm$core$Dict$member, n, eq.j.aM);
			},
			selected);
		return $elm$core$Set$isEmpty(intersection) ? $elm$core$Set$singleton(
			$author$project$Algo$Matcher$getID(
				$author$project$Algo$Math$getState(eq.ad))) : intersection;
	});
var $author$project$Algo$History$redo = function (model) {
	...
	if (!_v0.b) {
		...
		return _Utils_update(
			...
			{
				_: others,
				C: A2($elm$core$List$cons, x, model.C)
			});
	}
};
		...
		if (_v2.$ === 1) {
			...
			return $elm$core$Result$Ok(
				_Utils_update(
					model,
					{
						e: A3($elm$core$Dict$insert, eqNum, newHis, model.e),
						k: $elm$core$Maybe$Just(
							_Utils_Tuple2(
								eqNum,
								A2(
...
var $author$project$Algo$Matcher$MatchResult = F2(
	function (_var, exact) {
		return {z: exact, L: _var};
	});
var $author$project$Algo$Matcher$newResult = A2($author$project$Algo$Matcher$MatchResult, $elm$core$Dict$empty, $elm$core$Dict$empty);
	...
	function (eqNum, id, number, model) {
		...
		if (_v0.$ === 1) {
			...
			var replacement = (number < 0) ? $author$project$Algo$Math$UnaryNode(
				{
					Q: $author$project$Algo$Math$RealNode(
						{c: $elm$core$Maybe$Nothing, s: -number}),
					a: '-',
			...
			return A2(
				...
				A4(
					...
					replacement,
					$author$project$Algo$Matcher$newResult,
					$author$project$Algo$History$current(eq)));
		}
	});
	...
	function (id, target, subtree, eq) {
		return A3(
			...
			function (subEq) {
				...
				if (!_v0.$) {
					var n = _v0.a;
					return (!_Utils_eq(target, n.s)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v1) {
						var root = _v1.a;
						var tracker = _v1.b;
						var parent = A2($elm$core$Dict$get, id, tracker.aM);
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple2(
								...
								{
									ad: root,
									j: A3($author$project$Algo$Matcher$setParent_, root, parent, nextTracker)
								}));
					}(
						A2($author$project$Algo$Matcher$processID_, subEq.j, subtree));
				} else {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aM)),
					_Utils_Tuple2(
					'component',
					convert(node.aj)),
					_Utils_Tuple2(
					'children',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, node.E))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.ad)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'visits',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.C)),
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model._))
				]));
	});
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'value',
							$elm$json$Json$Encode$float(s.s)),
							_Utils_Tuple2(
							'type',
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'associative',
							$elm$json$Json$Encode$bool(s.l)),
							_Utils_Tuple2(
							'commutative',
							$elm$json$Json$Encode$bool(s.h)),
							_Utils_Tuple2(
							'identity',
							$elm$json$Json$Encode$float(s.m)),
							_Utils_Tuple2(
							'children',
							A2(
								$elm$json$Json$Encode$list,
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.j.n)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.j.aM))
							])))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model.ag))
				]));
	});
var $author$project$Algo$Math$encodeFunctionProperty = function (fp) {
	switch (fp.$) {
		case 2:
			return _List_fromArray(
				[
		...
		case 3:
			...
			return _List_fromArray(
				[
					...
					_Utils_Tuple2(
					'commutative',
					$elm$json$Json$Encode$bool(n.h)),
					_Utils_Tuple2(
					'associative',
					$elm$json$Json$Encode$bool(n.l)),
					_Utils_Tuple2(
					'identity',
					$elm$json$Json$Encode$float(n.m))
				]);
		case 4:
			var n = fp.a;
			return _List_fromArray(
...
var $author$project$Components$Rules$encodeFProp_ = function (prop) {
	return $elm$json$Json$Encode$object(
		A2(
			...
			$author$project$Algo$Math$encodeFunctionProperty(prop.X)));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'description',
				$elm$json$Json$Encode$string(rule.ak)),
				_Utils_Tuple2(
				'parameters',
				$elm$json$Json$Encode$object(
					A2(
						...
						function (_v0) {
							...
							return _Utils_Tuple2(
								p.a,
								$elm$json$Json$Encode$string(p.ak));
						},
						$elm$core$Dict$toList(rule.bg)))),
				_Utils_Tuple2(
				'matches',
				A2(
					$elm$json$Json$Encode$list,
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'from',
									$elm$json$Json$Encode$string(match.a8.a)),
									_Utils_Tuple2(
									'to',
									A2(
										$elm$json$Json$Encode$list,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.H)),
				_Utils_Tuple2(
				'actions',
...
var $author$project$UI$ActionView$encode = function (model) {
	var cNum = model.a;
	var show = model.b;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.ck))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.p.y)),
				_Utils_Tuple2(
				'right',
				$elm$json$Json$Encode$float(model.p.B)),
				_Utils_Tuple2(
				'top',
				$elm$json$Json$Encode$float(model.p.J)),
				_Utils_Tuple2(
				'bottom',
				$elm$json$Json$Encode$float(model.p.D)),
				_Utils_Tuple2(
				'id',
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'display',
						$author$project$Components$Display$encode(model.g)),
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bi)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aE)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.af)),
						_Utils_Tuple2(
						'menu',
						$author$project$UI$Menu$encode(model.aA)),
						_Utils_Tuple2(
						'evaluator',
						A2(
						...
						_Utils_Tuple2(
						'historyBox',
						$author$project$UI$Draggable$encode(model.ax)),
						_Utils_Tuple2(
						'actionView',
						$author$project$UI$ActionView$encode(model.av))
					]))));
};
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					ao: model.ao + 1,
					ag: A3($elm$core$Dict$insert, model.ao, c, model.ag)
				}),
			model.bj(
				{co: model.ao, cC: str}));
	});
...
var $author$project$Algo$Matcher$toReplacement_ = F2(
	function (strict, argDict) {
		var convert = function (node) {
			switch (node.$) {
				case 0:
					...
					return $elm$core$Result$Ok(
						$author$project$Algo$Math$RealNode(
							{c: $elm$core$Maybe$Nothing, s: s.s}));
				case 1:
					var s = node.a;
							...
							$author$project$Algo$Math$VariableNode(
								{
									U: false,
									a: '',
									c: $elm$core$Maybe$Just(index)
								}));
					} else {
						return (s.U || (!strict)) ? $elm$core$Result$Ok(
							$author$project$Algo$Math$VariableNode(
								{U: s.U, a: s.a, c: $elm$core$Maybe$Nothing})) : $elm$core$Result$Err('Cannot construct the variable ' + s.a);
					}
				case 2:
					var s = node.a;
					return A2(
						...
						function (child) {
							return $author$project$Algo$Math$UnaryNode(
								{Q: child, a: s.a, c: $elm$core$Maybe$Nothing});
						},
						convert(s.Q));
				case 3:
					var s = node.a;
				...
				case 4:
					...
					if (!_v3.$) {
						...
						return (!_Utils_eq(
							args,
							$elm$core$List$length(s.E))) ? $elm$core$Result$Err(s.a + ' has the wrong number of inputs') : A2(
							$elm$core$Result$map,
							function (children) {
						...
						var _v5 = s.b;
						if (_v5.$ === 1) {
							return strict ? $elm$core$Result$Err('Cannot construct the function ' + s.a) : A2(
								$elm$core$Result$map,
								function (children) {
									return $author$project$Algo$Math$GenericNode(
										{
...
var $author$project$Algo$Matcher$treeToMatcher_ = F4(
	function (checker, argMap, state, root) {
			...
			F2(
				function (child, _v13) {
					...
					return A2(
						...
						A4($author$project$Algo$Matcher$treeToMatcher_, checker, argMap, s, child));
				}),
		...
		switch (root.$) {
			...
			case 1:
				var s = root.a;
				var _v1 = A2($elm$core$Dict$get, s.a, argMap);
				if (_v1.$ === 1) {
					return s.U ? $elm$core$Result$Ok(
						_Utils_Tuple2(
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$treeToMatcher_, checker, argMap, state, s.Q));
			case 3:
				var s = root.a;
				return s.h ? A2(
					$elm$core$Result$map,
					function (_v3) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{
									b: $elm$core$List$reverse(children),
									a: s.a,
									aL: $elm$core$Maybe$Nothing
								}),
							newS);
					},
					processChildren(s.E)) : A2(
					$elm$core$Result$map,
					function (_v4) {
						var children = _v4.a;
						var newS = _v4.b;
			...
			default:
				var s = root.a;
				var _v6 = A2($elm$core$Dict$get, s.a, argMap);
				if (!_v6.$) {
					return A2(
						$elm$core$Result$map,
						function (_v7) {
					...
					if (_v8.$ === 1) {
									...
									return A3(
										...
										F2(
											function (child, _v9) {
												...
												if (child.$ === 1) {
													var n = child.a;
													return A2($elm$core$Set$member, n.a, seen) ? $elm$core$Result$Err('Function argument can only match on unique variables') : (n.U ? $elm$core$Result$Err('Only variables are supported in function arguments. Constants are not allowed') : A2(
														$elm$core$Result$map,
														function (finalS) {
															return _Utils_Tuple3(
						...
						return (!_Utils_eq(
							argNum,
							$elm$core$List$length(s.E))) ? $elm$core$Result$Err(s.a + ' has an unexpected function signature') : A2(
							$elm$core$Result$map,
							function (_v12) {
								var children = _v12.a;
								var newS = _v12.b;
...
var $author$project$Algo$Matcher$createMatcherPair_ = F3(
	function (funcs, left, right) {
		var toMatcherPair = function (_v7) {
			var from = _v7.a;
			var to = _v7.b;
			var _v0 = A4(
				$author$project$Algo$Matcher$treeToMatcher_,
				F2(
					function (_v1, _v2) {
						return $elm$core$Result$Ok;
					}),
				...
				return A2(
					...
					$elm$core$Result$toMaybe(
						A2(
												...
												function (_v6) {
													...
													return A2(
														...
														function (fromR) {
															return _List_fromArray(
																[
																	_Utils_Tuple2(toM, fromR)
																]);
														},
														A3($author$project$Algo$Matcher$toReplacement_, false, args, from));
												},
												A4(
													$author$project$Algo$Matcher$treeToMatcher_,
													F2(
							...
							A3($author$project$Algo$Matcher$toReplacement_, false, args, to))));
			} else {
				return _List_Nil;
			}
		};
		return function (res) {
			return $elm$core$List$isEmpty(res) ? $elm$core$Result$Err('Substitution requires the equation to be a variable or function definition') : $elm$core$Result$Ok(res);
		}(
			A2(
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2(right, left)
					])));
	});
var $author$project$Algo$Matcher$InternalValue_ = function (a) {
	return {$: 1, a: a};
};
var $author$project$Algo$Matcher$addExactState_ = F2(
	function (node, res) {
		return _Utils_update(
			res,
			{
				z: A3(
					...
					function (prev) {
						if (prev.$ === 1) {
							...
							var list = prev.a;
							return $elm$core$Maybe$Just(
								A2($elm$core$List$cons, node.c, list));
						}
					},
					res.z)
			});
	});
var $author$project$Algo$Backtrack$map = F2(
	function (func, token) {
		return _Utils_update(
			token,
			{
				...
				function (_v0, node, _v1) {
					switch (node.$) {
						case 1:
							...
							if (_v3.$ === 1) {
								return _Utils_Tuple2(
									_Utils_Tuple2(s.c, $elm$core$Maybe$Nothing),
									0);
							} else {
								var n = _v3.a;
								return _Utils_Tuple2(
...
var $author$project$Algo$Matcher$otherMatchEvaluator_ = F4(
	function (op, props, key, nodes) {
		return $author$project$Algo$Backtrack$return(
			function (result) {
				return $elm$core$List$isEmpty(nodes) ? $elm$core$Maybe$Just(
					_Utils_update(
						result,
						{
							L: A3(
								$elm$core$Dict$insert,
								key,
								$author$project$Algo$Matcher$ExternalValue_(
									$author$project$Algo$Math$RealNode(
										{c: $elm$core$Maybe$Nothing, s: props.m})),
								result.L)
						})) : (($elm$core$List$length(nodes) === 1) ? A2(
					$elm$core$Maybe$map,
					function (_v0) {
						var node = _v0.b;
						return _Utils_update(
									...
									$author$project$Algo$Matcher$MultiValue_(
										{
											...
											m: props.m,
											bK: op,
											bQ: processChildren(b),
											bR: processChildren(a)
										}),
									result.L)
							}));
				}(
		...
		while (true) {
			switch (from.$) {
				case 1:
					...
					if (!root.$) {
						var n = root.a;
						return _Utils_eq(n.s, s.s) ? A2(
							$author$project$Algo$Backtrack$return,
							A2(
								$elm$core$Basics$composeR,
								$author$project$Algo$Matcher$addExactState_(
									{
										a: $elm$core$String$fromFloat(n.s),
										c: n.c
									}),
								$elm$core$Maybe$Just),
							token) : $author$project$Algo$Backtrack$fail;
					} else {
						...
						return A2(
							...
							function (result) {
								return function (varDict) {
									...
									var _v3 = A2($elm$core$Dict$get, s.a, result.L);
									if (!_v3.$) {
										if (_v3.a.$ === 1) {
				...
				case 2:
					var s = from.a;
					if ($elm$core$List$isEmpty(s.b)) {
						if (root.$ === 1) {
							var n = root.a;
							return _Utils_eq(n.a, s.a) ? A2(
								$author$project$Algo$Backtrack$return,
								A2(
									$elm$core$Basics$composeR,
									$author$project$Algo$Matcher$addExactState_(n),
									$elm$core$Maybe$Just),
								token) : $author$project$Algo$Backtrack$fail;
						} else {
							return $author$project$Algo$Backtrack$fail;
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									$elm$core$List$length(s.b),
									$elm$core$List$length(n.E)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
									...
									n.E,
									A2(
										$author$project$Algo$Backtrack$map,
										$author$project$Algo$Matcher$addExactState_(n),
										token));
							case 2:
								var n = root.a;
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aL;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.E);
								return (!_Utils_eq(
									$elm$core$List$length(s.b),
								...
								return function (_v10) {
									...
									return A3(
										...
										_Utils_ap(
											...
											_List_fromArray(
												[
													A3($author$project$Algo$Matcher$otherMatchEvaluator_, s.a, n, o)
												])),
										_Utils_ap(a, b),
										A2(
											$author$project$Algo$Backtrack$map,
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.E)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
...
var $author$project$Algo$Matcher$replaceOnNode_ = F3(
	function (matches, id, _v0) {
		var selected = _v0.a;
		var eq = _v0.b;
		return function (res) {
			if (!res.$) {
				...
				var newEq = _v4.b;
				return _Utils_Tuple2(
					A2($elm$core$Set$insert, newRoot, selected),
					newEq);
			} else {
				return _Utils_Tuple2(selected, eq);
			}
		}(
			A3(
				$author$project$Algo$Matcher$processSubtree_,
										...
										return A2(
											...
											function (matchRes) {
												return $elm$core$Result$toMaybe(
													A3($author$project$Algo$Matcher$replaceSubtree_, replacement, matchRes, subEq));
											},
											A2(
												$elm$core$Maybe$andThen,
												$author$project$Algo$Backtrack$getState,
												A4(
													...
													matcher,
													subEq.ad,
													$author$project$Algo$Backtrack$init($author$project$Algo$Matcher$newResult))));
									}
								}),
							$elm$core$Maybe$Nothing,
							matches));
...
var $author$project$Algo$Matcher$replaceAllOccurrences = F4(
	function (funcs, roots, _with, on) {
		var _v0 = _with.ad;
		if (_v0.$ === 5) {
			var withN = _v0.a;
			if (withN.a !== '=') {
				return $elm$core$Result$Err('Chosen substitution equation is not an equation');
			} else {
				var _v1 = withN.E;
					...
					return A2(
						...
						function (pairs) {
							return function (_v3) {
								var newRoots = _v3.a;
								var newEq = _v3.b;
								return $elm$core$Set$isEmpty(newRoots) ? $elm$core$Result$Err('No selected nodes can be substituted') : $elm$core$Result$Ok(
									_Utils_Tuple2(newRoots, newEq));
							}(
								A3(
									$elm$core$Set$foldl,
									$author$project$Algo$Matcher$replaceOnNode_(pairs),
									_Utils_Tuple2($elm$core$Set$empty, on),
									roots));
						},
						A3($author$project$Algo$Matcher$createMatcherPair_, funcs, left, right));
				} else {
					return $elm$core$Result$Err('Ambiguous equation. Ensure that it only equates 2 statements');
				}
			}
		} else {
			return $elm$core$Result$Err('Chosen substitution equation is not an equation');
...
var $author$project$Components$Display$substitute = F5(
	function (funcs, origNum, selected, eqNum, model) {
		var _v0 = A2($elm$core$Dict$get, eqNum, model.e);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Substitution equation not found');
		} else {
			var subHis = _v0.a;
			var _v1 = A2($elm$core$Dict$get, origNum, model.e);
			if (_v1.$ === 1) {
				return $elm$core$Result$Err('Target equation not found');
			} else {
				var origHis = _v1.a;
				var origEq = $author$project$Algo$History$current(origHis);
				return A2(
					$elm$core$Result$map,
					function (_v2) {
						var newSelected = _v2.a;
						var newEq = _v2.b;
						return _Utils_update(
							model,
							{
								e: A3(
									$elm$core$Dict$insert,
									origNum,
									A2($author$project$Algo$History$add, newEq, origHis),
									model.e),
								k: $elm$core$Maybe$Just(
									_Utils_Tuple2(origNum, newSelected))
							});
					},
					A4(
						$author$project$Algo$Matcher$replaceAllOccurrences,
						funcs,
						selected,
						$author$project$Algo$History$current(subHis),
						origEq));
			}
		}
	});
	...
	function (eqNum, selected, model) {
		return {
			...
			a2: function (dict) {
				...
				if ((!_v2.$) && (_v2.a.$ === 1)) {
					var a = _v2.a.a;
					return A3($author$project$Main$ApplySubstitution, eqNum, selected, a);
				} else {
					return $author$project$Main$NoOp;
				}
			},
			a3: 'Substitute a variable for a formula'
		};
	});
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return function (actionView) {
													return {av: actionView, G: createMode, g: display, R: evaluator, ax: historyBox, aA: menu, ap: nextCreateInt, af: notification, bi: rules, Y: showHelp, aB: showHistory, P: showMenu, aE: tutorial};
												};
											};
										};
									};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {q: nodes, ad: root, _: undone, C: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {E: children, aj: component, aM: parent};
	});
			...
			switch (t) {
				...
				case 'variable':
					return A4(
						...
						A2($elm$json$Json$Decode$field, 'constant', $elm$json$Json$Decode$bool));
				case 'unary':
					return A4(
						$elm$json$Json$Decode$map3,
						F3(
				...
				case 'binary':
					return A7(
						...
						F6(
							function (s, n, a, c, i, children) {
								return $author$project$Algo$Math$BinaryNode(
									{l: a, E: children, h: c, m: i, a: n, c: s});
							}),
						sDec,
						A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
						...
						A2($elm$json$Json$Decode$field, 'identity', $elm$json$Json$Decode$float),
						A2(
							$elm$json$Json$Decode$field,
							'children',
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aH: copyState, aK: newState, n: id, aM: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aU: create, e: eq, S: hidden, aq: next, k: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F2(
	function (properties, javascript) {
		return {ab: javascript, X: properties};
	});
var $author$project$Algo$Math$functionPropertyDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (_arguments) {
		return (_arguments <= 0) ? $elm$json$Json$Decode$fail('Functions must contain a positive number of integers') : ((_arguments === 1) ? $elm$json$Json$Decode$succeed(
			$author$project$Algo$Math$UnaryNode(
				{
					Q: $author$project$Algo$Math$RealNode(
						{c: 0, s: 0}),
			...
			function (_v0) {
				...
				if ((!c) && (!a)) {
					return $elm$json$Json$Decode$succeed(
						$author$project$Algo$Math$GenericNode(
							{
								b: $elm$core$Maybe$Just(_arguments),
								E: _List_Nil,
								a: '',
								c: 0
							}));
					...
					if (i.$ === 1) {
						return $elm$json$Json$Decode$fail('Missing identity for binary function');
					} else {
						var iden = i.a;
						return $elm$json$Json$Decode$succeed(
							$author$project$Algo$Math$BinaryNode(
								{l: a, E: _List_Nil, h: c, m: iden, a: '', c: 0}));
					}
				}
			},
			A4(
				...
				F3(
					function (c, a, i) {
						return _Utils_Tuple3(
							A2($elm$core$Maybe$withDefault, false, c),
							A2($elm$core$Maybe$withDefault, false, a),
							i);
					}),
				$elm$json$Json$Decode$maybe(
					A2($elm$json$Json$Decode$field, 'commutative', $elm$json$Json$Decode$bool)),
				$elm$json$Json$Decode$maybe(
					A2($elm$json$Json$Decode$field, 'associative', $elm$json$Json$Decode$bool)),
				$elm$json$Json$Decode$maybe(
					A2($elm$json$Json$Decode$field, 'identity', $elm$json$Json$Decode$float)))) : $elm$json$Json$Decode$succeed(
			$author$project$Algo$Math$GenericNode(
				{
					b: $elm$core$Maybe$Just(_arguments),
					E: _List_Nil,
...
var $author$project$Components$Rules$functionDecoder_ = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Components$Rules$FunctionProperties_,
	$author$project$Algo$Math$functionPropertyDecoder,
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {F: constants, H: functions, a: name, bi: rules};
	});
var $author$project$Components$Rules$Rule = F4(
	function (title, description, parameters, matches) {
		return {ak: description, aX: matches, bg: parameters, a3: title};
	});
var $author$project$Algo$Matcher$parseMatcher = F3(
	function (checker, knownProps, state) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Algo$Math$parse(knownProps),
			$elm$core$Result$andThen(
				A3($author$project$Algo$Matcher$treeToMatcher_, checker, $elm$core$Dict$empty, state)));
	});
				...
				F2(
					function (_v0, _v1) {
						...
						return A2(
							...
							A2($author$project$Algo$Math$parse, $elm$core$Dict$empty, key));
					}),
				_Utils_Tuple2($elm$core$Dict$empty, $elm$core$Dict$empty)),
			$author$project$Helper$resultToDecoder),
		$elm$json$Json$Decode$keyValuePairs($elm$json$Json$Decode$string));
};
var $author$project$Algo$Matcher$toReplacement = F3(
	function (funcProps, strict, argDict) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Algo$Math$parse(funcProps),
			$elm$core$Result$andThen(
				A2($author$project$Algo$Matcher$toReplacement_, strict, argDict)));
	});
								...
								_Utils_update(
									s,
									{
										b: A2(
											...
											$author$project$Components$Rules$setOthers_(others),
											_Utils_ap(
												A2($elm$core$List$take, index, s.b),
												A2($elm$core$List$drop, index + 1, s.b))),
										aL: $elm$core$Maybe$Just(name)
									}));
						}
					}(
						A3(
							...
							F2(
								function (_v2, res) {
									...
									if (!n.$) {
										var c = n.a;
										return ($elm$core$List$isEmpty(c.b) && A2($elm$core$Set$member, c.a, others)) ? $elm$core$Maybe$Just(
							...
							$elm$core$Maybe$Nothing,
							A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, s.b)));
				}
		}
	});
									...
									function (to) {
										...
										return {
											a8: _Utils_update(
												from,
												{
													ad: A2($author$project$Components$Rules$setOthers_, otherSet, from.ad)
												}),
											bo: to
										};
									},
...
var $author$project$UI$ActionView$decoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$UI$ActionView$Current,
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {D: bottom, y: left, B: right, J: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {p: coordinates, al: drags, co: id};
	});
...
var $author$project$Main$swappableDecoder = A2(
	...
	function (_v0) {
		...
		var showMenu = _v6.c;
		var _v7 = _v5.b;
		var showHistory = _v7.a;
		var historyBox = _v7.b;
		var actionView = _v7.c;
		return $author$project$Main$Swappable(display)(rules)(tutorial)(notification)(menu)(evaluator)(createMode)(nextCreateInt)(showHelp)(showMenu)(showHistory)(historyBox)(actionView);
	},
	A4(
		$elm$json$Json$Decode$map3,
		...
		A7(
			...
			A2($elm$json$Json$Decode$field, 'actionView', $author$project$UI$ActionView$decoder))));
	...
	if (!_v0.b) {
		...
		if (!_v0.b.b) {
			...
			return _Utils_update(
				model,
				{
					_: A2($elm$core$List$cons, x, model._),
					C: others
				});
		}
	}
		...
		if (_v0.$ === 3) {
			...
			if (!n.l) {
						...
						if (!children.b) {
							...
							if (c.$ === 3) {
								...
								if (!_Utils_eq(m.a, n.a)) {
									...
									if (A2(
										$elm$core$Set$member,
										$author$project$Algo$Matcher$getID(m.c),
										nodes)) {
										return $elm$core$Result$Ok(
											_Utils_Tuple2(
												_Utils_ap(m.E, other),
				...
				return A2(
					...
					A2(traverseRemaining, false, n.E));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
	...
	function (id, nodes, eq) {
		return A2(
			...
			A3(
				$author$project$Algo$Matcher$processSubtree_,
				A2($author$project$Algo$Matcher$searchPath_, eq.j.aM, id),
				A3($author$project$Algo$Matcher$ungroupChild_, eq.j, id, nodes),
				eq));
	});
...
var $author$project$Algo$History$update = F2(
	function (e, model) {
		...
		return _Utils_update(
			...
			{
				_: _List_Nil,
				C: A2($elm$core$List$cons, n, model.C)
			});
	});
	...
	function (event, model) {
		switch (event.$) {
			...
			default:
				var eq = event.a;
				var he = event.b;
				var _v3 = A2($elm$core$Dict$get, eq, model.e);
				if (_v3.$ === 1) {
					...
					var newModel = _Utils_update(
						model,
						{
							e: A3($elm$core$Dict$insert, eq, newHis, model.e)
						});
					var _v4 = model.k;
					if (_v4.$ === 1) {
...
var $author$project$UI$ActionView$update = F2(
	function (e, m) {
		if (!e.$) {
			var num = e.a;
			return A2($author$project$UI$ActionView$Current, num, true);
		} else {
			var num = e.a;
			var cNum = m.a;
			var show = m.b;
			return _Utils_eq(cNum, num) ? A2($author$project$UI$ActionView$Current, cNum, !show) : A2($author$project$UI$ActionView$Current, num, true);
		}
	});
		...
		switch (e.$) {
					...
					_Utils_update(
						model,
						{
							al: A3(
								...
								{bv: d, a8: p, bM: model.p},
								model.al)
						}),
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$SetCapture, model.co, pid)));
			case 1:
				var pid = e.a;
				var to = e.b;
				var _v2 = A2(
				...
				if (_v2.$ === 1) {
					...
					var start = _v2.a;
					var orig = start.bM;
					var _v3 = A2($author$project$UI$Draggable$diff, start.a8, to);
					var diffX = _v3.a;
					var diffY = _v3.b;
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										p: {D: orig.D + dy, y: orig.y + dx, B: orig.B + dx, J: orig.J + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										p: _Utils_update(
											orig,
											{
												y: A2($elm$core$Basics$min, orig.B - 2, orig.y + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 1:
								...
								_Utils_update(
									model,
									{
										p: _Utils_update(
											orig,
											{
												B: A2($elm$core$Basics$max, orig.y + 2, orig.B + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 3:
								...
								_Utils_update(
									model,
									{
										p: _Utils_update(
											orig,
											{
												D: A2($elm$core$Basics$max, orig.J + 2, orig.D + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 4:
								...
								_Utils_update(
									model,
									{
										p: _Utils_update(
											...
											{
												y: A2($elm$core$Basics$min, orig.B - 2, orig.y + dx),
												J: A2($elm$core$Basics$min, orig.D - 2, orig.J + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 5:
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$ReleaseCapture, model.co, pid)));
			default:
				return _Utils_Tuple2(model, $elm$core$Maybe$Nothing);
		}
	});
...
var $author$project$UI$Notification$update = F2(
	function (e, model) {
		if (!e.$) {
			var id = e.a;
			var _v1 = A2($elm$core$Dict$get, id, model.O);
			if (_v1.$ === 1) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			} else {
				var n = _v1.a;
				return function (_v2) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								O: A3($elm$core$Dict$insert, id, elem, model.O)
							}),
						cmd);
				}(
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						O: A2($elm$core$Dict$remove, id, model.O)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Components$Display$update, e, model.g);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aE);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model.af);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								aA: A2($author$project$UI$Menu$update, e, model.aA)
							})),
					$elm$core$Platform$Cmd$none);
			case 7:
				var e = event.a;
				if (e.$ === 1) {
					var de = e.a;
					var _v5 = A3($author$project$UI$Draggable$update, core.a$, de, model.ax);
					var newBox = _v5.a;
					var action = _v5.b;
					return _Utils_Tuple2(
						updateCore(
					...
					var de = e.a;
					var _v6 = A2($author$project$Components$Display$update, de, model.g);
					var dModel = _v6.a;
					var dCmd = _v6.b;
					return _Utils_Tuple2(
						updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								av: A2($author$project$UI$ActionView$update, e, model.av)
							})),
					$elm$core$Platform$Cmd$none);
			case 9:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
			case 10:
				var input = event.a;
				var _v7 = _Utils_Tuple3(input.bt, input.b3, input.bb);
				_v7$3:
				while (true) {
					switch (_v7.c) {
						case 'Escape':
							var _v8 = _Utils_Tuple2(core.v, model.G);
							if (!_v8.a.$) {
								return _Utils_Tuple2(
									_Utils_update(
										core,
						...
						case 'z':
							if (_v7.a) {
								if (!_v7.b) {
									var _v10 = $author$project$Components$Display$undo(model.g);
									if (_v10.$ === 1) {
										var errStr = _v10.a;
									...
									var _v11 = $author$project$Components$Display$redo(model.g);
									if (_v11.$ === 1) {
										var errStr = _v11.a;
										return A2($author$project$Main$submitNotification_, core, errStr);
									} else {
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{G: $elm$core$Maybe$Nothing, Y: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v15 = A4(
						$author$project$Algo$Matcher$parseEquation,
						$author$project$Components$Rules$functionProperties(model.bi),
						$author$project$Components$Display$createState,
						$author$project$Components$Display$updateState,
						str);
					if (!_v15.$) {
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{G: $elm$core$Maybe$Nothing, g: dModel, Y: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
							...
							A2($author$project$Components$Display$addEquation, root, model.g));
					} else {
						var err = _v15.a;
			...
			case 20:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v18 = A2($author$project$Components$Rules$addTopic, topic, model.bi);
					if (_v18.$ === 1) {
						var errStr = _v18.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bi: A2($author$project$Components$Rules$addSources, source.x, model.bi)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
						...
						if (result.$ === 1) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									core,
									{I: s}),
								A2($author$project$Main$updateQuery_, core, s.g));
						}
					}(
						A2(
							$elm$core$Result$mapError,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.aX) === 1) && $elm$core$Dict$isEmpty(p.bg)) {
							var _v24 = A2($author$project$Helper$listIndex, 0, p.aX);
							if (_v24.$ === 1) {
					...
					case 1:
						...
						var root = e.b;
						var children = e.c;
						var _v25 = A4($author$project$Components$Display$groupChildren, eqNum, root, children, model.g);
						if (_v25.$ === 1) {
							var errStr = _v25.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						...
						var root = e.b;
						var selected = e.c;
						var _v26 = A4($author$project$Components$Display$ungroupChildren, eqNum, root, selected, model.g);
						if (_v26.$ === 1) {
							var errStr = _v26.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 4:
						var eqNum = e.a;
						var selected = e.b;
						return ($elm$core$Dict$size(model.g.e) < 2) ? A2($author$project$Main$submitNotification_, core, 'There are no equations to use for substitution') : _Utils_Tuple2(
							_Utils_update(
								core,
								{
									v: $elm$core$Maybe$Just(
										_Utils_Tuple2(
											A3($author$project$Main$substitutionDialog_, eqNum, selected, model),
											$elm$core$Maybe$Nothing))
								}),
							$elm$core$Platform$Cmd$none);
					case 3:
						...
						A2(
														...
														return A2(
															...
															function (tree) {
																return _Utils_update(
																	r,
																	{
																		a8: A3($author$project$Algo$Matcher$addMatch, k, tree, r.a8)
																	});
															},
															A4(
																$author$project$Algo$Matcher$toReplacement,
							...
							A2(
								...
								function () {
									...
									if ((!_v30.$) && (_v30.a.$ === 1)) {
										var n = _v30.a.a;
										return A2($author$project$Helper$listIndex, n, existing.aX);
									} else {
										return A2($author$project$Helper$listIndex, 0, existing.aX);
									}
								}())));
				} else {
					return _Utils_Tuple2(
			...
			case 28:
				var origNum = event.a;
				var selected = event.b;
				var eqNum = event.c;
				var _v34 = A5(
					$author$project$Components$Display$substitute,
					$author$project$Components$Rules$functionProperties(model.bi),
					origNum,
					selected,
					eqNum,
			...
			case 29:
				...
				if (_v35.$ === 1) {
					...
					var replacement = _v35.a;
					var _v36 = A2($author$project$Components$Rules$evaluateStr, model.bi, replacement);
					if (_v36.$ === 1) {
						var errStr = _v36.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.co, model.R);
				var eModel = _v38.a;
				var c = _v38.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var root = _v40.b;
						var target = _v40.c;
						var replacement = _v40.d;
						if (!_Utils_eq(target, reply.s)) {
							return A2(
								$author$project$Main$submitNotification_,
								newCore,
								'Expression evaluates to: ' + ($elm$core$String$fromFloat(reply.s) + (', but expecting: ' + $elm$core$String$fromFloat(target))));
						} else {
							var _v41 = A5($author$project$Components$Display$replaceNumber, eqNum, root, target, replacement, model.g);
							if (_v41.$ === 1) {
								var errStr = _v41.a;
						...
						var eqNum = _v42.a;
						var id = _v42.b;
						var _v43 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.s, model.g);
						if (_v43.$ === 1) {
							var errStr = _v43.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
...
var $author$project$Main$ActionEvent = function (a) {
	return {$: 8, a: a};
};
var $author$project$UI$Menu$Content = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$EnterCreateMode = {$: 11};
...
var $author$project$Main$Save = {$: 17};
var $author$project$Main$SaveFile = 1;
var $author$project$UI$Menu$Section = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Main$ToggleHistory = {$: 25};
			...
			az: _List_fromArray(
				[
					...
					[
						...
						{
							cm: $author$project$Main$FileSelect(0),
							aO: 'Select a file'
						})
					])
				]),
...
var $author$project$Main$ToggleHelp = {$: 15};
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Algo$Math$toString(
												$author$project$Algo$History$current(eq).ad))
										]))
								]))
						]));
			},
...
var $author$project$Components$Tutorial$menu = F2(
	function (converter, model) {
		return A2(
			...
			{aa: $elm$core$Maybe$Nothing, a: 'Tutorials'},
			_List_Nil);
	});
			...
			A3(
									...
									return A2(
										$author$project$UI$Menu$Section,
										{
											aa: $elm$core$Maybe$Just(
												function (c) {
													return $author$project$UI$Icon$download(
														_List_fromArray(
															[
																$author$project$UI$HtmlEvent$onClick(
																converter(
																...
																$author$project$UI$Icon$class('clickable'),
																$author$project$UI$Icon$class(c)
															]));
												}),
											a: k
										},
									...
									return A2(
										...
										A2(
											...
											function (rule) {
												return A2(
													$author$project$UI$Menu$Section,
													{aa: $elm$core$Maybe$Nothing, a: rule.a3},
													_List_fromArray(
														[
															$author$project$UI$Menu$Content(
				...
				_List_fromArray(
					[
						A2(
						$author$project$UI$Menu$Section,
						{aa: $elm$core$Maybe$Nothing, a: 'Core'},
						_List_fromArray(
							[
								A2(
								$author$project$UI$Menu$Section,
								{aa: $elm$core$Maybe$Nothing, a: 'Evaluate'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{aa: $elm$core$Maybe$Nothing, a: 'Number Substitution'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{aa: $elm$core$Maybe$Nothing, a: 'Substitute'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{aa: $elm$core$Maybe$Nothing, a: 'Group'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{aa: $elm$core$Maybe$Nothing, a: 'Ungroup'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
...
var $author$project$Components$Display$collapsedView_ = F3(
	function (eq, highlight, node) {
		if (!node.$) {
			...
			var s = node.a;
			var id = $author$project$Algo$Matcher$getID(s.c);
			return A2(
				$elm$html$Html$div,
				_Utils_ap(
					_List_fromArray(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													eqNum,
													highlight,
													$author$project$Algo$Math$symbolicate(eq.ad)),
													A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.ad)
												]))),
									result);
							}
						}),
...
var $author$project$UI$ActionView$Next = function (a) {
	return {$: 0, a: a};
};
var $author$project$UI$ActionView$coreToList_ = function (state) {
	return _List_fromArray(
		[
			...
			_Utils_Tuple2('Number Substitution', state.bd),
			_Utils_Tuple2('Substitution', state.bn),
			_Utils_Tuple2('Group', state.a9),
...
var $author$project$UI$ActionView$CoreTopicState = F5(
	function (substitute, group, ungroup, numSubstitute, evaluate) {
		return {by: evaluate, a9: group, bd: numSubstitute, bn: substitute, bp: ungroup};
	});
	...
	function (rModel, selection) {
		if (selection.$ === 1) {
			...
			var evaluateState = function () {
				var _v3 = A2($author$project$Components$Rules$evaluateStr, rModel, selected.aQ);
				if (_v3.$ === 1) {
					return $author$project$UI$ActionView$Disallowed;
				} else {
					var str = _v3.a;
					return $author$project$UI$ActionView$Allowed(
						A3($author$project$Components$Rules$Evaluate, selected.am, selected.ad, str));
				}
			}();
			var result = A5(
				$author$project$UI$ActionView$CoreTopicState,
				$author$project$UI$ActionView$Allowed(
					A2($author$project$Components$Rules$Substitute, selected.am, selected.k)),
						...
						var ungroupRes = sameBinaryNode ? _Utils_update(
							result,
							{
								bp: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Ungroup, selected.am, selected.ad, selected.q))
							}) : result;
						return (_Utils_eq(
							$elm$core$List$length(n.E),
							...
							ungroupRes,
							{
								a9: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Group, selected.am, selected.ad, selected.q))
							});
					}
				case 0:
					var n = _v1.a;
					return _Utils_update(
						result,
						{
							bd: $author$project$UI$ActionView$Allowed(
								A3($author$project$Components$Rules$NumericalSubstitution, selected.am, selected.ad, n.s)),
...
var $author$project$UI$ActionView$Toggle = function (a) {
	return {$: 1, a: a};
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$li = _VirtualDom_node('li');
var $author$project$UI$ActionView$displayTopic_ = F7(
	function (ruleConvert, eventConvert, selected, show, title, current, actions) {
		return A2(
			$elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					...
					$elm$html$Html$h2,
					_Utils_ap(
						_Utils_eq(current, selected) ? _List_fromArray(
							[
								$elm$html$Html$Attributes$class('selected')
							]) : _List_Nil,
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(
								eventConvert(
									$author$project$UI$ActionView$Toggle(current)))
							])),
					_List_fromArray(
						[
					...
					A2(
					$elm$html$Html$div,
					(_Utils_eq(current, selected) && show) ? _List_Nil : _List_fromArray(
						[
								...
								function () {
									switch (state.$) {
										...
										case 1:
											return _List_fromArray(
												[
													$elm$html$Html$Attributes$class('disallowed')
												]);
										default:
											var event = state.a;
											return _List_fromArray(
...
var $author$project$UI$Icon$left = function (attr) {
	return A2(
		$elm$svg$Svg$svg,
		A2(
			$elm$core$List$cons,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M8 12L16 6V18Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil)
				...
				if (selected.$ === 1) {
					...
					var matches = A2(
						...
						function (m) {
							return A2(
								$elm$core$Maybe$map,
								function (result) {
									return {a8: result, bX: m.bo};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.q, m.a8.ad, n.aQ));
						},
						rule.aX);
					return $elm$core$List$isEmpty(matches) ? $author$project$UI$ActionView$Disallowed : $author$project$UI$ActionView$Allowed(
						$author$project$Components$Rules$Apply(
							{aX: matches, bg: rule.bg, a3: rule.a3}));
				}
			}());
	});
var $author$project$UI$Icon$right = function (attr) {
	return A2(
		$elm$svg$Svg$svg,
		A2(
			$elm$core$List$cons,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M16 12L8 6V18Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil)
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var tree = _v1.c;
					return {am: eqNum, q: nodes, ad: root, k: ids, aQ: tree};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
						...
						A2(
							...
							$elm$core$Result$toMaybe)),
					A2($elm$core$Dict$get, eqNum, model.e)));
		},
		model.k);
};
var $author$project$UI$ActionView$view = F5(
	function (ruleConvert, eventConvert, rModel, dModel, vModel) {
		var selectedNode = $author$project$UI$ActionView$selectedNode_(dModel);
		var loadedTopics = $author$project$Components$Rules$loadedTopics(rModel);
		var _v0 = function () {
			var c = vModel.a;
			var s = vModel.b;
			return _Utils_Tuple2(
				A2(
					$elm$core$Basics$min,
					c,
					$elm$core$List$length(loadedTopics)),
				s);
		}();
		var current = _v0.a;
		var show = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					$author$project$UI$Icon$left(
					(current <= 0) ? _List_Nil : _List_fromArray(
						[
							$author$project$UI$HtmlEvent$onClick(
							eventConvert(
								$author$project$UI$ActionView$Next(current - 1))),
							$author$project$UI$Icon$class('clickable')
						])),
					A3(
					...
					A2(
						...
						A2(
							...
							loadedTopics))),
					$author$project$UI$Icon$right(
					(_Utils_cmp(
						current,
						$elm$core$List$length(loadedTopics)) > -1) ? _List_Nil : _List_fromArray(
						[
							$author$project$UI$HtmlEvent$onClick(
							eventConvert(
								$author$project$UI$ActionView$Next(current + 1))),
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.co)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.co),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.co))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.cm),
								$elm$html$Html$Attributes$class('clickable')
							]),
						_List_fromArray(
							[
						...
						function (section) {
							return A2(
								...
								A2(
									...
									A2($elm$core$List$map, $author$project$UI$Dialog$listView_, section.az)));
						},
						model.a_),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									$author$project$UI$HtmlEvent$onClick(model.aT)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					'left',
					$elm$core$String$fromFloat(model.p.y) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(model.p.J) + 'dvh'),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.p.B - model.p.y) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.p.D - model.p.J) + 'dvh'),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					A2($elm$html$Html$Attributes$style, 'padding', '1rem 0.2rem 0.2rem 0.2rem'),
					$elm$html$Html$Attributes$id(model.co)
				]),
...
var $author$project$UI$HistoryView$historyEntry_ = F3(
	function (current, event, t) {
		return A2(
			$elm$html$Html$a,
...
var $author$project$Algo$History$serialize_ = F5(
	function (processNode, selectedID, nodes, index, n) {
		return A4(
			processNode,
			_Utils_eq(selectedID, index),
			index,
			n.aj,
			A2(
				$elm$core$List$filterMap,
				function (i) {
					return A2(
						$elm$core$Maybe$map,
						A4($author$project$Algo$History$serialize_, processNode, selectedID, nodes, i),
						A2($elm$core$Dict$get, i, nodes));
				},
				n.E));
	});
var $author$project$Algo$History$serialize = F2(
	function (processNode, model) {
		return A5(
			$author$project$Algo$History$serialize_,
			processNode,
			$author$project$Algo$History$currentNode_(model),
			model.q,
			0,
			model.ad);
	});
			...
			function () {
				...
				if (_v0.$ === 1) {
					...
					return A2(
						...
						F4(
							function (current, index, c, children) {
								var middle = A2(
									$elm$core$Basics$max,
									0,
									$elm$core$List$length(children) - 1);
								var _v3 = $elm$core$List$head(
									A2($elm$core$List$drop, middle, children));
								if (_v3.$ === 1) {
									return _List_fromArray(
										[
											A3(
											$author$project$UI$HistoryView$historyEntry_,
											current,
											converter(
												$author$project$UI$HistoryView$DisplayEvent(
													A2($author$project$Components$Display$HistoryEvent, eqNum, index))),
											$author$project$Algo$Math$toString(c.ad))
										]);
								} else {
									var after = _v3.a;
									return A2(
										...
										_Utils_ap(
											A2(
												...
												A2($elm$core$List$take, middle, children)),
											after));
								}
							}),
						eq);
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.ax, model.g))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'actions',
								A5($author$project$UI$ActionView$view, $author$project$Main$RuleEvent, $author$project$Main$ActionEvent, model.bi, model.g, model.av))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
											...
											A2(
												...
												_List_fromArray(
													[
														...
														A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.G)
													]))),
											A2(
											$elm$html$Html$div,
											A2(
												...
												[
													...
													_List_fromArray(
														[
															A2(
															$author$project$UI$Menu$Section,
															{aa: $elm$core$Maybe$Nothing, a: 'Settings'},
															_List_fromArray(
																[
																	$author$project$UI$Menu$Content(
																	_List_fromArray(
															...
															A2($author$project$Components$Display$menu, $author$project$Main$DisplayEvent, model.g)),
															A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aE),
															A2(
															$author$project$UI$Menu$Section,
															{
																aa: $elm$core$Maybe$Just(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{cq: $author$project$Main$init, ct: $author$project$Main$EventUrlChange, cu: $author$project$Main$EventUrlRequest, cD: $author$project$Main$subscriptions, cF: $author$project$Main$update, cG: $author$project$Main$view});
