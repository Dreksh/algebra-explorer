...
{
	if (region.a7.aD === region.bd.aD)
	{
		return 'on line ' + region.a7.aD;
	}
	return 'on lines ' + region.a7.aD + ' through ' + region.bd.aD;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { N: 'hidden', bV: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { N: 'mozHidden', bV: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { N: 'msHidden', bV: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { N: 'webkitHidden', bV: 'webkitvisibilitychange' }
		: { N: 'hidden', bV: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.b6, request.bM, true);
		} catch (e) {
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{v: nodeList, q: (len / $elm$core$Array$branchFactor) | 0, t: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bh: fragment, bl: host, bs: path, bu: port_, bx: protocol, by: query};
	});
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$UI$Notification$delayedClear_(model.G)
					])));
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {ag: nextCallID, _: ongoing, a5: sender};
	});
				...
				_Utils_Tuple2(
					{
						...
						A: true,
						w: true,
						ae: $author$project$Components$Rules$InfixOp('+')
					},
					1)),
				_Utils_Tuple2(
				'*',
				...
				_Utils_Tuple2(
					{
						...
						A: false,
						w: false,
						ae: $author$project$Components$Rules$PrefixOp('-')
					},
					1)),
				_Utils_Tuple2(
				'/',
				_Utils_Tuple2(
					{
						...
						A: false,
						w: false,
						ae: $author$project$Components$Rules$PrefixOp('1/')
					},
					1))
			])),
	x: $elm$core$Dict$empty
};
var $author$project$Components$Tutorial$init = {bp: 0, bF: 0};
var $author$project$UI$Menu$init = function (shown) {
	return {U: shown};
};
var $author$project$UI$Notification$init = {G: 0, P: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bS: false, bU: r.bU, be: r.be, bi: r.bi, b6: r.b6, ci: r.ci, j: r.j, bM: r.bM}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bU: $elm$http$Http$emptyBody, be: r.be, bi: _List_Nil, b6: 'GET', ci: $elm$core$Maybe$Nothing, j: $elm$core$Maybe$Nothing, bM: r.bM});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.bX));
			}(
				function () {
					var _v0 = deadEnd.ca;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bX: col, bY: contextStack, ca: problem, bD: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bD, s.bX, x, s.h));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bX: col, h: s0.h, k: s0.k, e: offset, bD: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.e, s.bD, s.bX, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.e, s.bD, s.bX, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bX: newCol, h: s.h, k: s.k, e: newOffset, bD: newRow, d: s.d});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {bX: col, h: context, k: indent, e: offset, bD: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.a7, s.e, s.d);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.bf));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.aZ, s.e + 1, s.bD + 1, 1, s.d, s.k, s.h) : A7($elm$parser$Parser$Advanced$varHelp, i.aZ, firstOffset, s.bD, s.bX + 1, s.d, s.k, s.h);
			var name = A3($elm$core$String$slice, s.e, s1.e, s.d);
			return A2($elm$core$Set$member, name, i.a3) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.bf)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bf: $elm$parser$Parser$ExpectingVariable, aZ: i.aZ, a3: i.a3, a7: i.a7});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		a7: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{aZ: $elm$core$Char$isDigit, a3: $elm$core$Set$empty, a7: $elm$core$Char$isDigit});
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{A: true, b: children, w: true, a: '+', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bX: col, ca: problem, bD: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bD, p.bX, p.ca);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bX: 1, h: _List_Nil, k: 1, e: 0, bD: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aS(tracker.G);
					} else {
						var prev = previous.a;
						return A2(tracker.aO, prev, tracker.G);
					}
				}()),
			_Utils_update(
				tracker,
				{
					G: tracker.G + 1,
					g: A3($elm$core$Dict$insert, tracker.G, parent, tracker.g)
				}));
	});
...
var $author$project$Algo$Matcher$processID_ = F3(
	function (parent, tracker, oldRoot) {
		...
		switch (oldRoot.$) {
			...
			case 2:
				var s = oldRoot.a;
				var _v2 = A3($author$project$Algo$Matcher$processID_, id, newTracker, s.L);
				var newChild = _v2.a;
				var finalT = _v2.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$UnaryNode(
						{L: newChild, a: s.a, c: state}),
					finalT);
			case 3:
				var s = oldRoot.a;
				var _v3 = A2(processChildren, newTracker, s.b);
				var newChildren = _v3.a;
				var finalT = _v3.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{A: s.A, b: newChildren, w: s.w, a: s.a, c: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
				var _v4 = A2(processChildren, newTracker, s.b);
				var newChildren = _v4.a;
				var finalT = _v4.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$GenericNode(
						{b: newChildren, a: s.a, c: state}),
					finalT);
			default:
				var s = oldRoot.a;
				var _v5 = A2(processChildren, newTracker, s.b);
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{aO: copyState, aS: newState, G: 0, g: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
						...
						j: _Utils_update(
							tracker,
							{
								g: A2($elm$core$Dict$remove, 0, tracker.g)
							})
					};
				}),
...
var $author$project$Components$Display$updateState = F2(
	function (s, _v0) {
		return {
			am: $author$project$Algo$Matcher$getID(s)
		};
	});
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{aX: url, i: _List_Nil, a_: key, aU: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.by)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				by: query,
				C: {
					H: newScreen ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
					m: $author$project$Components$Display$init(eqs),
					M: $author$project$Components$Evaluate$init($author$project$Main$evaluateString),
					au: $author$project$UI$Menu$init(
						$elm$core$Set$fromList(
							_List_fromArray(
								['Settings', 'Equations', 'Tutorials']))),
					Z: nModel,
					aw: false,
					a4: $author$project$Components$Rules$init,
					T: false,
					ax: newScreen ? true : false,
					aq: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.aU)
					])));
	});
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.C.H, model.r);
				if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
...
var $author$project$Components$Display$addEquation = F2(
	function (eq, model) {
		return _Utils_update(
			model,
			{
				i: A3($elm$core$Dict$insert, model.ah, eq, model.i),
				ah: model.ah + 1
			});
	});
			...
			switch (node.$) {
				...
				case 3:
					...
					return $author$project$Algo$Math$BinaryNode(
						{
							A: s.A,
							b: A2($elm$core$List$map, convert, s.b),
							w: s.w,
							a: s.a,
							c: {
								D: $elm$core$Maybe$Nothing,
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								...
								B: functions,
								x: function () {
									var _v5 = A2($elm$core$Dict$get, topic.a, model.x);
									if (_v5.$ === 1) {
										return A3(
											$elm$core$Dict$insert,
											topic.a,
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.f, props.f) && (_Utils_eq(p.A, props.A) && _Utils_eq(p.w, props.w))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		var swappable = model.C;
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable.Z, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					g: A2($elm$core$Dict$remove, id, tracker.g)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					g: A3($elm$core$Dict$insert, id, p, tracker.g)
				});
		}
	});
var $author$project$Algo$Matcher$constructFromSource_ = F4(
	function (result, tracker, p, matcher) {
		...
		switch (matcher.$) {
			case 0:
				var m = matcher.a;
				var _v16 = A2($elm$core$Dict$get, m.a, result.l);
				if (!_v16.$) {
					if (!_v16.a.$) {
						...
						if (_v17.b) {
							var nodeID = _v17.a;
							var other = _v17.b;
							var _v18 = A2($elm$core$Dict$get, nodeID, result.s);
							if (!_v18.$) {
								var n = _v18.a;
								return _Utils_Tuple2(
									n,
								...
								return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.f, existing.K, tracker);
							}
						} else {
							return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.f, existing.K, tracker);
						}
							...
							return function (_v21) {
								...
								return _Utils_Tuple2(
									$author$project$Algo$Math$BinaryNode(
										{
											A: true,
											b: _Utils_ap(preNodes, postNodes),
											w: true,
											a: nodes.av,
											c: s
										}),
											...
											result,
											{
												l: A3(
													...
													$author$project$Algo$Matcher$MultiValue_(
														_Utils_update(
															nodes,
															{ak: newPost, al: newPre})),
													result.l)
											})));
							}(
								A4($author$project$Algo$Matcher$processMultiValue_, id, result.s, newT, nodes.ak));
						}(
							A4($author$project$Algo$Matcher$processMultiValue_, id, result.s, t, nodes.al));
					}
				} else {
					return _Utils_Tuple2(
						$author$project$Algo$Math$VariableNode(
			...
			default:
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						return _Utils_Tuple2(
							$author$project$Algo$Math$BinaryNode(
								{A: true, b: c, w: true, a: m.a, c: s}),
							_Utils_Tuple2(nextT, nextRes));
					} else {
						var o = _v29.a;
						var _v30 = A2($elm$core$Dict$get, o, result.l);
						if (_v30.$ === 1) {
							return _Utils_Tuple2(
								$author$project$Algo$Math$BinaryNode(
									{A: true, b: c, w: true, a: m.a, c: s}),
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.av, m.a)) ? function (_v31) {
									...
									return function (_v34) {
										...
										A4($author$project$Algo$Matcher$processMultiValue_, id, result.s, newT, mv.ak));
								}(
									A4($author$project$Algo$Matcher$processMultiValue_, id, result.s, nextT, mv.al));
							} else {
...
var $author$project$Algo$Matcher$constructFromValue_ = F5(
	function (parent, result, args, existing, tracker) {
		...
		var _v6 = A3(
			...
			$author$project$Algo$Math$getState(existing).Q,
			parent,
			tracker);
		var newS = _v6.a;
		...
		switch (existing.$) {
			...
			case 2:
				var s = existing.a;
				var _v9 = A5($author$project$Algo$Matcher$constructFromValue_, id, result, args, s.L, newTracker);
				var newChild = _v9.a;
				var _final = _v9.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$UnaryNode(
						{L: newChild, a: s.a, c: newS}),
					_final);
			case 3:
				var s = existing.a;
				var _v10 = A2(
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{A: s.A, b: newChildren, w: s.w, a: s.a, c: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
		...
		return A2(
			...
			F2(
				function (_v0, child) {
					var t = _v0.a;
					var r = _v0.b;
					var _v1 = $elm$core$List$head(child.u);
					if (_v1.$ === 1) {
						return function (_v2) {
							var node = _v2.a;
							var _v3 = _v2.b;
							...
							A5(
								...
								parent,
								{l: $elm$core$Dict$empty, s: $elm$core$Dict$empty},
								_List_Nil,
								child.K,
								t));
					} else {
									...
									_Utils_ap(
										...
										_List_fromArray(
											[
												...
												child,
												{
													u: A2($elm$core$List$drop, 1, child.u)
												})
											]))));
						} else {
							var node = _v4.a;
	...
	switch (root.$) {
		...
		case 2:
			...
			return A2(
				$elm$core$Set$insert,
				$author$project$Algo$Matcher$getID(s.c),
				$author$project$Algo$Matcher$getSubtreeIDs_(s.L));
		case 3:
			var s = root.a;
			return A3(
				$elm$core$List$foldl,
				...
				if (!children.b) {
					...
					if (_v1.$ === 1) {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								a,
								A2($elm$core$List$cons, newEq.n, others),
								newEq.j));
					}
				}
			});
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.n));
		if (!path.b) {
			return $elm$core$Result$Err('blah');
		} else {
			if (!path.b.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												n: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{L: newEq.n}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											n: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{b: children})),
											j: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											n: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{b: children})),
											j: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											n: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{b: children})),
											j: t
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.j.g);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.j.g, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							$author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(subEq.n)),
							subEq.j.g);
						var _v2 = A4($author$project$Algo$Matcher$constructFromSource_, _with, subEq.j, -1, into);
						var newRoot = _v2.a;
						var _v3 = _v2.b;
		...
		if (_v0.$ === 1) {
			...
			if (_v2.$ === 1) {
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$replaceSubtree, ids, matcher, result, eq));
			}
		}
	});
...
var $author$project$Components$Query$pushUrl = function (model) {
	var eqs = $author$project$Components$Query$marshalEquations_(model.i);
	return A2(
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.b));
	}
};
...
var $author$project$Algo$Math$getName = function (root) {
	switch (root.$) {
		case 0:
			var n = root.a;
			return $elm$core$String$fromFloat(n.y);
		case 1:
			var n = root.a;
			return n.a;
		case 2:
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.n);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.C;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.a$, params.X, swappable.m);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
				...
				switch (root.$) {
					...
					case 2:
						...
						return A2(
							...
							A2($author$project$Components$Rules$evaluateStr, model, s.L));
					case 3:
						var s = root.a;
						return A2(
							$elm$core$Result$andThen,
...
var $author$project$Components$Evaluate$finish = F2(
	function (id, model) {
		var _v0 = A2($elm$core$Dict$get, id, model._);
		if (_v0.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						_: A2($elm$core$Dict$remove, id, model._)
					}),
...
var $author$project$Algo$Matcher$groupSubtree = F2(
	function (ids, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.j.g);
		if (_v0.$ === 1) {
...
var $author$project$Components$Display$groupChildren = function (model) {
	var _v0 = model.o;
	if (_v0.$ === 1) {
		...
		if (_v2.$ === 1) {
			...
			return A2(
				...
				A2($author$project$Algo$Matcher$groupSubtree, ids, eq));
		}
	}
};
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aB: $author$project$Main$CloseDialog,
		at: $elm$core$Maybe$Just('expr'),
		aG: _List_fromArray(
			[
				{
				af: _List_fromArray(
				...
				ap: 'The expression to replace ' + $elm$core$String$fromFloat(target)
			}
			]),
		aH: function (dict) {
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
		...
		aG: function (sections) {
			return ($elm$core$List$length(params.l) <= 1) ? sections : A2(
				$elm$core$List$cons,
				{
					af: _List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					af: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.aW) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aJ: param.a + '= '}),
									$author$project$UI$Dialog$Text(
								...
								[
									...
									{f: param.aW, a: param.n}),
									$author$project$UI$Dialog$Info(
									{aJ: param.V})
								]);
						},
						params.ai),
					ap: 'Fill in the parameters'
				}
				])),
		aH: $author$project$Main$ApplyParameters,
		...
		switch (root.$) {
			case 2:
				...
				return A2(
					...
					A2($author$project$Components$Rules$replaceGlobalVar, model, s.L));
			case 3:
				var s = root.a;
				return A2(
					$elm$core$Result$map,
			...
			case 4:
				...
				return A2(
					$elm$core$Result$andThen,
					function (children) {
						var _v1 = A2($elm$core$Dict$get, s.a, model.B);
						if (_v1.$ === 1) {
							return $elm$core$Result$Ok(
								$author$project$Algo$Math$GenericNode(
									_Utils_update(
							...
							if ((f.f === 2) && (f.A || f.w)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{A: f.A, b: children, w: f.w, a: s.a, c: s.c}));
							} else {
								if (!_Utils_eq(
...
var $author$project$Components$Display$replaceNodeWithNumber = F4(
	function (eqNum, id, number, model) {
		var _v0 = A2($elm$core$Dict$get, eqNum, model.i);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Equation not found');
		} else {
			var eq = _v0.a;
			...
			return A2(
				...
				A3(
					...
					function (subEq) {
						...
						if (!_v2.$) {
							var n = _v2.a;
							return (!_Utils_eq(target, n.y)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								var parent = A2($elm$core$Dict$get, id, tracker.g);
								...
								A3($author$project$Algo$Matcher$processID_, -1, subEq.j, subtree));
						} else {
...
var $author$project$Components$Display$replaceNumber = F3(
		...
		if (_v0.$ === 1) {
			...
			if (_v2.$ === 1) {
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$replaceRealNode, ids, target, subtree, eq));
			}
		}
	});
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'child',
							A2($author$project$Algo$Math$encode, converter, s.L)),
							_Utils_Tuple2(
							'type',
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'associative',
							$elm$json$Json$Encode$bool(s.A)),
							_Utils_Tuple2(
							'commutative',
							$elm$json$Json$Encode$bool(s.w)),
							_Utils_Tuple2(
							'children',
							A2(
								$elm$json$Json$Encode$list,
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.j.G)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.j.g))
							])))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'nextCallID',
					$elm$json$Json$Encode$int(model.ag)),
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model._))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'arguments',
				$elm$json$Json$Encode$int(prop.f)),
				_Utils_Tuple2(
				'associative',
				$elm$json$Json$Encode$bool(prop.A)),
				_Utils_Tuple2(
				'commutative',
				$elm$json$Json$Encode$bool(prop.w)),
				_Utils_Tuple2(
				'javascript',
				function () {
					var _v0 = prop.ae;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'description',
				$elm$json$Json$Encode$string(rule.V)),
				_Utils_Tuple2(
				'parameters',
				$elm$json$Json$Encode$object(
					A2(
						...
						function (param) {
							return _Utils_Tuple2(
								param.aE.a,
								$elm$json$Json$Encode$string(param.V));
						},
						rule.ai))),
				_Utils_Tuple2(
				'matches',
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'from',
									$elm$json$Json$Encode$string(match.X.a)),
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aL.a))
								]));
					},
					rule.l))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.B)),
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.a4))
			]));
};
...
var $author$project$UI$Menu$encode = function (model) {
	return A2($elm$json$Json$Encode$set, $elm$json$Json$Encode$string, model.U);
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'display',
						$author$project$Components$Display$encode(model.m)),
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.a4)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aq)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.Z)),
						_Utils_Tuple2(
						'menu',
						$author$project$UI$Menu$encode(model.au)),
						_Utils_Tuple2(
						'evaluator',
						A2(
						...
						_Utils_Tuple2(
						'resetInput',
						$elm$json$Json$Encode$bool(model.aw)),
						_Utils_Tuple2(
						'showHelp',
						$elm$json$Json$Encode$bool(model.T)),
						_Utils_Tuple2(
						'showMenu',
						$elm$json$Json$Encode$bool(model.ax))
					]))));
};
...
var $author$project$Components$Display$selectedNode = function (model) {
	return A2(
		$elm$core$Maybe$andThen,
		function (_v0) {
			var eq = _v0.a;
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {bW: count, b$: eq, s: nodes, n: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					ag: model.ag + 1,
					_: A3($elm$core$Dict$insert, model.ag, c, model._)
				}),
			model.a5(
				{b2: model.ag, cg: str}));
	});
...
var $author$project$Components$Display$listUnselectedEquations = function (model) {
	var _v0 = model.o;
	if (_v0.$ === 1) {
		return model.i;
	} else {
						...
						[
							$author$project$UI$Dialog$Radio(
							{
								...
								br: A2(
									...
									$author$project$Components$Display$listUnselectedEquations(model.m))
							})
						])
					]),
				ap: 'Select the equation to use for substitution'
			}
			]),
		aH: function (dict) {
							...
							return function (resetInput) {
								return function (showHelp) {
									return function (showMenu) {
										return {H: createMode, m: display, M: evaluator, au: menu, Z: notification, aw: resetInput, a4: rules, T: showHelp, ax: showMenu, aq: tutorial};
									};
								};
							};
						};
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aO: copyState, aS: newState, G: id, g: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aP: create, i: eq, N: hidden, ah: next, o: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {f: _arguments, A: associative, w: commutative, ae: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.A || f.w) && (f.f !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.A && (!f.w)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
	...
	A2(
		...
		F2(
			function (_v0, dict) {
				...
				if (!elem.$) {
					var s = elem.a;
					return $elm$core$List$isEmpty(s.f) ? $elm$core$Result$Ok(
		...
		switch (root.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Components$Rules$treeToMatcher_, from, functions, constants, s.L));
			case 3:
				var s = root.a;
				return s.w ? A2(
					$elm$core$Result$map,
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{f: children, a: s.a, aF: $elm$core$Maybe$Nothing}),
							tokens);
					},
					processChildren(s.b)) : A2(
					$elm$core$Result$map,
					function (_v3) {
						var children = _v3.a;
						var tokens = _v3.b;
								...
								_Utils_update(
									s,
									{
										f: A2(
											...
											$author$project$Components$Rules$setOthers_(others),
											_Utils_ap(
												A2($elm$core$List$take, index, s.f),
												A2($elm$core$List$drop, index + 1, s.f))),
						...
						A3(
							...
							F2(
								function (_v2, res) {
									...
									if (!n.$) {
										var c = n.a;
										return ($elm$core$List$isEmpty(c.f) && A2($elm$core$Set$member, c.a, others)) ? $elm$core$Maybe$Just(
							...
							$elm$core$Maybe$Nothing,
							A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, s.f)));
				}
		}
	});
						...
						function (nSet) {
							return {
								X: _Utils_update(
									from,
									{
										n: A2($author$project$Components$Rules$setOthers_, nSet, from.n)
									}),
								aL: _Utils_update(
									to,
									{
										n: A2($author$project$Components$Rules$setOthers_, nSet, to.n)
									})
							};
						},
						A3(
	...
	function (functions, constants) {
		return A2(
			...
			function (_v6) {
				...
				return A2(
					$elm$json$Json$Decode$map,
					A3($author$project$Components$Rules$Rule_, title, description, parameters),
					A2(
						$elm$json$Json$Decode$field,
						'matches',
						$elm$json$Json$Decode$list(
		...
		if (_v0.$ === 3) {
			...
			if (!n.A) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.b));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
	});
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.j;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.g);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.j.g, id),
					A3($author$project$Algo$Matcher$ungroupChild_, tracker, id, nodes),
					eq));
		}
	});
var $author$project$Components$Display$ungroupChildren = function (model) {
	var _v0 = model.o;
	if (_v0.$ === 1) {
		return $elm$core$Result$Err('Nothing was selected');
	} else {
		...
		if (_v2.$ === 1) {
			...
			return A2(
				...
				A2($author$project$Algo$Matcher$ungroupSubtree, ids, eq));
		}
	}
};
...
var $author$project$Components$Display$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			default:
				var eq = event.a;
				return A2($elm$core$Set$member, eq, model.N) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							N: A2($elm$core$Set$remove, eq, model.N)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							N: A2($elm$core$Set$insert, eq, model.N)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$UI$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.U) ? _Utils_update(
			model,
			{
				U: A2($elm$core$Set$remove, entry, model.U)
			}) : _Utils_update(
			model,
			{
				U: A2($elm$core$Set$insert, entry, model.U)
			});
	});
...
var $author$project$Components$Display$updateEquation = F3(
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Components$Display$update, e, model.m);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aq);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model.Z);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								au: A2($author$project$UI$Menu$update, e, model.au)
							})),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
			case 8:
				...
				if (str !== 'Escape') {
					...
					var _v4 = _Utils_Tuple2(core.r, model.H);
					if (!_v4.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
						...
						if (!_v4.b.$) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{H: $elm$core$Maybe$Nothing, T: false})),
								$elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						}
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								H: $elm$core$Maybe$Just($elm$core$Maybe$Nothing),
								aw: false
							})),
			...
			case 11:
				...
				if (str === '') {
					...
					var _v5 = A3($author$project$Algo$Matcher$parseEquation, $author$project$Components$Display$createState, $author$project$Components$Display$updateState, str);
					if (!_v5.$) {
						var root = _v5.a;
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{H: $elm$core$Maybe$Nothing, m: dModel, aw: true, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
							...
							function () {
								if (id.$ === 1) {
									return A2($author$project$Components$Display$addEquation, root, model.m);
								} else {
									var i = id.a;
									return A3($author$project$Components$Display$updateEquation, i, root, model.m);
								}
							}());
					} else {
						var err = _v5.a;
					...
					_Utils_update(
						core,
						{
							...
							C: _Utils_update(
								model,
								{
									a4: A2($author$project$Components$Rules$deleteTopic, name, model.a4)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 18:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v9 = A2($author$project$Components$Rules$addTopic, topic, model.a4);
					if (_v9.$ === 1) {
						var errStr = _v9.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									a4: A2($author$project$Components$Rules$addSources, source.x, model.a4)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 20:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.a4);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
						...
						if (result.$ === 1) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									core,
									{C: s}),
								A2($author$project$Main$updateQuery_, core, s.m));
						}
					}(
						A2(
							$elm$core$Result$mapError,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.l) === 1) && $elm$core$List$isEmpty(p.ai)) {
							var _v15 = A2($author$project$Helper$listIndex, 0, p.l);
							if (_v15.$ === 1) {
					...
					case 1:
						var _v16 = $author$project$Components$Display$groupChildren(model.m);
						if (_v16.$ === 1) {
							var errStr = _v16.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v17 = $author$project$Components$Display$ungroupChildren(model.m);
						if (_v17.$ === 1) {
							var errStr = _v17.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v18 = $author$project$Components$Display$selectedNode(model.m);
						if (_v18.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v18.a;
							var id = $author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(n.n));
							var _v19 = A2($author$project$Components$Rules$evaluateStr, model.a4, n.n);
							if (_v19.$ === 1) {
								var errStr = _v19.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
								...
								var _v20 = A3(
									...
									A2($author$project$Main$EvalType_, n.b$, id),
									evalStr,
									model.M);
								var eModel = _v20.a;
								var cmd = _v20.b;
						...
						A2(
														...
														return A2(
															...
															function (tree) {
																return _Utils_update(
																	r,
																	{
																		X: A4($author$project$Algo$Matcher$addMatch, k, $elm$core$Dict$empty, tree, r.X)
																	});
															},
																...
																return A2(
																	...
																	function (tree) {
																		return _Utils_update(
																			r,
																			{
																				X: A4($author$project$Algo$Matcher$addMatch, k, argDict, tree, r.X)
																			});
																	},
																	$author$project$Algo$Math$parse(val));
															},
							...
							A2(
								...
								function () {
									...
									if ((!_v23.$) && (_v23.a.$ === 1)) {
										var n = _v23.a.a;
										return A2($author$project$Helper$listIndex, n, existing.l);
									} else {
										return A2($author$project$Helper$listIndex, 0, existing.l);
									}
								}())));
				} else {
					return _Utils_Tuple2(
			...
			case 25:
				...
				var _v27 = A2(
					$elm$core$Result$andThen,
					$author$project$Components$Rules$replaceGlobalVar(model.a4),
					$author$project$Algo$Math$parse(str));
				if (_v27.$ === 1) {
					var errStr = _v27.a;
					return A2($author$project$Main$submitNotification_, core, errStr);
					...
					var newTree = _v27.a;
					var _v28 = A2($author$project$Components$Rules$evaluateStr, model.a4, newTree);
					if (_v28.$ === 1) {
						var errStr = _v28.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v30 = A2($author$project$Components$Evaluate$finish, reply.b2, model.M);
				var eModel = _v30.a;
				var c = _v30.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var target = _v32.a;
						var tree = _v32.b;
						if (!_Utils_eq(target, reply.y)) {
							return A2(
								$author$project$Main$submitNotification_,
								newCore,
								'Expression evaluates to: ' + ($elm$core$String$fromFloat(reply.y) + (', but expecting: ' + $elm$core$String$fromFloat(target))));
						} else {
							var _v33 = A3($author$project$Components$Display$replaceNumber, target, tree, model.m);
							if (_v33.$ === 1) {
								var errStr = _v33.a;
						...
						var eqNum = _v34.a;
						var id = _v34.b;
						var _v35 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.y, model.m);
						if (_v35.$ === 1) {
							var errStr = _v35.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
			...
			af: _List_fromArray(
				[
					...
					[
						...
						{
							b0: $author$project$Main$FileSelect(0),
							aJ: 'Select a file'
						})
					])
				]),
					...
					return $author$project$UI$Menu$Content(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($elm$core$Set$member, num, model.N) ? $author$project$UI$Icon$hidden(_List_Nil) : $author$project$UI$Icon$shown(_List_Nil),
										$elm$html$Html$text(
										$author$project$Algo$Math$toString(eq.n))
									]))
							]));
				},
				$elm$core$Dict$toList(model.i)));
	});
...
var $author$project$Components$Rules$applyButton = F2(
...
var $author$project$Components$Rules$Evaluate = {$: 6};
var $author$project$Components$Rules$Group = {$: 1};
var $author$project$Components$Rules$NumericalSubstitution = function (a) {
	return {$: 3, a: a};
};
var $author$project$Components$Rules$Substitute = {$: 4};
var $author$project$Components$Rules$Ungroup = {$: 2};
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		var shouldDisplay = F2(
			function (a, conv) {
				return a.aY || function () {
					var _v3 = conv(a);
					if (!_v3.$) {
						return true;
					} else {
		...
		var apply = function () {
			var applies = {
				aY: false,
				aC: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{aY: true, aC: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.n;
				switch (_v1.$) {
					case 3:
						...
						if (!n.A) {
							return _Utils_update(
								applies,
								{
									ao: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
							...
							return _Utils_update(
								...
								{
									aQ: (_Utils_eq(
										$elm$core$List$length(n.b),
										val.bW) || (val.bW < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									ao: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									aV: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
						return _Utils_update(
							applies,
							{
								aT: $elm$core$Maybe$Just(
									$author$project$Components$Rules$NumericalSubstitution(n.y))
							});
					case 5:
						return _Utils_update(
							applies,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aC),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aT),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.ao),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aQ),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aV),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
...
var $author$project$Algo$Matcher$countChildren = function (m) {
	switch (m.$) {
		case 0:
			var s = m.a;
			return $elm$core$List$length(s.f);
		case 1:
			return 0;
		case 2:
			var s = m.a;
		...
		case 3:
			var s = m.a;
			return $elm$core$List$length(s.f) + A2(
				$elm$core$Maybe$withDefault,
				0,
				A2(
					$elm$core$Maybe$map,
...
var $author$project$Algo$Matcher$getName = function (m) {
	switch (m.$) {
		...
		case 1:
			var s = m.a;
			return $elm$core$String$fromFloat(s.y);
		case 2:
			var s = m.a;
			return s.a;
		case 3:
...
var $author$project$Algo$Matcher$matchNode = F2(
				...
				case 2:
					switch (_v0.b.$) {
						case 1:
							var m = _v0.a.a;
							var n = _v0.b.a;
							return _Utils_eq(m.a, n.a) && $elm$core$List$isEmpty(m.f);
						case 4:
							var m = _v0.a.a;
							var n = _v0.b.a;
							return _Utils_eq(m.a, n.a) && _Utils_eq(
								$elm$core$List$length(m.f),
								$elm$core$List$length(n.b));
						default:
							break _v0$7;
					}
									...
									$author$project$Algo$Matcher$SingleValue_(
										{
											u: _List_fromArray(
												[id]),
											K: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, node)
										}),
									result.l),
								s: A3($elm$core$Dict$insert, id, node, result.s)
							});
					},
					...
					var toReplacements = $elm$core$List$map(
						function (_v5) {
							...
							return {
								...
								K: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, n)
							};
						});
					return $elm$core$Maybe$Just(
						_Utils_update(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{aR: res, p: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && _Utils_eq(l.y, r.y);
					} else {
						break _v0$6;
					}
				case 1:
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.L, r.L));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.A, r.A) && (_Utils_eq(l.w, r.w) && (_Utils_eq(
							$elm$core$List$length(l.b),
							$elm$core$List$length(r.b)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
		...
		while (true) {
			switch (from.$) {
				case 1:
					...
					if (!root.$) {
						var n = root.a;
						return (!_Utils_eq(n.y, s.y)) ? $author$project$Algo$Backtrack$fail : A2($author$project$Algo$Backtrack$return, $elm$core$Maybe$Just, token);
					} else {
						...
						return A2(
							...
							function (result) {
								return A2(
									...
									function (varDict) {
										...
										if (!_v3.$) {
											if (_v3.a.$ === 1) {
												...
												return (!A2($author$project$Algo$Matcher$subtreeEqual_, newSubtree, existing.K)) ? $elm$core$Maybe$Nothing : ((!$elm$core$List$isEmpty(s.f)) ? $elm$core$Maybe$Just(result) : $elm$core$Maybe$Just(
													_Utils_update(
														result,
														{
															l: A3(
																...
																$author$project$Algo$Matcher$SingleValue_(
																	_Utils_update(
																		existing,
																		{
																			u: A2($elm$core$List$cons, id, existing.u)
																		})),
																result.l),
															s: A3($elm$core$Dict$insert, id, root, result.s)
														})));
											}
										} else {
											return (!$elm$core$List$isEmpty(s.f)) ? $elm$core$Maybe$Just(
												_Utils_update(
													result,
													{
														l: A3(
									...
									$elm$core$Result$toMaybe(
										$author$project$Algo$Matcher$variableArgsOnly(s.f)));
							},
							token);
					}
				case 2:
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									$elm$core$List$length(s.f),
									$elm$core$List$length(n.b)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aF;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.b);
								return (!_Utils_eq(
									$elm$core$List$length(s.f),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.b)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
...
var $author$project$Components$Rules$matchRule_ = F2(
	function (selected, rule) {
		if (selected.$ === 1) {
			...
			if (!A2(
				$elm$core$List$any,
				function (m) {
					return A2($author$project$Algo$Matcher$matchNode, m.X.n, n.n);
				},
				rule.l)) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {X: result, a$: m.aL.n, a: m.aL.a};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.s, m.X.n, n.n)));
					},
					_List_Nil,
					rule.l);
					...
					$elm$core$Maybe$Just(
						{
							...
							ai: A2(
								...
								function (p) {
									return {
										aW: $author$project$Algo$Matcher$countChildren(p.aE.n),
										V: p.V,
										a: p.aE.a,
										n: $author$project$Algo$Matcher$getName(p.aE.n)
									};
								},
								rule.ai),
							ab: rule.ab
...
var $author$project$Components$Rules$menuTopics = F3(
	function (converter, model, selectedNode) {
		var individualRule = function (rule) {
			var _v1 = A2($author$project$Components$Rules$matchRule_, selectedNode, rule);
			var display = _v1.a;
			var params = _v1.b;
			return A3(
				$author$project$UI$Menu$Section,
					...
					[
						...
						_Utils_ap(
							_List_fromArray(
								[
									A2(
									$author$project$Components$Rules$applyButton,
									converter,
									A2($elm$core$Maybe$map, $author$project$Components$Rules$Apply, params)),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.X.a + ('→' + match.aL.a))
												]));
									},
									rule.l),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.a4));
								}
							}());
					}),
				_List_fromArray(
					[
						A2($author$project$Components$Rules$coreTopic_, converter, selectedNode)
					]),
				model.x));
	});
		...
		var _v0 = $elm$core$List$isEmpty(children) ? _Utils_Tuple3(width + 1, depth, _List_Nil) : A3(
			...
			F2(
				function (child, _v1) {
					...
					var foldDepth = _v1.b;
					var foldDivs = _v1.c;
					var _v2 = A5($author$project$Components$Display$stackRecursive, eq, highlight, foldWidth, depth + 1, child);
					var w = _v2.a;
					var d = _v2.b;
					var divs = _v2.c;
					return _Utils_Tuple3(
...
var $author$project$Components$Display$stackedView_ = F3(
	function (eq, highlight, node) {
		var _v0 = A5($author$project$Components$Display$stackRecursive, eq, highlight, 1, 1, node);
		var width = _v0.a;
		var depth = _v0.b;
		var divs = _v0.c;
		return A2(
			...
			A3(
				...
				F3(
					function (eqNum, eq, result) {
						if (A2($elm$core$Set$member, eqNum, model.N)) {
							return result;
						} else {
							var highlight = A2(
								$elm$core$Maybe$withDefault,
									...
									A2(
										...
										_List_fromArray(
											[
												...
												eqNum,
												highlight,
												$author$project$Algo$Math$symbolicate(eq.n)),
												A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.n)
											]))),
								result);
						}
					}),
...
var $author$project$Components$Tutorial$view = F3(
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.b2)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.b2),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.b2))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.b0),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
				...
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aJ);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
						...
						[
							...
							_List_fromArray(
								[
									$author$project$UI$Icon$class('clickable'),
									$author$project$UI$Icon$class('cancelable'),
									$author$project$UI$HtmlEvent$onClick(model.aB)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
...
var $author$project$UI$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var display = part.b;
			var children = part.c;
			var shown = display && A2($elm$core$Set$member, name, model.U);
			return A2(
				$elm$html$Html$li,
					...
					_List_fromArray(
						[
							...
							A2(
								...
								model.ax ? _List_Nil : _List_fromArray(
									[
										$elm$html$Html$Attributes$class('closed')
									])),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											A2($author$project$Components$Display$menu, $author$project$Main$DisplayEvent, model.m),
											A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aq),
											A3(
											$author$project$UI$Menu$Section,
											'Topics',
											true,
											_Utils_ap(
												...
												A3(
													$author$project$Components$Rules$menuTopics,
													$author$project$Main$RuleEvent,
													model.a4,
													$author$project$Components$Display$selectedNode(model.m))))
										]))
								]))
						])),
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.aq),
					A3(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{b4: $author$project$Main$init, b7: $author$project$Main$EventUrlChange, b8: $author$project$Main$EventUrlRequest, ch: $author$project$Main$subscriptions, cj: $author$project$Main$update, ck: $author$project$Main$view});
