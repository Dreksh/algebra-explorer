...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aq: fragment, au: host, aB: path, aD: port_, aG: protocol, X: query};
	});
...
var $author$project$Notification$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.a0));
			}(
				function () {
					var _v0 = deadEnd.bd;
					switch (_v0.$) {
			...
			return _Utils_Tuple2(
				...
				$elm$core$Maybe$Just(
					A2(
						...
						{N: args, ay: children.ay, Q: parameters})));
		}),
	aH: F2(
		function (_v8, _v10) {
			var p = _v8.a;
...
var $author$project$Display$init = A2(
	...
	{ak: $elm$core$Maybe$Nothing, n: $elm$core$Dict$empty, P: 0, aN: $elm$core$Maybe$Nothing});
var $author$project$Notification$init = {H: 0, s: $elm$core$Dict$empty};
var $author$project$Rules$init = {q: false, I: _List_Nil};
var $author$project$Tutorial$init = {az: 0, aM: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{a0: col, c: s0.c, d: s0.d, b: offset, aK: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aK, s.a0, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a0: col, a1: contextStack, bd: problem, aK: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aK, s.a0, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aK, s.a0, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{a0: newCol, c: s.c, d: s.d, b: newOffset, aK: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {a0: col, c: context, d: indent, b: offset, aK: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.af, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.Z, s.b + 1, s.aK + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.Z, firstOffset, s.aK, s.a0 + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{ao: $elm$parser$Parser$ExpectingVariable, Z: i.Z, ad: i.ad, af: i.af});
};
var $author$project$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		af: $author$project$Math$validVarStart_
	});
...
var $author$project$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{Z: $elm$core$Char$isDigit, ad: $elm$core$Set$empty, af: $elm$core$Char$isDigit});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a0: col, bd: problem, aK: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aK, p.a0, p.bd);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a0: 1, c: _List_Nil, d: 1, b: 0, aK: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{Y: url, n: _List_Nil, _: key},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.X)));
	});
...
var $author$project$Display$searchFunction_ = F4(
	function (process, recurse, _v0, _v1) {
		...
		return function (_v6) {
			var o = _v6.a;
			var func = _v6.b;
			return ($elm$core$List$isEmpty(func.N) && $elm$core$List$isEmpty(func.Q)) ? _Utils_Tuple2(o, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
				o,
				$elm$core$Maybe$Just(
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.C);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
				...
				if (!_v5.$) {
					...
					return function (dModel) {
						return function (query) {
							...
							function (list) {
								return A2($author$project$Query$setEquations, list, model.X);
							}(
								$author$project$Display$listEquations(dModel)));
					}(
						function () {
					...
					var _v7 = A3(
						...
						str,
						err,
						_Utils_Tuple2(model.C, $elm$core$Platform$Cmd$none));
					var nModel = _v7.a;
					var nCmd = _v7.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$HtmlEvent$onClick(
						A2($author$project$Display$DeleteTree, eq, s.B))
					]),
				A2(
					$elm$core$List$map,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{a8: $author$project$Main$init, ba: $author$project$Main$EventUrlChange, bb: $author$project$Main$EventUrlRequest, bg: $author$project$Main$subscriptions, bi: $author$project$Main$update, bk: $author$project$Main$view});
