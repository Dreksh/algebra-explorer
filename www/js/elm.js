...
{
	if (region.as.U === region.aA.U)
	{
		return 'on line ' + region.as.U;
	}
	return 'on lines ' + region.as.U + ' through ' + region.aA.U;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bp: 'hidden', bi: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bp: 'mozHidden', bi: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bp: 'msHidden', bi: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bp: 'webkitHidden', bi: 'webkitvisibilitychange' }
		: { bp: 'hidden', bi: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bt, request.bH, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aE: fragment, aJ: host, aQ: path, aS: port_, aV: protocol, af: query};
	});
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$Notification$delayedClear_(model.M)
					])));
	});
...
var $author$project$Math$FunctionNode = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Math$RealNode = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Math$VariableNode = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
	...
	aF: F3(
		function (recurse, _v0, _v2) {
			...
			var _v3 = A4(
				...
				recurse,
				id,
				_Utils_Tuple2(id + 1, dict),
				children.R);
			var _v4 = _v3.a;
			var g = _v4.b;
			var args = _v3.b;
			var _v5 = A4($author$project$Display$idChildren_, recurse, id, g, children.X);
			var _v6 = _v5.a;
			var _v7 = _v6.b;
			var next = _v7.a;
			var finalDict = _v7.b;
			...
			return _Utils_Tuple2(
				_Utils_Tuple2(
					...
					_Utils_Tuple2(
						next,
						A3($elm$core$Dict$insert, id, p, finalDict))),
				$elm$core$Maybe$Just(
					A2(
						$author$project$Math$FunctionNode,
						{
							z: id,
							ae: _Utils_Tuple2(0, 0)
						},
						{R: args, aN: children.aN, X: parameters})));
		}),
	aW: F2(
		function (_v8, _v10) {
			var p = _v8.a;
			...
			return _Utils_Tuple2(
				_Utils_Tuple2(
					...
					_Utils_Tuple2(
						id + 1,
						A3($elm$core$Dict$insert, id, p, dict))),
				$elm$core$Maybe$Just(
					A2(
...
var $author$project$Display$init = A2(
	...
	{ax: $elm$core$Maybe$Nothing, n: $elm$core$Dict$empty, W: 0, x: $elm$core$Maybe$Nothing});
var $author$project$Menu$init = function (shown) {
	return {D: shown};
};
var $author$project$Notification$init = {M: 0, w: $elm$core$Dict$empty};
var $author$project$Rules$init = {p: $elm$core$Dict$empty, q: false, r: $elm$core$Dict$empty, E: $elm$core$Dict$empty};
var $author$project$Tutorial$init = {aO: 0, a1: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bj: col, c: s0.c, d: s0.d, b: offset, a$: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.a$, s.bj, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bj: col, bk: contextStack, bx: problem, a$: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.a$, s.bj, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.a$, s.bj, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bj: newCol, c: s.c, d: s.d, b: newOffset, a$: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {bj: col, c: context, d: indent, b: offset, a$: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.as, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.ai, s.b + 1, s.a$ + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.ai, firstOffset, s.a$, s.bj + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aC: $elm$parser$Parser$ExpectingVariable, ai: i.ai, ao: i.ao, as: i.as});
};
var $author$project$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		as: $author$project$Math$validVarStart_
	});
...
var $author$project$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{ai: $elm$core$Char$isDigit, ao: $elm$core$Set$empty, as: $elm$core$Char$isDigit});
	...
	function (str) {
		...
		if (_v0.$ === 1) {
			...
			return $elm$parser$Parser$succeed(
				A2($author$project$Math$RealNode, 0, f));
		}
	},
	A2(
		...
		_List_fromArray(
			[
				...
				function (_v6) {
					...
					var props = _v6.b;
					if (props.$ === 1) {
						return A2($author$project$Math$VariableNode, 0, name);
					} else {
						var p = props.a;
						return A2(
							$author$project$Math$FunctionNode,
				...
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed(
					$author$project$Math$VariableNode(0)),
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bj: col, bx: problem, a$: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.a$, p.bj, p.bx);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bj: 1, c: _List_Nil, d: 1, b: 0, a$: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{ah: url, n: _List_Nil, aj: key},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.af)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				V: $author$project$Menu$init(
					$elm$core$Set$fromList(
						_List_fromArray(
							['Settings', 'Tutorials', 'Constants', 'Functions', 'Rules']))),
				I: nModel,
				af: query,
				k: $author$project$Rules$init,
				C: false,
				Z: newScreen ? true : false,
				O: $author$project$Tutorial$init
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
...
var $author$project$Rules$deleteTopic = F2(
	function (name, model) {
		var _v0 = A2($elm$core$Dict$get, name, model.E);
		if (_v0.$ === 1) {
			return model;
		} else {
			var topic = _v0.a;
			...
			return _Utils_update(
				model,
				{
					p: newConstants,
					r: newFunctions,
					E: A2($elm$core$Dict$remove, name, model.E)
				});
		}
	});
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								p: constants,
								r: functions,
								E: A3($elm$core$Dict$insert, topic.aN, topic, model.E)
							});
					},
					A3(
						$elm$core$Set$foldl,
					...
					function (name, props, result) {
						if (result.$ === 1) {
							...
							if (_v1.$ === 1) {
								...
								var p = _v2.a;
								var count = _v2.b;
								return (_Utils_eq(p.R, props.R) && (_Utils_eq(p.Y, props.Y) && (_Utils_eq(p.S, props.S) && _Utils_eq(p.T, props.T)))) ? $elm$core$Result$Ok(
									A3(
										$elm$core$Dict$insert,
										name,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bf: false, bh: r.bh, bn: r.bn, aG: r.aG, bt: r.bt, bE: r.bE, a7: r.a7, bH: r.bH}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bh: $elm$http$Http$emptyBody, bn: r.bn, aG: _List_Nil, bt: 'GET', bE: $elm$core$Maybe$Nothing, a7: $elm$core$Maybe$Nothing, bH: r.bH});
};
					...
					function () {
						...
						switch (_v1) {
							...
							default:
								...
								return A2(
									$elm$core$List$cons,
									$author$project$Math$Text('\\' + (children.aN + '(')),
									_Utils_ap(
										args,
										_List_fromArray(
											[
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		var _v0 = A2(
			$author$project$Notification$displayError,
			str,
			_Utils_Tuple2(model.I, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {p: constants, r: functions, aN: name, k: rules};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Rules$FunctionProperties_ = F4(
	function (args, params, associative, commutative) {
		return {R: args, S: associative, T: commutative, Y: params};
	});
...
var $author$project$Rules$functionDecoder_ = $elm$json$Json$Decode$dict(
	A5(
		...
		A2($elm$json$Json$Decode$field, 'parameters', $elm$json$Json$Decode$int),
...
var $author$project$Rules$Rule_ = F6(
	function (title, description, reversible, lhs, rhs, parameters) {
		return {az: description, ak: lhs, X: parameters, ap: reversible, aq: rhs, bF: title};
	});
									...
									if (_v3.a.$ === 1) {
										...
										if (_v3.a.a.$ === 1) {
											...
											if (!_v3.b.$) {
												...
												var args = _v8.a;
												var params = _v8.b;
												return (_Utils_eq(tArgs, args) && _Utils_eq(tParams, params)) ? $elm$core$Result$Ok(dict) : $elm$core$Result$Err('Inconsistent function signature \'' + (name + '\' between expression and parameter'));
											} else {
												break _v3$3;
											}
										}
...
var $author$project$Rules$FunctionToken = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Rules$matchFunction_ = F2(
	function (props, node) {
		return (props.S && props.T) ? ($elm$core$List$isEmpty(node.X) && ($elm$core$List$length(node.R) > 1)) : (_Utils_eq(
			props.R,
			$elm$core$List$length(node.R)) && _Utils_eq(
			props.Y,
			$elm$core$List$length(node.X)));
	});
var $author$project$Rules$tokenExtractor_ = F2(
	function (str, functions) {
		return {
			aF: F3(
				function (recurse, res, _v0) {
					var fProp = _v0.b;
					return _Utils_Tuple2(
						function () {
							if (res.$ === 1) {
								...
								return function (result) {
									...
									function () {
										var _v2 = _Utils_Tuple2(
											A2($elm$core$Dict$get, fProp.aN, functions),
											A2($elm$core$Dict$get, fProp.aN, seenDict));
										if (_v2.a.$ === 1) {
											if (_v2.b.$ === 1) {
												var _v3 = _v2.a;
												var _v4 = _v2.b;
												return $elm$core$Result$Ok(
													A3(
														...
														A2(
															...
															$elm$core$List$length(fProp.R),
															$elm$core$List$length(fProp.X)),
														seenDict));
											} else {
												var _v5 = _v2.a;
												var seen = _v2.b.a;
												if (seen.$ === 1) {
													return $elm$core$Result$Err('\'' + (fProp.aN + ('\' is used as both a variable and a function in: ' + str)));
												} else {
													var numArgs = seen.a;
													var numParams = seen.b;
													return (_Utils_eq(
														$elm$core$List$length(fProp.R),
														numArgs) && _Utils_eq(
														$elm$core$List$length(fProp.X),
														numParams)) ? $elm$core$Result$Ok(seenDict) : $elm$core$Result$Err('The function signature of \'' + (fProp.aN + ('\' differs within ' + str)));
												}
											}
										} else {
											if (_v2.b.$ === 1) {
												var given = _v2.a.a;
												var _v7 = _v2.b;
												return A2($author$project$Rules$matchFunction_, given, fProp) ? $elm$core$Result$Ok(seenDict) : $elm$core$Result$Err('The function usage of \'' + (fProp.aN + ('\', in \'' + (str + '\' differs with the declared function'))));
											} else {
												return $elm$core$Result$Err('Processing error: Added function \'' + (fProp.aN + '\' as a token'));
											}
										}
									}());
							}
						...
						$elm$core$Maybe$Just(
							A2($author$project$Math$FunctionNode, 0, fProp)));
				}),
			aW: F2(
				function (res, _v10) {
					var val = _v10.b;
					return _Utils_Tuple2(
						res,
						$elm$core$Maybe$Just(
							A2($author$project$Math$RealNode, 0, val)));
				}),
			a9: F2(
				function (res, _v11) {
					var name = _v11.b;
					if (res.$ === 1) {
						return _Utils_Tuple2(
							res,
							$elm$core$Maybe$Just(
								A2($author$project$Math$VariableNode, 0, name)));
					} else {
						var dict = res.a;
						var _v13 = A2($elm$core$Dict$get, name, functions);
						if (!_v13.$) {
							return _Utils_Tuple2(
								$elm$core$Result$Err('\'' + (name + ('\' is treated as a variable in: ' + str))),
								$elm$core$Maybe$Just(
									A2($author$project$Math$VariableNode, 0, name)));
						} else {
							var _v14 = A2($elm$core$Dict$get, name, dict);
							if (_v14.$ === 1) {
								return _Utils_Tuple2(
									$elm$core$Result$Ok(
										A3($elm$core$Dict$insert, name, $author$project$Rules$AnyToken, dict)),
									$elm$core$Maybe$Just(
										A2($author$project$Math$VariableNode, 0, name)));
							} else {
								if (_v14.a.$ === 1) {
									...
									var _v16 = _v14.a;
									return _Utils_Tuple2(
										$elm$core$Result$Err(name + ' is shown as both a variable and a function'),
										$elm$core$Maybe$Just(
											A2($author$project$Math$VariableNode, 0, name)));
								}
							}
...
var $author$project$Rules$parseExpression_ = F2(
	function (functions, str) {
		...
		if (_v0.$ === 1) {
			...
			var _v1 = A3(
				$author$project$Math$process,
				A2($author$project$Rules$tokenExtractor_, str, functions),
				$elm$core$Result$Ok($elm$core$Dict$empty),
				root).a;
			if (_v1.$ === 1) {
				var errStr = _v1.a;
...
var $author$project$Rules$resultToParser_ = function (res) {
	if (res.$ === 1) {
		var str = res.a;
	...
	function (functions, constants) {
		return A2(
			...
			function (_v12) {
				var _v13 = _v12.a;
				var title = _v13.a;
				var description = _v13.b;
				var reversible = _v13.c;
				var _v14 = _v12.b;
				var originalLhs = _v14.a;
				var originalRhs = _v14.b;
				var _v15 = _v14.c;
				var parameters = _v15.a;
				var pDict = _v15.b;
				var _v16 = A4($author$project$Rules$extractUniqueTokens_, functions, constants, pDict, originalLhs.ab);
				if (_v16.$ === 1) {
					var errStr = _v16.a;
					return $elm$json$Json$Decode$fail(errStr);
				} else {
					var lhs = _v16.a;
					var _v17 = A4($author$project$Rules$extractUniqueTokens_, functions, constants, pDict, originalRhs.ab);
					if (_v17.$ === 1) {
						var errStr = _v17.a;
						return $elm$json$Json$Decode$fail(errStr);
					} else {
						var rhs = _v17.a;
						return $author$project$Rules$resultToParser_(
							A2(
								$elm$core$Result$map,
								function (_v28) {
														...
														if (_v19.b.$ === 1) {
															...
															if (_v19.a.a.$ === 1) {
																...
																if (!_v19.b.a.$) {
																	...
																	var rArgs = _v27.a;
																	var rParam = _v27.b;
																	return (_Utils_eq(lArgs, rArgs) && _Utils_eq(lParam, rParam)) ? $elm$core$Result$Ok(0) : $elm$core$Result$Err('inconsistent function signature for \'' + (name + '\' in lhs and rhs'));
																} else {
																	break _v19$5;
																}
															}
			...
			A7(
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$author$project$Rules$parseExpression_(functions),
							$author$project$Rules$resultToParser_),
											...
											F2(
												function (_v0, res) {
													...
													if (res.$ === 1) {
														...
														var others = _v2.a;
														var dict = _v2.b;
														var _v3 = A2($author$project$Rules$parseExpression_, functions, key);
														if (_v3.$ === 1) {
															var str = _v3.a;
															...
															return function (result) {
																...
																A3(
																	$elm$core$Dict$foldl,
																	F3(
																		function (name, tok, result) {
																			if (result.$ === 1) {
																				return result;
																			} else {
																				var newDict = result.a;
																				var _v5 = A2($elm$core$Dict$get, name, newDict);
																				if (_v5.$ === 1) {
																					return $elm$core$Result$Ok(
																						A3($elm$core$Dict$insert, name, tok, newDict));
																				} else {
																					var oldTok = _v5.a;
																					var _v6 = _Utils_Tuple2(oldTok, tok);
																					_v6$2:
																					while (true) {
																						if (!_v6.a.$) {
																							if (!_v6.b.$) {
																								...
																								var args = _v8.a;
																								var num = _v8.b;
																								return (_Utils_eq(oArgs, args) && _Utils_eq(oNum, num)) ? $elm$core$Result$Ok(newDict) : $elm$core$Result$Err('Different function signature for \'' + (name + '\' detected within parameters'));
																							} else {
																								break _v6$2;
																							}
																						} else {
		...
		if (!children.b) {
			...
			if (!path.b) {
				...
				return (!_Utils_eq(
					...
					return _Utils_Tuple2(
						o,
						A2($elm$core$List$cons, child, newChildren));
				}(
					A4(
						...
						recurse,
						_Utils_Tuple3(path, map, $elm$core$Maybe$Nothing),
						nextChildren)) : ((!$elm$core$List$isEmpty(next)) ? function (_v4) {
					var o = _v4.a;
					var newNode = _v4.b;
					if (newNode.$ === 1) {
						return _Utils_Tuple2(o, nextChildren);
					} else {
						var n = newNode.a;
						return _Utils_Tuple2(
							o,
							A2($elm$core$List$cons, n, nextChildren));
					}
				}(
					A2(
						recurse,
					...
					process(
						_Utils_Tuple2(map, child))));
			}
		}
	});
var $author$project$Display$searchFunction_ = F4(
	function (process, recurse, _v0, _v1) {
		var path = _v0.a;
		var map = _v0.b;
		var s = _v1.a;
		var props = _v1.b;
		return function (_v6) {
			var o = _v6.a;
			var func = _v6.b;
			return ($elm$core$List$isEmpty(func.R) && $elm$core$List$isEmpty(func.X)) ? _Utils_Tuple2(o, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
				o,
				$elm$core$Maybe$Just(
					A2($author$project$Math$FunctionNode, s, func)));
		}(
			function (_v2) {
				var _v3 = _v2.a;
				var firstMap = _v3.b;
...
var $author$project$Display$searchProcessor_ = function (process) {
	return {
		aF: $author$project$Display$searchFunction_(process),
		aW: F2(
			function (g, _v0) {
				var s = _v0.a;
				var val = _v0.b;
				return _Utils_Tuple2(
					g,
					$elm$core$Maybe$Just(
						A2($author$project$Math$RealNode, s, val)));
			}),
		a9: F2(
			function (g, _v1) {
				var s = _v1.a;
				...
				return _Utils_Tuple2(
					g,
					$elm$core$Maybe$Just(
						A2($author$project$Math$VariableNode, s, name)));
			})
	};
};
...
var $author$project$Display$deleteNode_ = F2(
	function (id, eq) {
		return A3($author$project$Display$processSearch_, id, $author$project$Display$deleteSubTree_, eq).a;
	});
		...
		switch (event.$) {
			case 0:
				...
				if (_v1.$ === 1) {
					...
					var e = _v2.a;
					var n = _v2.b;
					return (_Utils_eq(e, eq) && _Utils_eq(n, node)) ? _Utils_Tuple2(
						_Utils_update(
							model,
...
var $author$project$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.D) ? _Utils_update(
			model,
			{
				D: A2($elm$core$Set$remove, entry, model.D)
			}) : _Utils_update(
			model,
			{
				D: A2($elm$core$Set$insert, entry, model.D)
			});
	});
		...
		if (!e.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						w: A2($elm$core$Dict$remove, id, model.w)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 3:
				var e = event.a;
				var _v2 = A2($author$project$Rules$update, e, model.k);
				var rModel = _v2.a;
				var rCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				var e = event.a;
				var _v3 = A2($author$project$Tutorial$update, e, model.O);
				var tModel = _v3.a;
				var tCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.I);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 6:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							V: A2($author$project$Menu$update, e, model.V)
						}),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 8:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{q: $elm$core$Maybe$Nothing, C: false}),
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{q: $elm$core$Maybe$Nothing, u: dModel, C: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
							...
							function (list) {
								return A2($author$project$Query$setEquations, list, model.af);
							}(
								$author$project$Display$listEquations(dModel)));
					}(
						function () {
			...
			case 16:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							G: $elm$core$Maybe$Nothing,
							k: A2($author$project$Rules$deleteTopic, name, model.k)
						}),
					$elm$core$Platform$Cmd$none);
			case 17:
				var url = event.a;
			...
			case 18:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v8 = A2($author$project$Rules$addTopic, topic, model.k);
					if (_v8.$ === 1) {
						var errStr = _v8.a;
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							...
							function (topic) {
								return A2($author$project$Rules$addTopic, topic, model.k);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
...
var $author$project$Rules$ClickVariable = function (a) {
	return {$: 0, a: a};
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Rules$menuConstants = F2(
	function (converter, model) {
		return A3(
										...
										[
											...
											_List_fromArray(
												[
													...
													converter(
														$author$project$Rules$ClickVariable(name)))
												]),
											_List_fromArray(
												[
...
var $author$project$Rules$ClickFunction = function (a) {
	return {$: 1, a: a};
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$Rules$menuFunctions = F3(
	function (converter, model, createMode) {
		return A3(
			$author$project$Menu$Section,
			'Functions',
			true,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text(
															'Arguments: ' + $elm$core$String$fromInt(props.R))
														])),
													A2(
													$elm$html$Html$p,
													_List_Nil,
													_List_fromArray(
														[
															$elm$html$Html$text(
															'Parameters: ' + $elm$core$String$fromInt(props.Y))
														])),
													A2(
													$elm$html$Html$p,
													_List_Nil,
													...
													[
														...
														_List_fromArray(
															[
																$author$project$HtmlEvent$onClick(
																converter(
																	$author$project$Rules$ClickFunction(name)))
															]),
														_List_fromArray(
															[
...
var $author$project$Rules$ClickRule = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Rules$mathSymbolsToString_ = function (root) {
	if (!root.$) {
		var str = root.a;
		return str;
	} else {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Rules$mathSymbolsToString_, list));
	}
};
var $author$project$Rules$expressionToString_ = function (exp) {
	return $author$project$Rules$mathSymbolsToString_(
		$author$project$Math$symbolicate(exp.ag));
};
var $author$project$Rules$matchExpressionToNode_ = F2(
	function (exp, node) {
		var _v0 = exp.ag;
		switch (_v0.$) {
			case 1:
			...
			default:
				...
				if (!node.$) {
					var actual = node.b;
					return _Utils_eq(actual.aN, fProp.aN);
				} else {
					return false;
				}
		}
	});
var $author$project$Rules$matchRuleToNode_ = F2(
	function (rule, node) {
		return A2($author$project$Rules$matchExpressionToNode_, rule.ak, node) || (rule.ap && A2($author$project$Rules$matchExpressionToNode_, rule.aq, node));
	});
													...
													_Utils_ap(
														...
														_List_fromArray(
															[
																...
																$author$project$Menu$Section,
																_Utils_ap(
																	$author$project$Rules$expressionToString_(rule.ak),
																	_Utils_ap(
																		rule.ap ? '↔' : '→',
																		$author$project$Rules$expressionToString_(rule.aq))),
																A2(
																	$elm$core$Maybe$withDefault,
																	true,
																	A2(
																		$elm$core$Maybe$map,
																		$author$project$Rules$matchRuleToNode_(rule),
																		selectedNode)),
																A2(
																	$elm$core$List$cons,
																	$author$project$Menu$Content(
																						...
																						[
																							...
																							_List_fromArray(
																								[
																									$author$project$HtmlEvent$onClick(
																									converter(
																										A2($author$project$Rules$ClickRule, topic.aN, index)))
																								]),
																							_List_fromArray(
																								[
	...
	return A2(
		...
		function (_v0) {
			...
			return A2(
				...
				A2($elm$core$Dict$get, eq, model.n));
		},
		model.x);
};
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$author$project$HtmlEvent$onClick(
							A2($author$project$Display$Select, eq, s.z))
						]),
					_Utils_eq(
						s.z,
						A2($elm$core$Maybe$withDefault, -1, highlight)) ? _List_fromArray(
						[
					...
					function (eqNum, _v0, result) {
						...
						var highlight = A2(
							...
							function (_v1) {
								var eq = _v1.a;
								var num = _v1.b;
								return _Utils_eq(eq, eqNum) ? $elm$core$Maybe$Just(num) : $elm$core$Maybe$Nothing;
							},
							model.x);
...
var $author$project$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var display = part.b;
			var children = part.c;
			var shown = display && A2($elm$core$Set$member, name, model.D);
			return A2(
				$elm$html$Html$li,
		...
		bh: _Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							A2(
								...
								model.Z ? _List_Nil : _List_fromArray(
									[
										$elm$html$Html$Attributes$class('closed')
									])),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											A2($author$project$Tutorial$menu, $author$project$Main$TutorialEvent, model.O),
											A2($author$project$Rules$menuConstants, $author$project$Main$RulesEvent, model.k),
											A3(
					...
					A3($author$project$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.O),
					A3(
			...
			$author$project$Main$dialogPane_(model.G)),
		bF: 'Maths'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{br: $author$project$Main$init, bu: $author$project$Main$EventUrlChange, bv: $author$project$Main$EventUrlRequest, bD: $author$project$Main$subscriptions, bG: $author$project$Main$update, bI: $author$project$Main$view});
