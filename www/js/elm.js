...
{
	if (region.bd.aI === region.bj.aI)
	{
		return 'on line ' + region.bd.aI;
	}
	return 'on lines ' + region.bd.aI + ' through ' + region.bj.aI;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { M: 'hidden', bZ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { M: 'mozHidden', bZ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { M: 'msHidden', bZ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { M: 'webkitHidden', bZ: 'webkitvisibilitychange' }
		: { M: 'hidden', bZ: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ca, request.bR, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.bR));
		}
...
{
	for (var headers = request.bo; headers.b; headers = headers.b) // WHILE_CONS
	{
...
function _Http_toMetadata(xhr)
{
	return {
		...
		ci: xhr.status,
		cj: xhr.statusText,
		bo: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bn: fragment, bq: host, bx: path, bz: port_, bC: protocol, bD: query};
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {aj: nextCallID, aa: ongoing, bb: sender};
	});
...
var $author$project$Components$Tutorial$init = {bu: 0, bK: 0};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bW: false, bY: r.bY, bk: r.bk, bo: r.bo, ca: r.ca, cm: r.cm, h: r.h, bR: r.bR}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bY: $elm$http$Http$emptyBody, bk: r.bk, bo: _List_Nil, ca: 'GET', cm: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, bR: r.bR});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.b$));
			}(
				function () {
					var _v0 = deadEnd.ce;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {b$: col, b0: contextStack, ce: problem, bI: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bI, s.b$, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{b$: col, g: s0.g, i: s0.i, d: offset, bI: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.bI, s.b$, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.bI, s.b$, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{b$: newCol, g: s.g, i: s.i, d: newOffset, bI: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {b$: col, g: context, i: indent, d: offset, bI: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bd, s.d, s.c);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a3, s.d + 1, s.bI + 1, 1, s.c, s.i, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.a3, firstOffset, s.bI, s.b$ + 1, s.c, s.i, s.g);
			var name = A3($elm$core$String$slice, s.d, s1.d, s.c);
			return A2($elm$core$Set$member, name, i.a9) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bl: $elm$parser$Parser$ExpectingVariable, a3: i.a3, a9: i.a9, bd: i.bd});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		a9: $elm$core$Set$empty,
		bd: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{a3: $elm$core$Char$isDigit, a9: $elm$core$Set$empty, bd: $elm$core$Char$isDigit});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {b$: col, ce: problem, bI: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bI, p.b$, p.ce);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{b$: 1, g: _List_Nil, i: 1, d: 0, bI: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aY(tracker.D);
					} else {
						var prev = previous.a;
						return A2(tracker.aU, prev, tracker.D);
					}
				}()),
			_Utils_update(
				tracker,
				{
					D: tracker.D + 1,
					aL: A3($elm$core$Dict$insert, tracker.D, parent, tracker.aL)
				}));
	});
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{aU: copyState, aY: newState, D: 0, aL: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
						...
						h: _Utils_update(
							tracker,
							{
								aL: A2($elm$core$Dict$remove, 0, tracker.aL)
							})
					};
				}),
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a1: url, f: _List_Nil, a4: key, a_: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.bD)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				y: {
					...
					ay: $author$project$UI$Menu$init(
						$elm$core$Set$fromList(
							_List_fromArray(
								['Settings', 'Equations', 'Tutorials']))),
					_: nModel,
					aA: false,
					ba: $author$project$Components$Rules$init,
					T: false,
					aB: newScreen ? true : false,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.a_)
					])));
	});
...
var $elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _v0, state) {
		...
		var messages = A2($elm$core$List$filterMap, toMessage, state.bO);
		return A2(
			$elm$core$Task$andThen,
			function (_v1) {
				return $elm$core$Task$succeed(state);
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aL: A2($elm$core$Dict$remove, id, tracker.aL)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aL: A3($elm$core$Dict$insert, id, p, tracker.aL)
				});
		}
	});
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						...
						if (_v30.$ === 1) {
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.az, m.a)) ? function (_v31) {
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.h.aL);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.h.aL, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							...
							F2(
								function (elem, t) {
									return _Utils_update(
										t,
										{
											aL: A2($elm$core$Dict$remove, elem, t.aL)
										});
								}),
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.y;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.a5, params.X, swappable.k);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aF: $author$project$Main$CloseDialog,
		ax: $elm$core$Maybe$Just('expr'),
		aM: _List_fromArray(
			[
				{
				ai: _List_fromArray(
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
			...
			_List_fromArray(
				[
					...
					ai: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.a0) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aP: param.a + '= '}),
									$author$project$UI$Dialog$Text(
		...
		aN: $author$project$Main$ApplyParameters,
					...
					function (subEq) {
						...
						if (!_v2.$) {
							...
							return (!_Utils_eq(target, n.u)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								var parent = A2($elm$core$Dict$get, id, tracker.aL);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aL)),
					_Utils_Tuple2(
					'component',
					convert(node.aG)),
					_Utils_Tuple2(
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.h.aL))
							])))
				]));
	});
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aR.a))
								]));
					},
					rule.j))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.ba))
			]));
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.ba)),
						_Utils_Tuple2(
						'tutorial',
						...
						_Utils_Tuple2(
						'menu',
						$author$project$UI$Menu$encode(model.ay)),
						_Utils_Tuple2(
						'evaluator',
						A2(
						...
						_Utils_Tuple2(
						'resetInput',
						$elm$json$Json$Encode$bool(model.aA)),
						_Utils_Tuple2(
						'showHelp',
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {b_: count, b3: eq, O: nodes, ar: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
							...
							return function (resetInput) {
								return function (showHelp) {
									return function (showMenu) {
										return {F: createMode, k: display, L: evaluator, ay: menu, _: notification, aA: resetInput, ba: rules, T: showHelp, aB: showMenu, au: tutorial};
									};
								};
							};
						};
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {af: children, aG: component, aL: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aU: copyState, aY: newState, D: id, aL: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aV: create, f: eq, M: hidden, ak: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {A: constants, x: functions, a: name, ba: rules};
	});
					...
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{e: children, a: s.a, aK: $elm$core$Maybe$Nothing}),
							tokens);
					},
...
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.h;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.aL);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
	...
	function (event, core) {
		...
		switch (event.$) {
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								ay: A2($author$project$UI$Menu$update, e, model.ay)
							})),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, k: dModel, aA: true, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					_Utils_update(
						core,
						{
							...
							y: _Utils_update(
								model,
								{
									ba: A2($author$project$Components$Rules$deleteTopic, name, model.ba)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 18:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v9 = A2($author$project$Components$Rules$addTopic, topic, model.ba);
					if (_v9.$ === 1) {
						var errStr = _v9.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									ba: A2($author$project$Components$Rules$addSources, source.t, model.ba)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 20:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.ba);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
				...
				switch (e.$) {
					...
					default:
						...
						if (_v18.$ === 1) {
							...
							var _v19 = A2($author$project$Components$Rules$evaluateStr, model.ba, n.ar);
							if (_v19.$ === 1) {
								var errStr = _v19.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
								...
								var _v20 = A3(
									...
									A2($author$project$Main$EvalType_, n.b3, id),
									evalStr,
									model.L);
								var eModel = _v20.a;
								var cmd = _v20.b;
			...
			case 25:
				...
				var _v27 = A2(
					$elm$core$Result$andThen,
					$author$project$Components$Rules$replaceGlobalVar(model.ba),
					$author$project$Algo$Math$parse(str));
				if (_v27.$ === 1) {
					var errStr = _v27.a;
					return A2($author$project$Main$submitNotification_, core, errStr);
					...
					var newTree = _v27.a;
					var _v28 = A2($author$project$Components$Rules$evaluateStr, model.ba, newTree);
					if (_v28.$ === 1) {
						var errStr = _v28.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v30 = A2($author$project$Components$Evaluate$finish, reply.b6, model.L);
				var eModel = _v30.a;
				var c = _v30.b;
			...
			ai: _List_fromArray(
				[
					...
					[
						...
						{
							b4: $author$project$Main$FileSelect(0),
							aP: 'Select a file'
						})
					])
				]),
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		...
		var apply = function () {
			var applies = {
				a2: false,
				aH: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{a2: true, aH: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.ar;
				switch (_v1.$) {
							...
							return _Utils_update(
								applies,
								{
									aW: (_Utils_eq(
										...
										val.b_) || (val.b_ < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									as: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									a$: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aH),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aZ),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aW),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a$),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{aX: res, m: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {X: result, a5: m.aR.ar, a: m.aR.a};
								},
					...
					$elm$core$Maybe$Just(
						{
							...
							al: A2(
								...
								function (p) {
									return {
										a0: $author$project$Algo$Matcher$countChildren(p.aJ.ar),
										V: p.V,
										a: p.aJ.a,
										ar: $author$project$Algo$Matcher$getName(p.aJ.ar)
									};
								},
								rule.al),
							ac: rule.ac
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.X.a + ('→' + match.aR.a))
												]));
									},
									rule.j),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.ba));
								}
							}());
					}),
				_List_fromArray(
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.b6)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.b6),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.b6))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.b4),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(m.aP)
							]));
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aP);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
						...
						[
							...
							_List_fromArray(
								[
									$author$project$UI$Icon$class('clickable'),
									$author$project$UI$Icon$class('cancelable'),
									$author$project$UI$HtmlEvent$onClick(model.aF)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{b8: $author$project$Main$init, cb: $author$project$Main$EventUrlChange, cc: $author$project$Main$EventUrlRequest, cl: $author$project$Main$subscriptions, cn: $author$project$Main$update, co: $author$project$Main$view});
