		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$Notification$delayedClear_(model.D + 1)
					])));
	});
...
var $author$project$Display$insertParentIndex_ = F4(
	function (start, end, index, map) {
		return _Utils_eq(start, end) ? map : A4(
			$author$project$Display$insertParentIndex_,
			start + 1,
			end,
			index,
			A3(
...
var $author$project$Display$finalizeNode_ = F4(
	function (nodeGen, parentIndex, start, _v0) {
		var end = _v0.a;
		var _v1 = _v0.b;
		var c = _v1.a;
		var map = _v1.b;
		return _Utils_Tuple2(
			...
			_Utils_Tuple2(
				A2(
					...
					c),
				A4($author$project$Display$insertParentIndex_, start, end + 1, parentIndex, map)));
	});
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Display$processChildren_ = F4(
	function (_v5, start, map, children) {
		var indexStart = _v5.a;
		var indexIncr = _v5.b;
		return function (_v11) {
			var _v12 = _v11.a;
			var end = _v12.a;
			var result = _v11.b;
			return _Utils_Tuple2(end, result);
		}(
			A3(
				$elm$core$List$foldl,
				F2(
					function (input, _v6) {
						...
						var list = _v8.a;
						var newMap = _v8.b;
						var _v9 = A4($author$project$Display$processNode_, index, newStart, newMap, input);
						var end = _v9.a;
						var _v10 = _v9.b;
						var newChild = _v10.a;
						var finalMap = _v10.b;
						return _Utils_Tuple2(
							_Utils_Tuple2(end, index + indexIncr),
							_Utils_Tuple2(
								_Utils_ap(
									list,
									_List_fromArray(
...
var $author$project$Display$processNode_ = F4(
	function (parentIndex, start, map, root) {
		switch (root.$) {
			case 0:
				var children = root.b;
				return A4(
			...
			case 5:
				...
				return A4(
					...
					parentIndex,
					start,
					A3($author$project$Display$processFunctionProperties_, start, map, properties));
			case 3:
				var child = root.b;
				return A4(
					$author$project$Display$finalizeNode_,
					...
					parentIndex,
					start,
					A4($author$project$Display$processNode_, 0, start, map, child));
			case 4:
				var child = root.b;
				return A4(
					$author$project$Display$finalizeNode_,
			...
			default:
				...
				return A4(
					...
					_Utils_Tuple2(
						start,
						_Utils_Tuple2(val, map)));
		}
	});
var $author$project$Display$addEquation = F2(
	function (tree, model) {
		var _v0 = A4($author$project$Display$processNode_, 0, 0, $elm$core$Dict$empty, tree);
		var equation = _v0.b;
		return _Utils_update(
			model,
			{
				C: A3($elm$core$Dict$insert, model.J, equation, model.C),
				J: model.J + 1
			});
	});
var $author$project$Display$init = A2(
	...
	{ad: $elm$core$Maybe$Nothing, C: $elm$core$Dict$empty, J: 0, aH: $elm$core$Maybe$Nothing});
var $author$project$Notification$init = {D: 0, x: _List_Nil};
...
function $author$project$Math$cyclic$multiple_() {
	return A2(
		$elm$parser$Parser$map,
		$author$project$Math$Multiply(0),
		A2(
			$elm$parser$Parser$loop,
			_List_Nil,
			function (list) {
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				H: $elm$core$List$isEmpty(eqs) ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
				r: $author$project$Display$init(eqs),
				w: nModel,
				V: query,
...
var $author$project$Query$pushUrl = function (model) {
	var eqs = $author$project$Query$marshalEquations_(model.C);
	return A2(
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Display$update, e, model.r);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.w);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				...
				if (!_v5.$) {
					...
					return function (nModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{H: $elm$core$Maybe$Nothing, r: nModel}),
						...
						function () {
							if (id.$ === 1) {
								return A2($author$project$Display$addEquation, root, model.r);
							} else {
								var i = id.a;
								return A3($author$project$Display$updateEquation, i, root, model.r);
							}
						}());
				} else {
					var err = _v5.a;
					var _v7 = A3(
						...
						str,
						err,
						_Utils_Tuple2(model.w, $elm$core$Platform$Cmd$none));
					var nModel = _v7.a;
					var nCmd = _v7.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$EnterCreateMode = {$: 6};
			...
			if (_v0.$ === 1) {
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$HtmlEvent$onClick($author$project$Main$EnterCreateMode)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('+')
					...
					[
						...
						_List_fromArray(
							[
								...
								'equation',
								$author$project$Main$SubmitEquation(id))
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$Main$view = function (model) {
	return {
		aW: _List_fromArray(
			[
				A3($author$project$Display$view, $author$project$Main$DisplayEvent, _List_Nil, model.r),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				A3($author$project$Notification$view, $author$project$Main$NotificationEvent, _List_Nil, model.w)
			]),
		bf: 'Maths'
	};
};
