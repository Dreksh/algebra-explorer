...
{
	if (region.aR.K === region.al.K)
	{
		return 'on line ' + region.aR.K;
	}
	return 'on lines ' + region.aR.K + ' through ' + region.al.K;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bb: 'hidden', a3: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bb: 'mozHidden', a3: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bb: 'msHidden', a3: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bb: 'webkitHidden', a3: 'webkitvisibilitychange' }
		: { bb: 'hidden', a3: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ap: fragment, as: host, az: path, aB: port_, aG: protocol, U: query};
	});
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$Notification$delayedClear_(model.G)
					])));
	});
...
var $author$project$Display$idProcessor_ = {
	...
	aq: F3(
		function (recurse, _v10, prop) {
			...
			var newDict = _v13.b;
			var args = _v12.b;
			var _v14 = A4($author$project$Display$idChildren_, recurse, maxNum, newDict, prop.T);
			var g = _v14.a;
			var parameters = _v14.b;
			return _Utils_Tuple2(
				g,
				$elm$core$Maybe$Just(
					{S: args, ad: prop.ad, ai: prop.ai, av: prop.av, ax: prop.ax, T: parameters, aV: prop.aV}));
		}),
	aH: F2(
		function (_v15, val) {
			var p = _v15.a;
...
var $author$project$Display$init = A2(
	...
	{aj: $elm$core$Maybe$Nothing, n: $elm$core$Dict$empty, L: 0, aO: $elm$core$Maybe$Nothing});
var $author$project$Notification$init = {G: 0, A: _List_Nil};
var $author$project$Rules$init = {s: false, M: _List_Nil};
var $author$project$Tutorial$init = {ay: 0, aN: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ah: col, c: s0.c, d: s0.d, b: offset, aL: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aL, s.ah, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ah: col, a4: contextStack, aD: problem, aL: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aL, s.ah, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aL, s.ah, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ah: newCol, c: s.c, d: s.d, b: newOffset, aL: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ah: col, c: context, d: indent, b: offset, aL: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.at, s.b + 1, s.aL + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.at, firstOffset, s.aL, s.ah + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.aK) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{an: $elm$parser$Parser$ExpectingVariable, at: i.at, aK: i.aK, aR: i.aR});
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {ah: s.ah + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, aL: s.aL, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aL, s.ah - (floatOffset + s.b), invalid, s.c));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			a1: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.a1),
			an: $elm$parser$Parser$ExpectingNumber,
			a9: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.a9),
			ba: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.ba),
			be: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.be),
			bf: $elm$parser$Parser$ExpectingNumber,
...
function $author$project$Math$cyclic$args_() {
	return A2(
		...
		function (_v5) {
			...
			return {S: args, ad: false, ai: false, av: false, ax: '', T: parameters, aV: false};
		},
		A2(
			$elm$parser$Parser$keeper,
			A2(
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ah: col, aD: problem, aL: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aL, p.ah, p.aD);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ah: 1, c: _List_Nil, d: 1, b: 0, aL: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{W: url, n: _List_Nil, X: key},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.U)));
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				s: $elm$core$List$isEmpty(eqs) ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
				t: $author$project$Display$init(eqs),
				z: nModel,
				U: query,
				M: $author$project$Rules$init,
				w: false,
				V: false,
...
var $author$project$Math$symbolicateRecursive_ = F3(
	function (parent, sibling, root) {
		symbolicateRecursive_:
		while (true) {
			switch (root.$) {
				case 0:
					var s = root.a;
				...
				case 5:
					...
					return A2(
						...
						A2(
							$elm$core$List$cons,
							$author$project$Math$Text('\\' + (properties.ax + '(')),
							_Utils_ap(
								args,
								_List_fromArray(
									[
				...
				default:
					...
					root = $temp$root;
					continue symbolicateRecursive_;
			}
		}
	});
var $author$project$Math$symbolicate = function (root) {
	return A3($author$project$Math$symbolicateRecursive_, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, root);
};
...
var $author$project$Math$getChildren = function (root) {
	switch (root.$) {
		...
		case 5:
			var prop = root.b;
			return _Utils_ap(prop.S, prop.T);
		case 6:
			return _List_Nil;
		case 7:
			return _List_Nil;
...
var $author$project$Display$searchProcessor_ = function (process) {
	return {
		af: $author$project$Display$searchChild_(process),
		ag: F3(
			function (recurse, g, children) {
				return function (_v0) {
					var newG = _v0.a;
					var list = _v0.b;
					return $elm$core$List$isEmpty(list) ? _Utils_Tuple2(newG, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
						newG,
						$elm$core$Maybe$Just(list));
				}(
					A4($author$project$Display$searchChildren_, process, recurse, g, children));
			}),
		ao: F3(
			function (_v1, g, s) {
				return _Utils_Tuple2(g, s);
			}),
		aq: $author$project$Display$searchFunction_(process),
		aH: F2(
			function (g, val) {
				return _Utils_Tuple2(
					g,
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 3:
				var e = event.a;
				var _v2 = A2($author$project$Rules$update, e, model.M);
				var rModel = _v2.a;
				var rCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.z);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 7:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{s: $elm$core$Maybe$Nothing, w: false}),
			...
			case 8:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							s: $elm$core$Maybe$Just($elm$core$Maybe$Nothing)
						}),
					A2(
			...
			case 10:
				...
				if (!_v6.$) {
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{s: $elm$core$Maybe$Nothing, t: dModel, w: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
							...
							function (list) {
								return A2($author$project$Query$setEquations, list, model.U);
							}(
								$author$project$Display$listEquations(dModel)));
					}(
						function () {
					...
					var _v8 = A3(
						...
						str,
						err,
						_Utils_Tuple2(model.z, $elm$core$Platform$Cmd$none));
					var nModel = _v8.a;
					var nCmd = _v8.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$ToggleRules = {$: 12};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 4V20M4 12H20'),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill('currentColor'),
						$elm$svg$Svg$Attributes$mask('url(#text)')
					]),
				_List_Nil)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M5 15L11 20L20 5'),
						$elm$svg$Svg$Attributes$fill('none'),
						$elm$svg$Svg$Attributes$stroke('#fff'),
						$elm$svg$Svg$Attributes$strokeWidth('2')
					]),
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($author$project$Display$DeleteTree, eq, s.F))
					]),
				A2(
					$elm$core$List$map,
...
var $author$project$Main$view = function (model) {
	return {
		a2: _List_fromArray(
			[
				A3($author$project$Display$view, $author$project$Main$DisplayEvent, _List_Nil, model.t),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$HtmlEvent$onClick($author$project$Main$ToggleRules)
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										A3($author$project$Rules$view, $author$project$Main$RulesEvent, _List_Nil, model.M)
									]))
							]))
					])),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{bd: $author$project$Main$init, bh: $author$project$Main$EventUrlChange, bi: $author$project$Main$EventUrlRequest, bm: $author$project$Main$subscriptions, bo: $author$project$Main$update, bq: $author$project$Main$view});
