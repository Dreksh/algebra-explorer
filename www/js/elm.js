...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.ah, s.b + 1, s.a$ + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.ah, firstOffset, s.a$, s.bj + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.an) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aC: $elm$parser$Parser$ExpectingVariable, ah: i.ah, an: i.an, as: i.as});
};
...
var $author$project$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{ah: $elm$core$Char$isDigit, an: $elm$core$Set$empty, as: $elm$core$Char$isDigit});
...
var $author$project$Rules$deleteTopic = F2(
	function (name, model) {
		...
		var _v0 = A2($elm$core$Dict$get, id, model.E);
		if (_v0.$ === 1) {
			return model;
		} else {
			var topic = _v0.a;
...
var $author$project$Rules$addTopic = F2(
	function (topic, m) {
		var id = $elm$core$String$toLower(topic.aN);
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								p: constants,
								r: functions,
								E: A3($elm$core$Dict$insert, id, topic, model.E)
							});
					},
					A3(
						$elm$core$Set$foldl,
...
var $author$project$Rules$Rule_ = F6(
	function (title, description, reversible, lhs, rhs, parameters) {
		return {az: description, aj: lhs, X: parameters, ao: reversible, ap: rhs, bF: title};
	});
...
var $author$project$Rules$matchRuleToNode_ = F2(
	function (rule, node) {
		return A2($author$project$Rules$matchExpressionToNode_, rule.aj, node) || (rule.ao && A2($author$project$Rules$matchExpressionToNode_, rule.ap, node));
	});
