...
{
	if (region.bk.aK === region.bv.aK)
	{
		return 'on line ' + region.bk.aK;
	}
	return 'on lines ' + region.bk.aK + ' through ' + region.bv.aK;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { R: 'hidden', cf: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { R: 'mozHidden', cf: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { R: 'msHidden', cf: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { R: 'webkitHidden', cf: 'webkitvisibilitychange' }
		: { R: 'hidden', cf: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cq, request.b7, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.b7));
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bA: fragment, bD: host, bM: path, bO: port_, bT: protocol, bU: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ci: false, bu: element, a3: trigger};
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {ao: nextCallID, ag: ongoing, bh: sender};
	});
				...
				_Utils_Tuple2(
					{
						...
						W: $author$project$Algo$Math$BinaryNode(
							{m: true, ae: _List_Nil, i: true, n: 0, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'*',
				_Utils_Tuple2(
					{
						ab: $author$project$Components$Rules$InfixOp('*'),
						W: $author$project$Algo$Math$BinaryNode(
							{m: true, ae: _List_Nil, i: true, n: 1, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'-',
				_Utils_Tuple2(
					{
						...
						W: $author$project$Algo$Math$UnaryNode(
							{
								P: $author$project$Algo$Math$RealNode(
									{c: 0, w: 0}),
								a: '',
								c: 0
							})
...
var $author$project$Components$Tutorial$init = {bH: 0, b0: 0};
...
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			q: {C: top + height, x: left, A: left + width, I: top},
...
var $author$project$UI$Notification$init = {o: 0, N: $elm$core$Dict$empty};
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.cy));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cc: false, ce: r.ce, bx: r.bx, bB: r.bB, cq: r.cq, cC: r.cC, k: r.k, b7: r.b7}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ce: $elm$http$Http$emptyBody, bx: r.bx, bB: _List_Nil, cq: 'GET', cC: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, b7: r.b7});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.cg));
			}(
				function () {
					var _v0 = deadEnd.cu;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cg: col, ch: contextStack, cu: problem, b_: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.b_, s.cg, x, s.h));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cg: col, h: s0.h, j: s0.j, f: offset, b_: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.b_, s.cg, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.b_, s.cg, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cg: newCol, h: s.h, j: s.j, f: newOffset, b_: newRow, d: s.d});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cg: col, h: context, j: indent, f: offset, b_: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bk, s.f, s.d);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.by));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a8, s.f + 1, s.b_ + 1, 1, s.d, s.j, s.h) : A7($elm$parser$Parser$Advanced$varHelp, i.a8, firstOffset, s.b_, s.cg + 1, s.d, s.j, s.h);
			var name = A3($elm$core$String$slice, s.f, s1.f, s.d);
			return A2($elm$core$Set$member, name, i.bf) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.by)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{by: $elm$parser$Parser$ExpectingVariable, a8: i.a8, bf: i.bf, bk: i.bk});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		bk: $author$project$Algo$Math$validVarStart_
	});
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{a8: $elm$core$Char$isDigit, bf: $elm$core$Set$empty, bk: $elm$core$Char$isDigit});
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{m: true, ae: children, i: true, n: 0, a: '+', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
	...
	return A2(
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{m: true, ae: children, i: true, n: 1, a: '*', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
		...
		_List_fromArray(
			[
				...
				$elm$parser$Parser$lazy(
					function (_v11) {
						return $author$project$Algo$Math$negatable_(funcProps);
					})),
				A2(
				$elm$parser$Parser$keeper,
						...
						if (_v1.b.$ === 1) {
							...
							return $elm$parser$Parser$succeed(
								$author$project$Algo$Math$GenericNode(
									{b: $elm$core$Maybe$Nothing, ae: children, a: name, c: 0}));
						}
					} else {
						if (_v1.b.$ === 1) {
							var p = _v1.a.a;
							...
							if (p.$ === 1) {
								...
								return $elm$parser$Parser$problem(name + ' is not a constant, but a function');
							}
						} else {
							var p = _v1.a.a;
							var children = _v1.b.a;
							switch (p.$) {
								case 2:
									if (children.b && (!children.b.b)) {
										...
										return $elm$parser$Parser$problem(name + ' only takes 1 argument');
									}
								case 4:
									var n = p.a;
									var _v9 = n.b;
									if (_v9.$ === 1) {
										return $elm$parser$Parser$problem(name + ' did not specify the number of arguments');
									} else {
										var args = _v9.a;
										return (!_Utils_eq(
											args,
											$elm$core$List$length(children))) ? $elm$parser$Parser$problem(name + ' has incorrect number of arguments') : $elm$parser$Parser$succeed(
											$author$project$Algo$Math$GenericNode(
												{
								...
								case 3:
									var n = p.a;
									return ($elm$core$List$length(children) < 2) ? $elm$parser$Parser$problem(name + ' has less than 2 children') : $elm$parser$Parser$succeed(
										$author$project$Algo$Math$BinaryNode(
											{m: n.m, ae: children, i: n.i, n: n.n, a: name, c: 0}));
								default:
									return $elm$parser$Parser$problem(name + ' is not a function');
							}
						}
					}
				},
				...
				function (name) {
					...
					if (_v10.$ === 1) {
						...
						if (_v10.a.$ === 1) {
							...
							return $elm$parser$Parser$problem(name + ' is not a constant');
						}
					}
				},
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cg: col, cu: problem, b_: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.b_, p.cg, p.cu);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cg: 1, h: _List_Nil, j: 1, f: 0, b_: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aL(tracker.o);
					} else {
						var prev = previous.a;
						return A2(tracker.aI, prev, tracker.o);
					}
				}()),
			_Utils_update(
				tracker,
				{
					o: tracker.o + 1,
					aB: A3($elm$core$Dict$insert, tracker.o, parent, tracker.aB)
				}));
	});
				...
				return function (_v3) {
					...
					return _Utils_Tuple2(
						$author$project$Algo$Math$BinaryNode(
							{
								m: n.m,
								ae: $elm$core$List$reverse(finChildren),
								i: n.i,
								n: n.n,
								a: n.a,
								c: finS
			...
			$elm$core$Result$map(
				A2(
					...
					$author$project$Algo$Matcher$processID_(
						{aI: copyState, aL: newState, o: 0, aB: $elm$core$Dict$empty}),
					function (_v0) {
						var newRoot = _v0.a;
						var tracker = _v0.b;
						return {
							...
							k: _Utils_update(
								tracker,
								{
									aB: A2($elm$core$Dict$remove, 0, tracker.aB)
								})
						};
					})));
	});
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a4: url, e: _List_Nil, a9: key, a$: _List_Nil},
			A2(
				...
				a_: A2(
					...
					$elm$core$Result$toMaybe(
						A2(
							...
							flags))),
				H: {
					aw: $author$project$UI$ActionView$init,
					E: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
							$author$project$Main$uiCancelCmd_(0),
							0)) : $elm$core$Maybe$Nothing,
					g: $author$project$Components$Display$init(eqs),
					Q: $author$project$Components$Evaluate$init($author$project$Main$evaluateString),
					ay: A3(
					...
					ap: newScreen ? 1 : 0,
					af: nModel,
					bg: $author$project$Components$Rules$init,
					X: false,
					aC: false,
					O: false,
					aF: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.a$)
					])));
	});
	...
	if (action.$ === 1) {
		...
		if (!action.a.$) {
			...
			return $author$project$Main$capture(
				{a5: eId, bd: pId, bi: true});
		} else {
			var _v2 = action.a;
			var eId = _v2.a;
			var pId = _v2.b;
			return $author$project$Main$capture(
				{a5: eId, bd: pId, bi: false});
		}
	}
};
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{aV: res, p: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && _Utils_eq(l.w, r.w);
					} else {
						break _v0$6;
					}
				case 1:
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.P, r.P));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.m, r.m) && (_Utils_eq(l.i, r.i) && (_Utils_eq(
							$elm$core$List$length(l.ae),
							$elm$core$List$length(r.ae)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								...
								F: functions,
								v: function () {
									var _v7 = A2($elm$core$Dict$get, topic.a, model.v);
									if (_v7.$ === 1) {
										return A3(
											$elm$core$Dict$insert,
											topic.a,
					...
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							return (A3(
								...
								p.W,
								props.W) && _Utils_eq(p.ab, props.ab)) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
	...
	function (child, n) {
		return function (newChildren) {
			...
			A2(
				...
				F2(
					function (left, right) {
						return (!_Utils_eq(left.G, right.G)) ? ((_Utils_cmp(left.G, right.G) < 0) ? 0 : 2) : ((!_Utils_eq(left.J, right.J)) ? ((_Utils_cmp(left.J, right.J) < 0) ? 0 : 2) : 1);
					}),
				A2(
					$elm$core$List$cons,
					child,
					A2(
						...
						function (elem) {
							return !_Utils_eq(elem.aa, child.aa);
						},
						n.ae))));
	});
var $author$project$Algo$History$updateNodeValues_ = F3(
	function (index, child, model) {
		...
		while (true) {
			if (!index) {
				var _v0 = A2($author$project$Algo$History$updateNode_, child, model.au);
				var newNode = _v0.c;
				return _Utils_update(
					model,
					{au: newNode});
			} else {
				var _v1 = A2($elm$core$Dict$get, index, model.z);
				if (_v1.$ === 1) {
					return model;
				} else {
					var n = _v1.a;
					...
					var newNode = _v2.c;
					var $temp$index = n.aB,
						$temp$child = {G: height, aa: index, J: width},
						$temp$model = _Utils_update(
						model,
						{
							z: A3($elm$core$Dict$insert, index, newNode, model.z)
						});
					index = $temp$index;
					child = $temp$child;
					model = $temp$model;
	...
	function (list, model) {
		...
		return function (newModel) {
			...
			A3(
				...
				F2(
					function (c, m) {
						var nextID = $elm$core$Dict$size(m.z) + 1;
...
var $author$project$Algo$History$current = function (model) {
	return A2(
		...
		A2(
			$elm$core$Maybe$andThen,
			function (n) {
				return A2($elm$core$Dict$get, n, model.z);
			},
			$elm$core$List$head(model.B))).aj;
};
...
var $author$project$Algo$Matcher$processSubtree_ = F3(
	function (path, processor, eq) {
		...
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.au));
		if (!path.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												au: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{P: newEq.au}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											au: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{ae: children})),
											k: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											au: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{ae: children})),
											k: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											au: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{ae: children})),
											k: t
		...
		switch (replaceNode.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromInternalReplacement_, id, t, _arguments, n.P));
			case 3:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
							...
							function () {
								if (!res.$) {
									...
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
										$author$project$Algo$Math$BinaryNode(
											{m: n.m, ae: children, i: n.i, n: n.n, a: n.a, c: s}));
								} else {
									var pre = res.b;
									var post = res.c;
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
					...
					A3(constructChildren, n.a, t, n.ae));
			case 5:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
			...
			case 1:
				...
				if (_v40.b.$ === 1) {
					var oldS = _v40.a;
					var _v41 = _v40.b;
					var newState = A2(tracker.aI, oldS, tracker.o);
					return $elm$core$Result$Ok(
						_Utils_Tuple3(
							$author$project$Algo$Matcher$SingleNodeReplaced_(
								$author$project$Algo$Math$VariableNode(
									{
										T: n.T,
										a: n.a,
										c: A2($author$project$Algo$Matcher$State_, tracker.o, newState)
									})),
							_Utils_update(
								tracker,
								{
				...
				if (_v45.b.$ === 1) {
					...
					if (_v49.$ === 1) {
						...
						return A2(
							...
							A3(constructChildren, '', tracker, n.ae));
					}
				}
		}
	});
		...
		switch (replaceNode.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromReplacement_, id, t, _arguments, n.P));
			case 3:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
	...
	switch (root.$) {
		...
		case 2:
			...
			return A2(
				$elm$core$Set$insert,
				$author$project$Algo$Matcher$getID(s.c),
				$author$project$Algo$Matcher$getSubtreeIDs_(s.P));
		case 3:
			var s = root.a;
			return A3(
				$elm$core$List$foldl,
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aB: A2($elm$core$Dict$remove, id, tracker.aB)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aB: A3($elm$core$Dict$insert, id, p, tracker.aB)
				});
		}
	});
					...
					F2(
						function (elem, childT) {
							return _Utils_update(
								childT,
								{
									aB: A2($elm$core$Dict$remove, elem, childT.aB)
								});
						}),
					A3($author$project$Algo$Matcher$setParent_, newRoot, pID, newTracker),
					A2(
						$elm$core$Set$diff,
						$author$project$Algo$Matcher$getSubtreeIDs_(eq.au),
						$author$project$Algo$Matcher$getSubtreeIDs_(newRoot)));
				return _Utils_Tuple2(
					$author$project$Algo$Matcher$getID(
						$author$project$Algo$Math$getState(newRoot)),
					{au: newRoot, k: finalTracker});
			},
			A4($author$project$Algo$Matcher$constructFromReplacement_, -1, eq.k, args, replacement));
	});
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, replacement, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.k.aB);
		if (_v0.$ === 1) {
			...
			return A3(
				$author$project$Algo$Matcher$processSubtree_,
				A2($author$project$Algo$Matcher$searchPath_, eq.k.aB, id),
				A2($author$project$Algo$Matcher$replaceSubtree_, replacement, _with),
				eq);
		}
	});
							...
							F2(
								function (r, _v3) {
									...
									return A2(
										...
										A4($author$project$Algo$Matcher$replaceSubtree, ids, r.au, result, current));
								}),
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.ae));
	}
};
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.au);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.H;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bW, params.a6, swappable.g);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.ci ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{ci: true}),
		element.a3(0));
...
var $author$project$Components$Rules$toJavascriptString_ = F3(
	function (model, name, children) {
		var _v0 = A2($elm$core$Dict$get, name, model.F);
		if (_v0.$ === 1) {
		...
		return A2(
			...
			function () {
				switch (root.$) {
					...
					case 1:
						var s = root.a;
						var _v1 = A2($elm$core$Dict$get, s.a, model.D);
						if (_v1.$ === 1) {
					...
					case 2:
						...
						return A2(
							...
							A2($author$project$Components$Rules$evaluateStr, model, s.P));
					case 3:
						var s = root.a;
						return A2(
							$elm$core$Result$andThen,
...
var $author$project$Algo$History$add = F2(
	function (c, model) {
		var id = $author$project$Algo$History$currentNode_(model);
		var nextID = $elm$core$Dict$size(model.z) + 1;
		return function (newModel) {
			return _Utils_update(
				newModel,
				{
					Z: _List_Nil,
					B: A2($elm$core$List$cons, nextID, model.B)
				});
		}(
			function (nodes) {
				return A3(
															...
															A2(
																...
																$author$project$Algo$Math$BinaryNode(
																	_Utils_update(
																		n,
																		{
																			ae: $elm$core$List$reverse(group),
																			c: newS
																		})),
		...
		return {
			...
			aZ: _List_fromArray(
				[
					...
					aE: 'The expression to replace ' + $elm$core$String$fromFloat(target)
				}
				]),
			a1: function (dict) {
			...
			a2: 'Substitute a number for an expression'
		};
	});
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
		...
		aZ: function (sections) {
			return ($elm$core$List$length(params.aW) <= 1) ? sections : A2(
				$elm$core$List$cons,
				{
					az: _List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					az: A2(
						...
						$elm$core$Dict$toList(params.be)),
					aE: 'Fill in the parameters'
				}
				])),
		a1: $author$project$Main$ApplyParameters,
		a2: 'Set parameters for ' + params.a2
	};
};
...
var $author$project$Components$Display$newSelectedNodes_ = F2(
	function (selected, eq) {
		var intersection = A2(
			$elm$core$Set$filter,
			function (n) {
				return A2($elm$core$Dict$member, n, eq.k.aB);
			},
			selected);
		return $elm$core$Set$isEmpty(intersection) ? $elm$core$Set$singleton(
			$author$project$Algo$Matcher$getID(
				$author$project$Algo$Math$getState(eq.au))) : intersection;
	});
var $author$project$Algo$History$redo = function (model) {
	...
	if (!_v0.b) {
		...
		return _Utils_update(
			...
			{
				Z: others,
				B: A2($elm$core$List$cons, x, model.B)
			});
	}
};
	...
	function (eqNum, id, number, model) {
		...
		if (_v0.$ === 1) {
			...
			var replacement = (number < 0) ? $author$project$Algo$Math$UnaryNode(
				{
					P: $author$project$Algo$Math$RealNode(
						{c: $elm$core$Maybe$Nothing, w: -number}),
					a: '-',
			...
			function (subEq) {
				...
				if (!_v0.$) {
					...
					return (!_Utils_eq(target, n.w)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v1) {
						var root = _v1.a;
						var tracker = _v1.b;
						var parent = A2($elm$core$Dict$get, id, tracker.aB);
						...
						A2($author$project$Algo$Matcher$processID_, subEq.k, subtree));
				} else {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aB)),
					_Utils_Tuple2(
					'component',
					convert(node.aj)),
					_Utils_Tuple2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.au)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'visits',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.B)),
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.Z))
				]));
	});
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'child',
							A2($author$project$Algo$Math$encode, converter, s.P)),
							_Utils_Tuple2(
							'type',
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'associative',
							$elm$json$Json$Encode$bool(s.m)),
							_Utils_Tuple2(
							'commutative',
							$elm$json$Json$Encode$bool(s.i)),
							_Utils_Tuple2(
							'identity',
							$elm$json$Json$Encode$float(s.n)),
							_Utils_Tuple2(
							'children',
							A2(
								$elm$json$Json$Encode$list,
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.k.o)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.k.aB))
							])))
				]));
	});
		...
		case 3:
			...
			return _List_fromArray(
				[
					...
					_Utils_Tuple2(
					'commutative',
					$elm$json$Json$Encode$bool(n.i)),
					_Utils_Tuple2(
					'associative',
					$elm$json$Json$Encode$bool(n.m)),
					_Utils_Tuple2(
					'identity',
					$elm$json$Json$Encode$float(n.n))
				]);
		case 4:
			var n = fp.a;
			return _List_fromArray(
...
var $author$project$Components$Rules$encodeFProp_ = function (prop) {
	return $elm$json$Json$Encode$object(
		A2(
			...
			$author$project$Algo$Math$encodeFunctionProperty(prop.W)));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'arguments',
				$elm$json$Json$Encode$int(param.b)),
				_Utils_Tuple2(
				'description',
				$elm$json$Json$Encode$string(param.ak))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'parameters',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeParameter_, rule.be)),
				_Utils_Tuple2(
				'matches',
				A2(
					$elm$json$Json$Encode$list,
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'from',
									$elm$json$Json$Encode$string(match.a6.a)),
									_Utils_Tuple2(
									'to',
									A2(
										$elm$json$Json$Encode$list,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constants',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, topic.D)),
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.F)),
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.bg))
			]));
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.ci))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.q.x)),
				_Utils_Tuple2(
				'right',
				$elm$json$Json$Encode$float(model.q.A)),
				_Utils_Tuple2(
				'top',
				$elm$json$Json$Encode$float(model.q.I)),
				_Utils_Tuple2(
				'bottom',
				$elm$json$Json$Encode$float(model.q.C)),
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(model.cm))
			]));
};
var $author$project$UI$Menu$encode = function (model) {
	return A2($elm$json$Json$Encode$set, $elm$json$Json$Encode$string, model.Y);
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bg)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aF)),
						_Utils_Tuple2(
						'notification',
						...
						_Utils_Tuple2(
						'showMenu',
						$elm$json$Json$Encode$bool(model.O)),
						_Utils_Tuple2(
						'showHistory',
						$elm$json$Json$Encode$bool(model.aC)),
						_Utils_Tuple2(
						'historyBox',
						$author$project$UI$Draggable$encode(model.ay)),
						_Utils_Tuple2(
						'actionView',
						$author$project$UI$ActionView$encode(model.aw))
					]))));
};
		...
		var convert = function (node) {
			switch (node.$) {
				case 0:
					...
					return $elm$core$Result$Ok(
						$author$project$Algo$Math$RealNode(
							{c: $elm$core$Maybe$Nothing, w: s.w}));
				case 1:
					var s = node.a;
					...
					if (!_v1.$) {
						...
						return (s.T || (!strict)) ? $elm$core$Result$Ok(
							$author$project$Algo$Math$VariableNode(
								{T: s.T, a: s.a, c: $elm$core$Maybe$Nothing})) : $elm$core$Result$Err('Cannot construct the variable ' + s.a);
					}
				case 2:
					var s = node.a;
					return A2(
						...
						function (child) {
							return $author$project$Algo$Math$UnaryNode(
								{P: child, a: s.a, c: $elm$core$Maybe$Nothing});
						},
						convert(s.P));
				case 3:
					var s = node.a;
					return A2(
						...
						function (children) {
							return $author$project$Algo$Math$BinaryNode(
								{
									m: s.m,
									ae: $elm$core$List$reverse(children),
									i: s.i,
									n: s.n,
									a: s.a,
									c: $elm$core$Maybe$Nothing
				...
				case 4:
					...
					if (!_v3.$) {
						...
						return (!_Utils_eq(
							args,
							$elm$core$List$length(s.ae))) ? $elm$core$Result$Err(s.a + ' has the wrong number of inputs') : A2(
							$elm$core$Result$map,
							function (children) {
		...
		switch (root.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$treeToMatcher_, checker, argMap, state, s.P));
			case 3:
				var s = root.a;
				return s.i ? A2(
					$elm$core$Result$map,
						...
						return A2(
							...
							A2(
									...
									return A3(
										...
										F2(
											function (child, _v9) {
												...
												if (child.$ === 1) {
													var n = child.a;
													return A2($elm$core$Set$member, n.a, seen) ? $elm$core$Result$Err('Function argument can only match on unique variables') : (n.T ? $elm$core$Result$Err('Only variables are supported in function arguments. Constants are not allowed') : A2(
														$elm$core$Result$map,
														function (finalS) {
															return _Utils_Tuple3(
								...
								A3(
									checker,
									s.a,
									$elm$core$List$length(s.ae),
									state)));
					} else {
						var argNum = _v8.a;
						return (!_Utils_eq(
							argNum,
							$elm$core$List$length(s.ae))) ? $elm$core$Result$Err(s.a + ' has an unexpected function signature') : A2(
							$elm$core$Result$map,
							function (_v12) {
								var children = _v12.a;
								var newS = _v12.b;
				...
				return $elm$core$List$isEmpty(nodes) ? $elm$core$Maybe$Just(
					A3(
						...
						$author$project$Algo$Matcher$ExternalValue_(
							$author$project$Algo$Math$RealNode(
								{c: $elm$core$Maybe$Nothing, w: props.n})),
						result)) : (($elm$core$List$length(nodes) === 1) ? A2(
					$elm$core$Maybe$map,
					function (_v0) {
						var node = _v0.b;
						return A3(
							...
							$author$project$Algo$Matcher$MultiValue_(
								{
									...
									n: props.n,
									bJ: op,
									bP: processChildren(b),
									bQ: processChildren(a)
								}),
							result));
				}(
					A2(
		...
		while (true) {
			switch (from.$) {
				case 1:
					...
					if (!root.$) {
						var n = root.a;
						return _Utils_eq(n.w, s.w) ? A2($author$project$Algo$Backtrack$return, $elm$core$Maybe$Just, token) : $author$project$Algo$Backtrack$fail;
					} else {
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									...
									$elm$core$List$length(n.ae)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aM;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.ae);
								return (!_Utils_eq(
									$elm$core$List$length(s.b),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.ae)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
		...
		return {
			...
			aZ: _List_fromArray(
				[
					...
					aE: 'Select the equation to use for substitution'
				}
				]),
			a1: function (dict) {
			...
			a2: 'Substitute a variable for a formula'
		};
	});
										...
										return function (showHistory) {
											return function (historyBox) {
												return function (actionView) {
													return {aw: actionView, E: createMode, g: display, Q: evaluator, ay: historyBox, aA: menu, ap: nextCreateInt, af: notification, bg: rules, X: showHelp, aC: showHistory, O: showMenu, aF: tutorial};
												};
											};
										};
									};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {z: nodes, au: root, Z: undone, B: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {ae: children, aj: component, aB: parent};
	});
					...
					return A7(
						...
						F6(
							function (s, n, a, c, i, children) {
								return $author$project$Algo$Math$BinaryNode(
									{m: a, ae: children, i: c, n: i, a: n, c: s});
							}),
						sDec,
						A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aI: copyState, aL: newState, o: id, aB: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aU: create, e: eq, R: hidden, aq: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F2(
	function (properties, javascript) {
		return {ab: javascript, W: properties};
	});
			...
			function (_v0) {
				...
				if ((!c) && (!a)) {
					...
					if (i.$ === 1) {
						...
						return $elm$json$Json$Decode$succeed(
							$author$project$Algo$Math$BinaryNode(
								{m: a, ae: _List_Nil, i: c, n: iden, a: '', c: 0}));
					}
				}
			},
			A4(
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {D: constants, F: functions, a: name, bg: rules};
	});
var $author$project$Components$Rules$Rule = F4(
	function (title, description, parameters, matches) {
		return {ak: description, aW: matches, be: parameters, a2: title};
	});
									...
									function (to) {
										...
										return {
											a6: _Utils_update(
												from,
												{
													au: A2($author$project$Components$Rules$setOthers_, otherSet, from.au)
												}),
											bm: to
										};
									},
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {C: bottom, x: left, A: right, I: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {q: coordinates, al: drags, cm: id};
	});
	...
	if (!_v0.b) {
		...
		if (!_v0.b.b) {
			...
			return _Utils_update(
				model,
				{
					Z: A2($elm$core$List$cons, x, model.Z),
					B: others
				});
		}
	}
		...
		if (_v0.$ === 3) {
			...
			if (!n.m) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.ae));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
...
var $author$project$Algo$History$update = F2(
	function (e, model) {
		...
		return _Utils_update(
			...
			{
				Z: _List_Nil,
				B: A2($elm$core$List$cons, n, model.B)
			});
	});
var $author$project$Components$Display$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var eq = event.a;
				return A2($elm$core$Set$member, eq, model.R) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							R: A2($elm$core$Set$remove, eq, model.R)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							R: A2($elm$core$Set$insert, eq, model.R)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var eq = event.a;
		...
		switch (e.$) {
					...
					_Utils_update(
						model,
						{
							al: A3(
								...
								{bt: d, a6: p, bL: model.q},
								model.al)
						}),
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$SetCapture, model.cm, pid)));
			case 1:
				var pid = e.a;
				var to = e.b;
				var _v2 = A2(
				...
				if (_v2.$ === 1) {
					...
					var start = _v2.a;
					var orig = start.bL;
					var _v3 = A2($author$project$UI$Draggable$diff, start.a6, to);
					var diffX = _v3.a;
					var diffY = _v3.b;
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: {C: orig.C + dy, x: orig.x + dx, A: orig.A + dx, I: orig.I + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												x: A2($elm$core$Basics$min, orig.A - 2, orig.x + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 1:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												A: A2($elm$core$Basics$max, orig.x + 2, orig.A + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 3:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												C: A2($elm$core$Basics$max, orig.I + 2, orig.C + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 4:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											...
											{
												x: A2($elm$core$Basics$min, orig.A - 2, orig.x + dx),
												I: A2($elm$core$Basics$min, orig.C - 2, orig.I + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 5:
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$ReleaseCapture, model.cm, pid)));
			default:
				return _Utils_Tuple2(model, $elm$core$Maybe$Nothing);
		}
	});
var $author$project$UI$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.Y) ? _Utils_update(
			model,
			{
				Y: A2($elm$core$Set$remove, entry, model.Y)
			}) : _Utils_update(
			model,
			{
				Y: A2($elm$core$Set$insert, entry, model.Y)
			});
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aF);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 7:
				...
				if (e.$ === 1) {
					var de = e.a;
					var _v5 = A3($author$project$UI$Draggable$update, core.a_, de, model.ay);
					var newBox = _v5.a;
					var action = _v5.b;
					return _Utils_Tuple2(
						updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								aw: A2($author$project$UI$ActionView$update, e, model.aw)
							})),
					$elm$core$Platform$Cmd$none);
			case 9:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
			case 10:
				var input = event.a;
				var _v7 = _Utils_Tuple3(input.br, input.b2, input.a9);
				_v7$3:
				while (true) {
					switch (_v7.c) {
						case 'Escape':
							var _v8 = _Utils_Tuple2(core.t, model.E);
							if (!_v8.a.$) {
								return _Utils_Tuple2(
									_Utils_update(
										core,
			...
			case 13:
				...
				if (_v14.$ === 1) {
					...
					var m = _v14.a;
					return (!_Utils_eq(m.bu, num)) ? _Utils_Tuple2(core, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{E: $elm$core$Maybe$Nothing, X: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v15 = A4(
						$author$project$Algo$Matcher$parseEquation,
						$author$project$Components$Rules$functionProperties(model.bg),
						$author$project$Components$Display$createState,
						$author$project$Components$Display$updateState,
						str);
					if (!_v15.$) {
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{E: $elm$core$Maybe$Nothing, g: dModel, X: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
			...
			case 20:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v18 = A2($author$project$Components$Rules$addTopic, topic, model.bg);
					if (_v18.$ === 1) {
						var errStr = _v18.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bg: A2($author$project$Components$Rules$addSources, source.v, model.bg)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.bg);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.aW) === 1) && $elm$core$Dict$isEmpty(p.be)) {
							var _v24 = A2($author$project$Helper$listIndex, 0, p.aW);
							if (_v24.$ === 1) {
							...
							_Utils_update(
								core,
								{
									...
									H: _Utils_update(
										model,
										{
											bg: A2($author$project$Components$Rules$deleteTopic, topicName, model.bg)
										})
								}),
							$elm$core$Platform$Cmd$none);
				}
						...
						A2(
														...
														return A2(
															...
															function (tree) {
																return _Utils_update(
																	r,
																	{
																		a6: A3($author$project$Algo$Matcher$addMatch, k, tree, r.a6)
																	});
															},
															A4(
																$author$project$Algo$Matcher$toReplacement,
							...
							A2(
								...
								function () {
									...
									if ((!_v30.$) && (_v30.a.$ === 1)) {
										var n = _v30.a.a;
										return A2($author$project$Helper$listIndex, n, existing.aW);
									} else {
										return A2($author$project$Helper$listIndex, 0, existing.aW);
									}
								}())));
				} else {
					return _Utils_Tuple2(
			...
			case 29:
				...
				if (_v35.$ === 1) {
					...
					var _v36 = A2($author$project$Components$Rules$evaluateStr, model.bg, replacement);
					if (_v36.$ === 1) {
						var errStr = _v36.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.cm, model.Q);
				var eModel = _v38.a;
				var c = _v38.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var eqNum = _v42.a;
						var id = _v42.b;
						var _v43 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.w, model.g);
						if (_v43.$ === 1) {
							var errStr = _v43.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
			...
			az: _List_fromArray(
				[
					...
					[
						...
						{
							ck: $author$project$Main$FileSelect(0),
							aO: 'Select a file'
						})
					])
				]),
...
var $author$project$Main$inputDiv = function (model) {
	return _Utils_Tuple2(
		'textbar' + $elm$core$String$fromInt(model.bu),
		A2(
			$elm$html$Html$form,
			A2(
				$author$project$Helper$maybeAppend,
				...
				return $author$project$UI$Menu$Content(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$core$Set$member, num, model.R) ? $author$project$UI$Icon$hidden(_List_Nil) : $author$project$UI$Icon$shown(_List_Nil),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Algo$Math$toString(
												$author$project$Algo$History$current(eq).au))
										]))
								]))
						]));
			},
									...
									return A2(
										...
										A2(
											...
											function (rule) {
												return A2(
													$author$project$UI$Menu$Section,
													{_: $elm$core$Maybe$Nothing, a: rule.a2},
													_List_fromArray(
														[
															$author$project$UI$Menu$Content(
				...
				A3(
					...
					F3(
						function (eqNum, hisEq, result) {
							if (A2($elm$core$Set$member, eqNum, model.R)) {
								return result;
							} else {
								var highlight = A2(
									$elm$core$Maybe$withDefault,
										...
										A2(
											...
											_List_fromArray(
												[
													...
													eqNum,
													highlight,
													$author$project$Algo$Math$symbolicate(eq.au)),
													A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.au)
												]))),
									result);
							}
						}),
...
var $author$project$UI$ActionView$coreToList_ = function (state) {
	return _List_fromArray(
		[
			_Utils_Tuple2('Evaluate', state.bw),
			_Utils_Tuple2('Number Substitution', state.bb),
			_Utils_Tuple2('Substitution', state.bl),
			_Utils_Tuple2('Group', state.a7),
			_Utils_Tuple2('Ungroup', state.bn)
		]);
};
...
var $author$project$UI$ActionView$CoreTopicState = F5(
	function (substitute, group, ungroup, numSubstitute, evaluate) {
		return {bw: evaluate, a7: group, bb: numSubstitute, bl: substitute, bn: ungroup};
	});
			...
			var evaluateState = function () {
				...
				if (_v3.$ === 1) {
					...
					return $author$project$UI$ActionView$Allowed(
						A3($author$project$Components$Rules$Evaluate, selected.am, selected.au, str));
				}
			}();
			var result = A5(
				$author$project$UI$ActionView$CoreTopicState,
				$author$project$UI$ActionView$Allowed(
					A2($author$project$Components$Rules$Substitute, selected.am, selected.l)),
				...
				case 3:
					...
					if (!n.m) {
						...
						var ungroupRes = sameBinaryNode ? _Utils_update(
							result,
							{
								bn: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Ungroup, selected.am, selected.au, selected.z))
							}) : result;
						return (_Utils_eq(
							$elm$core$List$length(n.ae),
							...
							ungroupRes,
							{
								a7: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Group, selected.am, selected.au, selected.z))
							});
					}
				case 0:
					var n = _v1.a;
					return _Utils_update(
						result,
						{
							bb: $author$project$UI$ActionView$Allowed(
								A3($author$project$Components$Rules$NumericalSubstitution, selected.am, selected.au, n.w)),
							bl: $author$project$UI$ActionView$Disallowed
						});
				default:
					return result;
			}
				...
				if (selected.$ === 1) {
					...
					var matches = A2(
						...
						function (m) {
							return A2(
								$elm$core$Maybe$map,
								function (result) {
									return {a6: result, bW: m.bm};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.z, m.a6.au, n.aQ));
						},
						rule.aW);
					return $elm$core$List$isEmpty(matches) ? $author$project$UI$ActionView$Disallowed : $author$project$UI$ActionView$Allowed(
						$author$project$Components$Rules$Apply(
							{aW: matches, be: rule.be, a2: rule.a2}));
				}
			}());
	});
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var tree = _v1.c;
					return {am: eqNum, z: nodes, au: root, l: ids, aQ: tree};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.cm)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.cm),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.cm))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.ck),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					'left',
					$elm$core$String$fromFloat(model.q.x) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(model.q.I) + 'dvh'),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.q.A - model.q.x) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.q.C - model.q.I) + 'dvh'),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					A2($elm$html$Html$Attributes$style, 'padding', '1rem 0.2rem 0.2rem 0.2rem'),
					$elm$html$Html$Attributes$id(model.cm)
				]),
...
var $author$project$Algo$History$serialize_ = F5(
	function (converter, selectedID, nodes, index, n) {
		return A4(
			converter,
			...
			A2(
				...
				function (c) {
					return A2(
						$elm$core$Maybe$map,
						A4($author$project$Algo$History$serialize_, converter, selectedID, nodes, c.aa),
						A2($elm$core$Dict$get, c.aa, nodes));
				},
				n.ae));
	});
												...
												A2(
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Algo$Math$toString(c.au))
															])),
													children));
										})),
...
var $author$project$UI$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var title = part.a;
			var children = part.b;
			var shown = A2($elm$core$Set$member, title.a, model.Y);
			return A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(notification.bu)
								]))
						]))));
	});
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.ay, model.g))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'actions',
								A5($author$project$UI$ActionView$view, $author$project$Main$RuleEvent, $author$project$Main$ActionEvent, model.bg, model.g, model.aw))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
											...
											A2(
												...
												_List_fromArray(
													[
														...
														A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.E)
													]))),
											A2(
											$elm$html$Html$div,
											A2(
												...
												model.O ? _List_Nil : _List_fromArray(
													[
														$elm$html$Html$Attributes$class('closed')
													])),
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															...
															A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aF),
															A2(
															$author$project$UI$Menu$Section,
															{
																_: $elm$core$Maybe$Just(
															...
															A2($author$project$Components$Rules$menuTopics, $author$project$Main$RuleEvent, model.bg))
														])),
													$author$project$UI$Icon$menu(
													A2(
														$elm$core$List$filterMap,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{co: $author$project$Main$init, cr: $author$project$Main$EventUrlChange, cs: $author$project$Main$EventUrlRequest, cB: $author$project$Main$subscriptions, cD: $author$project$Main$update, cE: $author$project$Main$view});
