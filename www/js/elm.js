		...
		return _Utils_Tuple2(
			{
				...
				y: {
					...
					az: $author$project$UI$Menu$init(
					...
					au: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						...
						if (_v30.$ === 1) {
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.aA, m.a)) ? function (_v31) {
	...
	return {
		...
		aN: _List_fromArray(
			[
				...
				at: 'The expression to replace ' + $elm$core$String$fromFloat(target)
			}
			]),
		aO: function (dict) {
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.au)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model._)),
						_Utils_Tuple2(
						'menu',
						$author$project$UI$Menu$encode(model.az)),
						_Utils_Tuple2(
						'evaluator',
						A2(
	...
	return {
		...
		aN: _List_fromArray(
			[
				...
				at: 'Select the equation to use for substitution'
			}
			]),
		aO: function (dict) {
								...
								return function (showHelp) {
									return function (showMenu) {
										return function (showHistory) {
											return {F: createMode, k: display, L: evaluator, az: menu, _: notification, aB: resetInput, bb: rules, T: showHelp, aC: showHistory, aD: showMenu, au: tutorial};
										};
									};
								};
							};
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {af: children, aw: component, aM: parent};
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.au);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								az: A2($author$project$UI$Menu$update, e, model.az)
							})),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, k: dModel, aB: true, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					case 3:
						...
						if (!n.w) {
							return _Utils_update(
								applies,
								{
									as: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.as),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
		...
		bZ: A2(
			...
			_List_fromArray(
				[
								...
								[
									...
									_List_fromArray(
										[
											...
											A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.au),
											A3(
											$author$project$UI$Menu$Section,
											'Topics',
											true,
					...
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.au),
					A3(
