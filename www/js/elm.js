...
{
	if (region.br.aP === region.by.aP)
	{
		return 'on line ' + region.br.aP;
	}
	return 'on lines ' + region.br.aP + ' through ' + region.by.aP;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { S: 'hidden', cb: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { S: 'mozHidden', cb: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { S: 'msHidden', cb: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { S: 'webkitHidden', cb: 'webkitvisibilitychange' }
		: { S: 'hidden', cb: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.co, request.b3, true);
		} catch (e) {
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{s: nodeList, o: (len / $elm$core$Array$branchFactor) | 0, p: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bC: fragment, bF: host, bM: path, bO: port_, bR: protocol, bS: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {cf: false, bx: element, ba: trigger};
	});
...
var $author$project$Components$Tutorial$init = {bJ: 0, bZ: 0};
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			m: {y: top + height, u: left, A: left + width, v: top},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b8: false, ca: r.ca, bz: r.bz, bD: r.bD, co: r.co, cA: r.cA, h: r.h, b3: r.b3}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ca: $elm$http$Http$emptyBody, bz: r.bz, bD: _List_Nil, co: 'GET', cA: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, b3: r.b3});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.cd));
			}(
				function () {
					var _v0 = deadEnd.cs;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cd: col, ce: contextStack, cs: problem, bX: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bX, s.cd, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cd: col, g: s0.g, j: s0.j, d: offset, bX: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.bX, s.cd, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.bX, s.cd, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cd: newCol, g: s.g, j: s.j, d: newOffset, bX: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cd: col, g: context, j: indent, d: offset, bX: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.br, s.d, s.c);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.bg, s.d + 1, s.bX + 1, 1, s.c, s.j, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.bg, firstOffset, s.bX, s.cd + 1, s.c, s.j, s.g);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bA: $elm$parser$Parser$ExpectingVariable, bg: i.bg, bm: i.bm, br: i.br});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		br: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{bg: $elm$core$Char$isDigit, bm: $elm$core$Set$empty, br: $elm$core$Char$isDigit});
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{B: true, ak: children, t: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cd: col, cs: problem, bX: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bX, p.cd, p.cs);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cd: 1, g: _List_Nil, j: 1, d: 0, bX: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.a4(tracker.I);
					} else {
						var prev = previous.a;
						return A2(tracker.a$, prev, tracker.I);
					}
				}()),
			_Utils_update(
				tracker,
				{
					I: tracker.I + 1,
					aS: A3($elm$core$Dict$insert, tracker.I, parent, tracker.aS)
				}));
	});
...
var $author$project$Algo$Matcher$processID_ = F3(
	function (parent, tracker, oldRoot) {
		...
		switch (oldRoot.$) {
			...
			case 3:
				var s = oldRoot.a;
				var _v3 = A2(processChildren, newTracker, s.ak);
				var newChildren = _v3.a;
				var finalT = _v3.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{B: s.B, ak: newChildren, t: s.t, a: s.a, b: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
				var _v4 = A2(processChildren, newTracker, s.ak);
				var newChildren = _v4.a;
				var finalT = _v4.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$GenericNode(
						{ak: newChildren, a: s.a, b: state}),
					finalT);
			default:
				var s = oldRoot.a;
				var _v5 = A2(processChildren, newTracker, s.ak);
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{a$: copyState, a4: newState, I: 0, aS: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
						...
						h: _Utils_update(
							tracker,
							{
								aS: A2($elm$core$Dict$remove, 0, tracker.aS)
							})
					};
				}),
...
var $author$project$Components$Display$updateState = F2(
	function (s, _v0) {
		return {
			aw: $author$project$Algo$Matcher$getID(s)
		};
	});
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{bd: url, f: _List_Nil, bh: key, a8: _List_Nil},
			A2(
				...
				a7: A2(
					...
					$elm$core$Result$toMaybe(
						A2(
							...
							flags))),
				J: {
					C: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
					...
					aq: newScreen ? 1 : 0,
					ae: nModel,
					bn: $author$project$Components$Rules$init,
					Y: false,
					aJ: false,
					ab: false,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.a8)
					])));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'pId',
					$elm$core$Basics$identity($.bl)),
					_Utils_Tuple2(
					'set',
					$elm$json$Json$Encode$bool($.bp))
				]));
	});
	...
	if (action.$ === 1) {
		...
		if (!action.a.$) {
			...
			return $author$project$Main$capture(
				{be: eId, bl: pId, bp: true});
		} else {
			var _v2 = action.a;
			var eId = _v2.a;
			var pId = _v2.b;
			return $author$project$Main$capture(
				{be: eId, bl: pId, bp: false});
		}
	}
};
			...
			switch (node.$) {
				...
				case 3:
					...
					return $author$project$Algo$Math$BinaryNode(
						{
							B: s.B,
							ak: A2($elm$core$List$map, convert, s.ak),
							t: s.t,
							a: s.a,
							b: {
								E: $elm$core$Maybe$Nothing,
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								...
								D: functions,
								w: function () {
									var _v5 = A2($elm$core$Dict$get, topic.a, model.w);
									if (_v5.$ === 1) {
										return A3(
											$elm$core$Dict$insert,
											topic.a,
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.e, props.e) && (_Utils_eq(p.B, props.B) && _Utils_eq(p.t, props.t))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		...
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable.ae, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						function (elem) {
							return !_Utils_eq(elem.ad, child.ad);
						},
						n.ak))));
	});
var $author$project$Algo$History$updateNodeValues_ = F3(
	function (index, child, model) {
		...
		while (true) {
			if (!index) {
				var _v0 = A2($author$project$Algo$History$updateNode_, child, model.ay);
				var newNode = _v0.c;
				return _Utils_update(
					model,
					{ay: newNode});
				...
				if (_v1.$ === 1) {
					...
					var newNode = _v2.c;
					var $temp$index = n.aS,
						$temp$child = {G: height, ad: index, K: width},
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aS: A2($elm$core$Dict$remove, id, tracker.aS)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aS: A3($elm$core$Dict$insert, id, p, tracker.aS)
				});
		}
	});
var $author$project$Algo$Matcher$constructFromSource_ = F4(
	function (result, tracker, p, matcher) {
		...
		switch (matcher.$) {
			case 0:
				var m = matcher.a;
				var _v16 = A2($elm$core$Dict$get, m.a, result.k);
				if (!_v16.$) {
					if (!_v16.a.$) {
							...
							return function (_v21) {
								...
								return _Utils_Tuple2(
									$author$project$Algo$Math$BinaryNode(
										{
											B: true,
											ak: _Utils_ap(preNodes, postNodes),
											t: true,
											a: nodes.aI,
											b: s
										}),
											...
											result,
											{
												k: A3(
													...
													$author$project$Algo$Matcher$MultiValue_(
														_Utils_update(
															nodes,
															{au: newPost, av: newPre})),
													result.k)
											})));
							}(
								A4($author$project$Algo$Matcher$processMultiValue_, id, result.U, newT, nodes.au));
						}(
							A4($author$project$Algo$Matcher$processMultiValue_, id, result.U, t, nodes.av));
					}
				} else {
					return _Utils_Tuple2(
						$author$project$Algo$Math$VariableNode(
			...
			default:
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						return _Utils_Tuple2(
							$author$project$Algo$Math$BinaryNode(
								{B: true, ak: c, t: true, a: m.a, b: s}),
							_Utils_Tuple2(nextT, nextRes));
					} else {
						var o = _v29.a;
						var _v30 = A2($elm$core$Dict$get, o, result.k);
						if (_v30.$ === 1) {
							return _Utils_Tuple2(
								$author$project$Algo$Math$BinaryNode(
									{B: true, ak: c, t: true, a: m.a, b: s}),
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.aI, m.a)) ? function (_v31) {
									...
									return function (_v34) {
										...
										A4($author$project$Algo$Matcher$processMultiValue_, id, result.U, newT, mv.au));
								}(
									A4($author$project$Algo$Matcher$processMultiValue_, id, result.U, nextT, mv.av));
							} else {
	...
	function (parent, result, args, existing, tracker) {
		...
		switch (existing.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{B: s.B, ak: newChildren, t: s.t, a: s.a, b: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
					...
					if (_v1.$ === 1) {
						return function (_v2) {
							...
							A5(
								...
								parent,
								{k: $elm$core$Dict$empty, U: $elm$core$Dict$empty},
								_List_Nil,
								child.O,
								t));
					} else {
				...
				if (!children.b) {
					...
					if (_v1.$ === 1) {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								a,
								A2($elm$core$List$cons, newEq.ay, others),
								newEq.h));
					}
				}
			});
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.ay));
		if (!path.b) {
			return $elm$core$Result$Err('blah');
		} else {
			if (!path.b.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												ay: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{Q: newEq.ay}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											ay: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{ak: children})),
											h: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											ay: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{ak: children})),
											h: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											ay: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{ak: children})),
											h: t
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.h.aS);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.h.aS, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							$author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(subEq.ay)),
							subEq.h.aS);
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.ak));
	}
};
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.ay);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.J;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bi, params.ac, swappable.i);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.cf ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{cf: true}),
		element.ba(0));
...
var $author$project$Components$Rules$toJavascriptString_ = F3(
	function (model, name, children) {
		var _v0 = A2($elm$core$Dict$get, name, model.D);
		if (_v0.$ === 1) {
...
var $author$project$Components$Evaluate$finish = F2(
	function (id, model) {
		var _v0 = A2($elm$core$Dict$get, id, model.af);
		if (_v0.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						af: A2($elm$core$Dict$remove, id, model.af)
					}),
																	...
																	A2(
																		...
																		$author$project$Algo$Math$BinaryNode(
																			_Utils_update(
																				n,
																				{
																					ak: $elm$core$List$reverse(group),
																					b: newS
																				})),
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aN: $author$project$Main$CloseDialog,
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
		...
		aT: function (sections) {
			return ($elm$core$List$length(params.k) <= 1) ? sections : A2(
				$elm$core$List$cons,
				{
					ao: _List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					ao: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.bc) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aW: param.a + '= '}),
									$author$project$UI$Dialog$Text(
		...
		aU: $author$project$Main$ApplyParameters,
					...
					function (children) {
						...
						if (_v1.$ === 1) {
							...
							if ((f.e === 2) && (f.B || f.t)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{B: f.B, ak: children, t: f.t, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
									$elm$core$List$length(s.ak),
									f.e)) {
			...
			return A2(
				...
				A3(
					...
					function (subEq) {
						...
						if (!_v2.$) {
							var n = _v2.a;
							return (!_Utils_eq(target, n.x)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								var parent = A2($elm$core$Dict$get, id, tracker.aS);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aS)),
					_Utils_Tuple2(
					'component',
					convert(node.aD)),
					_Utils_Tuple2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.ay)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.ai))
				]));
	});
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.h.I)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.h.aS))
							])))
				]));
	});
								...
								return $elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'prevID',
											$elm$json$Json$Encode$int(s.aw))
										]));
							})),
					model.f)),
				_Utils_Tuple2(
				'nextEquationNum',
				$elm$json$Json$Encode$int(model.ar)),
				_Utils_Tuple2(
				'hidden',
				A2(
					$elm$json$Json$Encode$list,
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model.af))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'associative',
				$elm$json$Json$Encode$bool(prop.B)),
				_Utils_Tuple2(
				'commutative',
				$elm$json$Json$Encode$bool(prop.t)),
				_Utils_Tuple2(
				'javascript',
				function () {
					var _v0 = prop.an;
				...
				$elm$json$Json$Encode$object(
					A2(
						...
						function (param) {
							return _Utils_Tuple2(
								param.aQ.a,
								$elm$json$Json$Encode$string(param._));
						},
						rule.as))),
				_Utils_Tuple2(
				'matches',
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'from',
									$elm$json$Json$Encode$string(match.ac.a)),
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aY.a))
								]));
					},
					rule.k))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.D)),
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.bn))
			]));
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.cf))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.m.u)),
				_Utils_Tuple2(
				'right',
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bn)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aB)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.ae)),
						_Utils_Tuple2(
						'menu',
						...
						_Utils_Tuple2(
						'historyBox',
						$author$project$UI$Draggable$encode(model.aG))
					]))));
};
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {cc: count, ch: eq, U: nodes, ay: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					ap: model.ap + 1,
					af: A3($elm$core$Dict$insert, model.ap, c, model.af)
				}),
			model.bo(
				{ck: model.ap, cy: str}));
	});
						...
						[
							$author$project$UI$Dialog$Radio(
							{
								...
								bL: A2(
									...
									$author$project$Components$Display$listUnselectedEquations(model.i))
							})
						])
					]),
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {C: createMode, i: display, R: evaluator, aG: historyBox, aH: menu, aq: nextCreateInt, ae: notification, bn: rules, Y: showHelp, aJ: showHistory, ab: showMenu, aB: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {U: nodes, ay: root, ai: undone, P: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {ak: children, aD: component, aS: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {a$: copyState, a4: newState, I: id, aS: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {a0: create, f: eq, S: hidden, ar: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, B: associative, t: commutative, an: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.B || f.t) && (f.e !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.B && (!f.t)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {F: constants, D: functions, a: name, bn: rules};
	});
...
var $author$project$Components$Rules$Rule_ = F4(
	function (title, description, parameters, matches) {
		return {_: description, k: matches, as: parameters, ah: title};
	});
					...
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{e: children, a: s.a, aR: $elm$core$Maybe$Nothing}),
							tokens);
					},
					processChildren(s.ak)) : A2(
					$elm$core$Result$map,
					function (_v3) {
						var children = _v3.a;
						var tokens = _v3.b;
						...
						function (nSet) {
							return {
								ac: _Utils_update(
									from,
									{
										ay: A2($author$project$Components$Rules$setOthers_, nSet, from.ay)
									}),
								aY: _Utils_update(
									to,
									{
										ay: A2($author$project$Components$Rules$setOthers_, nSet, to.ay)
									})
							};
						},
						A3(
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {y: bottom, u: left, A: right, v: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {m: coordinates, al: drags, ck: id};
	});
		...
		if (_v0.$ === 3) {
			...
			if (!n.B) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.ak));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
...
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.h;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.aS);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
		...
		switch (e.$) {
			...
			case 1:
				...
				if (_v2.$ === 1) {
					...
					var start = _v2.a;
					var orig = start.V;
					var _v3 = A2($author$project$UI$Draggable$diff, start.ac, to);
					var diffX = _v3.a;
					var diffY = _v3.b;
					...
					if (_v5.$ === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									m: {y: orig.y + dy, u: orig.u + dx, A: orig.A + dx, v: orig.v + dy}
								}),
							$elm$core$Maybe$Nothing);
					} else {
						switch (_v5.a) {
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													u: A2($elm$core$Basics$min, orig.A - 2, orig.u + dx)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 1:
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													A: A2($elm$core$Basics$max, orig.u + 2, orig.A + dx)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 2:
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													v: A2($elm$core$Basics$min, orig.y - 2, orig.v + dy)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 3:
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													y: A2($elm$core$Basics$max, orig.v + 2, orig.y + dy)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 4:
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model.ae);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 7:
				...
				if (e.$ === 1) {
					var de = e.a;
					var _v5 = A3($author$project$UI$Draggable$update, core.a7, de, model.aG);
					var newBox = _v5.a;
					var action = _v5.b;
					return _Utils_Tuple2(
						updateCore(
			...
			case 9:
				...
				if (str !== 'Escape') {
					...
					var _v7 = _Utils_Tuple2(core.q, model.C);
					if (!_v7.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
						...
						_Utils_update(
							model,
							{
								C: $elm$core$Maybe$Just(
									A2(
										$author$project$UI$Animation$newDeletable,
										$author$project$Main$uiCancelCmd_(model.aq),
										model.aq)),
								aq: model.aq + 1
							})),
			...
			case 12:
				...
				if (_v11.$ === 1) {
					...
					var m = _v11.a;
					return (!_Utils_eq(m.bx, num)) ? _Utils_Tuple2(core, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{C: $elm$core$Maybe$Nothing, Y: false})),
						$elm$core$Platform$Cmd$none);
				} else {
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{C: $elm$core$Maybe$Nothing, i: dModel, Y: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					_Utils_update(
						core,
						{
							...
							J: _Utils_update(
								model,
								{
									bn: A2($author$project$Components$Rules$deleteTopic, name, model.bn)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 20:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v15 = A2($author$project$Components$Rules$addTopic, topic, model.bn);
					if (_v15.$ === 1) {
						var errStr = _v15.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bn: A2($author$project$Components$Rules$addSources, source.w, model.bn)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.bn);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.k) === 1) && $elm$core$List$isEmpty(p.as)) {
							var _v21 = A2($author$project$Helper$listIndex, 0, p.k);
							if (_v21.$ === 1) {
					...
					case 1:
						var _v22 = $author$project$Components$Display$groupChildren(model.i);
						if (_v22.$ === 1) {
							var errStr = _v22.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v23 = $author$project$Components$Display$ungroupChildren(model.i);
						if (_v23.$ === 1) {
							var errStr = _v23.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v24 = $author$project$Components$Display$selectedNode(model.i);
						if (_v24.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v24.a;
							var id = $author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(n.ay));
							var _v25 = A2($author$project$Components$Rules$evaluateStr, model.bn, n.ay);
							if (_v25.$ === 1) {
								var errStr = _v25.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
								...
								var _v26 = A3(
									...
									A2($author$project$Main$EvalType_, n.ch, id),
									evalStr,
									model.R);
								var eModel = _v26.a;
								var cmd = _v26.b;
					...
					return function (result) {
						...
						A2(
														...
														return A2(
															...
															function (tree) {
																return _Utils_update(
																	r,
																	{
																		ac: A4($author$project$Algo$Matcher$addMatch, k, $elm$core$Dict$empty, tree, r.ac)
																	});
															},
																...
																return A2(
																	...
																	function (tree) {
																		return _Utils_update(
																			r,
																			{
																				ac: A4($author$project$Algo$Matcher$addMatch, k, argDict, tree, r.ac)
																			});
																	},
																	$author$project$Algo$Math$parse(val));
															},
							...
							A2(
								...
								function () {
									var _v29 = A2($elm$core$Dict$get, '_method', params);
									if ((!_v29.$) && (_v29.a.$ === 1)) {
										var n = _v29.a.a;
										return A2($author$project$Helper$listIndex, n, existing.k);
									} else {
										return A2($author$project$Helper$listIndex, 0, existing.k);
									}
								}())));
				} else {
					return _Utils_Tuple2(
			...
			case 29:
				...
				var _v33 = A2(
					$elm$core$Result$andThen,
					$author$project$Components$Rules$replaceGlobalVar(model.bn),
					$author$project$Algo$Math$parse(str));
				if (_v33.$ === 1) {
					var errStr = _v33.a;
					return A2($author$project$Main$submitNotification_, core, errStr);
					...
					var newTree = _v33.a;
					var _v34 = A2($author$project$Components$Rules$evaluateStr, model.bn, newTree);
					if (_v34.$ === 1) {
						var errStr = _v34.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v36 = A2($author$project$Components$Evaluate$finish, reply.ck, model.R);
				var eModel = _v36.a;
				var c = _v36.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.x)) {
							...
							var _v39 = A3($author$project$Components$Display$replaceNumber, target, tree, model.i);
							if (_v39.$ === 1) {
								var errStr = _v39.a;
						...
						var eqNum = _v40.a;
						var id = _v40.b;
						var _v41 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.x, model.i);
						if (_v41.$ === 1) {
							var errStr = _v41.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
...
var $author$project$Main$inputDiv = function (model) {
	return _Utils_Tuple2(
		'textbar' + $elm$core$String$fromInt(model.bx),
		A2(
			$elm$html$Html$form,
			A2(
				$author$project$Helper$maybeAppend,
							...
							_List_fromArray(
								[
									...
									$author$project$Algo$Math$toString(
										$author$project$Algo$History$current(eq).ay))
								]))
						]));
			},
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		...
		var apply = function () {
			var applies = {
				bf: false,
				aO: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{bf: true, aO: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.ay;
				switch (_v1.$) {
					case 3:
						...
						if (!n.B) {
							return _Utils_update(
								applies,
								{
									az: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
							...
							return _Utils_update(
								...
								{
									a1: (_Utils_eq(
										$elm$core$List$length(n.ak),
										val.cc) || (val.cc < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									az: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									bb: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
						return _Utils_update(
							applies,
							{
								a5: $elm$core$Maybe$Just(
									$author$project$Components$Rules$NumericalSubstitution(n.x))
							});
					case 5:
						return _Utils_update(
							applies,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a5),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a1),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.bb),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
...
var $author$project$Algo$Matcher$getName = function (m) {
	switch (m.$) {
		...
		case 1:
			var s = m.a;
			return $elm$core$String$fromFloat(s.x);
		case 2:
			var s = m.a;
			return s.a;
		case 3:
...
var $author$project$Algo$Backtrack$getState = function (c) {
	return A2($elm$core$Maybe$map, $elm$core$Tuple$first, c.n);
};
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{a2: res, n: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				...
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.B, r.B) && (_Utils_eq(l.t, r.t) && (_Utils_eq(
							$elm$core$List$length(l.ak),
							$elm$core$List$length(r.ak)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
		...
		while (true) {
			switch (from.$) {
				case 1:
					...
					if (!root.$) {
						var n = root.a;
						return (!_Utils_eq(n.x, s.x)) ? $author$project$Algo$Backtrack$fail : A2($author$project$Algo$Backtrack$return, $elm$core$Maybe$Just, token);
					} else {
							...
							function (result) {
								return A2(
									...
									function (varDict) {
										...
										var _v3 = A2($elm$core$Dict$get, s.a, result.k);
										if (!_v3.$) {
											if (_v3.a.$ === 1) {
												return $elm$core$Maybe$Nothing;
											} else {
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									...
									$elm$core$List$length(n.ak)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aR;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.ak);
								return (!_Utils_eq(
									$elm$core$List$length(s.e),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.ak)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
	...
	function (selected, rule) {
		if (selected.$ === 1) {
			...
			if (!A2(
				$elm$core$List$any,
				function (m) {
					return A2($author$project$Algo$Matcher$matchNode, m.ac.ay, n.ay);
				},
				rule.k)) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {ac: result, bi: m.aY.ay, a: m.aY.a};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.U, m.ac.ay, n.ay)));
					},
					_List_Nil,
					rule.k);
					...
					$elm$core$Maybe$Just(
						{
							...
							as: A2(
								...
								function (p) {
									return {
										bc: $author$project$Algo$Matcher$countChildren(p.aQ.ay),
										_: p._,
										a: p.aQ.a,
										ay: $author$project$Algo$Matcher$getName(p.aQ.ay)
									};
								},
								rule.as),
							ah: rule.ah
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.ac.a + ('→' + match.aY.a))
												]));
									},
									rule.k),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.bn));
								}
							}());
					}),
				_List_fromArray(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												eqNum,
												highlight,
												$author$project$Algo$Math$symbolicate(eq.ay)),
												A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.ay)
											]))),
								result);
						}
					}),
	...
	$elm$core$List$map(
		function (input) {
			switch (input.$) {
				...
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aW);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
						...
						function (section) {
							return A2(
								...
								A2(
									...
									A2($elm$core$List$map, $author$project$UI$Dialog$listView_, section.ao)));
						},
						model.aT),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									$author$project$UI$HtmlEvent$onClick(model.aN)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
...
var $author$project$UI$HtmlEvent$onPointerDraw = F4(
	function (converter, activate, move, deactivate) {
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'left',
					$elm$core$String$fromFloat(model.m.u) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(model.m.v) + 'dvh'),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.m.A - model.m.u) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.m.y - model.m.v) + 'dvh'),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					$elm$html$Html$Attributes$id(model.ck)
				]),
			A4(
				$author$project$UI$HtmlEvent$onPointerDraw,
				converter,
				$author$project$UI$Draggable$DragStart($elm$core$Maybe$Nothing),
				$author$project$UI$Draggable$Drag,
				$author$project$UI$Draggable$DragEnd));
	});
					...
					[
						...
						_Utils_ap(
							...
							A4(
								$author$project$UI$HtmlEvent$onPointerDraw,
								converter,
								$author$project$UI$Draggable$DragStart(
		...
		return A3(
			...
			A2(
				...
				function (c) {
					return A2(
						$elm$core$Maybe$map,
						A3($author$project$Algo$History$serialize_, converter, nodes, c.ad),
						A2($elm$core$Dict$get, c.ad, nodes));
				},
				n.ak));
	});
var $author$project$Algo$History$serialize = F2(
	function (processNode, model) {
		return A4($author$project$Algo$History$serialize_, processNode, model.U, 0, model.ay);
	});
			...
			_List_fromArray(
				[
					...
					var _v0 = A2(
						...
						function (_v1) {
							var eq = _v1.a;
							return A2($elm$core$Dict$get, eq, model.f);
						},
						model.l);
					if (_v0.$ === 1) {
						return $elm$html$Html$text('No history selected');
					} else {
						var history = _v0.a;
						return A2(
											...
											[
												...
												converter(
													$author$project$UI$HistoryView$DisplayEvent(
														$author$project$Components$Display$HistoryEvent(index))))
											]),
										A2(
											$elm$core$List$cons,
											$elm$html$Html$text(
												$author$project$Algo$Math$toString(c.ay)),
											children));
								}),
							history);
					}
...
var $author$project$UI$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var display = part.b;
			var children = part.c;
			var shown = display && A2($elm$core$Set$member, name, model.Z);
			return A2(
				$elm$html$Html$li,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(notification.bx)
								]))
						]))));
	});
		...
		ca: A2(
			...
			_List_fromArray(
				[
								...
								A2(
									...
									_List_fromArray(
										[
											...
											_Utils_Tuple2(
												'history',
												A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.aG, model.i))),
											A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.C)
										]))),
								A2(
								$elm$html$Html$div,
								A2(
											...
											[
												...
												_Utils_ap(
													...
													A3(
														...
														model.bn,
														$author$project$Components$Display$selectedNode(model.i))))
											])),
					...
					$elm$core$Maybe$Just(
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.aB)),
					A2(
					$elm$core$Maybe$map,
