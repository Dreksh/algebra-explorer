...
{
	if (region.bm.aN === region.by.aN)
	{
		return 'on line ' + region.bm.aN;
	}
	return 'on lines ' + region.bm.aN + ' through ' + region.by.aN;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { S: 'hidden', cf: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { S: 'mozHidden', cf: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { S: 'msHidden', cf: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { S: 'webkitHidden', cf: 'webkitvisibilitychange' }
		: { S: 'hidden', cf: 'visibilitychange' };
}
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ci: false, bx: element, a7: trigger};
	});
...
var $author$project$Components$Tutorial$init = {bM: 0, b0: 0};
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			n: {A: top + height, v: left, y: left + width, D: top},
...
var $author$project$UI$Notification$init = {I: 0, O: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cc: false, ce: r.ce, bA: r.bA, bE: r.bE, cq: r.cq, cC: r.cC, k: r.k, b7: r.b7}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ce: $elm$http$Http$emptyBody, bA: r.bA, bE: _List_Nil, cq: 'GET', cC: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, b7: r.b7});
};
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.b_, s.cg, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cg: col, g: s0.g, i: s0.i, d: offset, b_: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.b_, s.cg, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.b_, s.cg, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cg: newCol, g: s.g, i: s.i, d: newOffset, b_: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cg: col, g: context, i: indent, d: offset, b_: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.bb, s.d + 1, s.b_ + 1, 1, s.c, s.i, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.bb, firstOffset, s.b_, s.cg + 1, s.c, s.i, s.g);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bB: $elm$parser$Parser$ExpectingVariable, bb: i.bb, bh: i.bh, bm: i.bm});
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cg: 1, g: _List_Nil, i: 1, d: 0, b_: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a8: url, e: _List_Nil, bc: key, a4: _List_Nil},
			A2(
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.f, props.f) && (_Utils_eq(p.z, props.z) && _Utils_eq(p.u, props.u))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
	...
	function (child, n) {
		return function (newChildren) {
			...
			A2(
				...
				F2(
					function (left, right) {
						return (!_Utils_eq(left.G, right.G)) ? ((_Utils_cmp(left.G, right.G) < 0) ? 0 : 2) : ((!_Utils_eq(left.L, right.L)) ? ((_Utils_cmp(left.L, right.L) < 0) ? 0 : 2) : 1);
					}),
				A2(
					$elm$core$List$cons,
					child,
		...
		while (true) {
			if (!index) {
				...
				if (_v1.$ === 1) {
					...
					var newNode = _v2.c;
					var $temp$index = n.aQ,
						$temp$child = {G: height, ac: index, L: width},
					...
					if (!_v16.a.$) {
						...
						if (_v17.b) {
							...
							if (!_v18.$) {
								...
								return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.f, existing.P, tracker);
							}
						} else {
							return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.f, existing.P, tracker);
						}
					...
					if (_v1.$ === 1) {
						return function (_v2) {
							...
							A5(
								...
								parent,
								{j: $elm$core$Dict$empty, U: $elm$core$Dict$empty},
								_List_Nil,
								child.P,
								t));
					} else {
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.J;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bK, params.aM, swappable.h);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$Components$Display$newSelectedNodes_ = F2(
	function (selected, eq) {
		var intersection = A2(
			$elm$core$Set$filter,
			function (n) {
				return A2($elm$core$Dict$member, n, eq.k.aQ);
			},
			selected);
		return $elm$core$Set$isEmpty(intersection) ? $elm$core$Set$singleton(
			$author$project$Algo$Matcher$getID(
				$author$project$Algo$Math$getState(eq.aw))) : intersection;
	});
var $author$project$Algo$History$redo = function (model) {
	...
	if (!_v0.b) {
		...
		return _Utils_update(
			...
			{
				ag: others,
				K: A2($elm$core$List$cons, x, model.K)
			});
	}
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.n.v)),
				_Utils_Tuple2(
				'right',
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {B: createMode, h: display, R: evaluator, aA: historyBox, aC: menu, ap: nextCreateInt, ad: notification, bi: rules, Y: showHelp, aE: showHistory, ab: showMenu, aI: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {U: nodes, aw: root, ag: undone, K: visits};
	});
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aZ: create, e: eq, S: hidden, aq: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {f: _arguments, z: associative, u: commutative, an: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.z || f.u) && (f.f !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.z && (!f.u)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
...
var $author$project$Components$Rules$Rule = F4(
	function (title, description, parameters, matches) {
		return {aj: description, j: matches, aP: parameters, aH: title};
	});
					...
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{f: children, a: s.a, aO: $elm$core$Maybe$Nothing}),
							tokens);
					},
...
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {n: coordinates, ak: drags, cm: id};
	});
	...
	if (!_v0.b) {
		...
		if (!_v0.b.b) {
			...
			return _Utils_update(
				model,
				{
					ag: A2($elm$core$List$cons, x, model.ag),
					K: others
				});
		}
	}
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										n: {A: orig.A + dy, v: orig.v + dx, y: orig.y + dx, D: orig.D + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 9:
				var input = event.a;
				var _v7 = _Utils_Tuple3(input.bu, input.b2, input.bc);
				_v7$3:
				while (true) {
					switch (_v7.c) {
						case 'Escape':
							var _v8 = _Utils_Tuple2(core.q, model.B);
							if (!_v8.a.$) {
								return _Utils_Tuple2(
									_Utils_update(
										core,
			...
			case 13:
				...
				if (str === '') {
					...
					var _v15 = A3($author$project$Algo$Matcher$parseEquation, $author$project$Components$Display$createState, $author$project$Components$Display$updateState, str);
					if (!_v15.$) {
						var root = _v15.a;
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{B: $elm$core$Maybe$Nothing, h: dModel, Y: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.j) === 1) && $elm$core$List$isEmpty(p.aP)) {
							var _v24 = A2($author$project$Helper$listIndex, 0, p.j);
							if (_v24.$ === 1) {
			...
			case 28:
				...
				if (_v34.$ === 1) {
					...
					var newTree = _v34.a;
					var _v35 = A2($author$project$Components$Rules$evaluateStr, model.bi, newTree);
					if (_v35.$ === 1) {
						var errStr = _v35.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v37 = A2($author$project$Components$Evaluate$finish, reply.cm, model.R);
				var eModel = _v37.a;
				var c = _v37.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.w)) {
							...
							var _v40 = A5($author$project$Components$Display$replaceNumber, eqNum, root, target, tree, model.h);
							if (_v40.$ === 1) {
								var errStr = _v40.a;
						...
						var eqNum = _v41.a;
						var id = _v41.b;
						var _v42 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.w, model.h);
						if (_v42.$ === 1) {
							var errStr = _v42.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
...
var $author$project$UI$ActionView$coreToList_ = function (state) {
	return _List_fromArray(
		[
			_Utils_Tuple2('Evaluate', state.bz),
...
var $author$project$UI$ActionView$CoreTopicState = F5(
	function (substitute, group, ungroup, numSubstitute, evaluate) {
		return {bz: evaluate, ba: group, be: numSubstitute, bn: substitute, bp: ungroup};
	});
									...
									$author$project$Algo$Matcher$SingleValue_(
										{
											r: _List_fromArray(
												[id]),
											P: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, node)
										}),
									result.j),
					...
					var toReplacements = $elm$core$List$map(
						function (_v5) {
							...
							return {
								...
								P: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, n)
							};
						});
					return $elm$core$Maybe$Just(
						_Utils_update(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{a_: res, m: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
									...
									function (varDict) {
										...
										if (!_v3.$) {
											if (_v3.a.$ === 1) {
												...
												return (!A2($author$project$Algo$Matcher$subtreeEqual_, newSubtree, existing.P)) ? $elm$core$Maybe$Nothing : ((!$elm$core$List$isEmpty(s.f)) ? $elm$core$Maybe$Just(result) : $elm$core$Maybe$Just(
													_Utils_update(
														result,
														{
															j: A3(
					...
					var matches = A2(
						...
						function (m) {
							return A2(
								$elm$core$Maybe$map,
								function (result) {
									return {aM: result, bK: m.bo.aw, a: m.bo.a};
								},
						...
						$author$project$Components$Rules$Apply(
							{
								...
								aP: A2(
									...
									function (p) {
										return {
											br: $author$project$Algo$Matcher$countChildren(p.bJ.aw),
											aj: p.aj,
											a: p.bJ.a,
											aw: $author$project$Algo$Matcher$getName(p.bJ.aw)
										};
									},
									rule.aP),
								aH: rule.aH
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					'left',
					$elm$core$String$fromFloat(model.n.v) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.n.y - model.n.v) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.aA, model.h))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'actions',
								A3($author$project$UI$ActionView$view, $author$project$Main$RuleEvent, model.bi, model.h))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
