...
{
	if (region.bh.aI === region.bs.aI)
	{
		return 'on line ' + region.bh.aI;
	}
	return 'on lines ' + region.bh.aI + ' through ' + region.bs.aI;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { R: 'hidden', cc: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { R: 'mozHidden', cc: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { R: 'msHidden', cc: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { R: 'webkitHidden', cc: 'webkitvisibilitychange' }
		: { R: 'hidden', cc: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cn, request.b4, true);
		} catch (e) {
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {cf: false, br: element, a0: trigger};
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {am: nextCallID, ad: ongoing, be: sender};
	});
	...
	y: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					{
						al: $author$project$Components$Rules$InfixOp('+'),
						k: {c: 2, j: true, g: true}
					},
					1)),
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
					{
						al: $author$project$Components$Rules$PrefixOp('-'),
						k: {c: 1, j: false, g: false}
					},
					1)),
				_Utils_Tuple2(
				'/',
				_Utils_Tuple2(
					{
						al: $author$project$Components$Rules$PrefixOp('1/'),
						k: {c: 1, j: false, g: false}
					},
					1))
			])),
...
var $author$project$Components$Tutorial$init = {bE: 0, bZ: 0};
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			q: {D: top + height, w: left, B: left + width, I: top},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b9: false, cb: r.cb, bu: r.bu, by: r.by, cn: r.cn, cz: r.cz, m: r.m, b4: r.b4}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cb: $elm$http$Http$emptyBody, bu: r.bu, by: _List_Nil, cn: 'GET', cz: $elm$core$Maybe$Nothing, m: $elm$core$Maybe$Nothing, b4: r.b4});
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cd: col, ce: contextStack, cr: problem, bX: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bX, s.cd, x, s.i));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cd: col, i: s0.i, l: s0.l, f: offset, bX: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.bX, s.cd, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.bX, s.cd, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cd: newCol, i: s.i, l: s.l, f: newOffset, bX: newRow, d: s.d});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cd: col, i: context, l: indent, f: offset, bX: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a5, s.f + 1, s.bX + 1, 1, s.d, s.l, s.i) : A7($elm$parser$Parser$Advanced$varHelp, i.a5, firstOffset, s.bX, s.cd + 1, s.d, s.l, s.i);
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{j: true, ab: children, g: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cd: col, cr: problem, bX: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bX, p.cd, p.cr);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cd: 1, i: _List_Nil, l: 1, f: 0, bX: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aJ(tracker.o);
					} else {
						var prev = previous.a;
						return A2(tracker.aG, prev, tracker.o);
					}
				}()),
			_Utils_update(
				tracker,
				{
					o: tracker.o + 1,
					az: A3($elm$core$Dict$insert, tracker.o, parent, tracker.az)
				}));
	});
				...
				return function (_v3) {
					...
					return _Utils_Tuple2(
						$author$project$Algo$Math$BinaryNode(
							{
								j: n.j,
								ab: $elm$core$List$reverse(finChildren),
								g: n.g,
								a: n.a,
								b: finS
							}),
	...
	function (newState, copyState) {
		return A2(
			...
			$author$project$Algo$Matcher$processID_(
				{aG: copyState, aJ: newState, o: 0, az: $elm$core$Dict$empty}),
			function (_v0) {
				var newRoot = _v0.a;
				var tracker = _v0.b;
				return {
					...
					m: _Utils_update(
						tracker,
						{
							az: A2($elm$core$Dict$remove, 0, tracker.az)
						})
				};
			});
	});
		...
		switch (root.$) {
			case 2:
				...
				return A2(
					...
					A2($author$project$Components$Rules$replaceGlobalVar, model, s.P));
			case 3:
				var s = root.a;
				return A2(
					$elm$core$Result$map,
				...
				return A2(
					...
					function (children) {
						...
						if (_v1.$ === 1) {
							...
							var _v2 = _v1.a;
							var f = _v2.a;
							if ((f.k.c === 2) && (f.k.j || f.k.g)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{j: f.k.j, ab: children, g: f.k.g, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
									$elm$core$List$length(s.ab),
									f.k.c)) {
		...
		return _Utils_Tuple2(
			{
				...
				H: {
					...
					h: $author$project$Components$Display$init(eqs),
					...
					aA: false,
					O: false,
					aD: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.k.c, props.k.c) && (_Utils_eq(p.k.j, props.k.j) && _Utils_eq(p.k.g, props.k.g))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		...
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable.ac, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						function (elem) {
							return !_Utils_eq(elem.Z, child.Z);
						},
						n.ab))));
	});
var $author$project$Algo$History$updateNodeValues_ = F3(
	function (index, child, model) {
		...
		while (true) {
			if (!index) {
				var _v0 = A2($author$project$Algo$History$updateNode_, child, model.as);
				var newNode = _v0.c;
				return _Utils_update(
					model,
					{as: newNode});
			} else {
				var _v1 = A2($elm$core$Dict$get, index, model.A);
				if (_v1.$ === 1) {
					return model;
				} else {
					var n = _v1.a;
					...
					var newNode = _v2.c;
					var $temp$index = n.az,
						$temp$child = {G: height, Z: index, J: width},
						$temp$model = _Utils_update(
						model,
						{
							A: A3($elm$core$Dict$insert, index, newNode, model.A)
						});
					index = $temp$index;
					child = $temp$child;
					model = $temp$model;
	...
	function (list, model) {
		...
		return function (newModel) {
			...
			A3(
				...
				F2(
					function (c, m) {
						var nextID = $elm$core$Dict$size(m.A) + 1;
...
var $author$project$Algo$History$current = function (model) {
	return A2(
		...
		A2(
			...
			function (n) {
				return A2($elm$core$Dict$get, n, model.A);
			},
			$elm$core$List$head(model.C))).ag;
};
				...
				if (!children.b) {
					...
					if (_v1.$ === 1) {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								a,
								A2($elm$core$List$cons, newEq.as, others),
								newEq.m));
					}
				}
			});
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.as));
		if (!path.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												as: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{P: newEq.as}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											as: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{ab: children})),
											m: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											as: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{ab: children})),
											m: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											as: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{ab: children})),
											m: t
		...
		switch (replaceNode.$) {
			...
			case 3:
				...
				return A2(
							...
							function () {
								if (!res.$) {
									...
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
										$author$project$Algo$Math$BinaryNode(
											{j: n.j, ab: children, g: n.g, a: n.a, b: s}));
								} else {
									var pre = res.b;
									var post = res.c;
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
					...
					A3(constructChildren, n.a, t, n.ab));
			case 5:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
			...
			case 1:
				...
				if (_v40.b.$ === 1) {
					var oldS = _v40.a;
					var _v41 = _v40.b;
					var newState = A2(tracker.aG, oldS, tracker.o);
					return $elm$core$Result$Ok(
						_Utils_Tuple3(
							$author$project$Algo$Matcher$SingleNodeReplaced_(
								$author$project$Algo$Math$VariableNode(
				...
				if (_v45.b.$ === 1) {
					...
					if (_v49.$ === 1) {
						...
						return A2(
							...
							A3(constructChildren, '', tracker, n.ab));
					}
				}
		}
	});
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					az: A2($elm$core$Dict$remove, id, tracker.az)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					az: A3($elm$core$Dict$insert, id, p, tracker.az)
				});
		}
	});
					...
					F2(
						function (elem, childT) {
							return _Utils_update(
								childT,
								{
									az: A2($elm$core$Dict$remove, elem, childT.az)
								});
						}),
					A3($author$project$Algo$Matcher$setParent_, newRoot, pID, newTracker),
					A2(
						$elm$core$Set$diff,
						$author$project$Algo$Matcher$getSubtreeIDs_(eq.as),
						$author$project$Algo$Matcher$getSubtreeIDs_(newRoot)));
				return _Utils_Tuple2(
					$author$project$Algo$Matcher$getID(
						$author$project$Algo$Math$getState(newRoot)),
					{as: newRoot, m: finalTracker});
			},
			A4($author$project$Algo$Matcher$constructFromReplacement_, -1, eq.m, args, replacement));
	});
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, replacement, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.m.az);
		if (_v0.$ === 1) {
			...
			return A3(
				$author$project$Algo$Matcher$processSubtree_,
				A2($author$project$Algo$Matcher$searchPath_, eq.m.az, id),
							...
							F2(
								function (r, _v3) {
									...
									return A2(
										...
										A4($author$project$Algo$Matcher$replaceSubtree, ids, r.as, result, current));
								}),
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.ab));
	}
};
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.as);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.H;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bT, params.a3, swappable.h);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$Components$Evaluate$finish = F2(
	function (id, model) {
		var _v0 = A2($elm$core$Dict$get, id, model.ad);
		if (_v0.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ad: A2($elm$core$Dict$remove, id, model.ad)
					}),
...
var $author$project$Algo$History$add = F2(
	function (c, model) {
		var id = $author$project$Algo$History$currentNode_(model);
		var nextID = $elm$core$Dict$size(model.A) + 1;
		return function (newModel) {
			return _Utils_update(
				newModel,
				{
															...
															A2(
																...
																$author$project$Algo$Math$BinaryNode(
																	_Utils_update(
																		n,
																		{
																			ab: $elm$core$List$reverse(group),
																			b: newS
																		})),
				...
				[
					...
					aw: A2(
						...
						function (_v0) {
							var key = _v0.a;
							var param = _v0.b;
							return (!param.c) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aL: param.a + '= '}),
									$author$project$UI$Dialog$Text(
...
var $author$project$Components$Display$newSelectedNodes_ = F2(
	function (selected, eq) {
		var intersection = A2(
			$elm$core$Set$filter,
			function (n) {
				return A2($elm$core$Dict$member, n, eq.m.az);
			},
			selected);
		return $elm$core$Set$isEmpty(intersection) ? $elm$core$Set$singleton(
			$author$project$Algo$Matcher$getID(
				$author$project$Algo$Math$getState(eq.as))) : intersection;
	});
			...
			function (subEq) {
				...
				if (!_v0.$) {
					...
					return (!_Utils_eq(target, n.x)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v1) {
						var root = _v1.a;
						var tracker = _v1.b;
						var parent = A2($elm$core$Dict$get, id, tracker.az);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.az)),
					_Utils_Tuple2(
					'component',
					convert(node.ag)),
					_Utils_Tuple2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.as)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.X))
				]));
	});
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.m.az))
							])))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model.ad))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'arguments',
				$elm$json$Json$Encode$int(prop.k.c)),
				_Utils_Tuple2(
				'associative',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'arguments',
				$elm$json$Json$Encode$int(param.c)),
				_Utils_Tuple2(
				'description',
				$elm$json$Json$Encode$string(param.ah))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'bottom',
				$elm$json$Json$Encode$float(model.q.D)),
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(model.cj))
			]));
};
var $author$project$UI$Menu$encode = function (model) {
	return A2($elm$json$Json$Encode$set, $elm$json$Json$Encode$string, model.W);
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'display',
						$author$project$Components$Display$encode(model.h)),
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bd)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aD)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.ac)),
						_Utils_Tuple2(
						'menu',
						...
						_Utils_Tuple2(
						'showHelp',
						$elm$json$Json$Encode$bool(model.V)),
						_Utils_Tuple2(
						'showMenu',
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					am: model.am + 1,
					ad: A3($elm$core$Dict$insert, model.am, c, model.ad)
				}),
			model.be(
				{cj: model.am, cx: str}));
	});
...
var $author$project$Algo$Matcher$KnownArgs_ = function (a) {
	return {$: 1, a: a};
};
var $author$project$Algo$Matcher$KnownFuncs_ = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Algo$Matcher$toReplacement_ = F2(
	function (funcProps, argDict) {
		var getFuncProp = function (name) {
			if (funcProps.$ === 1) {
				return $elm$core$Result$Ok($elm$core$Maybe$Nothing);
			} else {
				var fp = funcProps.a;
				var _v8 = A2($elm$core$Dict$get, name, fp);
				if (_v8.$ === 1) {
					return $elm$core$Result$Err('Unable to construct ' + name);
				} else {
					var p = _v8.a;
					return $elm$core$Result$Ok(
			...
			switch (node.$) {
						...
						return A2(
							...
							function (fp) {
								if (fp.$ === 1) {
									...
									var p = fp.a;
									return (!(!p.c)) ? $elm$core$Result$Err(s.a + ' is not a variable') : $elm$core$Result$Ok(
										$author$project$Algo$Math$VariableNode(
											{a: s.a, b: $elm$core$Maybe$Nothing}));
								}
							},
				...
				case 2:
					...
					return A2(
						...
						function (child) {
							return $author$project$Algo$Math$UnaryNode(
								{P: child, a: s.a, b: $elm$core$Maybe$Nothing});
						},
						convert(s.P));
				case 3:
					var s = node.a;
					return A2(
						...
						function (children) {
							return $author$project$Algo$Math$BinaryNode(
								{
									j: s.j,
									ab: $elm$core$List$reverse(children),
									g: s.g,
									a: s.a,
									b: $elm$core$Maybe$Nothing
								});
				...
				case 4:
					...
					if (!_v4.$) {
						...
						return (!_Utils_eq(
							args,
							$elm$core$List$length(s.ab))) ? $elm$core$Result$Err(s.a + ' has the wrong number of inputs') : A2(
							$elm$core$Result$map,
							function (children) {
								return $author$project$Algo$Math$GenericNode(
									{
	...
	function (checker, knownProps, state, root) {
		...
		switch (root.$) {
			...
			case 1:
				var s = root.a;
				if (knownProps.$ === 1) {
					var argMap = knownProps.a;
					var _v2 = A2($elm$core$Dict$get, s.a, argMap);
					if (_v2.$ === 1) {
						return $elm$core$Result$Ok(
							_Utils_Tuple2(
					...
					var kp = knownProps.a;
					var _v3 = A2($elm$core$Dict$get, s.a, kp);
					if (_v3.$ === 1) {
						return A2(
							$elm$core$Result$map,
							function (newS) {
						...
						var p = _v3.a;
						return (!(!p.c)) ? $elm$core$Result$Err(s.a + ' cannot be used as a variable') : $elm$core$Result$Ok(
							_Utils_Tuple2(
								$author$project$Algo$Matcher$ExactMatcher(
									{c: _List_Nil, a: s.a}),
								state));
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$treeToMatcher_, checker, knownProps, state, s.P));
			case 3:
				var s = root.a;
				return s.g ? A2(
					$elm$core$Result$map,
					function (_v5) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{
									c: $elm$core$List$reverse(children),
									a: s.a,
									ay: $elm$core$Maybe$Nothing
								}),
							newS);
					},
					processChildren(s.ab)) : A2(
					$elm$core$Result$map,
					function (_v6) {
						var children = _v6.a;
						var newS = _v6.b;
			...
			default:
				...
				if (knownProps.$ === 1) {
					...
					var kp = knownProps.a;
					var _v10 = A2($elm$core$Dict$get, s.a, kp);
					if (_v10.$ === 1) {
						return A2(
							$elm$core$Result$map,
							function (_v13) {
						...
						return (!_Utils_eq(
							prop.c,
							$elm$core$List$length(s.ab))) ? $elm$core$Result$Err(s.a + ' has an unexpected function signature') : (prop.g ? A2(
							$elm$core$Result$map,
							function (_v14) {
								var children = _v14.a;
								var newS = _v14.b;
								return _Utils_Tuple2(
									$author$project$Algo$Matcher$CommutativeMatcher(
										{c: children, a: s.a, ay: $elm$core$Maybe$Nothing}),
									newS);
							},
							processChildren(s.ab)) : A2(
							$elm$core$Result$map,
	...
	function (funcs, left, right) {
		var toMatcherPair = function (_v7) {
			...
			var _v0 = A4(
				...
				$author$project$Algo$Matcher$KnownFuncs_(funcs),
				0,
				from);
			if ((!_v0.$) && (!_v0.a.a.$)) {
				var _v3 = _v0.a;
											...
											A2(
												...
												function (_v6) {
													...
													return A2(
														...
														A3($author$project$Algo$Matcher$toReplacement_, $elm$core$Maybe$Nothing, args, from));
												},
												A4(
													$author$project$Algo$Matcher$treeToMatcher_,
													F2(
													...
													$author$project$Algo$Matcher$KnownArgs_(args),
													0,
													to)))));
							},
							A3($author$project$Algo$Matcher$toReplacement_, $elm$core$Maybe$Nothing, args, to))));
			} else {
				return _List_Nil;
			}
		};
			...
			switch (_v0.a.$) {
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.P, r.P));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						...
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.j, r.j) && (_Utils_eq(l.g, r.g) && (_Utils_eq(
							$elm$core$List$length(l.ab),
							$elm$core$List$length(r.ab)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									$elm$core$List$length(s.c),
									$elm$core$List$length(n.ab)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.ay;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.ab);
								return (!_Utils_eq(
									$elm$core$List$length(s.c),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.ab)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
		...
		return {
			...
			aW: _List_fromArray(
				[
					...
					aC: 'Select the equation to use for substitution'
				}
				]),
			a_: function (dict) {
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {F: createMode, h: display, Q: evaluator, av: historyBox, ax: menu, an: nextCreateInt, ac: notification, bd: rules, V: showHelp, aA: showHistory, O: showMenu, aD: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {A: nodes, as: root, X: undone, C: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {ab: children, ag: component, az: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aG: copyState, aJ: newState, o: id, az: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aR: create, e: eq, R: hidden, ao: next, n: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.k.j || f.k.g) && (f.k.c !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.k.j && (!f.k.g)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
		F3(
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {E: constants, y: functions, a: name, bd: rules};
	});
var $author$project$Components$Rules$Rule = F4(
	function (title, description, parameters, matches) {
		return {ah: description, aT: matches, bb: parameters, a$: title};
	});
		...
		return A2(
			...
			$elm$core$Result$andThen(
				A3(
					$author$project$Algo$Matcher$treeToMatcher_,
					checker,
					$author$project$Algo$Matcher$KnownFuncs_(knownProps),
					state)));
	});
...
var $author$project$Algo$Matcher$toReplacement = F2(
	function (funcProps, argDict) {
		return A2(
			...
			$elm$core$Result$andThen(
				A2(
					$author$project$Algo$Matcher$toReplacement_,
					$elm$core$Maybe$Just(funcProps),
					argDict)));
	});
								...
								_Utils_update(
									s,
									{
										c: A2(
											...
											$author$project$Components$Rules$setOthers_(others),
											_Utils_ap(
												A2($elm$core$List$take, index, s.c),
												A2($elm$core$List$drop, index + 1, s.c))),
						...
						A3(
							...
							F2(
								function (_v2, res) {
									...
									if (!n.$) {
										var c = n.a;
										return ($elm$core$List$isEmpty(c.c) && A2($elm$core$Set$member, c.a, others)) ? $elm$core$Maybe$Just(
							...
							$elm$core$Maybe$Nothing,
							A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, s.c)));
				}
		}
	});
									...
									function (to) {
										...
										return {
											a3: _Utils_update(
												from,
												{
													as: A2($author$project$Components$Rules$setOthers_, otherSet, from.as)
												}),
											bj: to
										};
									},
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {D: bottom, w: left, B: right, I: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {q: coordinates, ai: drags, cj: id};
	});
		...
		if (_v0.$ === 3) {
			...
			if (!n.j) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.ab));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
		...
		switch (e.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$SetCapture, model.cj, pid)));
			case 1:
				var pid = e.a;
				var to = e.b;
				var _v2 = A2(
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: {D: orig.D + dy, w: orig.w + dx, B: orig.B + dx, I: orig.I + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												w: A2($elm$core$Basics$min, orig.B - 2, orig.w + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 1:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												B: A2($elm$core$Basics$max, orig.w + 2, orig.B + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 3:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												D: A2($elm$core$Basics$max, orig.I + 2, orig.D + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 4:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											...
											{
												w: A2($elm$core$Basics$min, orig.B - 2, orig.w + dx),
												I: A2($elm$core$Basics$min, orig.D - 2, orig.I + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 5:
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$ReleaseCapture, model.cj, pid)));
			default:
				return _Utils_Tuple2(model, $elm$core$Maybe$Nothing);
		}
	});
var $author$project$UI$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.W) ? _Utils_update(
			model,
			{
				W: A2($elm$core$Set$remove, entry, model.W)
			}) : _Utils_update(
			model,
			{
				W: A2($elm$core$Set$insert, entry, model.W)
			});
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Components$Display$update, e, model.h);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aD);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model.ac);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 7:
				...
				if (e.$ === 1) {
					...
					var de = e.a;
					var _v6 = A2($author$project$Components$Display$update, de, model.h);
					var dModel = _v6.a;
					var dCmd = _v6.b;
					return _Utils_Tuple2(
						updateCore(
			...
			case 9:
				var input = event.a;
				var _v7 = _Utils_Tuple3(input.bo, input.b$, input.a6);
				_v7$3:
				while (true) {
					switch (_v7.c) {
						case 'Escape':
							var _v8 = _Utils_Tuple2(core.t, model.F);
							if (!_v8.a.$) {
								return _Utils_Tuple2(
									_Utils_update(
										core,
						...
						case 'z':
							if (_v7.a) {
								if (!_v7.b) {
									var _v10 = $author$project$Components$Display$undo(model.h);
									if (_v10.$ === 1) {
										var errStr = _v10.a;
									...
									var _v11 = $author$project$Components$Display$redo(model.h);
									if (_v11.$ === 1) {
										var errStr = _v11.a;
										return A2($author$project$Main$submitNotification_, core, errStr);
									} else {
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{F: $elm$core$Maybe$Nothing, V: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v15 = A2(
						$elm$core$Result$map,
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, h: dModel, V: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
							...
							A2($author$project$Components$Display$addEquation, root, model.h));
					} else {
						var err = _v15.a;
			...
			case 3:
				...
				switch (e.$) {
					...
					case 1:
						...
						var root = e.b;
						var children = e.c;
						var _v25 = A4($author$project$Components$Display$groupChildren, eqNum, root, children, model.h);
						if (_v25.$ === 1) {
							var errStr = _v25.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						...
						var root = e.b;
						var selected = e.c;
						var _v26 = A4($author$project$Components$Display$ungroupChildren, eqNum, root, selected, model.h);
						if (_v26.$ === 1) {
							var errStr = _v26.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 4:
						var eqNum = e.a;
						var selected = e.b;
						return ($elm$core$Dict$size(model.h.e) < 2) ? A2($author$project$Main$submitNotification_, core, 'There are no equations to use for substitution') : _Utils_Tuple2(
							_Utils_update(
								core,
								{
									t: $elm$core$Maybe$Just(
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.cj, model.Q);
				var eModel = _v38.a;
				var c = _v38.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.x)) {
							...
							var _v41 = A5($author$project$Components$Display$replaceNumber, eqNum, root, target, replacement, model.h);
							if (_v41.$ === 1) {
								var errStr = _v41.a;
						...
						var eqNum = _v42.a;
						var id = _v42.b;
						var _v43 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.x, model.h);
						if (_v43.$ === 1) {
							var errStr = _v43.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
			...
			aw: _List_fromArray(
				[
					...
					[
						...
						{
							ch: $author$project$Main$FileSelect(0),
							aL: 'Select a file'
						})
					])
				]),
								...
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Algo$Math$toString(
												$author$project$Algo$History$current(eq).as))
										]))
								]))
						]));
			},
...
var $author$project$Components$Tutorial$menu = F2(
	function (converter, model) {
		return A2(
			...
			{Y: $elm$core$Maybe$Nothing, a: 'Tutorials'},
			_List_Nil);
	});
			...
			A3(
									...
									return A2(
										...
										A2(
											...
											function (rule) {
												return A2(
													$author$project$UI$Menu$Section,
													{Y: $elm$core$Maybe$Nothing, a: rule.a$},
													_List_fromArray(
														[
															$author$project$UI$Menu$Content(
				...
				_List_fromArray(
					[
						A2(
						$author$project$UI$Menu$Section,
						{Y: $elm$core$Maybe$Nothing, a: 'Core'},
						_List_fromArray(
							[
								A2(
								$author$project$UI$Menu$Section,
								{Y: $elm$core$Maybe$Nothing, a: 'Evaluate'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Y: $elm$core$Maybe$Nothing, a: 'Number Substitution'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Y: $elm$core$Maybe$Nothing, a: 'Substitute'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Y: $elm$core$Maybe$Nothing, a: 'Group'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Y: $elm$core$Maybe$Nothing, a: 'Ungroup'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
...
var $author$project$UI$HtmlEvent$onClickThrough = $elm$html$Html$Events$onClick;
									...
									A2(
										...
										_List_fromArray(
											[
												...
												eqNum,
												highlight,
												$author$project$Algo$Math$symbolicate(eq.as)),
												A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.as)
											]))),
								result);
						}
					}),
			...
			var evaluateState = function () {
				...
				if (_v3.$ === 1) {
					...
					return $author$project$UI$ActionView$Allowed(
						A3($author$project$Components$Rules$Evaluate, selected.aj, selected.as, str));
				}
			}();
			var result = A5(
				$author$project$UI$ActionView$CoreTopicState,
				$author$project$UI$ActionView$Allowed(
					A2($author$project$Components$Rules$Substitute, selected.aj, selected.n)),
						...
						var ungroupRes = sameBinaryNode ? _Utils_update(
							result,
							{
								bk: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Ungroup, selected.aj, selected.as, selected.A))
							}) : result;
						return (_Utils_eq(
							$elm$core$List$length(n.ab),
							...
							ungroupRes,
							{
								a4: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Group, selected.aj, selected.as, selected.A))
							});
					}
				case 0:
					var n = _v1.a;
					return _Utils_update(
						result,
						{
							a8: $author$project$UI$ActionView$Allowed(
								A3($author$project$Components$Rules$NumericalSubstitution, selected.aj, selected.as, n.x)),
					...
					var matches = A2(
						...
						function (m) {
							return A2(
								$elm$core$Maybe$map,
								function (result) {
									return {a3: result, bT: m.bj};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.A, m.a3.as, n.aN));
						},
						rule.aT);
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var tree = _v1.c;
					return {aj: eqNum, A: nodes, as: root, n: ids, aN: tree};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.cj)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.cj),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.cj))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.ch),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.q.B - model.q.w) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.q.D - model.q.I) + 'dvh'),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					A2($elm$html$Html$Attributes$style, 'padding', '1rem 0.2rem 0.2rem 0.2rem'),
					$elm$html$Html$Attributes$id(model.cj)
				]),
		...
		return A4(
			...
			A2(
				...
				function (c) {
					return A2(
						$elm$core$Maybe$map,
						A4($author$project$Algo$History$serialize_, converter, selectedID, nodes, c.Z),
						A2($elm$core$Dict$get, c.Z, nodes));
				},
				n.ab));
	});
												...
												A2(
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Algo$Math$toString(c.as))
															])),
													children));
										})),
...
var $author$project$UI$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var title = part.a;
			var children = part.b;
			var shown = A2($elm$core$Set$member, title.a, model.W);
			return A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.av, model.h))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'actions',
								A3($author$project$UI$ActionView$view, $author$project$Main$RuleEvent, model.bd, model.h))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													$author$project$UI$HtmlEvent$onClickThrough(
													model.O ? $author$project$Main$ToggleMenu : $author$project$Main$NoOp)
												]),
											A2(
												$elm$core$List$filterMap,
												$elm$core$Basics$identity,
												...
												[
													...
													_List_fromArray(
														[
															A2(
															$author$project$UI$Menu$Section,
															{Y: $elm$core$Maybe$Nothing, a: 'Settings'},
															_List_fromArray(
																[
																	$author$project$UI$Menu$Content(
																	_List_fromArray(
															...
															A2($author$project$Components$Display$menu, $author$project$Main$DisplayEvent, model.h)),
															A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aD),
															A2(
															$author$project$UI$Menu$Section,
															{
																Y: $elm$core$Maybe$Just(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{cl: $author$project$Main$init, co: $author$project$Main$EventUrlChange, cp: $author$project$Main$EventUrlRequest, cy: $author$project$Main$subscriptions, cA: $author$project$Main$update, cB: $author$project$Main$view});
