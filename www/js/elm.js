...
{
	if (region.bs.aQ === region.bz.aQ)
	{
		return 'on line ' + region.bs.aQ;
	}
	return 'on lines ' + region.bs.aQ + ' through ' + region.bz.aQ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { S: 'hidden', cc: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { S: 'mozHidden', cc: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { S: 'msHidden', cc: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { S: 'webkitHidden', cc: 'webkitvisibilitychange' }
		: { S: 'hidden', cc: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.co, request.b4, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bD: fragment, bG: host, bN: path, bP: port_, bS: protocol, bT: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ak: false, by: element, bb: trigger};
	});
				...
				model,
				{
					...
					N: A3(
						...
						A2(
							...
							$author$project$UI$Notification$delayedDelete_(model.J),
							str),
						model.N)
				}),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$UI$Animation$delayEvent,
						15000,
						$author$project$UI$Notification$ClearEvent(model.J))
					])));
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {ap: nextCallID, ae: ongoing, bp: sender};
	});
...
var $author$project$Components$Tutorial$init = {bK: 0, b_: 0};
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			m: {y: top + height, u: left, B: left + width, v: top},
...
var $author$project$UI$Notification$init = {J: 0, N: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b9: false, cb: r.cb, bA: r.bA, bE: r.bE, co: r.co, cA: r.cA, h: r.h, b4: r.b4}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cb: $elm$http$Http$emptyBody, bA: r.bA, bE: _List_Nil, co: 'GET', cA: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, b4: r.b4});
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ce: col, cf: contextStack, cs: problem, bY: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bY, s.ce, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ce: col, g: s0.g, j: s0.j, d: offset, bY: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.bY, s.ce, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.bY, s.ce, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ce: newCol, g: s.g, j: s.j, d: newOffset, bY: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ce: col, g: context, j: indent, d: offset, bY: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bs, s.d, s.c);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.bB));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.bh, s.d + 1, s.bY + 1, 1, s.c, s.j, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.bh, firstOffset, s.bY, s.ce + 1, s.c, s.j, s.g);
			var name = A3($elm$core$String$slice, s.d, s1.d, s.c);
			return A2($elm$core$Set$member, name, i.bn) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.bB)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bB: $elm$parser$Parser$ExpectingVariable, bh: i.bh, bn: i.bn, bs: i.bs});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		bs: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{bh: $elm$core$Char$isDigit, bn: $elm$core$Set$empty, bs: $elm$core$Char$isDigit});
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{C: true, aj: children, t: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ce: col, cs: problem, bY: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bY, p.ce, p.cs);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ce: 1, g: _List_Nil, j: 1, d: 0, bY: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.a5(tracker.J);
					} else {
						var prev = previous.a;
						return A2(tracker.a0, prev, tracker.J);
					}
				}()),
			_Utils_update(
				tracker,
				{
					J: tracker.J + 1,
					aT: A3($elm$core$Dict$insert, tracker.J, parent, tracker.aT)
				}));
	});
...
var $author$project$Algo$Matcher$processID_ = F3(
	function (parent, tracker, oldRoot) {
		...
		switch (oldRoot.$) {
			...
			case 3:
				var s = oldRoot.a;
				var _v3 = A2(processChildren, newTracker, s.aj);
				var newChildren = _v3.a;
				var finalT = _v3.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{C: s.C, aj: newChildren, t: s.t, a: s.a, b: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
				var _v4 = A2(processChildren, newTracker, s.aj);
				var newChildren = _v4.a;
				var finalT = _v4.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$GenericNode(
						{aj: newChildren, a: s.a, b: state}),
					finalT);
			default:
				var s = oldRoot.a;
				var _v5 = A2(processChildren, newTracker, s.aj);
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{a0: copyState, a5: newState, J: 0, aT: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
						...
						h: _Utils_update(
							tracker,
							{
								aT: A2($elm$core$Dict$remove, 0, tracker.aT)
							})
					};
				}),
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{be: url, f: _List_Nil, bi: key, a9: _List_Nil},
			A2(
				...
				a8: A2(
					...
					$elm$core$Result$toMaybe(
						A2(
							...
							flags))),
				E: {
					z: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
					...
					aq: newScreen ? 1 : 0,
					ad: nModel,
					bo: $author$project$Components$Rules$init,
					Y: false,
					aK: false,
					az: false,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Main$loadSources(query.a9)
					])));
	});
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.E.z, model.p);
				if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'pId',
					$elm$core$Basics$identity($.bm)),
					_Utils_Tuple2(
					'set',
					$elm$json$Json$Encode$bool($.bq))
				]));
	});
	...
	if (action.$ === 1) {
		...
		if (!action.a.$) {
			...
			return $author$project$Main$capture(
				{bf: eId, bm: pId, bq: true});
		} else {
			var _v2 = action.a;
			var eId = _v2.a;
			var pId = _v2.b;
			return $author$project$Main$capture(
				{bf: eId, bm: pId, bq: false});
		}
	}
};
			...
			switch (node.$) {
				...
				case 3:
					...
					return $author$project$Algo$Math$BinaryNode(
						{
							C: s.C,
							aj: A2($elm$core$List$map, convert, s.aj),
							t: s.t,
							a: s.a,
							b: {
								F: $elm$core$Maybe$Nothing,
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.e, props.e) && (_Utils_eq(p.C, props.C) && _Utils_eq(p.t, props.t))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
	...
	function (child, n) {
		return function (newChildren) {
					...
					F2(
						function (elem, res) {
							return _Utils_update(
								res,
								{
									H: A2($elm$core$Basics$max, res.H, elem.H),
									K: res.K + elem.K
								});
						}),
					{H: 1, K: 0},
			...
			A2(
				...
				F2(
					function (left, right) {
						return (!_Utils_eq(left.H, right.H)) ? ((_Utils_cmp(left.H, right.H) < 0) ? 0 : 2) : ((!_Utils_eq(left.K, right.K)) ? ((_Utils_cmp(left.K, right.K) < 0) ? 0 : 2) : 1);
					}),
				A2(
					$elm$core$List$cons,
					child,
		...
		while (true) {
			if (!index) {
				...
				if (_v1.$ === 1) {
					...
					var newNode = _v2.c;
					var $temp$index = n.aT,
						$temp$child = {H: height, ac: index, K: width},
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aT: A2($elm$core$Dict$remove, id, tracker.aT)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aT: A3($elm$core$Dict$insert, id, p, tracker.aT)
				});
		}
	});
							...
							return function (_v21) {
								...
								return _Utils_Tuple2(
									$author$project$Algo$Math$BinaryNode(
										{
											C: true,
											aj: _Utils_ap(preNodes, postNodes),
											t: true,
											a: nodes.aJ,
											b: s
										}),
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						...
						if (_v30.$ === 1) {
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.aJ, m.a)) ? function (_v31) {
	...
	function (parent, result, args, existing, tracker) {
		...
		switch (existing.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{C: s.C, aj: newChildren, t: s.t, a: s.a, b: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.h.aT);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.h.aT, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							...
							F2(
								function (elem, t) {
									return _Utils_update(
										t,
										{
											aT: A2($elm$core$Dict$remove, elem, t.aT)
										});
								}),
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.aj));
	}
};
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.E;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bj, params.ab, swappable.i);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.ak ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{ak: true}),
		element.bb(0));
		...
		return A2(
			...
			function () {
				switch (root.$) {
					...
					case 1:
						var s = root.a;
						var _v1 = A2($elm$core$Dict$get, s.a, model.G);
						if (_v1.$ === 1) {
																	...
																	A2(
																		...
																		$author$project$Algo$Math$BinaryNode(
																			_Utils_update(
																				n,
																				{
																					aj: $elm$core$List$reverse(group),
																					b: newS
																				})),
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aO: $author$project$Main$CloseDialog,
		...
		ag: 'Substitute a number for an expression'
	};
};
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
			...
			_List_fromArray(
				[
					...
					ao: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.bd) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aX: param.a + '= '}),
									$author$project$UI$Dialog$Text(
		...
		ag: 'Set parameters for ' + params.ag
	};
};
					...
					function (children) {
						...
						if (_v1.$ === 1) {
							...
							if ((f.e === 2) && (f.C || f.t)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{C: f.C, aj: children, t: f.t, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
									$elm$core$List$length(s.aj),
									f.e)) {
					...
					function (subEq) {
						...
						if (!_v2.$) {
							...
							return (!_Utils_eq(target, n.x)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								var parent = A2($elm$core$Dict$get, id, tracker.aT);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aT)),
					_Utils_Tuple2(
					'component',
					convert(node.aE)),
					_Utils_Tuple2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.ah))
				]));
	});
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.h.J)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.h.aT))
							])))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'associative',
				$elm$json$Json$Encode$bool(prop.C)),
				_Utils_Tuple2(
				'commutative',
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'from',
									$elm$json$Json$Encode$string(match.ab.a)),
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aZ.a))
								]));
					},
					rule.k))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constants',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, topic.G)),
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.D)),
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.bo))
			]));
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.ak))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'right',
				$elm$json$Json$Encode$float(model.m.B)),
				_Utils_Tuple2(
				'top',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nextID',
				$elm$json$Json$Encode$int(model.J)),
				_Utils_Tuple2(
				'notifications',
				A3(
					$elm$json$Json$Encode$dict,
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bo)),
						_Utils_Tuple2(
						'tutorial',
						...
						_Utils_Tuple2(
						'historyBox',
						$author$project$UI$Draggable$encode(model.aH))
					]))));
};
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {cd: count, ch: eq, U: nodes, ay: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					ap: model.ap + 1,
					ae: A3($elm$core$Dict$insert, model.ap, c, model.ae)
				}),
			model.bp(
				{ck: model.ap, cy: str}));
	});
...
var $author$project$Main$substitutionDialog_ = function (model) {
	return {
		...
		ag: 'Substitute a variable for a formula'
	};
};
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {z: createMode, i: display, R: evaluator, aH: historyBox, aI: menu, aq: nextCreateInt, ad: notification, bo: rules, Y: showHelp, aK: showHistory, az: showMenu, aC: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {U: nodes, ay: root, ah: undone, P: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {aj: children, aE: component, aT: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {a0: copyState, a5: newState, J: id, aT: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {a1: create, f: eq, S: hidden, ar: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, C: associative, t: commutative, an: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.C || f.t) && (f.e !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.C && (!f.t)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {G: constants, D: functions, a: name, bo: rules};
	});
...
var $author$project$Components$Rules$Rule_ = F4(
	function (title, description, parameters, matches) {
		return {_: description, k: matches, as: parameters, ag: title};
	});
					...
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{e: children, a: s.a, aS: $elm$core$Maybe$Nothing}),
							tokens);
					},
					processChildren(s.aj)) : A2(
					$elm$core$Result$map,
					function (_v3) {
						var children = _v3.a;
						var tokens = _v3.b;
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {y: bottom, u: left, B: right, v: top};
	});
		...
		if (_v0.$ === 3) {
			...
			if (!n.C) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.aj));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
...
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.h;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.aT);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
		...
		switch (e.$) {
			...
			case 1:
				...
				if (_v2.$ === 1) {
					...
					var start = _v2.a;
					var orig = start.V;
					var _v3 = A2($author$project$UI$Draggable$diff, start.ab, to);
					var diffX = _v3.a;
					var diffY = _v3.b;
					...
					if (_v5.$ === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									m: {y: orig.y + dy, u: orig.u + dx, B: orig.B + dx, v: orig.v + dy}
								}),
							$elm$core$Maybe$Nothing);
					} else {
						switch (_v5.a) {
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													u: A2($elm$core$Basics$min, orig.B - 2, orig.u + dx)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 1:
									...
									_Utils_update(
										model,
										{
											m: _Utils_update(
												orig,
												{
													B: A2($elm$core$Basics$max, orig.u + 2, orig.B + dx)
												})
										}),
									$elm$core$Maybe$Nothing);
							case 2:
	...
	function (event, core) {
		...
		switch (event.$) {
			...
			case 7:
				...
				if (e.$ === 1) {
					var de = e.a;
					var _v5 = A3($author$project$UI$Draggable$update, core.a8, de, model.aH);
					var newBox = _v5.a;
					var action = _v5.b;
					return _Utils_Tuple2(
						updateCore(
			...
			case 9:
				...
				if (str !== 'Escape') {
					...
					var _v7 = _Utils_Tuple2(core.p, model.z);
					if (!_v7.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
			...
			case 12:
				...
				if (_v12.$ === 1) {
					...
					var m = _v12.a;
					return (!_Utils_eq(m.by, num)) ? _Utils_Tuple2(core, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{z: $elm$core$Maybe$Nothing, Y: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v13 = A3($author$project$Algo$Matcher$parseEquation, $author$project$Components$Display$createState, $author$project$Components$Display$updateState, str);
					if (!_v13.$) {
						var root = _v13.a;
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{z: $elm$core$Maybe$Nothing, i: dModel, Y: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					_Utils_update(
						core,
						{
							...
							E: _Utils_update(
								model,
								{
									bo: A2($author$project$Components$Rules$deleteTopic, name, model.bo)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 20:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v16 = A2($author$project$Components$Rules$addTopic, topic, model.bo);
					if (_v16.$ === 1) {
						var errStr = _v16.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bo: A2($author$project$Components$Rules$addSources, source.w, model.bo)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.bo);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
				...
				switch (e.$) {
					case 0:
						...
						if (($elm$core$List$length(p.k) === 1) && $elm$core$List$isEmpty(p.as)) {
							var _v22 = A2($author$project$Helper$listIndex, 0, p.k);
							if (_v22.$ === 1) {
					...
					case 1:
						var _v23 = $author$project$Components$Display$groupChildren(model.i);
						if (_v23.$ === 1) {
							var errStr = _v23.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v24 = $author$project$Components$Display$ungroupChildren(model.i);
						if (_v24.$ === 1) {
							var errStr = _v24.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v25 = $author$project$Components$Display$selectedNode(model.i);
						if (_v25.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v25.a;
							...
							var _v26 = A2($author$project$Components$Rules$evaluateStr, model.bo, n.ay);
							if (_v26.$ === 1) {
								var errStr = _v26.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
														...
														return A2(
															...
															function (tree) {
																return _Utils_update(
																	r,
																	{
																		ab: A4($author$project$Algo$Matcher$addMatch, k, $elm$core$Dict$empty, tree, r.ab)
																	});
															},
																...
																return A2(
																	...
																	function (tree) {
																		return _Utils_update(
																			r,
																			{
																				ab: A4($author$project$Algo$Matcher$addMatch, k, argDict, tree, r.ab)
																			});
																	},
																	$author$project$Algo$Math$parse(val));
															},
			...
			case 29:
				...
				var _v34 = A2(
					$elm$core$Result$andThen,
					$author$project$Components$Rules$replaceGlobalVar(model.bo),
					$author$project$Algo$Math$parse(str));
				if (_v34.$ === 1) {
					var errStr = _v34.a;
					return A2($author$project$Main$submitNotification_, core, errStr);
					...
					var newTree = _v34.a;
					var _v35 = A2($author$project$Components$Rules$evaluateStr, model.bo, newTree);
					if (_v35.$ === 1) {
						var errStr = _v35.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v37 = A2($author$project$Components$Evaluate$finish, reply.ck, model.R);
				var eModel = _v37.a;
				var c = _v37.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.x)) {
							...
							var _v40 = A3($author$project$Components$Display$replaceNumber, target, tree, model.i);
							if (_v40.$ === 1) {
								var errStr = _v40.a;
...
var $author$project$Main$inputDiv = function (model) {
	return _Utils_Tuple2(
		'textbar' + $elm$core$String$fromInt(model.by),
		A2(
			$elm$html$Html$form,
			A2(
				$author$project$Helper$maybeAppend,
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		...
		var apply = function () {
			var applies = {
				bg: false,
				aP: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{bg: true, aP: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.ay;
				switch (_v1.$) {
					case 3:
						...
						if (!n.C) {
							return _Utils_update(
								applies,
								{
									aA: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
							...
							return _Utils_update(
								...
								{
									a2: (_Utils_eq(
										$elm$core$List$length(n.aj),
										val.cd) || (val.cd < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									aA: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									bc: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aP),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a6),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aA),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.bc),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{a3: res, n: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				...
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.C, r.C) && (_Utils_eq(l.t, r.t) && (_Utils_eq(
							$elm$core$List$length(l.aj),
							$elm$core$List$length(r.aj)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									...
									$elm$core$List$length(n.aj)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aS;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.aj);
								return (!_Utils_eq(
									$elm$core$List$length(s.e),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.aj)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
	...
	function (selected, rule) {
		if (selected.$ === 1) {
			...
			if (!A2(
				$elm$core$List$any,
				function (m) {
					return A2($author$project$Algo$Matcher$matchNode, m.ab.ay, n.ay);
				},
				rule.k)) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {ab: result, bj: m.aZ.ay, a: m.aZ.a};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.U, m.ab.ay, n.ay)));
					},
					_List_Nil,
					rule.k);
					...
					$elm$core$Maybe$Just(
						{
							...
							as: A2(
								...
								function (p) {
									return {
										bd: $author$project$Algo$Matcher$countChildren(p.aR.ay),
										_: p._,
										a: p.aR.a,
										ay: $author$project$Algo$Matcher$getName(p.aR.ay)
									};
								},
								rule.as),
							ag: rule.ag
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.ab.a + ('→' + match.aZ.a))
												]));
									},
									rule.k),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.bo));
								}
							}());
					}),
				_List_fromArray(
			...
			switch (input.$) {
				...
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(m.aX)
							]));
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aX);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$UI$HtmlEvent$onClick(model.aO)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.m.B - model.m.u) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(notification.by)
								]))
						]))));
	});
		...
		cb: A2(
			...
			_List_fromArray(
				[
								...
								A2(
									...
									_List_fromArray(
										[
											...
											_Utils_Tuple2(
												'history',
												A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.aH, model.i))),
											A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.z)
										]))),
								A2(
								$elm$html$Html$div,
								A2(
									...
									model.az ? _List_Nil : _List_fromArray(
										[
					...
					$elm$core$Maybe$Just(
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.aC)),
					A2(
					$elm$core$Maybe$map,
