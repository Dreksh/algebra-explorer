...
{
	if (region.ak.N === region.at.N)
	{
		return 'on line ' + region.ak.N;
	}
	return 'on lines ' + region.ak.N + ' through ' + region.at.N;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bg: 'hidden', ba: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bg: 'mozHidden', ba: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bg: 'msHidden', ba: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bg: 'webkitHidden', ba: 'webkitvisibilitychange' }
		: { bg: 'hidden', ba: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ax: fragment, aB: host, aJ: path, aL: port_, aO: protocol, Z: query};
	});
...
var $author$project$Display$idProcessor_ = {
	ay: F3(
		function (recurse, _v0, _v2) {
			...
			var g = _v4.b;
			var args = _v3.b;
			var _v5 = A4($author$project$Display$idChildren_, recurse, id, g, children.Q);
			var _v6 = _v5.a;
			var _v7 = _v6.b;
			var next = _v7.a;
			var finalDict = _v7.b;
			...
			return _Utils_Tuple2(
				...
				$elm$core$Maybe$Just(
					A2(
						...
						{M: args, aG: children.aG, Q: parameters})));
		}),
	aP: F2(
		function (_v8, _v10) {
			var p = _v8.a;
...
var $author$project$Display$init = A2(
	...
	{aq: $elm$core$Maybe$Nothing, n: $elm$core$Dict$empty, P: 0, aX: $elm$core$Maybe$Nothing});
var $author$project$Menu$init = function (opened) {
	return {aX: opened};
};
var $author$project$Notification$init = {H: 0, s: $elm$core$Dict$empty};
var $author$project$Rules$init = {W: $elm$core$Dict$empty, q: false, X: $elm$core$Dict$empty, am: _List_Nil};
var $author$project$Tutorial$init = {aH: 0, aW: 0};
...
var $author$project$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.bb));
			}(
				function () {
					var _v0 = deadEnd.bn;
					switch (_v0.$) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bb: col, c: s0.c, d: s0.d, b: offset, aU: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aU, s.bb, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bb: col, bc: contextStack, bn: problem, aU: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aU, s.bb, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aU, s.bb, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bb: newCol, c: s.c, d: s.d, b: newOffset, aU: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {bb: col, c: context, d: indent, b: offset, aU: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.ac, s.b + 1, s.aU + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.ac, firstOffset, s.aU, s.bb + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.ah) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{av: $elm$parser$Parser$ExpectingVariable, ac: i.ac, ah: i.ah, ak: i.ak});
};
...
var $author$project$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{ac: $elm$core$Char$isDigit, ah: $elm$core$Set$empty, ak: $elm$core$Char$isDigit});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bb: col, bn: problem, aU: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aU, p.bb, p.bn);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bb: 1, c: _List_Nil, d: 1, b: 0, aU: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{ab: url, n: _List_Nil, ad: key},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.Z)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				O: $author$project$Menu$init(
					$elm$core$Set$singleton('Settings')),
				B: nModel,
				Z: query,
				E: $author$project$Rules$init,
				x: false,
				R: newScreen ? true : false,
				J: $author$project$Tutorial$init
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
					...
					function () {
						...
						switch (_v1) {
							...
							default:
								...
								return A2(
									$elm$core$List$cons,
									$author$project$Math$Text('\\' + (children.aG + '(')),
									_Utils_ap(
										args,
										_List_fromArray(
											[
...
var $author$project$Display$searchFunction_ = F4(
	function (process, recurse, _v0, _v1) {
		...
		return function (_v6) {
			var o = _v6.a;
			var func = _v6.b;
			return ($elm$core$List$isEmpty(func.M) && $elm$core$List$isEmpty(func.Q)) ? _Utils_Tuple2(o, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
				o,
				$elm$core$Maybe$Just(
...
var $author$project$Display$searchProcessor_ = function (process) {
	return {
		ay: $author$project$Display$searchFunction_(process),
		aP: F2(
			function (g, _v0) {
				var s = _v0.a;
				var val = _v0.b;
...
var $author$project$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.aX) ? _Utils_update(
			model,
			{
				aX: A2($elm$core$Set$remove, entry, model.aX)
			}) : _Utils_update(
			model,
			{
				aX: A2($elm$core$Set$insert, entry, model.aX)
			});
	});
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 3:
				var e = event.a;
				var _v2 = A2($author$project$Rules$update, e, model.E);
				var rModel = _v2.a;
				var rCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				var e = event.a;
				var _v3 = A2($author$project$Tutorial$update, e, model.J);
				var tModel = _v3.a;
				var tCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 6:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							O: A2($author$project$Menu$update, e, model.O)
						}),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 8:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{q: $elm$core$Maybe$Nothing, x: false}),
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{q: $elm$core$Maybe$Nothing, u: dModel, x: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
							...
							function (list) {
								return A2($author$project$Query$setEquations, list, model.Z);
							}(
								$author$project$Display$listEquations(dModel)));
					}(
						function () {
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Arguments: ' + $elm$core$String$fromInt(props.M))
											])),
										A2(
										$elm$html$Html$p,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Parameters: ' + $elm$core$String$fromInt(props.Q))
											])),
										A2(
										$elm$html$Html$p,
										_List_Nil,
	...
	function (converter, model) {
		return F4(
			function (display, attr, name, children) {
				var shown = display && A2($elm$core$Set$member, name, model.aX);
				return _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
...
var $author$project$Rules$expressionToString_ = function (exp) {
	return $author$project$Rules$mathSymbolsToString_(
		$author$project$Math$symbolicate(exp.ai));
};
													...
													A4(
														...
														_List_fromArray(
															[
																$author$project$HtmlEvent$onClick(
																converter(
																	A2($author$project$Rules$ClickRule, topic.aG, index)))
															]),
														_Utils_ap(
															$author$project$Rules$expressionToString_(rule.aE),
															_Utils_ap(
																rule.aS ? '↔' : '→',
																$author$project$Rules$expressionToString_(rule.aT))),
														_List_fromArray(
															[
																A2(
																$elm$html$Html$h2,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$HtmlEvent$onClick(
						A2($author$project$Display$DeleteTree, eq, s.A))
					]),
				A2(
					$elm$core$List$map,
				...
				_List_fromArray(
					[
						...
						A2(
							...
							model.R ? _List_Nil : _List_fromArray(
								[
									$elm$html$Html$Attributes$class('closed')
								])),
						_List_fromArray(
							[
								...
								function () {
									var menuItem = A2($author$project$Menu$menuItem, $author$project$Main$MenuEvent, model.O);
									return _Utils_ap(
										A4(
											menuItem,
											true,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('Add Topic')
														]))
												])),
										_Utils_ap(
											A3($author$project$Tutorial$menu, $author$project$Main$TutorialEvent, menuItem, model.J),
											_Utils_ap(
												A3($author$project$Rules$menuConstants, $author$project$Main$RulesEvent, menuItem, model.E),
												_Utils_ap(
													A3($author$project$Rules$menuFunctions, $author$project$Main$RulesEvent, menuItem, model.E),
													A3($author$project$Rules$menuRules, $author$project$Main$RulesEvent, menuItem, model.E)))));
								}())
							]))
					])),
				A3($author$project$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.J),
				A3(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{bi: $author$project$Main$init, bk: $author$project$Main$EventUrlChange, bl: $author$project$Main$EventUrlRequest, bp: $author$project$Main$subscriptions, br: $author$project$Main$update, bs: $author$project$Main$view});
