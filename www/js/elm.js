...
{
	if (region.bg.aK === region.bn.aK)
	{
		return 'on line ' + region.bg.aK;
	}
	return 'on lines ' + region.bg.aK + ' through ' + region.bn.aK;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { N: 'hidden', b1: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { N: 'mozHidden', b1: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { N: 'msHidden', b1: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { N: 'webkitHidden', b1: 'webkitvisibilitychange' }
		: { N: 'hidden', b1: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cd, request.bV, true);
		} catch (e) {
		...
		request.b0.a && xhr.setRequestHeader('Content-Type', request.b0.a);
		xhr.send(request.b0.b);
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {br: fragment, bu: host, bB: path, bD: port_, bG: protocol, bH: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ag: false, bm: element, a1: trigger};
	});
				...
				model,
				{
					...
					I: A3(
						...
						A2(
							...
							$author$project$UI$Notification$delayedDelete_(model.E),
							str),
						model.I)
				}),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$UI$Animation$delayEvent,
						15000,
						$author$project$UI$Notification$ClearEvent(model.E))
					])));
	});
				...
				_Utils_Tuple2(
					{
						...
						w: true,
						s: true,
						ai: $author$project$Components$Rules$InfixOp('+')
					},
					1)),
				_Utils_Tuple2(
				'*',
				...
				_Utils_Tuple2(
					{
						...
						w: false,
						s: false,
						ai: $author$project$Components$Rules$PrefixOp('-')
					},
					1)),
				_Utils_Tuple2(
				'/',
				_Utils_Tuple2(
					{
						...
						w: false,
						s: false,
						ai: $author$project$Components$Rules$PrefixOp('1/')
					},
					1))
			])),
	t: $elm$core$Dict$empty
};
var $author$project$Components$Tutorial$init = {by: 0, bO: 0};
var $author$project$UI$Menu$init = function (shown) {
	return {U: shown};
};
var $author$project$UI$Notification$init = {E: 0, I: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{b_: false, b0: r.b0, bo: r.bo, bs: r.bs, cd: r.cd, cp: r.cp, h: r.h, bV: r.bV}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b0: $elm$http$Http$emptyBody, bo: r.bo, bs: _List_Nil, cd: 'GET', cp: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, bV: r.bV});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.b3));
			}(
				function () {
					var _v0 = deadEnd.ch;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {b3: col, b4: contextStack, ch: problem, bM: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bM, s.b3, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{b3: col, g: s0.g, i: s0.i, d: offset, bM: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.bM, s.b3, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.bM, s.b3, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{b3: newCol, g: s.g, i: s.i, d: newOffset, bM: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {b3: col, g: context, i: indent, d: offset, bM: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bg, s.d, s.c);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a6, s.d + 1, s.bM + 1, 1, s.c, s.i, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.a6, firstOffset, s.bM, s.b3 + 1, s.c, s.i, s.g);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bp: $elm$parser$Parser$ExpectingVariable, a6: i.a6, bc: i.bc, bg: i.bg});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		bg: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{a6: $elm$core$Char$isDigit, bc: $elm$core$Set$empty, bg: $elm$core$Char$isDigit});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {b3: col, ch: problem, bM: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bM, p.b3, p.ch);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{b3: 1, g: _List_Nil, i: 1, d: 0, bM: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.a_(tracker.E);
					} else {
						var prev = previous.a;
						return A2(tracker.aW, prev, tracker.E);
					}
				}()),
			_Utils_update(
				tracker,
				{
					E: tracker.E + 1,
					aN: A3($elm$core$Dict$insert, tracker.E, parent, tracker.aN)
				}));
	});
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{aW: copyState, a_: newState, E: 0, aN: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
						...
						h: _Utils_update(
							tracker,
							{
								aN: A2($elm$core$Dict$remove, 0, tracker.aN)
							})
					};
				}),
...
var $author$project$Components$Display$updateState = F2(
	function (s, _v0) {
		return {
			ar: $author$project$Algo$Matcher$getID(s)
		};
	});
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a4: url, f: _List_Nil, a7: key, a0: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.bH)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				bH: query,
				z: {
					x: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
							$author$project$Main$uiCancelCmd_(0),
							0)) : $elm$core$Maybe$Nothing,
					l: $author$project$Components$Display$init(eqs),
					...
					aE: false,
					au: false,
					ax: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.z.x, model.o);
				if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
	...
	function (child, n) {
		return function (newChildren) {
					...
					F2(
						function (elem, res) {
							return _Utils_update(
								res,
								{
									C: A2($elm$core$Basics$max, res.C, elem.C),
									F: res.F + elem.F
								});
						}),
					{C: 1, F: 0},
			...
			A2(
				...
				F2(
					function (left, right) {
						return (!_Utils_eq(left.C, right.C)) ? ((_Utils_cmp(left.C, right.C) < 0) ? 0 : 2) : ((!_Utils_eq(left.F, right.F)) ? ((_Utils_cmp(left.F, right.F) < 0) ? 0 : 2) : 1);
					}),
				A2(
					$elm$core$List$cons,
					child,
...
var $author$project$Algo$History$updateNodeValues_ = F3(
	function (index, child, model) {
		...
		while (true) {
			if (!index) {
				var _v0 = A2($author$project$Algo$History$updateNode_, child, model.at);
				var newNode = _v0.c;
				return _Utils_update(
					model,
					{at: newNode});
			} else {
				var _v1 = A2($elm$core$Dict$get, index, model.P);
				if (_v1.$ === 1) {
					return model;
				} else {
					var n = _v1.a;
					...
					var newNode = _v2.c;
					var $temp$index = n.aN,
						$temp$child = {C: height, Y: index, F: width},
						$temp$model = _Utils_update(
						model,
						{
							P: A3($elm$core$Dict$insert, index, newNode, model.P)
						});
					index = $temp$index;
					child = $temp$child;
					model = $temp$model;
...
var $author$project$Algo$History$add = F2(
	function (c, model) {
		...
		var nextID = $elm$core$Dict$size(model.P) + 1;
		return function (newModel) {
			return _Utils_update(
				newModel,
				{
					ad: _List_Nil,
					K: A2($elm$core$List$cons, nextID, model.K)
				});
		}(
			function (nodes) {
				return A3(
...
var $author$project$Algo$History$current = function (model) {
	return A2(
		...
		A2(
			...
			function (n) {
				return A2($elm$core$Dict$get, n, model.P);
			},
			$elm$core$List$head(model.K))).az;
};
	...
	function (root, parent, tracker) {
		...
		if (parent.$ === 1) {
			return _Utils_update(
				tracker,
				{
					aN: A2($elm$core$Dict$remove, id, tracker.aN)
				});
		} else {
			var p = parent.a;
			return _Utils_update(
				tracker,
				{
					aN: A3($elm$core$Dict$insert, id, p, tracker.aN)
				});
		}
	});
					...
					if (!_v16.a.$) {
						...
						if (_v17.b) {
							...
							if (!_v18.$) {
								...
								return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.e, existing.J, tracker);
							}
						} else {
							return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.e, existing.J, tracker);
						}
											...
											result,
											{
												j: A3(
													...
													$author$project$Algo$Matcher$MultiValue_(
														_Utils_update(
															nodes,
															{ap: newPost, aq: newPre})),
													result.j)
											})));
							}(
								A4($author$project$Algo$Matcher$processMultiValue_, id, result.P, newT, nodes.ap));
						}(
							A4($author$project$Algo$Matcher$processMultiValue_, id, result.P, t, nodes.aq));
					}
				} else {
					return _Utils_Tuple2(
						$author$project$Algo$Math$VariableNode(
							...
							if (_v30.a.$ === 1) {
								...
								return (!_Utils_eq(mv.aD, m.a)) ? function (_v31) {
									...
									return function (_v34) {
										...
										A4($author$project$Algo$Matcher$processMultiValue_, id, result.P, newT, mv.ap));
								}(
									A4($author$project$Algo$Matcher$processMultiValue_, id, result.P, nextT, mv.aq));
							} else {
					...
					if (_v1.$ === 1) {
						return function (_v2) {
							...
							A5(
								...
								parent,
								{j: $elm$core$Dict$empty, P: $elm$core$Dict$empty},
								_List_Nil,
								child.J,
								t));
					} else {
...
var $author$project$Algo$Matcher$processSubtree_ = F3(
	function (path, processor, eq) {
		...
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.at));
		if (!path.b) {
			return $elm$core$Result$Err('blah');
		} else {
			if (!path.b.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												at: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{L: newEq.at}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											at: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{af: children})),
											h: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											at: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{af: children})),
											h: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											at: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{af: children})),
											h: t
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.h.aN);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.h.aN, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							$author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(subEq.at)),
							subEq.h.aN);
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.at);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.z;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.a8, params.X, swappable.l);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.ag ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{ag: true}),
		element.a1(0));
...
var $author$project$Main$CloseDialog = {$: 17};
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aI: $author$project$Main$CloseDialog,
		aB: $elm$core$Maybe$Just('expr'),
		aO: _List_fromArray(
			[
				{
				aj: _List_fromArray(
				...
				aw: 'The expression to replace ' + $elm$core$String$fromFloat(target)
			}
			]),
		aP: function (dict) {
			...
			_List_fromArray(
				[
					...
					aj: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.a3) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aR: param.a + '= '}),
									$author$project$UI$Dialog$Text(
								...
								[
									...
									{e: param.a3, a: param.at}),
									$author$project$UI$Dialog$Info(
									{aR: param.V})
								]);
						},
						params.an),
					aw: 'Fill in the parameters'
				}
				])),
		aP: $author$project$Main$ApplyParameters,
					...
					function (subEq) {
						...
						if (!_v2.$) {
							...
							return (!_Utils_eq(target, n.u)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								var parent = A2($elm$core$Dict$get, id, tracker.aN);
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'parent',
					$elm$json$Json$Encode$int(node.aN)),
					_Utils_Tuple2(
					'component',
					convert(node.az)),
					_Utils_Tuple2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.at)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'visits',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.K)),
					_Utils_Tuple2(
					'undone',
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.h.E)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.h.aN))
							])))
				]));
	});
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aT.a))
								]));
					},
					rule.j))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constants',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, topic.B)),
				_Utils_Tuple2(
				'functions',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.ag))
				]));
	});
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'display',
						$author$project$Components$Display$encode(model.l)),
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bd)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.ax)),
						_Utils_Tuple2(
						'notification',
						...
						_Utils_Tuple2(
						'showMenu',
						$elm$json$Json$Encode$bool(model.au)),
						_Utils_Tuple2(
						'showHistory',
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {b2: count, b6: eq, P: nodes, at: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					ak: model.ak + 1,
					aa: A3($elm$core$Dict$insert, model.ak, c, model.aa)
				}),
			model.be(
				{b9: model.ak, cn: str}));
	});
						...
						[
							$author$project$UI$Dialog$Radio(
							{
								...
								bA: A2(
									...
									$author$project$Components$Display$listUnselectedEquations(model.l))
							})
						])
					]),
				aw: 'Select the equation to use for substitution'
			}
			]),
		aP: function (dict) {
								...
								return function (showHelp) {
									return function (showMenu) {
										return function (showHistory) {
											return {x: createMode, l: display, M: evaluator, aC: menu, al: nextCreateInt, _: notification, bd: rules, T: showHelp, aE: showHistory, au: showMenu, ax: tutorial};
										};
									};
								};
							};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {P: nodes, at: root, ad: undone, K: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {af: children, az: component, aN: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aW: copyState, a_: newState, E: id, aN: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aX: create, f: eq, N: hidden, am: next, k: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, w: associative, s: commutative, ai: javascript};
	});
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {B: constants, y: functions, a: name, bd: rules};
	});
...
var $author$project$Components$Rules$Rule_ = F4(
	function (title, description, parameters, matches) {
		return {V: description, j: matches, an: parameters, ac: title};
	});
					...
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{e: children, a: s.a, aM: $elm$core$Maybe$Nothing}),
							tokens);
					},
						...
						function (nSet) {
							return {
								X: _Utils_update(
									from,
									{
										at: A2($author$project$Components$Rules$setOthers_, nSet, from.at)
									}),
								aT: _Utils_update(
									to,
									{
										at: A2($author$project$Components$Rules$setOthers_, nSet, to.at)
									})
							};
						},
						A3(
...
var $author$project$Main$swappableDecoder = A2(
	...
	function (_v0) {
		...
		return $author$project$Main$Swappable(display)(rules)(tutorial)(notification)(menu)(evaluator)(createMode)(nextCreateInt)(showHelp)(showMenu)(showHistory);
	},
	A4(
		$elm$json$Json$Decode$map3,
...
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.h;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.aN);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
...
var $author$project$Algo$History$update = F2(
	function (e, model) {
		...
		return _Utils_update(
			model,
			{
				K: A2($elm$core$List$cons, n, model.K)
			});
	});
...
var $author$project$UI$Notification$update = F2(
	function (e, model) {
		if (!e.$) {
			var id = e.a;
			var _v1 = A2($elm$core$Dict$get, id, model.I);
			if (_v1.$ === 1) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			} else {
				var n = _v1.a;
				return function (_v2) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								I: A3($elm$core$Dict$insert, id, elem, model.I)
							}),
						cmd);
				}(
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Components$Display$update, e, model.l);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.ax);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 8:
				...
				if (str !== 'Escape') {
					...
					var _v4 = _Utils_Tuple2(core.o, model.x);
					if (!_v4.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
						...
						_Utils_update(
							model,
							{
								x: $elm$core$Maybe$Just(
									A2(
										$author$project$UI$Animation$newDeletable,
										$author$project$Main$uiCancelCmd_(model.al),
										model.al)),
								al: model.al + 1
							})),
			...
			case 11:
				...
				if (_v8.$ === 1) {
					...
					var m = _v8.a;
					return (!_Utils_eq(m.bm, num)) ? _Utils_Tuple2(core, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{x: $elm$core$Maybe$Nothing, T: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v9 = A3($author$project$Algo$Matcher$parseEquation, $author$project$Components$Display$createState, $author$project$Components$Display$updateState, str);
					if (!_v9.$) {
						var root = _v9.a;
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{x: $elm$core$Maybe$Nothing, l: dModel, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
							...
							A2($author$project$Components$Display$addEquation, root, model.l));
					} else {
						var err = _v9.a;
					...
					_Utils_update(
						core,
						{
							...
							z: _Utils_update(
								model,
								{
									bd: A2($author$project$Components$Rules$deleteTopic, name, model.bd)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 19:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v12 = A2($author$project$Components$Rules$addTopic, topic, model.bd);
					if (_v12.$ === 1) {
						var errStr = _v12.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bd: A2($author$project$Components$Rules$addSources, source.t, model.bd)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 21:
						...
						if (result.$ === 1) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									core,
									{z: s}),
								A2($author$project$Main$updateQuery_, core, s.l));
						}
					}(
						A2(
							$elm$core$Result$mapError,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.j) === 1) && $elm$core$List$isEmpty(p.an)) {
							var _v18 = A2($author$project$Helper$listIndex, 0, p.j);
							if (_v18.$ === 1) {
					...
					case 1:
						var _v19 = $author$project$Components$Display$groupChildren(model.l);
						if (_v19.$ === 1) {
							var errStr = _v19.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v20 = $author$project$Components$Display$ungroupChildren(model.l);
						if (_v20.$ === 1) {
							var errStr = _v20.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v21 = $author$project$Components$Display$selectedNode(model.l);
						if (_v21.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v21.a;
							var id = $author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(n.at));
							var _v22 = A2($author$project$Components$Rules$evaluateStr, model.bd, n.at);
							if (_v22.$ === 1) {
								var errStr = _v22.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
								...
								var _v23 = A3(
									...
									A2($author$project$Main$EvalType_, n.b6, id),
									evalStr,
									model.M);
								var eModel = _v23.a;
								var cmd = _v23.b;
					...
					return function (result) {
						...
						A2(
							...
							A2(
								...
								function () {
									var _v26 = A2($elm$core$Dict$get, '_method', params);
									if ((!_v26.$) && (_v26.a.$ === 1)) {
										var n = _v26.a.a;
			...
			case 27:
				...
				if (_v30.$ === 1) {
					...
					var newTree = _v30.a;
					var _v31 = A2($author$project$Components$Rules$evaluateStr, model.bd, newTree);
					if (_v31.$ === 1) {
						var errStr = _v31.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v33 = A2($author$project$Components$Evaluate$finish, reply.b9, model.M);
				var eModel = _v33.a;
				var c = _v33.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						if (!_Utils_eq(target, reply.u)) {
							...
							var _v36 = A3($author$project$Components$Display$replaceNumber, target, tree, model.l);
							if (_v36.$ === 1) {
								var errStr = _v36.a;
						...
						var eqNum = _v37.a;
						var id = _v37.b;
						var _v38 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.u, model.l);
						if (_v38.$ === 1) {
							var errStr = _v38.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
...
var $author$project$Main$Save = {$: 15};
			...
			aj: _List_fromArray(
				[
					...
					[
						...
						{
							b7: $author$project$Main$FileSelect(0),
							aR: 'Select a file'
						})
					])
				]),
...
var $author$project$Algo$History$view = F3(
	function (convert, serializer, model) {
		return A2(
			...
			_List_fromArray(
				[
					A5($author$project$Algo$History$serialize_, convert, serializer, model.P, 0, model.at)
				]));
	});
...
var $author$project$Main$ToggleHelp = {$: 13};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					'textbar' + $elm$core$String$fromInt(model.bm)),
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$text(
									$author$project$Algo$Math$toString(
										$author$project$Algo$History$current(eq).at))
								]))
						]));
			},
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		...
		var apply = function () {
			var applies = {
				a5: false,
				aJ: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{a5: true, aJ: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.at;
				switch (_v1.$) {
					case 3:
						...
						if (!n.w) {
							return _Utils_update(
								applies,
								{
									av: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
							...
							return _Utils_update(
								applies,
								{
									aY: (_Utils_eq(
										...
										val.b2) || (val.b2 < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									av: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									a2: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aJ),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aY),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a2),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
									...
									$author$project$Algo$Matcher$SingleValue_(
										{
											q: _List_fromArray(
												[id]),
											J: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, node)
										}),
									result.j),
								P: A3($elm$core$Dict$insert, id, node, result.P)
							});
					},
					...
					var toReplacements = $elm$core$List$map(
						function (_v5) {
							...
							return {
								...
								J: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, n)
							};
						});
					return $elm$core$Maybe$Just(
						_Utils_update(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{aZ: res, m: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.L, r.L));
					} else {
						break _v0$6;
					}
				case 3:
									...
									function (varDict) {
										...
										if (!_v3.$) {
											if (_v3.a.$ === 1) {
												...
												return (!A2($author$project$Algo$Matcher$subtreeEqual_, newSubtree, existing.J)) ? $elm$core$Maybe$Nothing : ((!$elm$core$List$isEmpty(s.e)) ? $elm$core$Maybe$Just(result) : $elm$core$Maybe$Just(
													_Utils_update(
														result,
														{
															j: A3(
	...
	function (selected, rule) {
		if (selected.$ === 1) {
			...
			if (!A2(
				$elm$core$List$any,
				function (m) {
					return A2($author$project$Algo$Matcher$matchNode, m.X.at, n.at);
				},
				rule.j)) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {X: result, a8: m.aT.at, a: m.aT.a};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.P, m.X.at, n.at)));
					},
					_List_Nil,
					rule.j);
					...
					$elm$core$Maybe$Just(
						{
							...
							an: A2(
								...
								function (p) {
									return {
										a3: $author$project$Algo$Matcher$countChildren(p.aL.at),
										V: p.V,
										a: p.aL.a,
										at: $author$project$Algo$Matcher$getName(p.aL.at)
									};
								},
								rule.an),
							ac: rule.ac
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.X.a + ('→' + match.aT.a))
												]));
									},
									rule.j),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.bd));
								}
							}());
					}),
				_List_fromArray(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												eqNum,
												highlight,
												$author$project$Algo$Math$symbolicate(eq.at)),
												A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.at)
											]))),
								result);
						}
					}),
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.b9)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.b9),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.b9))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.b7),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(m.aR)
							]));
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aR);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
							...
							return A2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(section.aw)
											])),
									A2($elm$core$List$map, $author$project$UI$Dialog$listView_, section.aj)));
						},
						model.aO),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									$author$project$UI$HtmlEvent$onClick(model.aI)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(notification.bm)
								]))
						]))));
	});
						...
						_List_fromArray(
							[
								...
								A2(
									...
									model.au ? _List_Nil : _List_fromArray(
										[
										...
										_List_fromArray(
											[
												...
												A2(
													...
													A2($author$project$Components$Display$menu, $author$project$Main$DisplayEvent, model.l))),
												A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.ax),
												A3(
												$author$project$UI$Menu$Section,
												'Topics',
												true,
												_Utils_ap(
													...
													A3(
														...
														model.bd,
														$author$project$Components$Display$selectedNode(model.l))))
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Helper$maybeGuard,
											model.aE,
											A3($author$project$Components$Display$historyView, $author$project$Main$DisplayEvent, _List_Nil, model.l)),
											A2(
											$elm$core$Maybe$map,
											$elm$html$Html$Lazy$lazy($author$project$Main$inputDiv),
											model.x)
										])))
							]))),
					$elm$core$Maybe$Just(
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.ax)),
					A2(
					$elm$core$Maybe$map,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{cb: $author$project$Main$init, ce: $author$project$Main$EventUrlChange, cf: $author$project$Main$EventUrlRequest, co: $author$project$Main$subscriptions, cq: $author$project$Main$update, cr: $author$project$Main$view});
