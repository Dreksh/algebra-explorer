...
var $author$project$Rules$init = {q: false, M: _List_Nil};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				q: $elm$core$List$isEmpty(eqs) ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
		...
		switch (event.$) {
			...
			case 7:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{q: $elm$core$Maybe$Nothing, w: false}),
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{q: $elm$core$Maybe$Nothing, t: dModel, w: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
