...
var $author$project$Algo$Matcher$toReplacement_ = F3(
	function (funcProps, strict, argDict) {
		var getFuncProp = function (name) {
			var _v7 = A2($elm$core$Dict$get, name, funcProps);
			if (_v7.$ === 1) {
				return strict ? $elm$core$Result$Err('Unable to construct ' + name) : $elm$core$Result$Ok($elm$core$Maybe$Nothing);
			} else {
				var p = _v7.a;
				return $elm$core$Result$Ok(
				...
				return A2(
					...
					$elm$core$Result$toMaybe(
						A2(
											...
											A2(
												...
												function (_v6) {
													...
													return A2(
														...
														A4($author$project$Algo$Matcher$toReplacement_, $elm$core$Dict$empty, false, args, from));
												},
												A4(
													$author$project$Algo$Matcher$treeToMatcher_,
													F2(
							...
							A4($author$project$Algo$Matcher$toReplacement_, $elm$core$Dict$empty, false, args, to))));
			} else {
				return _List_Nil;
			}
		};
...
var $author$project$Algo$Matcher$toReplacement = F3(
	function (funcProps, strict, argDict) {
		return A2(
			...
			$author$project$Algo$Math$parse,
			$elm$core$Result$andThen(
				A3($author$project$Algo$Matcher$toReplacement_, funcProps, strict, argDict)));
	});
