...
{
	if (region.ae.M === region.ap.M)
	{
		return 'on line ' + region.ae.M;
	}
	return 'on lines ' + region.ae.M + ' through ' + region.ap.M;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {au: fragment, ay: host, aG: path, aI: port_, aM: protocol, W: query};
	});
...
var $author$project$Notification$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.a7));
			}(
				function () {
					var _v0 = deadEnd.bk;
					switch (_v0.$) {
...
var $author$project$Display$idProcessor_ = {
	...
	av: F3(
		function (recurse, _v10, prop) {
			...
			var newDict = _v13.b;
			var args = _v12.b;
			var _v14 = A4($author$project$Display$idChildren_, recurse, maxNum, newDict, prop.V);
			var g = _v14.a;
			var parameters = _v14.b;
			return _Utils_Tuple2(
				g,
				$elm$core$Maybe$Just(
					{U: args, ah: prop.ah, am: prop.am, aB: prop.aB, aD: prop.aD, V: parameters, aZ: prop.aZ}));
		}),
	aN: F2(
		function (_v15, val) {
			var p = _v15.a;
...
var $author$project$Display$init = A2(
	...
	{an: $elm$core$Maybe$Nothing, n: $elm$core$Dict$empty, N: 0, aT: $elm$core$Maybe$Nothing});
var $author$project$Notification$init = {H: 0, s: $elm$core$Dict$empty};
var $author$project$Rules$init = {q: false, O: _List_Nil};
var $author$project$Tutorial$init = {aE: 0, aS: 0};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{a7: col, c: s0.c, d: s0.d, b: offset, aQ: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aQ, s.a7, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a7: col, a8: contextStack, bk: problem, aQ: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aQ, s.a7, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aQ, s.a7, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{a7: newCol, c: s.c, d: s.d, b: newOffset, aQ: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {a7: col, c: context, d: indent, b: offset, aQ: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
	...
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.ar));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.Y, s.b + 1, s.aQ + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.Y, firstOffset, s.aQ, s.a7 + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.ac) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.ar)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{ar: $elm$parser$Parser$ExpectingVariable, Y: i.Y, ac: i.ac, ae: i.ae});
};
...
function $author$project$Math$cyclic$args_() {
	return A2(
		...
		function (_v5) {
			...
			return {U: args, ah: false, am: false, aB: false, aD: '', V: parameters, aZ: false};
		},
		A2(
			$elm$parser$Parser$keeper,
			A2(
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a7: col, bk: problem, aQ: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aQ, p.a7, p.bk);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a7: 1, c: _List_Nil, d: 1, b: 0, aQ: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
		...
		return _Utils_Tuple2(
			{
				...
				A: newScreen ? $elm$core$Maybe$Just(1) : $elm$core$Maybe$Nothing,
				B: nModel,
				W: query,
			...
			switch (root.$) {
				...
				case 5:
					...
					return A2(
						...
						A2(
							$elm$core$List$cons,
							$author$project$Math$Text('\\' + (properties.aD + '(')),
							_Utils_ap(
								args,
								_List_fromArray(
									[
...
var $author$project$Math$getChildren = function (root) {
	switch (root.$) {
		...
		case 5:
			var prop = root.b;
			return _Utils_ap(prop.U, prop.V);
		case 6:
			return _List_Nil;
		case 7:
			return _List_Nil;
...
var $author$project$Display$searchProcessor_ = function (process) {
	return {
		ak: $author$project$Display$searchChild_(process),
		al: F3(
		...
		av: $author$project$Display$searchFunction_(process),
		aN: F2(
			function (g, val) {
				return _Utils_Tuple2(
					g,
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 3:
				var e = event.a;
				var _v2 = A2($author$project$Rules$update, e, model.O);
				var rModel = _v2.a;
				var rCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($author$project$Main$menuDisplayAttr_, model.A, 1),
										model.J),
										A2($author$project$Main$menuTitle_, 'Rules', 0),
										A3(
										$author$project$Rules$view,
										$author$project$Main$RulesEvent,
										A2($author$project$Main$menuDisplayAttr_, model.A, 0),
										model.O)
									]))
							]))
					])),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{bf: $author$project$Main$init, bh: $author$project$Main$EventUrlChange, bi: $author$project$Main$EventUrlRequest, bn: $author$project$Main$subscriptions, bp: $author$project$Main$update, br: $author$project$Main$view});
