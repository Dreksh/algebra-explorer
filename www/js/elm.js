...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { Q: 'hidden', cc: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { Q: 'mozHidden', cc: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { Q: 'msHidden', cc: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { Q: 'webkitHidden', cc: 'webkitvisibilitychange' }
		: { Q: 'hidden', cc: 'visibilitychange' };
}
		...
		switch (root.$) {
			case 2:
				...
				return A2(
					...
					A2($author$project$Components$Rules$replaceGlobalVar, model, s.O));
			case 3:
				var s = root.a;
				return A2(
					$elm$core$Result$map,
		...
		while (true) {
			if (!index) {
				...
				if (_v1.$ === 1) {
					...
					var newNode = _v2.c;
					var $temp$index = n.az,
						$temp$child = {G: height, Y: index, J: width},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.W))
				]));
	});
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'showMenu',
						$elm$json$Json$Encode$bool(model._)),
						_Utils_Tuple2(
						'showHistory',
			...
			switch (node.$) {
				...
				case 2:
					...
					return A2(
						...
						function (child) {
							return $author$project$Algo$Math$UnaryNode(
								{O: child, a: s.a, b: $elm$core$Maybe$Nothing});
						},
						convert(s.O));
				case 3:
					var s = node.a;
		...
		switch (root.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$treeToMatcher_, checker, knownProps, state, s.O));
			case 3:
				var s = root.a;
				return s.g ? A2(
					$elm$core$Result$map,
			...
			switch (_v0.a.$) {
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.O, r.O));
					} else {
						break _v0$6;
					}
				case 3:
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {F: createMode, h: display, P: evaluator, av: historyBox, ax: menu, an: nextCreateInt, ac: notification, bd: rules, U: showHelp, aA: showHistory, _: showMenu, aD: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {A: nodes, as: root, W: undone, C: visits};
	});
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aR: create, e: eq, Q: hidden, ao: next, n: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
	...
	if (!_v0.b) {
		...
		if (!_v0.b.b) {
			...
			return _Utils_update(
				model,
				{
					W: A2($elm$core$List$cons, x, model.W),
					C: others
				});
		}
	}
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{F: $elm$core$Maybe$Nothing, U: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v15 = A2(
						$elm$core$Result$map,
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, h: dModel, U: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.cj, model.P);
				var eModel = _v38.a;
				var c = _v38.b;
...
var $author$project$Components$Tutorial$menu = F2(
	function (converter, model) {
		return A2(
			...
			{X: $elm$core$Maybe$Nothing, a: 'Tutorials'},
			_List_Nil);
	});
			...
			A3(
									...
									return A2(
										...
										A2(
											...
											function (rule) {
												return A2(
													$author$project$UI$Menu$Section,
													{X: $elm$core$Maybe$Nothing, a: rule.a$},
													_List_fromArray(
														[
															$author$project$UI$Menu$Content(
				...
				_List_fromArray(
					[
						A2(
						$author$project$UI$Menu$Section,
						{X: $elm$core$Maybe$Nothing, a: 'Core'},
						_List_fromArray(
							[
								A2(
								$author$project$UI$Menu$Section,
								{X: $elm$core$Maybe$Nothing, a: 'Evaluate'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{X: $elm$core$Maybe$Nothing, a: 'Number Substitution'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{X: $elm$core$Maybe$Nothing, a: 'Substitute'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{X: $elm$core$Maybe$Nothing, a: 'Group'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{X: $elm$core$Maybe$Nothing, a: 'Ungroup'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
		...
		return A4(
			...
			A2(
				...
				function (c) {
					return A2(
						$elm$core$Maybe$map,
						A4($author$project$Algo$History$serialize_, converter, selectedID, nodes, c.Y),
												...
												[
													...
													_List_fromArray(
														[
															A2(
															$author$project$UI$Menu$Section,
															{X: $elm$core$Maybe$Nothing, a: 'Settings'},
															_List_fromArray(
																[
																	$author$project$UI$Menu$Content(
																	_List_fromArray(
