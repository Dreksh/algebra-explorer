			...
			return _Utils_Tuple2(
				...
				$elm$core$Maybe$Just(
					A2(
						...
						{Q: args, aN: children.aN, X: parameters})));
		}),
	aW: F2(
		function (_v8, _v10) {
			var p = _v8.a;
...
var $author$project$Menu$init = {z: $elm$core$Set$empty};
var $author$project$Notification$init = {L: 0, w: $elm$core$Dict$empty};
var $author$project$Rules$init = {p: $elm$core$Dict$empty, t: false, q: $elm$core$Dict$empty, E: $elm$core$Dict$empty};
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		...
		return _Utils_Tuple2(
			{
				t: newScreen ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
				...
				N: $author$project$Tutorial$init
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
					...
					function (name, props, result) {
						if (result.$ === 1) {
							...
							if (_v1.$ === 1) {
								...
								var p = _v2.a;
								var count = _v2.b;
								return (_Utils_eq(p.Q, props.Q) && (_Utils_eq(p.Y, props.Y) && (_Utils_eq(p.R, props.R) && _Utils_eq(p.S, props.S)))) ? $elm$core$Result$Ok(
									A3(
										$elm$core$Dict$insert,
										name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		var _v0 = A2(
			$author$project$Notification$displayError,
			str,
			_Utils_Tuple2(model.H, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {p: constants, q: functions, aN: name, k: rules};
	});
...
var $author$project$Rules$FunctionProperties_ = F4(
	function (args, params, associative, commutative) {
		return {Q: args, R: associative, S: commutative, Y: params};
	});
...
var $author$project$Rules$matchFunction_ = F2(
	function (props, node) {
		return (props.R && props.S) ? ($elm$core$List$isEmpty(node.X) && ($elm$core$List$length(node.Q) > 1)) : (_Utils_eq(
			props.Q,
			$elm$core$List$length(node.Q)) && _Utils_eq(
			props.Y,
...
var $author$project$Display$searchFunction_ = F4(
	function (process, recurse, _v0, _v1) {
		...
		return function (_v6) {
			var o = _v6.a;
			var func = _v6.b;
			return ($elm$core$List$isEmpty(func.Q) && $elm$core$List$isEmpty(func.X)) ? _Utils_Tuple2(o, $elm$core$Maybe$Nothing) : _Utils_Tuple2(
				o,
				$elm$core$Maybe$Just(
...
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 4:
				var e = event.a;
				var _v3 = A2($author$project$Tutorial$update, e, model.N);
				var tModel = _v3.a;
				var tCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 5:
				var e = event.a;
				var _v4 = A2($author$project$Notification$update, e, model.H);
				var nModel = _v4.a;
				var nCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 8:
				...
				return (str === 'Escape') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{t: $elm$core$Maybe$Nothing, D: false}),
			...
			case 9:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							t: $elm$core$Maybe$Just($elm$core$Maybe$Nothing)
						}),
					...
					return function (dModel) {
						return function (query) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{t: $elm$core$Maybe$Nothing, u: dModel, D: false}),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											$author$project$Query$pushUrl(query),
...
var $author$project$Tutorial$menu = F3(
	function (converter, menuItem, model) {
		return A4(menuItem, true, _List_Nil, 'Tutorials', _List_Nil);
	});
var $author$project$Rules$ClickVariable = function (a) {
	return {$: 0, a: a};
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Rules$menuConstants = F3(
	function (converter, menuItem, model) {
		return A4(
			menuItem,
			true,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Arguments: ' + $elm$core$String$fromInt(props.Q))
											])),
										A2(
										$elm$html$Html$p,
										_List_Nil,
...
var $author$project$Icon$rightArrow = function (attr) {
	return A2(
		$elm$svg$Svg$svg,
		_Utils_ap(
			attr,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M3 5L18 12 L3 19 L9 12Z'),
						$elm$svg$Svg$Attributes$stroke('none'),
						$elm$svg$Svg$Attributes$fill('currentColor')
					]),
				_List_Nil)
...
var $author$project$Menu$menuItem = F2(
	function (converter, model) {
		return F4(
			function (display, attr, name, children) {
				var closed = (!display) || A2($elm$core$Set$member, name, model.z);
				return _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						A2(
							...
							closed ? _List_Nil : _List_fromArray(
								[
									$elm$html$Html$Attributes$class('shown')
								])),
						_List_fromArray(
							[
								$author$project$Icon$rightArrow(
								A2(
									$elm$core$List$cons,
									$author$project$HtmlEvent$onClick(
										converter(name)),
									closed ? _List_Nil : _List_fromArray(
										[
											$author$project$Icon$class('shown')
										]))),
								A2(
								$elm$html$Html$h1,
								attr,
...
var $author$project$Rules$menuRules = F4(
	function (converter, menuItem, model, selectedNode) {
		return A4(
			menuItem,
			true,
			_List_Nil,
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$author$project$HtmlEvent$onClick(
							A2($author$project$Display$Select, eq, s.A))
						]),
					_Utils_eq(
						s.A,
		...
		bh: _Utils_ap(
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									function () {
										var menuItem = A2($author$project$Menu$menuItem, $author$project$Main$MenuEvent, model.V);
										return _Utils_ap(
											A4(
												menuItem,
												true,
											...
											_Utils_ap(
												A3($author$project$Tutorial$menu, $author$project$Main$TutorialEvent, menuItem, model.N),
												_Utils_ap(
													A3($author$project$Rules$menuConstants, $author$project$Main$RulesEvent, menuItem, model.k),
													_Utils_ap(
														A3($author$project$Rules$menuFunctions, $author$project$Main$RulesEvent, menuItem, model.k),
														A4(
					...
					A3($author$project$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.N),
					A3(
			...
			$author$project$Main$dialogPane_(model.T)),
		bF: 'Maths'
	};
};
