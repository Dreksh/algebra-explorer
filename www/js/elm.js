...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {al: nextCallID, ac: ongoing, be: sender};
	});
...
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			q: {B: top + height, w: left, A: left + width, F: top},
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bW, s.cc, x, s.i));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cc: col, i: s0.i, l: s0.l, f: offset, bW: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.bW, s.cc, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.bW, s.cc, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cc: newCol, i: s.i, l: s.l, f: newOffset, bW: newRow, d: s.d});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cc: col, i: context, l: indent, f: offset, bW: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a5, s.f + 1, s.bW + 1, 1, s.d, s.l, s.i) : A7($elm$parser$Parser$Advanced$varHelp, i.a5, firstOffset, s.bW, s.cc + 1, s.d, s.l, s.i);
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cc: 1, i: _List_Nil, l: 1, f: 0, bW: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		...
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable.ab, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
		...
		return A2(
			...
			function (_v0) {
				...
				var finalTracker = A3(
					...
					A2(
						$elm$core$Set$diff,
						$author$project$Algo$Matcher$getSubtreeIDs_(eq.ar),
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.E;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.cs, params.a3, swappable.h);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model.ac))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'top',
				$elm$json$Json$Encode$float(model.q.F)),
				_Utils_Tuple2(
				'bottom',
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.ab)),
						_Utils_Tuple2(
						'menu',
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					al: model.al + 1,
					ac: A3($elm$core$Dict$insert, model.al, c, model.ac)
				}),
			model.be(
				{ci: model.al, cx: str}));
	});
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {D: createMode, h: display, O: evaluator, av: historyBox, ax: menu, am: nextCreateInt, ab: notification, bd: rules, U: showHelp, az: showHistory, Y: showMenu, aC: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {R: nodes, ar: root, Z: undone, I: visits};
	});
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aR: create, e: eq, P: hidden, an: next, n: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {B: bottom, w: left, A: right, F: top};
	});
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: {B: orig.B + dy, w: orig.w + dx, A: orig.A + dx, F: orig.F + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												B: A2($elm$core$Basics$max, orig.F + 2, orig.B + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 4:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											...
											{
												w: A2($elm$core$Basics$min, orig.A - 2, orig.w + dx),
												F: A2($elm$core$Basics$min, orig.B - 2, orig.F + dy)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 5:
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model.ab);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{D: $elm$core$Maybe$Nothing, h: dModel, U: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.ci, model.O);
				var eModel = _v38.a;
				var c = _v38.b;
		...
		if (selection.$ === 1) {
			...
			var result = A5(
				...
				$author$project$UI$ActionView$Allowed(
					A2($author$project$Components$Rules$Substitute, selected.ai, selected.n)),
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var tree = _v1.c;
					return {ai: eqNum, R: nodes, ar: root, n: ids, aN: tree};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'top',
					$elm$core$String$fromFloat(model.q.F) + 'dvh'),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					...
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat(model.q.B - model.q.F) + 'dvh'),
