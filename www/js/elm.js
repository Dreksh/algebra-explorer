...
{
	if (region.be.aJ === region.bk.aJ)
	{
		return 'on line ' + region.be.aJ;
	}
	return 'on lines ' + region.be.aJ + ' through ' + region.bk.aJ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { M: 'hidden', b_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { M: 'mozHidden', b_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { M: 'msHidden', b_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { M: 'webkitHidden', b_: 'webkitvisibilitychange' }
		: { M: 'hidden', b_: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cb, request.bS, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bo: fragment, br: host, by: path, bA: port_, bD: protocol, bE: query};
	});
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$UI$Notification$delayedClear_(model.D)
					])));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'str',
					$elm$json$Json$Encode$string($.cl))
				]));
	});
...
var $author$project$Components$Evaluate$Model = F3(
	function (nextCallID, ongoing, sender) {
		return {aj: nextCallID, aa: ongoing, bc: sender};
	});
				...
				_Utils_Tuple2(
					{
						...
						w: true,
						s: true,
						ah: $author$project$Components$Rules$InfixOp('+')
					},
					1)),
				_Utils_Tuple2(
				'*',
				...
				_Utils_Tuple2(
					{
						...
						w: false,
						s: false,
						ah: $author$project$Components$Rules$PrefixOp('-')
					},
					1)),
				_Utils_Tuple2(
				'/',
				_Utils_Tuple2(
					{
						...
						w: false,
						s: false,
						ah: $author$project$Components$Rules$PrefixOp('1/')
					},
					1))
			])),
	t: $elm$core$Dict$empty
};
var $author$project$Components$Tutorial$init = {bv: 0, bL: 0};
var $author$project$UI$Menu$init = function (shown) {
	return {U: shown};
};
var $author$project$UI$Notification$init = {D: 0, P: $elm$core$Dict$empty};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bX: false, bZ: r.bZ, bl: r.bl, bp: r.bp, cb: r.cb, cn: r.cn, h: r.h, bS: r.bS}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bZ: $elm$http$Http$emptyBody, bl: r.bl, bp: _List_Nil, cb: 'GET', cn: $elm$core$Maybe$Nothing, h: $elm$core$Maybe$Nothing, bS: r.bS});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.b0));
			}(
				function () {
					var _v0 = deadEnd.cf;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {b0: col, b1: contextStack, cf: problem, bJ: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bJ, s.b0, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{b0: col, g: s0.g, i: s0.i, d: offset, bJ: row, c: s0.c});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.bJ, s.b0, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.bJ, s.b0, s.c);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{b0: newCol, g: s.g, i: s.i, d: newOffset, bJ: newRow, c: s.c});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {b0: col, g: context, i: indent, d: offset, bJ: row, c: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.be, s.d, s.c);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a4, s.d + 1, s.bJ + 1, 1, s.c, s.i, s.g) : A7($elm$parser$Parser$Advanced$varHelp, i.a4, firstOffset, s.bJ, s.b0 + 1, s.c, s.i, s.g);
			var name = A3($elm$core$String$slice, s.d, s1.d, s.c);
			return A2($elm$core$Set$member, name, i.ba) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bm: $elm$parser$Parser$ExpectingVariable, a4: i.a4, ba: i.ba, be: i.be});
};
var $author$project$Algo$Math$tokenLongName_ = $elm$parser$Parser$variable(
	{
		...
		ba: $elm$core$Set$empty,
		be: $author$project$Algo$Math$validVarStart_
	});
...
var $author$project$Algo$Math$tokenDigit_ = $elm$parser$Parser$variable(
	{a4: $elm$core$Char$isDigit, ba: $elm$core$Set$empty, be: $elm$core$Char$isDigit});
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{w: true, af: children, s: true, a: '+', b: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {b0: col, cf: problem, bJ: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bJ, p.b0, p.cf);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{b0: 1, g: _List_Nil, i: 1, d: 0, bJ: 1, c: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aZ(tracker.D);
					} else {
						var prev = previous.a;
						return A2(tracker.aV, prev, tracker.D);
					}
				}()),
			_Utils_update(
				tracker,
				{
					D: tracker.D + 1,
					aM: A3($elm$core$Dict$insert, tracker.D, parent, tracker.aM)
				}));
	});
...
var $author$project$Algo$Matcher$processID_ = F3(
	function (parent, tracker, oldRoot) {
		...
		switch (oldRoot.$) {
			...
			case 2:
				var s = oldRoot.a;
				var _v2 = A3($author$project$Algo$Matcher$processID_, id, newTracker, s.K);
				var newChild = _v2.a;
				var finalT = _v2.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$UnaryNode(
						{K: newChild, a: s.a, b: state}),
					finalT);
			case 3:
				var s = oldRoot.a;
				var _v3 = A2(processChildren, newTracker, s.af);
				var newChildren = _v3.a;
				var finalT = _v3.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{w: s.w, af: newChildren, s: s.s, a: s.a, b: state}),
					finalT);
			case 4:
				var s = oldRoot.a;
				var _v4 = A2(processChildren, newTracker, s.af);
				var newChildren = _v4.a;
				var finalT = _v4.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$GenericNode(
						{af: newChildren, a: s.a, b: state}),
					finalT);
			default:
				var s = oldRoot.a;
				var _v5 = A2(processChildren, newTracker, s.af);
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					-1,
					{aV: copyState, aZ: newState, D: 0, aM: $elm$core$Dict$empty}),
				function (_v0) {
					var newRoot = _v0.a;
					var tracker = _v0.b;
					return {
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a2: url, f: _List_Nil, a5: key, a$: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.bE)));
	});
		...
		return _Utils_Tuple2(
			{
				...
				bE: query,
				y: {
					F: newScreen ? $elm$core$Maybe$Just($elm$core$Maybe$Nothing) : $elm$core$Maybe$Nothing,
					k: $author$project$Components$Display$init(eqs),
					L: $author$project$Components$Evaluate$init($author$project$Main$evaluateString),
					...
					_: nModel,
					aC: false,
					bb: $author$project$Components$Rules$init,
					T: false,
					aD: false,
					as: newScreen ? true : false,
					av: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.y.F, model.o);
				if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
					var _v1 = _v0.a;
					var _v2 = _v0.b;
			...
			switch (node.$) {
				...
				case 3:
					...
					return $author$project$Algo$Math$BinaryNode(
						{
							w: s.w,
							af: A2($elm$core$List$map, convert, s.af),
							s: s.s,
							a: s.a,
							b: {
								z: $elm$core$Maybe$Nothing,
				...
				F3(
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							var p = _v1.a;
							var count = _v1.b;
							return (_Utils_eq(p.e, props.e) && (_Utils_eq(p.w, props.w) && _Utils_eq(p.s, props.s))) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Main$submitNotification_ = F2(
	function (model, str) {
		var swappable = model.y;
		var _v0 = A2(
			$author$project$UI$Notification$displayError,
			str,
			_Utils_Tuple2(swappable._, $elm$core$Platform$Cmd$none));
		var nModel = _v0.a;
		var nCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
	...
	function (child, n) {
		return function (newChildren) {
					...
					F2(
						function (elem, res) {
							return _Utils_update(
								res,
								{
									B: A2($elm$core$Basics$max, res.B, elem.B),
									E: res.E + elem.E
								});
						}),
					{B: 1, E: 0},
			...
			A2(
				...
				F2(
					function (left, right) {
						return (!_Utils_eq(left.B, right.B)) ? ((_Utils_cmp(left.B, right.B) < 0) ? 0 : 2) : ((!_Utils_eq(left.E, right.E)) ? ((_Utils_cmp(left.E, right.E) < 0) ? 0 : 2) : 1);
					}),
				A2(
					$elm$core$List$cons,
					child,
					A2(
						...
						function (elem) {
							return !_Utils_eq(elem.Y, child.Y);
						},
						n.af))));
	});
	...
	function (index, child, model) {
		...
		while (true) {
			if (!index) {
				...
				var _v1 = A2($elm$core$Dict$get, index, model.O);
				if (_v1.$ === 1) {
					return model;
				} else {
					var n = _v1.a;
					...
					var newNode = _v2.c;
					var $temp$index = n.aM,
						$temp$child = {B: height, Y: index, E: width},
						$temp$model = _Utils_update(
						model,
						{
							O: A3($elm$core$Dict$insert, index, newNode, model.O)
						});
					index = $temp$index;
					child = $temp$child;
					model = $temp$model;
...
var $author$project$Algo$History$add = F2(
	function (c, model) {
		...
		var nextID = $elm$core$Dict$size(model.O) + 1;
		return function (newModel) {
			return _Utils_update(
				newModel,
				{
					ad: _List_Nil,
					J: A2($elm$core$List$cons, nextID, model.J)
				});
		}(
			function (nodes) {
				return A3(
...
var $author$project$Algo$History$current = function (model) {
	return A2(
		...
		A2(
			...
			function (n) {
				return A2($elm$core$Dict$get, n, model.O);
			},
			$elm$core$List$head(model.J))).ax;
};
...
var $author$project$Algo$Matcher$constructFromSource_ = F4(
	function (result, tracker, p, matcher) {
		...
		switch (matcher.$) {
			case 0:
				var m = matcher.a;
				var _v16 = A2($elm$core$Dict$get, m.a, result.j);
				if (!_v16.$) {
					if (!_v16.a.$) {
						...
						if (_v17.b) {
							var nodeID = _v17.a;
							var other = _v17.b;
							var _v18 = A2($elm$core$Dict$get, nodeID, result.O);
							if (!_v18.$) {
								var n = _v18.a;
								return _Utils_Tuple2(
									n,
								...
								return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.e, existing.I, tracker);
							}
						} else {
							return A5($author$project$Algo$Matcher$constructFromValue_, p, result, m.e, existing.I, tracker);
						}
							...
							return function (_v21) {
								...
								return _Utils_Tuple2(
									$author$project$Algo$Math$BinaryNode(
										{
											w: true,
											af: _Utils_ap(preNodes, postNodes),
											s: true,
											a: nodes.aB,
											b: s
										}),
											...
											result,
											{
												j: A3(
													...
													$author$project$Algo$Matcher$MultiValue_(
														_Utils_update(
															nodes,
															{an: newPost, ao: newPre})),
													result.j)
											})));
							}(
								A4($author$project$Algo$Matcher$processMultiValue_, id, result.O, newT, nodes.an));
						}(
							A4($author$project$Algo$Matcher$processMultiValue_, id, result.O, t, nodes.ao));
					}
				} else {
					return _Utils_Tuple2(
						$author$project$Algo$Math$VariableNode(
			...
			default:
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						return _Utils_Tuple2(
							$author$project$Algo$Math$BinaryNode(
								{w: true, af: c, s: true, a: m.a, b: s}),
							_Utils_Tuple2(nextT, nextRes));
					} else {
						var o = _v29.a;
						var _v30 = A2($elm$core$Dict$get, o, result.j);
						if (_v30.$ === 1) {
							return _Utils_Tuple2(
								$author$project$Algo$Math$BinaryNode(
									{w: true, af: c, s: true, a: m.a, b: s}),
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.aB, m.a)) ? function (_v31) {
									...
									return function (_v34) {
										...
										A4($author$project$Algo$Matcher$processMultiValue_, id, result.O, newT, mv.an));
								}(
									A4($author$project$Algo$Matcher$processMultiValue_, id, result.O, nextT, mv.ao));
							} else {
...
var $author$project$Algo$Matcher$constructFromValue_ = F5(
	function (parent, result, args, existing, tracker) {
		...
		switch (existing.$) {
			...
			case 2:
				var s = existing.a;
				var _v9 = A5($author$project$Algo$Matcher$constructFromValue_, id, result, args, s.K, newTracker);
				var newChild = _v9.a;
				var _final = _v9.b;
				return _Utils_Tuple2(
					$author$project$Algo$Math$UnaryNode(
						{K: newChild, a: s.a, b: newS}),
					_final);
			case 3:
				var s = existing.a;
				var _v10 = A2(
				...
				return _Utils_Tuple2(
					$author$project$Algo$Math$BinaryNode(
						{w: s.w, af: newChildren, s: s.s, a: s.a, b: newS}),
					_final);
			case 4:
				var s = existing.a;
				var _v11 = A2(
		...
		return A2(
			...
			F2(
				function (_v0, child) {
					var t = _v0.a;
					var r = _v0.b;
					var _v1 = $elm$core$List$head(child.q);
					if (_v1.$ === 1) {
						return function (_v2) {
							var node = _v2.a;
							var _v3 = _v2.b;
							...
							A5(
								...
								parent,
								{j: $elm$core$Dict$empty, O: $elm$core$Dict$empty},
								_List_Nil,
								child.I,
								t));
					} else {
									...
									_Utils_ap(
										...
										_List_fromArray(
											[
												...
												child,
												{
													q: A2($elm$core$List$drop, 1, child.q)
												})
											]))));
						} else {
							var node = _v4.a;
	...
	switch (root.$) {
		...
		case 2:
			...
			return A2(
				$elm$core$Set$insert,
				$author$project$Algo$Matcher$getID(s.b),
				$author$project$Algo$Matcher$getSubtreeIDs_(s.K));
		case 3:
			var s = root.a;
			return A3(
				$elm$core$List$foldl,
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, into, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.h.aM);
		if (_v0.$ === 1) {
			...
			return A2(
				...
				A3(
					$author$project$Algo$Matcher$processSubtree_,
					A2($author$project$Algo$Matcher$searchPath_, eq.h.aM, id),
					function (subEq) {
						var pID = A2(
							$elm$core$Dict$get,
							...
							subEq.h.aM);
						var _v2 = A4($author$project$Algo$Matcher$constructFromSource_, _with, subEq.h, -1, into);
						var newRoot = _v2.a;
						var _v3 = _v2.b;
							...
							F2(
								function (elem, t) {
									return _Utils_update(
										t,
										{
											aM: A2($elm$core$Dict$remove, elem, t.aM)
										});
								}),
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.y;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.a6, params.X, swappable.k);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
		...
		return A2(
			...
			function () {
				switch (root.$) {
					...
					case 1:
						var s = root.a;
						var _v1 = A2($elm$core$Dict$get, s.a, model.A);
						if (_v1.$ === 1) {
					...
					case 2:
						...
						return A2(
							...
							A2($author$project$Components$Rules$evaluateStr, model, s.K));
					case 3:
						var s = root.a;
						return A2(
							$elm$core$Result$andThen,
...
var $author$project$Components$Evaluate$finish = F2(
	function (id, model) {
		var _v0 = A2($elm$core$Dict$get, id, model.aa);
		if (_v0.$ === 1) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aa: A2($elm$core$Dict$remove, id, model.aa)
					}),
...
var $author$project$Main$numSubDialog_ = function (target) {
	return {
		aH: $author$project$Main$CloseDialog,
		az: $elm$core$Maybe$Just('expr'),
		aN: _List_fromArray(
			[
				{
				ai: _List_fromArray(
				...
				au: 'The expression to replace ' + $elm$core$String$fromFloat(target)
			}
			]),
		aO: function (dict) {
...
var $author$project$Main$parameterDialog_ = function (params) {
	return {
		...
		aN: function (sections) {
			return ($elm$core$List$length(params.j) <= 1) ? sections : A2(
				$elm$core$List$cons,
				{
					ai: _List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					ai: A2(
						$elm$core$List$map,
						function (param) {
							return (!param.a1) ? _List_fromArray(
								[
									$author$project$UI$Dialog$Info(
									{aQ: param.a + '= '}),
									$author$project$UI$Dialog$Text(
								...
								[
									...
									{e: param.a1, a: param.ar}),
									$author$project$UI$Dialog$Info(
									{aQ: param.V})
								]);
						},
						params.al),
					au: 'Fill in the parameters'
				}
				])),
		aO: $author$project$Main$ApplyParameters,
		...
		switch (root.$) {
			case 2:
				...
				return A2(
					...
					A2($author$project$Components$Rules$replaceGlobalVar, model, s.K));
			case 3:
				var s = root.a;
				return A2(
					$elm$core$Result$map,
			...
			case 4:
				...
				return A2(
					$elm$core$Result$andThen,
					function (children) {
						var _v1 = A2($elm$core$Dict$get, s.a, model.x);
						if (_v1.$ === 1) {
							return $elm$core$Result$Ok(
								$author$project$Algo$Math$GenericNode(
									_Utils_update(
							...
							if ((f.e === 2) && (f.w || f.s)) {
								return $elm$core$Result$Ok(
									$author$project$Algo$Math$BinaryNode(
										{w: f.w, af: children, s: f.s, a: s.a, b: s.b}));
							} else {
								if (!_Utils_eq(
			...
			return A2(
				...
				A3(
					...
					function (subEq) {
						...
						if (!_v2.$) {
							var n = _v2.a;
							return (!_Utils_eq(target, n.u)) ? $elm$core$Result$Err('Expression does not equal to the node\'s value') : function (_v3) {
								var root = _v3.a;
								var tracker = _v3.b;
								...
								return $elm$core$Result$Ok(
									_Utils_Tuple2(
										...
										{
											ar: root,
											h: A3($author$project$Algo$Matcher$setParent_, root, parent, nextTracker)
										}));
							}(
								A3($author$project$Algo$Matcher$processID_, -1, subEq.h, subtree));
						} else {
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'value',
							$elm$json$Json$Encode$float(s.u)),
							_Utils_Tuple2(
							'type',
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'child',
							A2($author$project$Algo$Math$encode, converter, s.K)),
							_Utils_Tuple2(
							'type',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'visits',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.J)),
					_Utils_Tuple2(
					'undone',
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'nextID',
								$elm$json$Json$Encode$int(eq.h.D)),
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.h.aM))
							])))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'nextCallID',
					$elm$json$Json$Encode$int(model.aj)),
					_Utils_Tuple2(
					'ongoing',
					A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, converter, model.aa))
				]));
	});
						...
						return $elm$json$Json$Encode$object(
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'to',
									$elm$json$Json$Encode$string(match.aS.a))
								]));
					},
					rule.j))
			]));
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constants',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, topic.A)),
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.x)),
				_Utils_Tuple2(
				'actions',
				A2($elm$json$Json$Encode$list, $author$project$Components$Rules$encodeRule_, topic.bb))
			]));
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'display',
						$author$project$Components$Display$encode(model.k)),
						_Utils_Tuple2(
						'rules',
						$author$project$Components$Rules$encode(model.bb)),
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.av)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model._)),
						_Utils_Tuple2(
						'menu',
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var count = _v1.c;
					return {b$: count, b4: eq, O: nodes, ar: root};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					aj: model.aj + 1,
					aa: A3($elm$core$Dict$insert, model.aj, c, model.aa)
				}),
			model.bc(
				{b7: model.aj, cl: str}));
	});
						...
						[
							$author$project$UI$Dialog$Radio(
							{
								...
								bx: A2(
									...
									$author$project$Components$Display$listUnselectedEquations(model.k))
							})
						])
					]),
				au: 'Select the equation to use for substitution'
			}
			]),
		aO: function (dict) {
								...
								return function (showHelp) {
									return function (showMenu) {
										return function (showHistory) {
											return {F: createMode, k: display, L: evaluator, aA: menu, _: notification, aC: resetInput, bb: rules, T: showHelp, aD: showHistory, as: showMenu, av: tutorial};
										};
									};
								};
							};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {O: nodes, ar: root, ad: undone, J: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {af: children, ax: component, aM: parent};
	});
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aV: copyState, aZ: newState, D: id, aM: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aW: create, f: eq, M: hidden, ak: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F4(
	function (_arguments, associative, commutative, javascript) {
		return {e: _arguments, w: associative, s: commutative, ah: javascript};
	});
...
var $author$project$Components$Rules$functionDecoder_ = A2(
	$elm$json$Json$Decode$andThen,
	function (f) {
		return ((f.w || f.s) && (f.e !== 2)) ? $elm$json$Json$Decode$fail('Associative and Commutative properties only apply to binary functions') : ((f.w && (!f.s)) ? $elm$json$Json$Decode$fail('Only associative binary nodes is not supported yet') : $elm$json$Json$Decode$succeed(f));
	},
	A5(
		$elm$json$Json$Decode$map4,
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {A: constants, x: functions, a: name, bb: rules};
	});
...
var $author$project$Components$Rules$Rule_ = F4(
	function (title, description, parameters, matches) {
		return {V: description, j: matches, al: parameters, ac: title};
	});
		...
		switch (root.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Components$Rules$treeToMatcher_, from, functions, constants, s.K));
			case 3:
				var s = root.a;
				return s.s ? A2(
					$elm$core$Result$map,
					function (_v2) {
						...
						return _Utils_Tuple2(
							$author$project$Algo$Matcher$CommutativeMatcher(
								{e: children, a: s.a, aL: $elm$core$Maybe$Nothing}),
							tokens);
					},
						...
						function (nSet) {
							return {
								X: _Utils_update(
									from,
									{
										ar: A2($author$project$Components$Rules$setOthers_, nSet, from.ar)
									}),
								aS: _Utils_update(
									to,
									{
										ar: A2($author$project$Components$Rules$setOthers_, nSet, to.ar)
									})
							};
						},
						A3(
...
var $author$project$Main$swappableDecoder = A2(
	...
	function (_v0) {
		...
		var showHelp = _v5.a;
		var showMenu = _v5.b;
		var showHistory = _v5.c;
		return $author$project$Main$Swappable(display)(rules)(tutorial)(notification)(menu)(evaluator)(createMode)(resetInput)(showHelp)(showMenu)(showHistory);
	},
	A4(
		$elm$json$Json$Decode$map3,
...
var $author$project$Algo$Matcher$ungroupSubtree = F2(
	function (ids, eq) {
		var tracker = eq.h;
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, tracker.aM);
		if (_v0.$ === 1) {
			return $elm$core$Result$Err('Nodes not found');
		} else {
			var _v1 = _v0.a;
...
var $author$project$Algo$History$update = F2(
	function (e, model) {
		...
		return _Utils_update(
			model,
			{
				J: A2($elm$core$List$cons, n, model.J)
			});
	});
var $author$project$Components$Display$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var eq = event.a;
				return A2($elm$core$Set$member, eq, model.M) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							M: A2($elm$core$Set$remove, eq, model.M)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							M: A2($elm$core$Set$insert, eq, model.M)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var he = event.a;
										...
										_Utils_update(
											model,
											{
												f: A3(
													$elm$core$Dict$insert,
													num,
													A2($author$project$Algo$History$update, he, eq),
													model.f)
											}),
										$elm$core$Platform$Cmd$none);
								},
								A2($elm$core$Dict$get, num, model.f));
						},
						model.l));
		}
	});
...
var $author$project$Components$Display$updateEquation = F3(
	function (id, eq, model) {
		var _v0 = A2($elm$core$Dict$get, id, model.f);
		if (_v0.$ === 1) {
			return _Utils_update(
				model,
				{
			...
			return _Utils_update(
				model,
				{
					f: A3(
						$elm$core$Dict$insert,
						id,
						A2($author$project$Algo$History$add, eq, hisModel),
						model.f)
				});
		}
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 2:
				var e = event.a;
				var _v1 = A2($author$project$Components$Display$update, e, model.k);
				var dModel = _v1.a;
				var dCmd = _v1.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.av);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 5:
				var e = event.a;
				var _v3 = A2($author$project$UI$Notification$update, e, model._);
				var nModel = _v3.a;
				var nCmd = _v3.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 8:
				...
				if (str !== 'Escape') {
					...
					var _v4 = _Utils_Tuple2(core.o, model.F);
					if (!_v4.a.$) {
						return _Utils_Tuple2(
							_Utils_update(
								core,
						...
						if (!_v4.b.$) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, T: false})),
								$elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						}
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								F: $elm$core$Maybe$Just($elm$core$Maybe$Nothing),
								aC: false
							})),
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, k: dModel, aC: true, T: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
							...
							function () {
								if (id.$ === 1) {
									return A2($author$project$Components$Display$addEquation, root, model.k);
								} else {
									var i = id.a;
									return A3($author$project$Components$Display$updateEquation, i, root, model.k);
								}
							}());
					} else {
						var err = _v5.a;
					...
					_Utils_update(
						core,
						{
							...
							y: _Utils_update(
								model,
								{
									bb: A2($author$project$Components$Rules$deleteTopic, name, model.bb)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 18:
				...
				if (result.$ === 1) {
					...
					var topic = result.a;
					var _v9 = A2($author$project$Components$Rules$addTopic, topic, model.bb);
					if (_v9.$ === 1) {
						var errStr = _v9.a;
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bb: A2($author$project$Components$Rules$addSources, source.t, model.bb)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 20:
				...
				if (!fileType) {
					return function (result) {
						...
						A2(
							$elm$core$Result$andThen,
							function (topic) {
								return A2($author$project$Components$Rules$addTopic, topic, model.bb);
							},
							A2(
								$elm$core$Result$mapError,
								$elm$json$Json$Decode$errorToString,
						...
						if (result.$ === 1) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									core,
									{y: s}),
								A2($author$project$Main$updateQuery_, core, s.k));
						}
					}(
						A2(
							$elm$core$Result$mapError,
			...
			case 3:
				...
				switch (e.$) {
					case 0:
						var p = e.a;
						if (($elm$core$List$length(p.j) === 1) && $elm$core$List$isEmpty(p.al)) {
							var _v15 = A2($author$project$Helper$listIndex, 0, p.j);
							if (_v15.$ === 1) {
					...
					case 1:
						var _v16 = $author$project$Components$Display$groupChildren(model.k);
						if (_v16.$ === 1) {
							var errStr = _v16.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					case 2:
						var _v17 = $author$project$Components$Display$ungroupChildren(model.k);
						if (_v17.$ === 1) {
							var errStr = _v17.a;
							return A2($author$project$Main$submitNotification_, core, errStr);
						} else {
					...
					default:
						var _v18 = $author$project$Components$Display$selectedNode(model.k);
						if (_v18.$ === 1) {
							return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
						} else {
							var n = _v18.a;
							var id = $author$project$Algo$Matcher$getID(
								$author$project$Algo$Math$getState(n.ar));
							var _v19 = A2($author$project$Components$Rules$evaluateStr, model.bb, n.ar);
							if (_v19.$ === 1) {
								var errStr = _v19.a;
								return A2($author$project$Main$submitNotification_, core, errStr);
							} else {
								...
								var _v20 = A3(
									...
									A2($author$project$Main$EvalType_, n.b4, id),
									evalStr,
									model.L);
								var eModel = _v20.a;
								var cmd = _v20.b;
						...
						A2(
							...
							A2(
								...
								function () {
									...
									if ((!_v23.$) && (_v23.a.$ === 1)) {
										var n = _v23.a.a;
										return A2($author$project$Helper$listIndex, n, existing.j);
									} else {
										return A2($author$project$Helper$listIndex, 0, existing.j);
									}
								}())));
				} else {
					return _Utils_Tuple2(
			...
			case 26:
				...
				var _v27 = A2(
					$elm$core$Result$andThen,
					$author$project$Components$Rules$replaceGlobalVar(model.bb),
					$author$project$Algo$Math$parse(str));
				if (_v27.$ === 1) {
					var errStr = _v27.a;
					return A2($author$project$Main$submitNotification_, core, errStr);
					...
					var newTree = _v27.a;
					var _v28 = A2($author$project$Components$Rules$evaluateStr, model.bb, newTree);
					if (_v28.$ === 1) {
						var errStr = _v28.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v30 = A2($author$project$Components$Evaluate$finish, reply.b7, model.L);
				var eModel = _v30.a;
				var c = _v30.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var target = _v32.a;
						var tree = _v32.b;
						if (!_Utils_eq(target, reply.u)) {
							return A2(
								$author$project$Main$submitNotification_,
								newCore,
								'Expression evaluates to: ' + ($elm$core$String$fromFloat(reply.u) + (', but expecting: ' + $elm$core$String$fromFloat(target))));
						} else {
							var _v33 = A3($author$project$Components$Display$replaceNumber, target, tree, model.k);
							if (_v33.$ === 1) {
								var errStr = _v33.a;
						...
						var eqNum = _v34.a;
						var id = _v34.b;
						var _v35 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.u, model.k);
						if (_v35.$ === 1) {
							var errStr = _v35.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
...
var $author$project$Main$ToggleHistory = {$: 23};
			...
			ai: _List_fromArray(
				[
					...
					[
						...
						{
							b5: $author$project$Main$FileSelect(0),
							aQ: 'Select a file'
						})
					])
				]),
...
var $author$project$Components$Display$HistoryEvent = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Algo$History$serialize_ = F5(
	function (convert, serializer, nodes, index, n) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			A2(
				...
				A2(
					...
					function (c) {
						return A2(
							$elm$core$Maybe$map,
							A4($author$project$Algo$History$serialize_, convert, serializer, nodes, c.Y),
							A2($elm$core$Dict$get, c.Y, nodes));
					},
					n.af)));
	});
var $author$project$Algo$History$view = F3(
	function (convert, serializer, model) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					A5($author$project$Algo$History$serialize_, convert, serializer, model.O, 0, model.ar)
				]));
	});
var $author$project$Components$Display$historyView = F3(
	function (converter, attr, model) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			function (_v1) {
				var eqNum = _v1.a;
				return A2($elm$core$Dict$get, eqNum, model.f);
			},
			model.l);
		if (_v0.$ === 1) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('No History to view')
					]));
		} else {
			var eq = _v0.a;
			return A3(
				$author$project$Algo$History$view,
				A2($elm$core$Basics$composeR, $author$project$Components$Display$HistoryEvent, converter),
				A2(
					$elm$core$Basics$composeR,
					function ($) {
						return $.ar;
					...
					return $author$project$UI$Menu$Content(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($elm$core$Set$member, num, model.M) ? $author$project$UI$Icon$hidden(_List_Nil) : $author$project$UI$Icon$shown(_List_Nil),
										$elm$html$Html$text(
										$author$project$Algo$Math$toString(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M3 0H21C23 0 24 1 24 3C24 5 23 6 21 6H3C1 6 0 5 0 3C0 1 1 0 3 0Z'),
						$elm$svg$Svg$Attributes$fill('currentColor'),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M3 9H21C23 9 24 10 24 12C24 14 23 15 21 15H3C1 15 0 14 0 12C0 10 1 9 3 9Z'),
						$elm$svg$Svg$Attributes$fill('currentColor'),
						$elm$svg$Svg$Attributes$mask('url(#menuMask)')
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M3 18H21C23 18 24 19 24 21C24 23 23 24 21 24H3C1 24 0 23 0 21C0 19 1 18 3 18Z'),
						$elm$svg$Svg$Attributes$fill('currentColor'),
						$elm$svg$Svg$Attributes$mask('url(#menuMask)')
					]),
				_List_Nil)
...
var $author$project$Components$Rules$coreTopic_ = F2(
	function (converter, selected) {
		...
		var apply = function () {
			var applies = {
				a3: false,
				aI: $elm$core$Maybe$Just($author$project$Components$Rules$Evaluate),
			...
			if (selected.$ === 1) {
				return _Utils_update(
					applies,
					{a3: true, aI: $elm$core$Maybe$Nothing});
			} else {
				var val = selected.a;
				var _v1 = val.ar;
				switch (_v1.$) {
					case 3:
						...
						if (!n.w) {
							return _Utils_update(
								applies,
								{
									at: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute)
								});
						} else {
							...
							return _Utils_update(
								applies,
								{
									aX: (_Utils_eq(
										...
										val.b$) || (val.b$ < 2)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Components$Rules$Group),
									at: $elm$core$Maybe$Just($author$project$Components$Rules$Substitute),
									a0: sameBinaryNode ? $elm$core$Maybe$Just($author$project$Components$Rules$Ungroup) : $elm$core$Maybe$Nothing
								});
						}
					case 0:
						var n = _v1.a;
						return _Utils_update(
							applies,
							{
								a_: $elm$core$Maybe$Just(
									$author$project$Components$Rules$NumericalSubstitution(n.u))
							});
					case 5:
						return _Utils_update(
							applies,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aI),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a_),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.aX),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Components$Rules$applyButton, converter, apply.a0),
									A2(
									$elm$html$Html$h3,
									_List_Nil,
									_List_fromArray(
...
var $author$project$Algo$Matcher$getName = function (m) {
	switch (m.$) {
		...
		case 1:
			var s = m.a;
			return $elm$core$String$fromFloat(s.u);
		case 2:
			var s = m.a;
			return s.a;
		case 3:
				...
				case 2:
					switch (_v0.b.$) {
						case 1:
							var m = _v0.a.a;
							var n = _v0.b.a;
							return _Utils_eq(m.a, n.a) && $elm$core$List$isEmpty(m.e);
						case 4:
							var m = _v0.a.a;
							var n = _v0.b.a;
...
var $author$project$Algo$Backtrack$getState = function (c) {
	return A2($elm$core$Maybe$map, $elm$core$Tuple$first, c.m);
};
									...
									$author$project$Algo$Matcher$SingleValue_(
										{
											q: _List_fromArray(
												[id]),
											I: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, node)
										}),
									result.j),
								O: A3($elm$core$Dict$insert, id, node, result.O)
							});
					},
					...
					var toReplacements = $elm$core$List$map(
						function (_v5) {
							...
							return {
								...
								I: A3($author$project$Algo$Matcher$toValue_, $elm$core$Maybe$Just, $elm$core$Dict$empty, n)
							};
						});
					return $elm$core$Maybe$Just(
						_Utils_update(
					...
					return A2(
						...
						function (newChoices) {
							var _v11 = A3(
								...
								nextEvals,
								newChoices,
								{aY: res, m: $elm$core$Maybe$Nothing});
							if (_v11.$ === 1) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && _Utils_eq(l.u, r.u);
					} else {
						break _v0$6;
					}
				case 1:
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.K, r.K));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.b, r.b) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.w, r.w) && (_Utils_eq(l.s, r.s) && (_Utils_eq(
		...
		while (true) {
			switch (from.$) {
				case 1:
					...
					if (!root.$) {
						var n = root.a;
						return (!_Utils_eq(n.u, s.u)) ? $author$project$Algo$Backtrack$fail : A2($author$project$Algo$Backtrack$return, $elm$core$Maybe$Just, token);
					} else {
							...
							function (result) {
								return A2(
									...
									function (varDict) {
										...
										var _v3 = A2($elm$core$Dict$get, s.a, result.j);
										if (!_v3.$) {
											if (_v3.a.$ === 1) {
												return $elm$core$Maybe$Nothing;
											} else {
												var existing = _v3.a.a;
												return (!A2($author$project$Algo$Matcher$subtreeEqual_, newSubtree, existing.I)) ? $elm$core$Maybe$Nothing : ((!$elm$core$List$isEmpty(s.e)) ? $elm$core$Maybe$Just(result) : $elm$core$Maybe$Just(
													_Utils_update(
														result,
														{
															j: A3(
																...
																$author$project$Algo$Matcher$SingleValue_(
																	_Utils_update(
																		existing,
																		{
																			q: A2($elm$core$List$cons, id, existing.q)
																		})),
																result.j),
															O: A3($elm$core$Dict$insert, id, root, result.O)
														})));
											}
										} else {
	...
	function (selected, rule) {
		if (selected.$ === 1) {
			...
			if (!A2(
				$elm$core$List$any,
				function (m) {
					return A2($author$project$Algo$Matcher$matchNode, m.X.ar, n.ar);
				},
				rule.j)) {
					...
					function (m) {
						return $author$project$Helper$maybeAppend(
							A2(
								$elm$core$Maybe$map,
								function (result) {
									return {X: result, a6: m.aS.ar, a: m.aS.a};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.O, m.X.ar, n.ar)));
					},
					_List_Nil,
					rule.j);
					...
					$elm$core$Maybe$Just(
						{
							...
							al: A2(
								...
								function (p) {
									return {
										a1: $author$project$Algo$Matcher$countChildren(p.aK.ar),
										V: p.V,
										a: p.aK.a,
										ar: $author$project$Algo$Matcher$getName(p.aK.ar)
									};
								},
								rule.al),
							ac: rule.ac
								...
								A2(
									...
									function (match) {
										return A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(match.X.a + ('→' + match.aS.a))
												]));
									},
									rule.j),
								_List_fromArray(
							...
							function () {
								if (!t.$) {
									...
									return A3(
										...
										topic.a,
										true,
										A2($elm$core$List$map, individualRule, topic.bb));
								}
							}());
					}),
				_List_fromArray(
			...
			A3(
				...
				F3(
					function (eqNum, hisEq, result) {
						if (A2($elm$core$Set$member, eqNum, model.M)) {
							return result;
						} else {
							var highlight = A2(
								$elm$core$Maybe$withDefault,
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.b7)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.b7),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.b7))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.b5),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
				...
				case 2:
					var i = input.a;
					return $elm$html$Html$text(i.aQ);
				case 3:
					var r = input.a;
					return A2(
						$elm$html$Html$span,
							...
							return A2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(section.au)
											])),
									A2($elm$core$List$map, $author$project$UI$Dialog$listView_, section.ai)));
						},
						model.aN),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$UI$Icon$class('clickable'),
									$author$project$UI$Icon$class('cancelable'),
									$author$project$UI$HtmlEvent$onClick(model.aH)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($author$project$Components$Display$menu, $author$project$Main$DisplayEvent, model.k),
												A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.av),
												A3(
												$author$project$UI$Menu$Section,
												'Topics',
												true,
												_Utils_ap(
													...
													A3(
														...
														model.bb,
														$author$project$Components$Display$selectedNode(model.k))))
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Helper$maybeGuard,
											model.aD,
											A3($author$project$Components$Display$historyView, $author$project$Main$DisplayEvent, _List_Nil, model.k))
										])))
							]))),
					$elm$core$Maybe$Just(
					$author$project$Main$inputDiv(model)),
					$elm$core$Maybe$Just(
					A3($author$project$Components$Tutorial$view, $author$project$Main$TutorialEvent, _List_Nil, model.av)),
					A2(
					$elm$core$Maybe$map,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{b9: $author$project$Main$init, cc: $author$project$Main$EventUrlChange, cd: $author$project$Main$EventUrlRequest, cm: $author$project$Main$subscriptions, co: $author$project$Main$update, cp: $author$project$Main$view});
