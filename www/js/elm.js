		...
		return _Utils_Tuple2(
			{
				...
				J: {
					...
					aI: false,
					ab: false,
					aK: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
				...
				return function (_v27) {
					...
					if (_v29.$ === 1) {
						...
						if (_v30.$ === 1) {
							...
							if (_v30.a.$ === 1) {
								var mv = _v30.a.a;
								return (!_Utils_eq(mv.aH, m.a)) ? function (_v31) {
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aK)),
						_Utils_Tuple2(
						'notification',
						$author$project$UI$Notification$encode(model.ae)),
						_Utils_Tuple2(
						'menu',
						$author$project$UI$Menu$encode(model.aG)),
						_Utils_Tuple2(
						'evaluator',
						A2(
						...
						_Utils_Tuple2(
						'historyBox',
						$author$project$UI$Draggable$encode(model.aF))
					]))));
};
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {C: createMode, i: display, R: evaluator, aF: historyBox, aG: menu, aq: nextCreateInt, ae: notification, bn: rules, Y: showHelp, aI: showHistory, ab: showMenu, aK: tutorial};
											};
										};
									};
								};
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {ak: children, aC: component, aS: parent};
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aK);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
			...
			case 7:
				...
				if (e.$ === 1) {
					var de = e.a;
					var _v5 = A3($author$project$UI$Draggable$update, core.a7, de, model.aF);
					var newBox = _v5.a;
					var action = _v5.b;
					return _Utils_Tuple2(
						updateCore(
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'padding', '0.2rem'),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.aF, model.i))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
												...
												[
													...
													_List_fromArray(
														[
															...
															A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aK),
															A3(
															$author$project$UI$Menu$Section,
															'Topics',
															true,
