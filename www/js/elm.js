		...
		while (true) {
			if (!index) {
				...
				if (_v1.$ === 1) {
					...
					var newNode = _v2.c;
					var $temp$index = n.aJ,
						$temp$child = {G: height, _: index, J: width},
									...
									return function (showMenu) {
										return function (showHistory) {
											return function (historyBox) {
												return {D: createMode, h: display, O: evaluator, av: historyBox, ax: menu, am: nextCreateInt, aa: notification, bd: rules, U: showHelp, az: showHistory, Y: showMenu, aC: tutorial};
											};
										};
									};
								};
