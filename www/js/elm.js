...
{
	if (region.bh.aG === region.bs.aG)
	{
		return 'on line ' + region.bh.aG;
	}
	return 'on lines ' + region.bh.aG + ' through ' + region.bs.aG;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { Q: 'hidden', ce: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { Q: 'mozHidden', ce: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { Q: 'msHidden', ce: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { Q: 'webkitHidden', ce: 'webkitvisibilitychange' }
		: { Q: 'hidden', ce: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cp, request.b5, true);
		} catch (e) {
		...
		request.cd.a && xhr.setRequestHeader('Content-Type', request.cd.a);
		xhr.send(request.cd.b);
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{v: nodeList, s: (len / $elm$core$Array$branchFactor) | 0, t: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bx: fragment, bB: host, bK: path, bM: port_, bR: protocol, bS: query};
	});
...
var $author$project$UI$Animation$newDeletable = F2(
	function (trigger, element) {
		return {ch: false, br: element, a0: trigger};
	});
	...
	G: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
					{
						_: $author$project$Components$Rules$InfixOp('+'),
						V: $author$project$Algo$Math$BinaryNode(
							{m: true, D: _List_Nil, i: true, n: 0, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'*',
				_Utils_Tuple2(
					{
						_: $author$project$Components$Rules$InfixOp('*'),
						V: $author$project$Algo$Math$BinaryNode(
							{m: true, D: _List_Nil, i: true, n: 1, a: '', c: 0})
					},
					1)),
				_Utils_Tuple2(
				'-',
				_Utils_Tuple2(
					{
						_: $author$project$Components$Rules$PrefixOp('-'),
						V: $author$project$Algo$Math$UnaryNode(
							{
								O: $author$project$Algo$Math$RealNode(
									{c: 0, x: 0}),
								a: '',
								c: 0
							})
				...
				_Utils_Tuple2(
					{
						_: $author$project$Components$Rules$PrefixOp('1/'),
						V: $author$project$Algo$Math$UnaryNode(
							{
								O: $author$project$Algo$Math$RealNode(
									{c: 0, x: 0}),
...
var $author$project$Components$Tutorial$init = {bF: 0, b_: 0};
...
var $author$project$UI$Draggable$init = F3(
	function (id, _v0, _v1) {
		...
		var height = _v1.b;
		return {
			q: {C: top + height, y: left, A: left + width, I: top},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cb: false, cd: r.cd, bu: r.bu, by: r.by, cp: r.cp, cB: r.cB, k: r.k, b5: r.b5}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{cd: $elm$http$Http$emptyBody, bu: r.bu, by: _List_Nil, cp: 'GET', cB: $elm$core$Maybe$Nothing, k: $elm$core$Maybe$Nothing, b5: r.b5});
};
...
var $author$project$Algo$Math$deadEndToString_ = A2(
	...
	$elm$core$List$map(
		function (deadEnd) {
			return function (str) {
				return str + (', at position: ' + $elm$core$String$fromInt(deadEnd.cf));
			}(
				function () {
					var _v0 = deadEnd.ct;
					switch (_v0.$) {
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cf: col, cg: contextStack, ct: problem, bY: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bY, s.cf, x, s.h));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cf: col, h: s0.h, j: s0.j, f: offset, bY: row, d: s0.d});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.bY, s.cf, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.bY, s.cf, s.d);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cf: newCol, h: s.h, j: s.j, f: newOffset, bY: newRow, d: s.d});
	};
};
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cf: col, h: context, j: indent, f: offset, bY: row, d: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.bh, s.f, s.d);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.a5, s.f + 1, s.bY + 1, 1, s.d, s.j, s.h) : A7($elm$parser$Parser$Advanced$varHelp, i.a5, firstOffset, s.bY, s.cf + 1, s.d, s.j, s.h);
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{m: true, D: children, i: true, n: 0, a: '+', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
	...
	return A2(
		...
		function (children) {
			if (children.b && (!children.b.b)) {
				...
				return $author$project$Algo$Math$BinaryNode(
					{m: true, D: children, i: true, n: 1, a: '*', c: 0});
			}
		},
		A2(
			$elm$parser$Parser$loop,
						...
						if (_v1.b.$ === 1) {
							...
							return $elm$parser$Parser$succeed(
								$author$project$Algo$Math$GenericNode(
									{b: $elm$core$Maybe$Nothing, D: children, a: name, c: 0}));
						}
					} else {
						if (_v1.b.$ === 1) {
							var p = _v1.a.a;
								...
								case 3:
									...
									return ($elm$core$List$length(children) < 2) ? $elm$parser$Parser$problem(name + ' has less than 2 children') : $elm$parser$Parser$succeed(
										$author$project$Algo$Math$BinaryNode(
											{m: n.m, D: children, i: n.i, n: n.n, a: name, c: 0}));
								default:
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cf: col, ct: problem, bY: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bY, p.cf, p.ct);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cf: 1, h: _List_Nil, j: 1, f: 0, bY: 1, d: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (previous, parent, tracker) {
		return _Utils_Tuple2(
			A2(
				...
				function () {
					if (previous.$ === 1) {
						return tracker.aH(tracker.o);
					} else {
						var prev = previous.a;
						return A2(tracker.aE, prev, tracker.o);
					}
				}()),
			_Utils_update(
				tracker,
				...
				return function (_v3) {
					...
					return _Utils_Tuple2(
						$author$project$Algo$Math$BinaryNode(
							{
								m: n.m,
								D: $elm$core$List$reverse(finChildren),
								i: n.i,
								n: n.n,
								a: n.a,
								c: finS
			...
			$elm$core$Result$map(
				A2(
					...
					$author$project$Algo$Matcher$processID_(
						{aE: copyState, aH: newState, o: 0, aJ: $elm$core$Dict$empty}),
					function (_v0) {
						var newRoot = _v0.a;
						var tracker = _v0.b;
						return {
...
var $author$project$Components$Display$updateState = F2(
	function (s, _v0) {
		return {
			aq: $author$project$Algo$Matcher$getID(s)
		};
	});
...
var $author$project$Components$Query$parseInit = F2(
	function (url, key) {
		return A3(
			...
			{a1: url, e: _List_Nil, a6: key, aY: _List_Nil},
			A2(
				$elm$core$String$split,
				'&',
				A2($elm$core$Maybe$withDefault, '', url.bS)));
	});
				...
				aX: A2(
					...
					$elm$core$Result$toMaybe(
						A2(
							...
							flags))),
				H: {
					at: $author$project$UI$ActionView$init,
					F: newScreen ? $elm$core$Maybe$Just(
						A2(
							$author$project$UI$Animation$newDeletable,
							$author$project$Main$uiCancelCmd_(0),
							0)) : $elm$core$Maybe$Nothing,
					g: $author$project$Components$Display$init(eqs),
					P: $author$project$Components$Evaluate$init($author$project$Main$evaluateString),
					av: A3(
					...
					ay: false,
					N: false,
					aB: $author$project$Components$Tutorial$init
				}
			},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
...
var $author$project$Components$Rules$deleteTopic = F2(
	function (name, model) {
		var _v0 = A2($elm$core$Dict$get, name, model.w);
		if ((!_v0.$) && (_v0.a.$ === 1)) {
			var _v1 = _v0.a;
			var url = _v1.a;
			var topic = _v1.b;
			...
			return _Utils_update(
				model,
				{
					...
					w: function () {
						if (url.$ === 1) {
							return A2($elm$core$Dict$remove, name, model.w);
						} else {
							var existing = url.a;
							return A3(
								$elm$core$Dict$insert,
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && _Utils_eq(l.x, r.x);
					} else {
						break _v0$6;
					}
				case 1:
				...
				case 2:
					if (_v0.b.$ === 2) {
						var l = _v0.a.a;
						var r = _v0.b.a;
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && A3($author$project$Algo$Math$equal, check, l.O, r.O));
					} else {
						break _v0$6;
					}
				case 3:
					if (_v0.b.$ === 3) {
						...
						return A2(check, l.c, r.c) && (_Utils_eq(l.a, r.a) && (_Utils_eq(l.m, r.m) && (_Utils_eq(l.i, r.i) && (_Utils_eq(
							$elm$core$List$length(l.D),
							$elm$core$List$length(r.D)) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2(
								$elm$core$Maybe$andThen,
					...
					function (constants) {
						return _Utils_update(
							model,
							{
								...
								G: functions,
								w: function () {
									var _v7 = A2($elm$core$Dict$get, topic.a, model.w);
									if (_v7.$ === 1) {
										return A3(
											$elm$core$Dict$insert,
											topic.a,
					...
					function (name, props, dict) {
						...
						if (_v0.$ === 1) {
							...
							return (A3(
								...
								p.V,
								props.V) && _Utils_eq(p._, props._)) ? $elm$core$Result$Ok(
								A3(
									$elm$core$Dict$insert,
									name,
...
var $author$project$Algo$History$addAll = F2(
	function (list, model) {
		...
		var start = $elm$core$Dict$size(model.r) + 1;
		return function (newModel) {
			var m = _Utils_update(
				newModel,
				{
					...
					B: A2(
						$elm$core$List$cons,
						$elm$core$Dict$size(newModel.r),
						model.B)
				});
			var end = $elm$core$Dict$size(m.r);
			if (!id) {
				var p = model.ab;
				return _Utils_update(
					m,
					...
					function (c, m) {
						return _Utils_update(
							m,
							{
								r: A3(
									$elm$core$Dict$insert,
									$elm$core$Dict$size(m.r) + 1,
									{D: _List_Nil, ah: c, aJ: id},
									m.r)
							});
					}),
				model,
				...
				if (!children.b) {
					...
					if (_v1.$ === 1) {
						...
						return $elm$core$Result$Ok(
							_Utils_Tuple3(
								a,
								A2($elm$core$List$cons, newEq.ab, others),
								newEq.k));
					}
				}
			});
		var id = $author$project$Algo$Matcher$getID(
			$author$project$Algo$Math$getState(eq.ab));
		if (!path.b) {
								...
								function (_v6) {
									...
									return _Utils_Tuple2(
										...
										_Utils_update(
											newEq,
											{
												ab: $author$project$Algo$Math$UnaryNode(
													_Utils_update(
														s,
														{O: newEq.ab}))
											}));
							...
							return A2(
								...
								function (_v7) {
									...
									return _Utils_Tuple2(
										r,
										{
											ab: $author$project$Algo$Math$BinaryNode(
												_Utils_update(
													s,
													{D: children})),
											k: t
							...
							return A2(
								...
								function (_v8) {
									...
									return _Utils_Tuple2(
										r,
										{
											ab: $author$project$Algo$Math$GenericNode(
												_Utils_update(
													s,
													{D: children})),
											k: t
							...
							return A2(
								...
								function (_v9) {
									...
									return _Utils_Tuple2(
										r,
										{
											ab: $author$project$Algo$Math$DeclarativeNode(
												_Utils_update(
													s,
													{D: children})),
											k: t
		...
		switch (replaceNode.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromInternalReplacement_, id, t, _arguments, n.O));
			case 3:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
							...
							function () {
								if (!res.$) {
									...
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
										$author$project$Algo$Math$BinaryNode(
											{m: n.m, D: children, i: n.i, n: n.n, a: n.a, c: s}));
								} else {
									var pre = res.b;
									var post = res.c;
									return $author$project$Algo$Matcher$SingleNodeReplaced_(
					...
					A3(constructChildren, n.a, t, n.D));
			case 5:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
			...
			case 1:
				...
				if (_v40.b.$ === 1) {
					var oldS = _v40.a;
					var _v41 = _v40.b;
					var newState = A2(tracker.aE, oldS, tracker.o);
					return $elm$core$Result$Ok(
						_Utils_Tuple3(
							$author$project$Algo$Matcher$SingleNodeReplaced_(
								$author$project$Algo$Math$VariableNode(
				...
				if (_v45.b.$ === 1) {
					...
					if (_v49.$ === 1) {
						...
						return A2(
							...
							A3(constructChildren, '', tracker, n.D));
					}
				}
		}
	});
		...
		switch (replaceNode.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$constructFromReplacement_, id, t, _arguments, n.O));
			case 3:
				var n = replaceNode.a;
				return A2(
					$elm$core$Result$map,
	...
	switch (root.$) {
		...
		case 2:
			...
			return A2(
				$elm$core$Set$insert,
				$author$project$Algo$Matcher$getID(s.c),
				$author$project$Algo$Matcher$getSubtreeIDs_(s.O));
		case 3:
			var s = root.a;
			return A3(
				$elm$core$List$foldl,
...
var $author$project$Algo$Matcher$replaceSubtree = F4(
	function (ids, replacement, _with, eq) {
		var _v0 = A2($author$project$Algo$Matcher$affectedSubtree_, ids, eq.k.aJ);
		if (_v0.$ === 1) {
			...
			return A3(
				$author$project$Algo$Matcher$processSubtree_,
				A2($author$project$Algo$Matcher$searchPath_, eq.k.aJ, id),
							...
							F2(
								function (r, _v3) {
									...
									return A2(
										...
										A4($author$project$Algo$Matcher$replaceSubtree, ids, r.ab, result, current));
								}),
...
var $author$project$Algo$Math$eqToString_ = function (root) {
	if (!root.$) {
		...
		return A2(
			$elm$core$String$join,
			'',
			A2($elm$core$List$map, $author$project$Algo$Math$eqToString_, s.D));
	}
};
	...
	function (dict, model) {
		return function (result) {
			...
			A2(
				...
				function (_v0) {
					var elem = _v0.b;
					return $author$project$Algo$Math$toString(elem.ab);
				},
...
var $author$project$Main$applyChange_ = F2(
	function (params, model) {
		var swappable = model.H;
		var _v0 = A3($author$project$Components$Display$transformEquation, params.bU, params.a3, swappable.g);
		if (_v0.$ === 1) {
			var errStr = _v0.a;
...
var $author$project$UI$Animation$delete = function (element) {
	return element.ch ? _Utils_Tuple2(element, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
		_Utils_update(
			element,
			{ch: true}),
		element.a0(0));
...
var $author$project$Components$Rules$toJavascriptString_ = F3(
	function (model, name, children) {
		var _v0 = A2($elm$core$Dict$get, name, model.G);
		if (_v0.$ === 1) {
		...
		return A2(
			...
			function () {
				switch (root.$) {
					...
					case 1:
						var s = root.a;
						var _v1 = A2($elm$core$Dict$get, s.a, model.E);
						if (_v1.$ === 1) {
					...
					case 2:
						...
						return A2(
							...
							A2($author$project$Components$Rules$evaluateStr, model, s.O));
					case 3:
						var s = root.a;
						return A2(
							$elm$core$Result$andThen,
...
var $author$project$Components$Display$newSelectedNodes_ = F2(
	function (selected, eq) {
		var intersection = A2(
			$elm$core$Set$filter,
			function (n) {
				return A2($elm$core$Dict$member, n, eq.k.aJ);
			},
			selected);
		return $elm$core$Set$isEmpty(intersection) ? $elm$core$Set$singleton(
			$author$project$Algo$Matcher$getID(
				$author$project$Algo$Math$getState(eq.ab))) : intersection;
	});
	...
	function (eqNum, id, number, model) {
		...
		if (_v0.$ === 1) {
			...
			var replacement = (number < 0) ? $author$project$Algo$Math$UnaryNode(
				{
					O: $author$project$Algo$Math$RealNode(
						{c: $elm$core$Maybe$Nothing, x: -number}),
					a: '-',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'children',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, node.D))
				]));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'root',
					A2($author$project$Algo$History$encodeNode_, convert, model.ab)),
					_Utils_Tuple2(
					'nodes',
					A3(
					...
					_Utils_Tuple2(
					'undone',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, model.Y))
				]));
	});
				...
				return $elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'child',
							A2($author$project$Algo$Math$encode, converter, s.O)),
							_Utils_Tuple2(
							'type',
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								...
								_Utils_Tuple2(
								'parent',
								A3($elm$json$Json$Encode$dict, $elm$core$String$fromInt, $elm$json$Json$Encode$int, eq.k.aJ))
							])))
				]));
	});
...
var $author$project$Components$Rules$encodeFProp_ = function (prop) {
	return $elm$json$Json$Encode$object(
		A2(
			...
			$author$project$Algo$Math$encodeFunctionProperty(prop.V)));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'description',
				$elm$json$Json$Encode$string(rule.ai)),
				_Utils_Tuple2(
				'parameters',
				$elm$json$Json$Encode$object(
					A2(
						...
						function (_v0) {
							...
							return _Utils_Tuple2(
								p.a,
								$elm$json$Json$Encode$string(p.ai));
						},
						$elm$core$Dict$toList(rule.bb)))),
				_Utils_Tuple2(
				'matches',
				A2(
					$elm$json$Json$Encode$list,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constants',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, topic.E)),
				_Utils_Tuple2(
				'functions',
				A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Components$Rules$encodeFProp_, topic.G)),
				_Utils_Tuple2(
				'actions',
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'deleting',
					$elm$json$Json$Encode$bool(element.ch))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$float(model.q.y)),
				_Utils_Tuple2(
				'right',
...
var $author$project$UI$Menu$encode = function (model) {
	return A2($elm$json$Json$Encode$set, $elm$json$Json$Encode$string, model.X);
};
			...
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'tutorial',
						$author$project$Components$Tutorial$encode(model.aB)),
						_Utils_Tuple2(
						'notification',
						...
						_Utils_Tuple2(
						'showMenu',
						$elm$json$Json$Encode$bool(model.N)),
						_Utils_Tuple2(
						'showHistory',
						...
						_Utils_Tuple2(
						'actionView',
						$author$project$UI$ActionView$encode(model.at))
					]))));
};
	...
	function (c, str, model) {
		return _Utils_Tuple2(
			_Utils_update(
				...
				{
					am: model.am + 1,
					ae: A3($elm$core$Dict$insert, model.am, c, model.ae)
				}),
			model.be(
				{cl: model.am, cz: str}));
	});
		...
		var convert = function (node) {
			switch (node.$) {
				case 0:
					...
					return $elm$core$Result$Ok(
						$author$project$Algo$Math$RealNode(
							{c: $elm$core$Maybe$Nothing, x: s.x}));
				case 1:
					var s = node.a;
					...
					if (!_v1.$) {
						...
						return (s.S || (!strict)) ? $elm$core$Result$Ok(
							$author$project$Algo$Math$VariableNode(
								{S: s.S, a: s.a, c: $elm$core$Maybe$Nothing})) : $elm$core$Result$Err('Cannot construct the variable ' + s.a);
					}
				case 2:
					var s = node.a;
					return A2(
						...
						function (child) {
							return $author$project$Algo$Math$UnaryNode(
								{O: child, a: s.a, c: $elm$core$Maybe$Nothing});
						},
						convert(s.O));
				case 3:
					var s = node.a;
					return A2(
						...
						function (children) {
							return $author$project$Algo$Math$BinaryNode(
								{
									m: s.m,
									D: $elm$core$List$reverse(children),
									i: s.i,
									n: s.n,
									a: s.a,
									c: $elm$core$Maybe$Nothing
				...
				case 4:
					...
					if (!_v3.$) {
						...
						return (!_Utils_eq(
							args,
							$elm$core$List$length(s.D))) ? $elm$core$Result$Err(s.a + ' has the wrong number of inputs') : A2(
							$elm$core$Result$map,
							function (children) {
		...
		switch (root.$) {
			...
			case 2:
				...
				return A2(
					...
					A4($author$project$Algo$Matcher$treeToMatcher_, checker, argMap, state, s.O));
			case 3:
				var s = root.a;
				return s.i ? A2(
					$elm$core$Result$map,
						...
						return A2(
							...
							A2(
									...
									return A3(
										...
										F2(
											function (child, _v9) {
												...
												if (child.$ === 1) {
													var n = child.a;
													return A2($elm$core$Set$member, n.a, seen) ? $elm$core$Result$Err('Function argument can only match on unique variables') : (n.S ? $elm$core$Result$Err('Only variables are supported in function arguments. Constants are not allowed') : A2(
														$elm$core$Result$map,
														function (finalS) {
															return _Utils_Tuple3(
								...
								A3(
									checker,
									s.a,
									$elm$core$List$length(s.D),
									state)));
					} else {
						var argNum = _v8.a;
						return (!_Utils_eq(
							argNum,
							$elm$core$List$length(s.D))) ? $elm$core$Result$Err(s.a + ' has an unexpected function signature') : A2(
							$elm$core$Result$map,
							function (_v12) {
								var children = _v12.a;
								var newS = _v12.b;
				...
				return $elm$core$List$isEmpty(nodes) ? $elm$core$Maybe$Just(
					A3(
						...
						$author$project$Algo$Matcher$ExternalValue_(
							$author$project$Algo$Math$RealNode(
								{c: $elm$core$Maybe$Nothing, x: props.n})),
							...
							$author$project$Algo$Matcher$MultiValue_(
								{
									...
									n: props.n,
									bH: op,
									bN: processChildren(b),
									bO: processChildren(a)
								}),
							result));
				}(
					A2(
						...
						switch (root.$) {
							case 4:
								...
								return ((!_Utils_eq(n.a, s.a)) || (!_Utils_eq(
									...
									$elm$core$List$length(n.D)))) ? $author$project$Algo$Backtrack$fail : A3(
									$author$project$Algo$Backtrack$run,
									A2(
				...
				case 3:
					...
					if (root.$ === 3) {
						...
						if (!_Utils_eq(s.a, n.a)) {
							...
							var _v8 = s.aI;
							if (_v8.$ === 1) {
								var priorityList = A2($author$project$Algo$Matcher$priorityList_, priority, n.D);
								return (!_Utils_eq(
									$elm$core$List$length(s.b),
								...
								return function (_v10) {
									...
									A2(
										...
										A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, n.D)));
							}
						}
					} else {
						return $author$project$Algo$Backtrack$fail;
		...
		return {
			...
			aW: _List_fromArray(
				[
					...
					aA: 'Select the equation to use for substitution'
				}
				]),
			a_: function (dict) {
										...
										return function (showHistory) {
											return function (historyBox) {
												return function (actionView) {
													return {at: actionView, F: createMode, g: display, P: evaluator, av: historyBox, ax: menu, an: nextCreateInt, ad: notification, bd: rules, W: showHelp, ay: showHistory, N: showMenu, aB: tutorial};
												};
											};
										};
									};
...
var $author$project$Algo$History$Model = F4(
	function (nodes, root, visits, undone) {
		return {r: nodes, ab: root, Y: undone, B: visits};
	});
...
var $author$project$Algo$History$Node_ = F3(
	function (parent, component, children) {
		return {D: children, ah: component, aJ: parent};
	});
					...
					return A7(
						...
						F6(
							function (s, n, a, c, i, children) {
								return $author$project$Algo$Math$BinaryNode(
									{m: a, D: children, i: c, n: i, a: n, c: s});
							}),
						sDec,
						A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		...
		return A3(
			...
			A2(
				...
				A3(
					...
					F2(
						function (id, p) {
							return {aE: copyState, aH: newState, o: id, aJ: p};
						}),
...
var $author$project$Components$Display$decoder = A6(
	...
	F5(
		function (eq, next, hidden, sel, create) {
			return {aR: create, e: eq, Q: hidden, ao: next, l: sel};
		}),
	A2(
		$elm$json$Json$Decode$field,
		'equations',
...
var $author$project$Components$Rules$FunctionProperties_ = F2(
	function (properties, javascript) {
		return {_: javascript, V: properties};
	});
			...
			function (_v0) {
				...
				if ((!c) && (!a)) {
					...
					if (i.$ === 1) {
						...
						return $elm$json$Json$Decode$succeed(
							$author$project$Algo$Math$BinaryNode(
								{m: a, D: _List_Nil, i: c, n: iden, a: '', c: 0}));
					}
				}
			},
			A4(
...
var $author$project$Components$Rules$Topic = F4(
	function (name, constants, functions, rules) {
		return {E: constants, G: functions, a: name, bd: rules};
	});
var $author$project$Components$Rules$Rule = F4(
	function (title, description, parameters, matches) {
		return {ai: description, aT: matches, bb: parameters, a$: title};
	});
									...
									function (to) {
										...
										return {
											a3: _Utils_update(
												from,
												{
													ab: A2($author$project$Components$Rules$setOthers_, otherSet, from.ab)
												}),
											bj: to
										};
									},
...
var $author$project$UI$Draggable$Coordinates = F4(
	function (left, right, top, bottom) {
		return {C: bottom, y: left, A: right, I: top};
	});
var $author$project$UI$Draggable$Model = F3(
	function (coordinates, drags, id) {
		return {q: coordinates, aj: drags, cl: id};
	});
	...
	if (!_v0.b) {
		...
		if (!_v0.b.b) {
			...
			return _Utils_update(
				model,
				{
					Y: A2($elm$core$List$cons, x, model.Y),
					B: others
				});
		}
	}
		...
		if (_v0.$ === 3) {
			...
			if (!n.m) {
				...
				return A2(
					...
					A2(traverseRemaining, false, n.D));
			}
		} else {
			return $elm$core$Result$Err('Node is not associative');
		}
...
var $author$project$Components$Display$update = F2(
	function (event, model) {
		switch (event.$) {
			...
			case 2:
				var eq = event.a;
				return A2($elm$core$Set$member, eq, model.Q) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($elm$core$Set$remove, eq, model.Q)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($elm$core$Set$insert, eq, model.Q)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var eq = event.a;
		...
		switch (e.$) {
					...
					_Utils_update(
						model,
						{
							aj: A3(
								...
								{bq: d, a3: p, bJ: model.q},
								model.aj)
						}),
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$SetCapture, model.cl, pid)));
			case 1:
				var pid = e.a;
				var to = e.b;
				var _v2 = A2(
						...
						case 2:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: {C: orig.C + dy, y: orig.y + dx, A: orig.A + dx, I: orig.I + dy}
									}),
								$elm$core$Maybe$Nothing);
						case 0:
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												y: A2($elm$core$Basics$min, orig.A - 2, orig.y + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 1:
								...
								_Utils_update(
									model,
									{
										q: _Utils_update(
											orig,
											{
												A: A2($elm$core$Basics$max, orig.y + 2, orig.A + dx)
											})
									}),
								$elm$core$Maybe$Nothing);
						case 3:
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Maybe$Just(
						A2($author$project$UI$Draggable$ReleaseCapture, model.cl, pid)));
			default:
				return _Utils_Tuple2(model, $elm$core$Maybe$Nothing);
		}
	});
var $author$project$UI$Menu$update = F2(
	function (event, model) {
		var entry = event;
		return A2($elm$core$Set$member, entry, model.X) ? _Utils_update(
			model,
			{
				X: A2($elm$core$Set$remove, entry, model.X)
			}) : _Utils_update(
			model,
			{
				X: A2($elm$core$Set$insert, entry, model.X)
			});
	});
...
var $author$project$Main$update = F2(
	function (event, core) {
		...
		switch (event.$) {
			...
			case 4:
				var e = event.a;
				var _v2 = A2($author$project$Components$Tutorial$update, e, model.aB);
				var tModel = _v2.a;
				var tCmd = _v2.b;
				return _Utils_Tuple2(
					updateCore(
				...
				return _Utils_Tuple2(
					updateCore(
						_Utils_update(
							model,
							{
								at: A2($author$project$UI$ActionView$update, e, model.at)
							})),
					$elm$core$Platform$Cmd$none);
			case 9:
				return _Utils_Tuple2(core, $elm$core$Platform$Cmd$none);
			case 10:
				var input = event.a;
				var _v7 = _Utils_Tuple3(input.bo, input.b0, input.a6);
				_v7$3:
				while (true) {
					switch (_v7.c) {
						case 'Escape':
							var _v8 = _Utils_Tuple2(core.u, model.F);
							if (!_v8.a.$) {
								return _Utils_Tuple2(
									_Utils_update(
										core,
						...
						_Utils_update(
							model,
							{
								F: $elm$core$Maybe$Just(
									A2(
										$author$project$UI$Animation$newDeletable,
										$author$project$Main$uiCancelCmd_(model.an),
										model.an)),
								an: model.an + 1,
								N: false
							})),
				...
				if (str === '') {
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{F: $elm$core$Maybe$Nothing, W: false})),
						$elm$core$Platform$Cmd$none);
				} else {
					var _v15 = A4(
						$author$project$Algo$Matcher$parseEquation,
						...
						return function (dModel) {
							return _Utils_Tuple2(
								updateCore(
									_Utils_update(
										model,
										{F: $elm$core$Maybe$Nothing, g: dModel, W: false})),
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											A2($author$project$Main$updateQuery_, core, dModel),
					...
					return _Utils_Tuple2(
						updateCore(
							_Utils_update(
								model,
								{
									bd: A2($author$project$Components$Rules$addSources, source.w, model.bd)
								})),
						$elm$core$Platform$Cmd$none);
				}
			case 22:
			...
			case 29:
				...
				if (_v35.$ === 1) {
					...
					var _v36 = A2($author$project$Components$Rules$evaluateStr, model.bd, replacement);
					if (_v36.$ === 1) {
						var errStr = _v36.a;
						return A2($author$project$Main$submitNotification_, core, errStr);
					} else {
			...
			default:
				var reply = event.a;
				var _v38 = A2($author$project$Components$Evaluate$finish, reply.cl, model.P);
				var eModel = _v38.a;
				var c = _v38.b;
				...
				if (c.$ === 1) {
					...
					if (!c.a.$) {
						...
						var eqNum = _v42.a;
						var id = _v42.b;
						var _v43 = A4($author$project$Components$Display$replaceNodeWithNumber, eqNum, id, reply.x, model.g);
						if (_v43.$ === 1) {
							var errStr = _v43.a;
							return A2($author$project$Main$submitNotification_, newCore, errStr);
						} else {
			...
			aw: _List_fromArray(
				[
					...
					[
						...
						{
							cj: $author$project$Main$FileSelect(0),
							aL: 'Select a file'
						})
					])
				]),
				...
				return $author$project$UI$Menu$Content(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$core$Set$member, num, model.Q) ? $author$project$UI$Icon$hidden(_List_Nil) : $author$project$UI$Icon$shown(_List_Nil),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											$author$project$Algo$Math$toString(
												$author$project$Algo$History$current(eq).ab))
										]))
								]))
						]));
			},
...
var $author$project$Components$Tutorial$menu = F2(
	function (converter, model) {
		return A2(
			...
			{Z: $elm$core$Maybe$Nothing, a: 'Tutorials'},
			_List_Nil);
	});
			...
			A3(
									...
									return A2(
										...
										A2(
											...
											function (rule) {
												return A2(
													$author$project$UI$Menu$Section,
													{Z: $elm$core$Maybe$Nothing, a: rule.a$},
													_List_fromArray(
														[
															$author$project$UI$Menu$Content(
				...
				_List_fromArray(
					[
						A2(
						$author$project$UI$Menu$Section,
						{Z: $elm$core$Maybe$Nothing, a: 'Core'},
						_List_fromArray(
							[
								A2(
								$author$project$UI$Menu$Section,
								{Z: $elm$core$Maybe$Nothing, a: 'Evaluate'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Z: $elm$core$Maybe$Nothing, a: 'Number Substitution'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Z: $elm$core$Maybe$Nothing, a: 'Substitute'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Z: $elm$core$Maybe$Nothing, a: 'Group'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
								...
								A2(
								$author$project$UI$Menu$Section,
								{Z: $elm$core$Maybe$Nothing, a: 'Ungroup'},
								_List_fromArray(
									[
										$author$project$UI$Menu$Content(
										_List_fromArray(
				...
				A3(
					...
					F3(
						function (eqNum, hisEq, result) {
							if (A2($elm$core$Set$member, eqNum, model.Q)) {
								return result;
							} else {
								var highlight = A2(
									$elm$core$Maybe$withDefault,
										...
										A2(
											...
											_List_fromArray(
												[
													...
													eqNum,
													highlight,
													$author$project$Algo$Math$symbolicate(eq.ab)),
													A3($author$project$Components$Display$stackedView_, eqNum, highlight, eq.ab)
												]))),
									result);
							}
						}),
			...
			var evaluateState = function () {
				...
				if (_v3.$ === 1) {
					...
					return $author$project$UI$ActionView$Allowed(
						A3($author$project$Components$Rules$Evaluate, selected.ak, selected.ab, str));
				}
			}();
			var result = A5(
				$author$project$UI$ActionView$CoreTopicState,
				$author$project$UI$ActionView$Allowed(
					A2($author$project$Components$Rules$Substitute, selected.ak, selected.l)),
						...
						var ungroupRes = sameBinaryNode ? _Utils_update(
							result,
							{
								bk: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Ungroup, selected.ak, selected.ab, selected.r))
							}) : result;
						return (_Utils_eq(
							$elm$core$List$length(n.D),
							...
							ungroupRes,
							{
								a4: $author$project$UI$ActionView$Allowed(
									A3($author$project$Components$Rules$Group, selected.ak, selected.ab, selected.r))
							});
					}
				case 0:
					var n = _v1.a;
					return _Utils_update(
						result,
						{
							a8: $author$project$UI$ActionView$Allowed(
								A3($author$project$Components$Rules$NumericalSubstitution, selected.ak, selected.ab, n.x)),
					...
					var matches = A2(
						...
						function (m) {
							return A2(
								$elm$core$Maybe$map,
								function (result) {
									return {a3: result, bU: m.bj};
								},
								A3($author$project$Algo$Matcher$matchSubtree, n.r, m.a3.ab, n.aN));
						},
						rule.aT);
		...
		function (_v0) {
			...
			return A2(
				...
				function (_v1) {
					...
					var nodes = _v1.b;
					var tree = _v1.c;
					return {ak: eqNum, r: nodes, ab: root, l: ids, aN: tree};
				},
				A2(
					$elm$core$Maybe$andThen,
					A2(
			...
			switch (input.$) {
				case 0:
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for(t.cl)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$name(t.cl),
										$elm$html$Html$Attributes$id(
										$author$project$UI$Dialog$fieldID(t.cl))
									]),
								_List_Nil)
							]));
				case 1:
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$UI$HtmlEvent$onClick(m.cj),
								$author$project$UI$Icon$class('clickable')
							]),
						_List_fromArray(
							[
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					'left',
					$elm$core$String$fromFloat(model.q.y) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(model.q.A - model.q.y) + 'dvw'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					...
					$elm$html$Html$Attributes$id(model.cl)
				]),
								...
								if (_v3.$ === 1) {
									return _List_fromArray(
										[
											...
											$author$project$Algo$Math$toString(c.ab))
										]);
								} else {
									var after = _v3.a;
									return A2(
...
var $author$project$UI$Menu$partToHtml_ = F3(
	function (converter, model, part) {
		if (part.$ === 1) {
			...
			var title = part.a;
			var children = part.b;
			var shown = A2($elm$core$Set$member, title.a, model.X);
			return A2(
				$elm$html$Html$li,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'history',
								A3($author$project$UI$HistoryView$view, $author$project$Main$HistoryEvent, model.av, model.g))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'actions',
								A5($author$project$UI$ActionView$view, $author$project$Main$RuleEvent, $author$project$Main$ActionEvent, model.bd, model.g, model.at))),
							$elm$core$Maybe$Just(
							_Utils_Tuple2(
								'inputPane',
								A2(
											...
											A2(
												...
												_List_fromArray(
													[
														...
														A2($elm$core$Maybe$map, $author$project$Main$inputDiv, model.F)
													]))),
											A2(
											$elm$html$Html$div,
											A2(
												...
												model.N ? _List_Nil : _List_fromArray(
													[
														$elm$html$Html$Attributes$class('closed')
													])),
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A2(
															$author$project$UI$Menu$Section,
															{Z: $elm$core$Maybe$Nothing, a: 'Settings'},
															_List_fromArray(
																[
																	$author$project$UI$Menu$Content(
																	_List_fromArray(
															...
															A2($author$project$Components$Tutorial$menu, $author$project$Main$TutorialEvent, model.aB),
															A2(
															$author$project$UI$Menu$Section,
															{
																Z: $elm$core$Maybe$Just(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{cn: $author$project$Main$init, cq: $author$project$Main$EventUrlChange, cr: $author$project$Main$EventUrlRequest, cA: $author$project$Main$subscriptions, cC: $author$project$Main$update, cD: $author$project$Main$view});
